...
public class FatherToInsuranceClient__CONSISTENCY_106_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FamilyToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 6, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCONTEXT__SRC__family(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCREATE__TRG__insuranceClient(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCREATE__CORR__familyToInsuranceClient();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCONTEXT__SRC__familyRegister(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCREATE__SRC__father(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCREATE__CORR__memberToInsuranceClient();
			...
			case "FamilyToInsuranceClient_object_SP0": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_106_localSearch", 9);
			...
			case "MemberToInsuranceClient_object_SP0": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_106_localSearch", 9);
			...
			case "FatherToInsuranceClient__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_106_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_3_1_orchestration, match_8);
				}
				break;
			case "FatherToInsuranceClient__FWD_103_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_106_localSearch", 9);
				...
				break;
			case "FatherToInsuranceClient__BWD_79_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_106_localSearch", 9);
		...
		case "Families2Insurance.FamilyToInsuranceClient_source_Family": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.Family) {
				{
					...
					HMatch match = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_106_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register FatherToInsuranceClient__FWD
		...
		// register FatherToInsuranceClient__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister FatherToInsuranceClient__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister FatherToInsuranceClient__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(5);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof edu.kit.ipd.sdq.metamodels.families.Member) {
			HMatch match_2 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_106_localSearch", 9);
		...
		if(obj instanceof edu.kit.ipd.sdq.metamodels.families.Family) {
			HMatch match_0 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_106_localSearch", 9);
		...
		if(obj instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) {
			HMatch match_3 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_106_localSearch", 9);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, father.getFirstName(), "java.lang.String"));
