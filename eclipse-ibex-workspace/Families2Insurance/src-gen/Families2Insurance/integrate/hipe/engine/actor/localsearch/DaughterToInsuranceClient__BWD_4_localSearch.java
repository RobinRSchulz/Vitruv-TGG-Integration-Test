...
public class DaughterToInsuranceClient__BWD_4_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("DaughterToInsuranceClient__CONSISTENCY_31_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Family_object_SP0": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("DaughterToInsuranceClient__BWD_4_localSearch", 5);
			...
			case "FamilyRegister_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("DaughterToInsuranceClient__BWD_4_localSearch", 5);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("DaughterToInsuranceClient__BWD_4_localSearch", 5);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_3_1_orchestration, match_2);
				}
				break;
			case "DaughterToInsuranceClient__TRG_1_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("DaughterToInsuranceClient__BWD_4_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DaughterToInsuranceClient__BWD_4_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register DaughterToInsuranceClient__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister DaughterToInsuranceClient__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[3];
		oMatch_Nodes_0[1] = objs[4];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) {
			HMatch match_4 = new LocalSearchMatch("DaughterToInsuranceClient__BWD_4_localSearch", 5);
