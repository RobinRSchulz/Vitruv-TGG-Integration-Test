...
public class SonToInsuranceClient__SRC_200_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SonToInsuranceClient__FWD_204_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("SonToInsuranceClient__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Family_object_SP6": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("SonToInsuranceClient__SRC_200_localSearch", 3);
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("SonToInsuranceClient__SRC_200_localSearch", 3);
			...
			case "Member_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// son
						HMatch match_2 = new LocalSearchMatch("SonToInsuranceClient__SRC_200_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "SonToInsuranceClient_son_daughters_incoming_SRC__FILTER_NAC_SRC_184_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SonToInsuranceClient__SRC_200_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SonToInsuranceClient_son_father_incoming_SRC__FILTER_NAC_SRC_187_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SonToInsuranceClient__SRC_200_localSearch", 3);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "SonToInsuranceClient_son_mother_incoming_SRC__FILTER_NAC_SRC_190_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("SonToInsuranceClient__SRC_200_localSearch", 3);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("SonToInsuranceClient__SRC_200_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
