...
public class SonToInsuranceClient__CC_193_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyRegisterToInsuranceDatabase) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 0, 4, edge_explorer_6_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SonToInsuranceClient__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Family_object_SP2": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("SonToInsuranceClient__CC_193_localSearch", 6);
			...
			case "FamilyRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("SonToInsuranceClient__CC_193_localSearch", 6);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP2": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("SonToInsuranceClient__CC_193_localSearch", 6);
			...
			case "InsuranceDatabase_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("SonToInsuranceClient__CC_193_localSearch", 6);
			...
			case "Member_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// son
						HMatch match_4 = new LocalSearchMatch("SonToInsuranceClient__CC_193_localSearch", 6);
			...
			case "InsuranceClient_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_5 = new LocalSearchMatch("SonToInsuranceClient__CC_193_localSearch", 6);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_4_1_orchestration, match_5);
					}
				}
				break;
			case "SonToInsuranceClient_son_daughters_incoming_SRC__FILTER_NAC_SRC_184_localSearch": 
				{
				...
				break;
			case "SonToInsuranceClient_son_father_incoming_SRC__FILTER_NAC_SRC_187_localSearch": 
				{
				...
				break;
			case "SonToInsuranceClient_son_mother_incoming_SRC__FILTER_NAC_SRC_190_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "SonToInsuranceClient_son_daughters_incoming_SRC__FILTER_NAC_SRC_184_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SonToInsuranceClient__CC_193_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SonToInsuranceClient_son_father_incoming_SRC__FILTER_NAC_SRC_187_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SonToInsuranceClient__CC_193_localSearch", 6);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "SonToInsuranceClient_son_mother_incoming_SRC__FILTER_NAC_SRC_190_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("SonToInsuranceClient__CC_193_localSearch", 6);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
		...
		case "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) {
				{
					...
					HMatch match = new LocalSearchMatch("SonToInsuranceClient__CC_193_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		edu.kit.ipd.sdq.metamodels.families.Member son = (edu.kit.ipd.sdq.metamodels.families.Member) match.getNodes()[4];
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Concat csp_32 = new org.emoflon.ibex.tgg.operational.csp.constraints.Concat();
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, son.getFirstName(), "java.lang.String"));
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, family.getLastName(), "java.lang.String"));
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getName(), "java.lang.String"));
		csp_32.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectMale csp_33 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectMale();
		csp_33.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getGender(), "Enum::Gender"));
		csp_33.solve();
