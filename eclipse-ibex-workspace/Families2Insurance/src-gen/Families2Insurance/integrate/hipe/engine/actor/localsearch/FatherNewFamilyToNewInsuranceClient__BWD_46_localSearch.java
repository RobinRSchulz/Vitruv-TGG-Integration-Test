...
public class FatherNewFamilyToNewInsuranceClient__BWD_46_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FatherNewFamilyToNewInsuranceClient__BWD_production"), this::returnTrue , 0  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_72_localSearch"), this::returnTrue  , false ));
	}
			...
			case "FamilyRegister_object_SP0": 
				{
					...
					// familyRegister
					HMatch match_0 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__BWD_46_localSearch", 4);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP4": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__BWD_46_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_1_orchestration, match_1);
				}
				break;
			case "FatherNewFamilyToNewInsuranceClient__TRG_43_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__BWD_46_localSearch", 4);
		...
		case "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) {
				{
					...
					HMatch match = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__BWD_46_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register FatherNewFamilyToNewInsuranceClient__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister FatherNewFamilyToNewInsuranceClient__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[2];
		oMatch_Nodes_0[1] = objs[3];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) {
			HMatch match_3 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__BWD_46_localSearch", 4);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectMale csp_7 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectMale();
