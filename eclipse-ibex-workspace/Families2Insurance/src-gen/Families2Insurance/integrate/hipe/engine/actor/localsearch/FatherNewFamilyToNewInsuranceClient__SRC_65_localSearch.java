...
public class FatherNewFamilyToNewInsuranceClient__SRC_65_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_69_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("FatherNewFamilyToNewInsuranceClient__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Family_object_SP1": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__SRC_65_localSearch", 3);
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__SRC_65_localSearch", 3);
			...
			case "Member_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// father
						HMatch match_2 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__SRC_65_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "FatherNewFamilyToNewInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_49_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__SRC_65_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "FatherNewFamilyToNewInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_52_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__SRC_65_localSearch", 3);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "FatherNewFamilyToNewInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_55_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__SRC_65_localSearch", 3);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.Family_father_Member": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__SRC_65_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
