...
public class MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_156_localSearch extends GenericLocalSearchActor{
			...
			case "Family_object_SP8": 
				{
					...
					// FILTER_NAC_NODE
					HMatch match_0 = new LocalSearchMatch("MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_156_localSearch", 2);
			...
			case "Member_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// mother
						HMatch match_1 = new LocalSearchMatch("MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_156_localSearch", 2);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.Family_father_Member": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_156_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
