...
public class FatherToInsuranceClient__CC_92_localSearch extends GenericLocalSearchActor{
			...
			case "Family_object_SP3": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("FatherToInsuranceClient__CC_92_localSearch", 6);
			...
			case "FamilyRegister_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("FatherToInsuranceClient__CC_92_localSearch", 6);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP3": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("FatherToInsuranceClient__CC_92_localSearch", 6);
			...
			case "InsuranceDatabase_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("FatherToInsuranceClient__CC_92_localSearch", 6);
			...
			case "Member_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// father
						HMatch match_4 = new LocalSearchMatch("FatherToInsuranceClient__CC_92_localSearch", 6);
			...
			case "InsuranceClient_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_5 = new LocalSearchMatch("FatherToInsuranceClient__CC_92_localSearch", 6);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_2_orchestration, match_5);
					}
				}
				break;
			case "FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_83_localSearch": 
				{
				...
				break;
			case "FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_86_localSearch": 
				{
				...
				break;
			case "FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_89_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_83_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("FatherToInsuranceClient__CC_92_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_86_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("FatherToInsuranceClient__CC_92_localSearch", 6);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_89_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("FatherToInsuranceClient__CC_92_localSearch", 6);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("FatherToInsuranceClient__CC_92_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Concat csp_14 = new org.emoflon.ibex.tgg.operational.csp.constraints.Concat();
		...
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, father.getFirstName(), "java.lang.String"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, family.getLastName(), "java.lang.String"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getName(), "java.lang.String"));
		csp_14.solve();
