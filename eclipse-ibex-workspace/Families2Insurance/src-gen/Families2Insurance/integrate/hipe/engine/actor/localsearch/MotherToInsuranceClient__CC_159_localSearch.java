...
public class MotherToInsuranceClient__CC_159_localSearch extends GenericLocalSearchActor{
			...
			case "Family_object_SP5": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("MotherToInsuranceClient__CC_159_localSearch", 6);
			...
			case "FamilyRegister_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("MotherToInsuranceClient__CC_159_localSearch", 6);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP4": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MotherToInsuranceClient__CC_159_localSearch", 6);
			...
			case "InsuranceDatabase_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("MotherToInsuranceClient__CC_159_localSearch", 6);
			...
			case "Member_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// mother
						HMatch match_4 = new LocalSearchMatch("MotherToInsuranceClient__CC_159_localSearch", 6);
			...
			case "InsuranceClient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_5 = new LocalSearchMatch("MotherToInsuranceClient__CC_159_localSearch", 6);
		...
		switch(match.creator) {
			...
			case "MotherToInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_150_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MotherToInsuranceClient__CC_159_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "MotherToInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_153_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("MotherToInsuranceClient__CC_159_localSearch", 6);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_156_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("MotherToInsuranceClient__CC_159_localSearch", 6);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
		...
		case "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) {
				{
					...
					HMatch match = new LocalSearchMatch("MotherToInsuranceClient__CC_159_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Concat csp_26 = new org.emoflon.ibex.tgg.operational.csp.constraints.Concat();
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mother.getFirstName(), "java.lang.String"));
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, family.getLastName(), "java.lang.String"));
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getName(), "java.lang.String"));
		csp_26.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectFemale csp_27 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectFemale();
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getGender(), "Enum::Gender"));
		csp_27.solve();
