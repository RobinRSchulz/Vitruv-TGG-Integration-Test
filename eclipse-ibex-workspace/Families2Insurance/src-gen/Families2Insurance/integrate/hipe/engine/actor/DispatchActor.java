...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAddEdge() {
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__SRC__familyRegister(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_31_localSearch").tell(new ReferenceAdded<Something2Else.DaughterToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.DaughterToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.DaughterToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase_Target(), notification -> {
			...
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_40_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__BWD_46_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CC_58_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_69_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__BWD_79_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__CC_92_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__FWD_103_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__BWD_113_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CC_125_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_136_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__BWD_146_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CC_159_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_170_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__BWD_180_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CC_193_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getMotherToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient(), notification -> {
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<Something2Else.MotherToInsuranceClient__Marker, Something2Else.MemberToInsuranceClient>(incUtil,(Something2Else.MotherToInsuranceClient__Marker) notification.getNotifier(), (Something2Else.MemberToInsuranceClient) notification.getNewValue(), "Something2Else.MotherToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient_MemberToInsuranceClient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyToInsuranceClient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_31_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_72_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_139_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_207_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getSonToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB(), notification -> {
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_207_localSearch").tell(new ReferenceAdded<Something2Else.SonToInsuranceClient__Marker, Something2Else.FamilyRegisterToInsuranceDatabase>(incUtil,(Something2Else.SonToInsuranceClient__Marker) notification.getNotifier(), (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNewValue(), "Something2Else.SonToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB_FamilyRegisterToInsuranceDatabase"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getMotherToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB(), notification -> {
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<Something2Else.MotherToInsuranceClient__Marker, Something2Else.FamilyRegisterToInsuranceDatabase>(incUtil,(Something2Else.MotherToInsuranceClient__Marker) notification.getNotifier(), (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNewValue(), "Something2Else.MotherToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB_FamilyRegisterToInsuranceDatabase"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getMotherToInsuranceClient__Marker_CREATE__CORR__familyToInsuranceClient(), notification -> {
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<Something2Else.MotherToInsuranceClient__Marker, Something2Else.FamilyToInsuranceClient>(incUtil,(Something2Else.MotherToInsuranceClient__Marker) notification.getNotifier(), (Something2Else.FamilyToInsuranceClient) notification.getNewValue(), "Something2Else.MotherToInsuranceClient__Marker_CREATE__CORR__familyToInsuranceClient_FamilyToInsuranceClient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__SRC__family(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_31_localSearch").tell(new ReferenceAdded<Something2Else.DaughterToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.DaughterToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.DaughterToInsuranceClient__Marker_CONTEXT__SRC__family_Family"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getMemberToInsuranceClient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_31_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_72_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__CONSISTENCY_106_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_139_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_207_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_source_Member"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getSonToInsuranceClient__Marker_CONTEXT__SRC__familyRegister(), notification -> {
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_207_localSearch").tell(new ReferenceAdded<Something2Else.SonToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.SonToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.SonToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getMotherToInsuranceClient__Marker_CONTEXT__SRC__familyRegister(), notification -> {
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<Something2Else.MotherToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.MotherToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.MotherToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__BWD_4_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_40_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__BWD_46_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CC_58_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_69_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__BWD_79_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__CC_92_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__FWD_103_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__BWD_113_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CC_125_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_136_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__BWD_146_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CC_159_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_170_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__BWD_180_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CC_193_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__FWD_204_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getMotherToInsuranceClient__Marker_CONTEXT__TRG__insuranceDB(), notification -> {
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<Something2Else.MotherToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.MotherToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.MotherToInsuranceClient__Marker_CONTEXT__TRG__insuranceDB_InsuranceDatabase"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getSonToInsuranceClient__Marker_CONTEXT__SRC__family(), notification -> {
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_207_localSearch").tell(new ReferenceAdded<Something2Else.SonToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.SonToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.SonToInsuranceClient__Marker_CONTEXT__SRC__family_Family"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getMotherToInsuranceClient__Marker_CONTEXT__SRC__family(), notification -> {
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<Something2Else.MotherToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.MotherToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.MotherToInsuranceClient__Marker_CONTEXT__SRC__family_Family"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyToInsuranceClient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_31_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_72_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_139_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_207_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_source_Family"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getMemberToInsuranceClient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_31_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_72_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_139_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_207_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getSonToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient(), notification -> {
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_207_localSearch").tell(new ReferenceAdded<Something2Else.SonToInsuranceClient__Marker, Something2Else.MemberToInsuranceClient>(incUtil,(Something2Else.SonToInsuranceClient__Marker) notification.getNotifier(), (Something2Else.MemberToInsuranceClient) notification.getNewValue(), "Something2Else.SonToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient_MemberToInsuranceClient"), getSelf());
		});
	...
	private void initializeRemoveEdge() {
		...
		feature2removeEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase_Target(), notification -> {
			...
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_40_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__BWD_46_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CC_58_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_69_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__BWD_79_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__CC_92_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__FWD_103_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__BWD_113_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CC_125_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_136_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__BWD_146_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CC_159_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_170_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__BWD_180_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CC_193_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__FWD_204_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
		});
