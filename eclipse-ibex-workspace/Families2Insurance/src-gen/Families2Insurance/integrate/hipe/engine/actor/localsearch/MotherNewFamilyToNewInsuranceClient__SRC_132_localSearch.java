...
public class MotherNewFamilyToNewInsuranceClient__SRC_132_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_136_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("MotherNewFamilyToNewInsuranceClient__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Family_object_SP3": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__SRC_132_localSearch", 3);
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__SRC_132_localSearch", 3);
			...
			case "Member_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// mother
						HMatch match_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__SRC_132_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_116_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__SRC_132_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_119_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__SRC_132_localSearch", 3);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_122_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__SRC_132_localSearch", 3);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__SRC_132_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
