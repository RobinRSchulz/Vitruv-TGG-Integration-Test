...
public class MotherToInsuranceClient__FWD_155_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MotherToInsuranceClient__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Family_object_SP0": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("MotherToInsuranceClient__FWD_155_localSearch", 5);
			...
			case "FamilyRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("MotherToInsuranceClient__FWD_155_localSearch", 5);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MotherToInsuranceClient__FWD_155_localSearch", 5);
			...
			case "InsuranceDatabase_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("MotherToInsuranceClient__FWD_155_localSearch", 5);
			...
			case "Member_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// mother
						HMatch match_4 = new LocalSearchMatch("MotherToInsuranceClient__FWD_155_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "MotherToInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_136_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MotherToInsuranceClient__FWD_155_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "MotherToInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_139_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("MotherToInsuranceClient__FWD_155_localSearch", 5);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_142_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("MotherToInsuranceClient__FWD_155_localSearch", 5);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
		...
		case "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister) {
				{
					...
					HMatch match = new LocalSearchMatch("MotherToInsuranceClient__FWD_155_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
