...
public class MotherNewFamilyToNewInsuranceClient__BWD_100_localSearch extends GenericLocalSearchActor{
			...
			case "FamilyRegister_object_SP1": 
				{
					...
					// familyRegister
					HMatch match_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__BWD_100_localSearch", 4);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP0": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__BWD_100_localSearch", 4);
			...
			case "InsuranceDatabase_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__BWD_100_localSearch", 4);
			...
			case "InsuranceClient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_3 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__BWD_100_localSearch", 4);
		...
		case "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) {
				{
					...
					HMatch match = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__BWD_100_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
