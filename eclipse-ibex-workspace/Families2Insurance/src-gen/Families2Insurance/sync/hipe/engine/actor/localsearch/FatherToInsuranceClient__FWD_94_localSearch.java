...
public class FatherToInsuranceClient__FWD_94_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FatherToInsuranceClient__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Family_object_SP7": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("FatherToInsuranceClient__FWD_94_localSearch", 5);
			...
			case "FamilyRegister_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("FatherToInsuranceClient__FWD_94_localSearch", 5);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP4": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("FatherToInsuranceClient__FWD_94_localSearch", 5);
			...
			case "InsuranceDatabase_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("FatherToInsuranceClient__FWD_94_localSearch", 5);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_3_1_orchestration, match_3);
					}
				}
				break;
			case "Member_object_SP6": 
				{
					if(!lazy_initialization) {
						
						// father
						HMatch match_4 = new LocalSearchMatch("FatherToInsuranceClient__FWD_94_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_75_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("FatherToInsuranceClient__FWD_94_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_78_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("FatherToInsuranceClient__FWD_94_localSearch", 5);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_81_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("FatherToInsuranceClient__FWD_94_localSearch", 5);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
		...
		case "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister) {
				{
					...
					HMatch match = new LocalSearchMatch("FatherToInsuranceClient__FWD_94_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
