...
public class DaughterToInsuranceClient__FWD_26_localSearch extends GenericLocalSearchActor{
			...
			case "Family_object_SP5": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("DaughterToInsuranceClient__FWD_26_localSearch", 5);
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("DaughterToInsuranceClient__FWD_26_localSearch", 5);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP2": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("DaughterToInsuranceClient__FWD_26_localSearch", 5);
			...
			case "InsuranceDatabase_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("DaughterToInsuranceClient__FWD_26_localSearch", 5);
			...
			case "Member_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// daughter
						HMatch match_4 = new LocalSearchMatch("DaughterToInsuranceClient__FWD_26_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "DaughterToInsuranceClient_daughter_sons_incoming_SRC__FILTER_NAC_SRC_7_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DaughterToInsuranceClient__FWD_26_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "DaughterToInsuranceClient_daughter_father_incoming_SRC__FILTER_NAC_SRC_10_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("DaughterToInsuranceClient__FWD_26_localSearch", 5);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "DaughterToInsuranceClient_daughter_mother_incoming_SRC__FILTER_NAC_SRC_13_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("DaughterToInsuranceClient__FWD_26_localSearch", 5);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.Member_familyDaughter_Family": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DaughterToInsuranceClient__FWD_26_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
