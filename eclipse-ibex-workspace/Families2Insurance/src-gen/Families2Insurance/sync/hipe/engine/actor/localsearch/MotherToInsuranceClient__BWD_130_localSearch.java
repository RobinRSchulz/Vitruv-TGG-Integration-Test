...
public class MotherToInsuranceClient__BWD_130_localSearch extends GenericLocalSearchActor{
			...
			case "Family_object_SP4": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("MotherToInsuranceClient__BWD_130_localSearch", 5);
			...
			case "FamilyRegister_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("MotherToInsuranceClient__BWD_130_localSearch", 5);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP3": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MotherToInsuranceClient__BWD_130_localSearch", 5);
			...
			case "InsuranceDatabase_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("MotherToInsuranceClient__BWD_130_localSearch", 5);
			...
			case "InsuranceClient_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_4 = new LocalSearchMatch("MotherToInsuranceClient__BWD_130_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("MotherToInsuranceClient__BWD_130_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
