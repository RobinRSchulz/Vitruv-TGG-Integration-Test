...
public class FatherNewFamilyToNewInsuranceClient__FWD_63_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "FamilyRegister_object_SP2": 
				{
					...
					// familyRegister
					HMatch match_0 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__FWD_63_localSearch", 5);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP1": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__FWD_63_localSearch", 5);
			...
			case "InsuranceDatabase_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_2 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__FWD_63_localSearch", 5);
			...
			case "Family_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// family
						HMatch match_3 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__FWD_63_localSearch", 5);
			...
			case "Member_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// father
						HMatch match_4 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__FWD_63_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "FatherNewFamilyToNewInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_44_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__FWD_63_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "FatherNewFamilyToNewInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_47_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__FWD_63_localSearch", 5);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "FatherNewFamilyToNewInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_50_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__FWD_63_localSearch", 5);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__FWD_63_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
