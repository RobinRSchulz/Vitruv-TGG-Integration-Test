...
public class MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCONTEXT__SRC__familyRegister(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCREATE__SRC__family(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCREATE__CORR__familyToInsuranceClient();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCREATE__TRG__insuranceClient(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) o).getInsuranceclient();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) return edge_explorer_8_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyToInsuranceClient) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Family) o).getMother();
						edge_explorer_10_methods.unique_opposite_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Member) o).getFamilyMother();
						edge_explorer_10 = new EdgeExplorer(this, 0, 2, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCREATE__SRC__mother(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MemberToInsuranceClient) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
						edge_explorer_12 = new CachedEdgeExplorer(this, 7, 3, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCONTEXT__TRG__insuranceDB(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyRegisterToInsuranceDatabase) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
						edge_explorer_14 = new CachedEdgeExplorer(this, 5, 1, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCONTEXT__CORR__familyRegisterToInsuranceDB();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCREATE__CORR__memberToInsuranceClient();
						edge_explorer_16 = new CachedEdgeExplorer(this, 8, 7, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyRegisterToInsuranceDatabase) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MemberToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
						edge_explorer_18 = new CachedEdgeExplorer(this, 7, 2, edge_explorer_18_methods);
			...
			case "Family_object_SP8": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
			...
			case "Member_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// mother
						HMatch match_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
			...
			case "InsuranceClient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_3 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_7_1_orchestration, match_3);
					}
				}
				break;
			case "InsuranceDatabase_object_SP2": 
				{
					if(!lazy_initialization) {
						
						// insuranceDB
						HMatch match_4 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
			...
			case "FamilyToInsuranceClient_object_SP1": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
			...
			case "MemberToInsuranceClient_object_SP1": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
			...
			case "MotherNewFamilyToNewInsuranceClient__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_105_localSearch": 
				{
				...
				break;
			case "MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_108_localSearch": 
				{
				...
				break;
			case "MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_111_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_105_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_108_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_111_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
		...
		case "Something2Else.MotherNewFamilyToNewInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister) {
				{
					...
					HMatch match = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_114_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
