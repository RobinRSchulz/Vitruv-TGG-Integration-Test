...
public class SonToInsuranceClient__CC_93_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Family) o).getSons();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Member) o).getFamilySon();
			...
			case "Family_object_SP2": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("SonToInsuranceClient__CC_93_localSearch", 6);
			...
			case "FamilyRegister_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("SonToInsuranceClient__CC_93_localSearch", 6);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP1": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("SonToInsuranceClient__CC_93_localSearch", 6);
			...
			case "InsuranceDatabase_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("SonToInsuranceClient__CC_93_localSearch", 6);
			...
			case "Member_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// son
						HMatch match_4 = new LocalSearchMatch("SonToInsuranceClient__CC_93_localSearch", 6);
			...
			case "InsuranceClient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_5 = new LocalSearchMatch("SonToInsuranceClient__CC_93_localSearch", 6);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_2_orchestration, match_5);
					}
				}
				break;
			case "SonToInsuranceClient_son_daughters_incoming_SRC__FILTER_NAC_SRC_84_localSearch": 
				{
				...
				break;
			case "SonToInsuranceClient_son_father_incoming_SRC__FILTER_NAC_SRC_87_localSearch": 
				{
				...
				break;
			case "SonToInsuranceClient_son_mother_incoming_SRC__FILTER_NAC_SRC_90_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "SonToInsuranceClient_son_daughters_incoming_SRC__FILTER_NAC_SRC_84_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SonToInsuranceClient__CC_93_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SonToInsuranceClient_son_father_incoming_SRC__FILTER_NAC_SRC_87_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SonToInsuranceClient__CC_93_localSearch", 6);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "SonToInsuranceClient_son_mother_incoming_SRC__FILTER_NAC_SRC_90_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("SonToInsuranceClient__CC_93_localSearch", 6);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("SonToInsuranceClient__CC_93_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
