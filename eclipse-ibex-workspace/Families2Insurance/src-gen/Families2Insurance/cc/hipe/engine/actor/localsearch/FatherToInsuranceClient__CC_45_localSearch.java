...
public class FatherToInsuranceClient__CC_45_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Family) o).getFather();
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Member) o).getFamilyFather();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FatherToInsuranceClient__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Family_object_SP2": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("FatherToInsuranceClient__CC_45_localSearch", 6);
			...
			case "FamilyRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("FatherToInsuranceClient__CC_45_localSearch", 6);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("FatherToInsuranceClient__CC_45_localSearch", 6);
			...
			case "InsuranceDatabase_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("FatherToInsuranceClient__CC_45_localSearch", 6);
			...
			case "Member_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// father
						HMatch match_4 = new LocalSearchMatch("FatherToInsuranceClient__CC_45_localSearch", 6);
			...
			case "InsuranceClient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_5 = new LocalSearchMatch("FatherToInsuranceClient__CC_45_localSearch", 6);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_6_1_orchestration, match_5);
					}
				}
				break;
			case "FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_36_localSearch": 
				{
				...
				break;
			case "FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_39_localSearch": 
				{
				...
				break;
			case "FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_42_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_36_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("FatherToInsuranceClient__CC_45_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_39_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("FatherToInsuranceClient__CC_45_localSearch", 6);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_42_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("FatherToInsuranceClient__CC_45_localSearch", 6);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
		...
		case "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister) {
				{
					...
					HMatch match = new LocalSearchMatch("FatherToInsuranceClient__CC_45_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
