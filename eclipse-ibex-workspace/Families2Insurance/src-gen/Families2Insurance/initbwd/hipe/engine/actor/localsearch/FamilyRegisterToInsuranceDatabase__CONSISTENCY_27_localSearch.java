...
public class FamilyRegisterToInsuranceDatabase__CONSISTENCY_27_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyRegisterToInsuranceDatabase__Marker) o).getCREATE__TRG__insuranceDb(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
			...
			case "FamilyRegister_object_SP2": 
				{
					...
					// familyRegister
					HMatch match_0 = new LocalSearchMatch("FamilyRegisterToInsuranceDatabase__CONSISTENCY_27_localSearch", 4);
			...
			case "InsuranceDatabase_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDb
						HMatch match_1 = new LocalSearchMatch("FamilyRegisterToInsuranceDatabase__CONSISTENCY_27_localSearch", 4);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP2": 
				{
					...
					// famRegToInsDb
					HMatch match_2 = new LocalSearchMatch("FamilyRegisterToInsuranceDatabase__CONSISTENCY_27_localSearch", 4);
			...
			case "FamilyRegisterToInsuranceDatabase__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("FamilyRegisterToInsuranceDatabase__CONSISTENCY_27_localSearch", 4);
		...
		case "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister) {
				{
					...
					HMatch match = new LocalSearchMatch("FamilyRegisterToInsuranceDatabase__CONSISTENCY_27_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
