...
public class MotherToInsuranceClient__CONSISTENCY_120_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherToInsuranceClient__Marker) o).getCONTEXT__TRG__insuranceDB(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 8, 4, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherToInsuranceClient__Marker) o).getCONTEXT__SRC__family(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherToInsuranceClient__Marker) o).getCONTEXT__SRC__familyRegister(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherToInsuranceClient__Marker) o).getCREATE__TRG__insuranceClient(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MemberToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyRegisterToInsuranceDatabase) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherToInsuranceClient__Marker) o).getCREATE__SRC__mother(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Something2Else.MotherToInsuranceClient__Marker) o).getCREATE__CORR__familyToInsuranceClient();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Something2Else.MotherToInsuranceClient__Marker) o).getCONTEXT__CORR__familyRegisterToInsuranceDB();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Something2Else.MotherToInsuranceClient__Marker) o).getCREATE__CORR__memberToInsuranceClient();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Something2Else.MotherToInsuranceClient__Marker_CONTEXT__TRG__insuranceDB_InsuranceDatabase": 
			if(!lazy_initialization) {
			...
			break;
		case "Something2Else.MotherToInsuranceClient__Marker_CONTEXT__SRC__family_Family": 
			if(!lazy_initialization) {
			...
			break;
		case "Something2Else.MotherToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister": 
			if(!lazy_initialization) {
			...
			break;
		case "Something2Else.MotherToInsuranceClient__Marker_CREATE__TRG__insuranceClient_InsuranceClient": 
			if(!lazy_initialization) {
		...
		case "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase": 
			...
			break;
		case "Something2Else.MotherToInsuranceClient__Marker_CREATE__SRC__mother_Member": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.Member) {
				{
		...
		case "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family": 
			...
			break;
		case "Something2Else.MotherToInsuranceClient__Marker_CREATE__CORR__familyToInsuranceClient_FamilyToInsuranceClient": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Something2Else.MotherToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB_FamilyRegisterToInsuranceDatabase": 
			if(!lazy_initialization) {
				{
		...
		case "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient": 
			...
			break;
		case "Something2Else.MotherToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient_MemberToInsuranceClient": 
			if(!lazy_initialization) {
				{
