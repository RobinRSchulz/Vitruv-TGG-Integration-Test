...
public class MotherToInsuranceClient__CONSISTENCY_120_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCONTEXT__CORR__familyRegisterToInsuranceDB();
						edge_explorer = new CachedEdgeExplorer(this, 8, 5, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) o).getInsuranceclient();
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) return edge_explorer_3_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_3 = new EdgeExplorer(this, 4, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCONTEXT__SRC__family(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCREATE__TRG__insuranceClient(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCONTEXT__SRC__familyRegister(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FamilyToInsuranceClient) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCONTEXT__TRG__insuranceDB(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCREATE__SRC__mother(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCREATE__CORR__memberToInsuranceClient();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FamilyToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FamilyRegisterToInsuranceDatabase) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
						edge_explorer_13 = new CachedEdgeExplorer(this, 5, 4, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Family) o).getMother();
						edge_explorer_14_methods.unique_opposite_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Member) o).getFamilyMother();
						edge_explorer_14 = new EdgeExplorer(this, 0, 2, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCREATE__CORR__familyToInsuranceClient();
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MemberToInsuranceClient) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MemberToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MotherToInsuranceClient__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Family_object_SP5": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
			...
			case "Member_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// mother
						HMatch match_2 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
			...
			case "InsuranceClient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_3 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
			...
			case "InsuranceDatabase_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_4 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_3_1_orchestration, match_4);
					}
				}
				break;
			case "FamilyRegisterToInsuranceDatabase_object_SP2": 
				{
					edge_explorer_13.registerSourceObject(objs[0]);
					edge_explorer_16.registerSourceObject(objs[0]);
					
					// familyRegisterToInsuranceDB
					HMatch match_5 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
			...
			case "FamilyToInsuranceClient_object_SP0": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
			...
			case "MemberToInsuranceClient_object_SP0": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_11_1_orchestration, match_7);
				}
				break;
			case "MotherToInsuranceClient__Marker_object": 
				{
					...
					// MotherToInsuranceClient_eMoflon_ProtocolNode
					HMatch match_8 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "MotherToInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_111_localSearch": 
				{
				...
				break;
			case "MotherToInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_114_localSearch": 
				{
				...
				break;
			case "MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_117_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MotherToInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_111_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "MotherToInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_114_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_117_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Families2Insurance.MotherToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB_FamilyRegisterToInsuranceDatabase": 
			if(!lazy_initialization) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_120_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
		...
		case "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient": 
			...
			break;
		case "Families2Insurance.MotherToInsuranceClient__Marker_CONTEXT__SRC__family_Family": 
			if(!lazy_initialization) {
			...
			break;
		case "Families2Insurance.MotherToInsuranceClient__Marker_CREATE__TRG__insuranceClient_InsuranceClient": 
			if(!lazy_initialization) {
			...
			break;
		case "Families2Insurance.MotherToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister": 
			if(!lazy_initialization) {
		...
		case "Families2Insurance.FamilyToInsuranceClient_target_InsuranceClient": 
			...
			break;
		case "Families2Insurance.MotherToInsuranceClient__Marker_CONTEXT__TRG__insuranceDB_InsuranceDatabase": 
			if(!lazy_initialization) {
			...
			break;
		case "Families2Insurance.MotherToInsuranceClient__Marker_CREATE__SRC__mother_Member": 
			if(!lazy_initialization) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family": 
			...
			break;
		case "Families2Insurance.MotherToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient_MemberToInsuranceClient": 
			if(!lazy_initialization) {
				{
		...
		case "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member": 
			...
			break;
		case "Families2Insurance.MotherToInsuranceClient__Marker_CREATE__CORR__familyToInsuranceClient_FamilyToInsuranceClient": 
			if(!lazy_initialization) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register MotherToInsuranceClient_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister MotherToInsuranceClient_eMoflon_ProtocolNode
		Collection<HMatch> matches_8 = obj2matches.get(objs[8]);
		if(matches_8 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Concat csp_13 = new org.emoflon.ibex.tgg.operational.csp.constraints.Concat();
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mother.getFirstName(), "java.lang.String"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, family.getLastName(), "java.lang.String"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getName(), "java.lang.String"));
		csp_13.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectFemale csp_14 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectFemale();
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getGender(), "Enum::Gender"));
		csp_14.solve();
