...
public class FatherNewFamilyToNewInsuranceClient__BWD_32_localSearch extends GenericLocalSearchActor{
			...
			case "FamilyRegister_object_SP3": 
				{
					...
					// familyRegister
					HMatch match_0 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__BWD_32_localSearch", 4);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP3": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__BWD_32_localSearch", 4);
			...
			case "InsuranceDatabase_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_2 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__BWD_32_localSearch", 4);
			...
			case "InsuranceClient_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_3 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__BWD_32_localSearch", 4);
		...
		case "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) {
				{
					...
					HMatch match = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__BWD_32_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
