...
public class FatherToInsuranceClient__BWD_56_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FatherToInsuranceClient__BWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Family_object_SP2": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("FatherToInsuranceClient__BWD_56_localSearch", 5);
			...
			case "FamilyRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("FatherToInsuranceClient__BWD_56_localSearch", 5);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP1": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("FatherToInsuranceClient__BWD_56_localSearch", 5);
			...
			case "InsuranceDatabase_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("FatherToInsuranceClient__BWD_56_localSearch", 5);
			...
			case "InsuranceClient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_4 = new LocalSearchMatch("FatherToInsuranceClient__BWD_56_localSearch", 5);
		...
		case "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister) {
				{
					...
					HMatch match = new LocalSearchMatch("FatherToInsuranceClient__BWD_56_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectMale csp_6 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectMale();
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getGender(), "Enum::Gender"));
		csp_6.solve();
