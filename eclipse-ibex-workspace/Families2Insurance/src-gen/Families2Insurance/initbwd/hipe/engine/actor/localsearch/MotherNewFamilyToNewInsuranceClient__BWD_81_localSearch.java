...
public class MotherNewFamilyToNewInsuranceClient__BWD_81_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MotherNewFamilyToNewInsuranceClient__BWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "FamilyRegister_object_SP3": 
				{
					...
					// familyRegister
					HMatch match_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__BWD_81_localSearch", 4);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP3": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__BWD_81_localSearch", 4);
			...
			case "InsuranceDatabase_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__BWD_81_localSearch", 4);
			...
			case "InsuranceClient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_3 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__BWD_81_localSearch", 4);
		...
		case "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister) {
				{
					...
					HMatch match = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__BWD_81_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
