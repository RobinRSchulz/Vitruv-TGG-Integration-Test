...
public class MotherToInsuranceClient__CONSISTENCY_116_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCREATE__CORR__memberToInsuranceClient();
						edge_explorer = new CachedEdgeExplorer(this, 8, 7, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCREATE__SRC__mother(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MemberToInsuranceClient) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 7, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FamilyRegisterToInsuranceDatabase) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MemberToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCREATE__CORR__familyToInsuranceClient();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCONTEXT__SRC__family(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MotherToInsuranceClient__Marker) o).getCONTEXT__SRC__familyRegister(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FamilyToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.multi_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) o).getInsuranceclient();
						edge_explorer_17_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) return edge_explorer_17_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_17 = new EdgeExplorer(this, 4, 3, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FamilyRegisterToInsuranceDatabase) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
						edge_explorer_18 = new CachedEdgeExplorer(this, 5, 1, edge_explorer_18_methods);
			...
			case "Family_object_SP4": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
			...
			case "Member_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// mother
						HMatch match_2 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
			...
			case "InsuranceClient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_3 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
			...
			case "InsuranceDatabase_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_4 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
			...
			case "FamilyToInsuranceClient_object_SP0": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
			...
			case "MemberToInsuranceClient_object_SP0": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
			...
			case "MotherToInsuranceClient__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "MotherToInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_107_localSearch": 
				{
				...
				break;
			case "MotherToInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_110_localSearch": 
				{
				...
				break;
			case "MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_113_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MotherToInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_107_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "MotherToInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_110_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_113_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("MotherToInsuranceClient__CONSISTENCY_116_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[7] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Concat csp_8 = new org.emoflon.ibex.tgg.operational.csp.constraints.Concat();
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mother.getFirstName(), "java.lang.String"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, family.getLastName(), "java.lang.String"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getName(), "java.lang.String"));
		csp_8.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectFemale csp_9 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectFemale();
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getGender(), "Enum::Gender"));
		csp_9.solve();
