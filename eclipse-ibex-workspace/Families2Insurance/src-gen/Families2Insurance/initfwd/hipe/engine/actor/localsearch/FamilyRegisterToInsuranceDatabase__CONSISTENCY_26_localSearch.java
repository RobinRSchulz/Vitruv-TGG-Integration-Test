...
public class FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyRegisterToInsuranceDatabase__Marker) o).getCREATE__TRG__insuranceDb(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 3, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Something2Else.FamilyRegisterToInsuranceDatabase__Marker) o).getCREATE__CORR__famRegToInsDb();
						edge_explorer_3 = new CachedEdgeExplorer(this, 3, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyRegisterToInsuranceDatabase__Marker) o).getCREATE__SRC__familyRegister(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
			...
			case "FamilyRegister_object_SP2": 
				{
					...
					// familyRegister
					HMatch match_0 = new LocalSearchMatch("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch", 4);
			...
			case "InsuranceDatabase_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDb
						HMatch match_1 = new LocalSearchMatch("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch", 4);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP2": 
				{
					...
					// famRegToInsDb
					HMatch match_2 = new LocalSearchMatch("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch", 4);
			...
			case "FamilyRegisterToInsuranceDatabase__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Something2Else.FamilyRegisterToInsuranceDatabase__Marker_CREATE__TRG__insuranceDb_InsuranceDatabase": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
			...
			break;
		case "Something2Else.FamilyRegisterToInsuranceDatabase__Marker_CREATE__CORR__famRegToInsDb_FamilyRegisterToInsuranceDatabase": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Something2Else.FamilyRegisterToInsuranceDatabase__Marker_CREATE__SRC__familyRegister_FamilyRegister": 
			if(!lazy_initialization) {
