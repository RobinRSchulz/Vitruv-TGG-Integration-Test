...
public class SonToInsuranceClient__FWD_151_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SonToInsuranceClient__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Family_object_SP5": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("SonToInsuranceClient__FWD_151_localSearch", 5);
			...
			case "FamilyRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("SonToInsuranceClient__FWD_151_localSearch", 5);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("SonToInsuranceClient__FWD_151_localSearch", 5);
			...
			case "InsuranceDatabase_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("SonToInsuranceClient__FWD_151_localSearch", 5);
			...
			case "Member_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// son
						HMatch match_4 = new LocalSearchMatch("SonToInsuranceClient__FWD_151_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "SonToInsuranceClient_son_daughters_incoming_SRC__FILTER_NAC_SRC_132_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SonToInsuranceClient__FWD_151_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SonToInsuranceClient_son_father_incoming_SRC__FILTER_NAC_SRC_135_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SonToInsuranceClient__FWD_151_localSearch", 5);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "SonToInsuranceClient_son_mother_incoming_SRC__FILTER_NAC_SRC_138_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("SonToInsuranceClient__FWD_151_localSearch", 5);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("SonToInsuranceClient__FWD_151_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
