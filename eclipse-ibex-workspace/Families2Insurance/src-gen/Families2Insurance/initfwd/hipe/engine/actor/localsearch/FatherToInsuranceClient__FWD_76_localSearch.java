...
public class FatherToInsuranceClient__FWD_76_localSearch extends GenericLocalSearchActor{
			...
			case "Family_object_SP6": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("FatherToInsuranceClient__FWD_76_localSearch", 5);
			...
			case "FamilyRegister_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("FatherToInsuranceClient__FWD_76_localSearch", 5);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP2": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("FatherToInsuranceClient__FWD_76_localSearch", 5);
			...
			case "InsuranceDatabase_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("FatherToInsuranceClient__FWD_76_localSearch", 5);
			...
			case "Member_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// father
						HMatch match_4 = new LocalSearchMatch("FatherToInsuranceClient__FWD_76_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_57_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("FatherToInsuranceClient__FWD_76_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_60_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("FatherToInsuranceClient__FWD_76_localSearch", 5);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_63_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("FatherToInsuranceClient__FWD_76_localSearch", 5);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.Family_father_Member": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("FatherToInsuranceClient__FWD_76_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
