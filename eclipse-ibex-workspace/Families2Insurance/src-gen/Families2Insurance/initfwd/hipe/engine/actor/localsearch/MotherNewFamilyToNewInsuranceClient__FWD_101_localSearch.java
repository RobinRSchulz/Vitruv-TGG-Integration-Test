...
public class MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch extends GenericLocalSearchActor{
			...
			case "FamilyRegister_object_SP1": 
				{
					...
					// familyRegister
					HMatch match_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch", 5);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP0": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch", 5);
			...
			case "InsuranceDatabase_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch", 5);
			...
			case "Family_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// family
						HMatch match_3 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch", 5);
			...
			case "Member_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// mother
						HMatch match_4 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_82_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_85_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch", 5);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_88_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch", 5);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
