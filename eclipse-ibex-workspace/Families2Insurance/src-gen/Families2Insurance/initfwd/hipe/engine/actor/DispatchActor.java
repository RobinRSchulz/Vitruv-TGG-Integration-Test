package Families2Insurance.initfwd.hipe.engine.actor;
...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAddEdge() {
		feature2addEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getFamilyRegister_Families(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__CONSISTENCY_66_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__FWD_76_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__FWD_151_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getFamily_Sons(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_32_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_sons_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_57_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_sons_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_82_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_sons_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_107_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_sons_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_sons_Member"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getFamily_Father(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__CONSISTENCY_66_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__FWD_76_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_88_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_113_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient_son_father_incoming_SRC__FILTER_NAC_SRC_135_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getFamily_Daughters(), notification -> {
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_35_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_daughters_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_60_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_daughters_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_85_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_daughters_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_110_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_daughters_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient_son_daughters_incoming_SRC__FILTER_NAC_SRC_132_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_daughters_Member"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getMemberToInsuranceClient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Families2Insurance.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Families2Insurance.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Families2Insurance.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Families2Insurance.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getFamilyToInsuranceClient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Families2Insurance.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Families2Insurance.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Families2Insurance.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Families2Insurance.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
		});
		feature2addEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Families2Insurance.DaughterToInsuranceClient__Marker, Families2Insurance.MemberToInsuranceClient>(incUtil,(Families2Insurance.DaughterToInsuranceClient__Marker) notification.getNotifier(), (Families2Insurance.MemberToInsuranceClient) notification.getNewValue(), "Families2Insurance.DaughterToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient_MemberToInsuranceClient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getMemberToInsuranceClient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Families2Insurance.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Families2Insurance.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Families2Insurance.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Families2Insurance.MemberToInsuranceClient_source_Member"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__SRC__familyRegister(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Families2Insurance.DaughterToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Families2Insurance.DaughterToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Families2Insurance.DaughterToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getMember_FamilyDaughter(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Member, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Member) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Member_familyDaughter_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Member, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Member) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Member_familyDaughter_Family"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.insurance.InsurancePackage.eINSTANCE.getInsuranceDatabase_Insuranceclient(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient"), getSelf());
		});
		feature2addEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getFamilyToInsuranceClient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Families2Insurance.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Families2Insurance.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Families2Insurance.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Families2Insurance.FamilyToInsuranceClient_source_Family"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Families2Insurance.DaughterToInsuranceClient__Marker, Families2Insurance.FamilyRegisterToInsuranceDatabase>(incUtil,(Families2Insurance.DaughterToInsuranceClient__Marker) notification.getNotifier(), (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNewValue(), "Families2Insurance.DaughterToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB_FamilyRegisterToInsuranceDatabase"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getFamily_Mother(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_38_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_63_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient_son_mother_incoming_SRC__FILTER_NAC_SRC_138_localSearch").tell(new ReferenceAdded<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__SRC__family(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Families2Insurance.DaughterToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Families2Insurance.DaughterToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Families2Insurance.DaughterToInsuranceClient__Marker_CONTEXT__SRC__family_Family"), getSelf());
		});
	...
	private void initializeRemoveEdge() {
		feature2removeEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getFamilyRegister_Families(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__FWD_151_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.FamilyRegister, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
		...
		feature2removeEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getFamily_Sons(), notification -> {
			...
			name2actor.get("FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_57_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_sons_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_82_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_sons_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_107_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_sons_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_sons_Member"), getSelf());
			incUtil.newMessage();
		...
		feature2removeEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getFamily_Father(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__CONSISTENCY_66_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__FWD_76_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_father_Member"), getSelf());
		...
		feature2removeEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getFamily_Daughters(), notification -> {
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_35_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_daughters_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_60_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_daughters_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_85_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_daughters_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_110_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_daughters_Member"), getSelf());
		...
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getMemberToInsuranceClient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "Families2Insurance.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceDeleted<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "Families2Insurance.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceDeleted<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "Families2Insurance.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceDeleted<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "Families2Insurance.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
		...
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CREATE__SRC__daughter(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.DaughterToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (Families2Insurance.DaughterToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "Families2Insurance.DaughterToInsuranceClient__Marker_CREATE__SRC__daughter_Member"), getSelf());
		});
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getFamilyToInsuranceClient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "Families2Insurance.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "Families2Insurance.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "Families2Insurance.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "Families2Insurance.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.DaughterToInsuranceClient__Marker, Families2Insurance.MemberToInsuranceClient>(incUtil, (Families2Insurance.DaughterToInsuranceClient__Marker) notification.getNotifier(), (Families2Insurance.MemberToInsuranceClient) notification.getOldValue(), "Families2Insurance.DaughterToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient_MemberToInsuranceClient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getMemberToInsuranceClient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "Families2Insurance.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceDeleted<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "Families2Insurance.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceDeleted<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "Families2Insurance.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceDeleted<Families2Insurance.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (Families2Insurance.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "Families2Insurance.MemberToInsuranceClient_source_Member"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__SRC__familyRegister(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.DaughterToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil, (Families2Insurance.DaughterToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getOldValue(), "Families2Insurance.DaughterToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getMember_FamilyDaughter(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Member, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Member_familyDaughter_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Member, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Member_familyDaughter_Family"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.insurance.InsurancePackage.eINSTANCE.getInsuranceDatabase_Insuranceclient(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil, (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getFamilyToInsuranceClient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "Families2Insurance.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "Families2Insurance.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "Families2Insurance.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceDeleted<Families2Insurance.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (Families2Insurance.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "Families2Insurance.FamilyToInsuranceClient_source_Family"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__TRG__insuranceDB(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.DaughterToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Families2Insurance.DaughterToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Families2Insurance.DaughterToInsuranceClient__Marker_CONTEXT__TRG__insuranceDB_InsuranceDatabase"), getSelf());
		});
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.DaughterToInsuranceClient__Marker, Families2Insurance.FamilyRegisterToInsuranceDatabase>(incUtil, (Families2Insurance.DaughterToInsuranceClient__Marker) notification.getNotifier(), (Families2Insurance.FamilyRegisterToInsuranceDatabase) notification.getOldValue(), "Families2Insurance.DaughterToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB_FamilyRegisterToInsuranceDatabase"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(edu.kit.ipd.sdq.metamodels.families.FamiliesPackage.eINSTANCE.getFamily_Mother(), notification -> {
			...
			name2actor.get("FatherNewFamilyToNewInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_38_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_63_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceDeleted<edu.kit.ipd.sdq.metamodels.families.Family, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil, (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getOldValue(), "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member"), getSelf());
		...
		feature2removeEdgeConsumer.put(Families2Insurance.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__SRC__family(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceDeleted<Families2Insurance.DaughterToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil, (Families2Insurance.DaughterToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getOldValue(), "Families2Insurance.DaughterToInsuranceClient__Marker_CONTEXT__SRC__family_Family"), getSelf());
		});
