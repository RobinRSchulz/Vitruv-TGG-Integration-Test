...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAddEdge() {
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__SRC__familyRegister(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Something2Else.DaughterToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.DaughterToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.DaughterToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyToInsuranceClient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_target_InsuranceClient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getSonToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB(), notification -> {
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Something2Else.SonToInsuranceClient__Marker, Something2Else.FamilyRegisterToInsuranceDatabase>(incUtil,(Something2Else.SonToInsuranceClient__Marker) notification.getNotifier(), (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNewValue(), "Something2Else.SonToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB_FamilyRegisterToInsuranceDatabase"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase__Marker_CREATE__CORR__famRegToInsDb(), notification -> {
			incUtil.newMessage();
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase__Marker, Something2Else.FamilyRegisterToInsuranceDatabase>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase__Marker) notification.getNotifier(), (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase__Marker_CREATE__CORR__famRegToInsDb_FamilyRegisterToInsuranceDatabase"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getMemberToInsuranceClient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_source_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Member>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Member) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_source_Member"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getDaughterToInsuranceClient__Marker_CONTEXT__SRC__family(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Something2Else.DaughterToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.DaughterToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.DaughterToInsuranceClient__Marker_CONTEXT__SRC__family_Family"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getSonToInsuranceClient__Marker_CONTEXT__SRC__familyRegister(), notification -> {
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Something2Else.SonToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.SonToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.SonToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase__Marker_CREATE__SRC__familyRegister(), notification -> {
			incUtil.newMessage();
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase__Marker, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase__Marker_CREATE__SRC__familyRegister_FamilyRegister"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getSonToInsuranceClient__Marker_CONTEXT__SRC__family(), notification -> {
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Something2Else.SonToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.SonToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.SonToInsuranceClient__Marker_CONTEXT__SRC__family_Family"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getMemberToInsuranceClient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Something2Else.MemberToInsuranceClient, edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient>(incUtil,(Something2Else.MemberToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) notification.getNewValue(), "Something2Else.MemberToInsuranceClient_target_InsuranceClient"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyToInsuranceClient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__CONSISTENCY_10_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_source_Family"), getSelf());
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Something2Else.FamilyToInsuranceClient, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.FamilyToInsuranceClient) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.FamilyToInsuranceClient_source_Family"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getSonToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient(), notification -> {
			incUtil.newMessage();
			name2actor.get("SonToInsuranceClient__CONSISTENCY_141_localSearch").tell(new ReferenceAdded<Something2Else.SonToInsuranceClient__Marker, Something2Else.MemberToInsuranceClient>(incUtil,(Something2Else.SonToInsuranceClient__Marker) notification.getNotifier(), (Something2Else.MemberToInsuranceClient) notification.getNewValue(), "Something2Else.SonToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient_MemberToInsuranceClient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFatherToInsuranceClient__Marker_CONTEXT__SRC__familyRegister(), notification -> {
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__CONSISTENCY_66_localSearch").tell(new ReferenceAdded<Something2Else.FatherToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.FamilyRegister>(incUtil,(Something2Else.FatherToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.FamilyRegister) notification.getNewValue(), "Something2Else.FatherToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFatherToInsuranceClient__Marker_CONTEXT__SRC__family(), notification -> {
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__CONSISTENCY_66_localSearch").tell(new ReferenceAdded<Something2Else.FatherToInsuranceClient__Marker, edu.kit.ipd.sdq.metamodels.families.Family>(incUtil,(Something2Else.FatherToInsuranceClient__Marker) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.families.Family) notification.getNewValue(), "Something2Else.FatherToInsuranceClient__Marker_CONTEXT__SRC__family_Family"), getSelf());
		});
	...
	private void initializeRemoveEdge() {
		...
		feature2removeEdgeConsumer.put(Something2Else.Families2InsurancePackage.eINSTANCE.getFamilyRegisterToInsuranceDatabase_Target(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("DaughterToInsuranceClient__FWD_20_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FamilyRegisterToInsuranceDatabase__CONSISTENCY_26_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__CONSISTENCY_41_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherNewFamilyToNewInsuranceClient__FWD_51_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__CONSISTENCY_66_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("FatherToInsuranceClient__FWD_76_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			...
			name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherNewFamilyToNewInsuranceClient__FWD_101_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__CONSISTENCY_116_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
			incUtil.newMessage();
			name2actor.get("MotherToInsuranceClient__FWD_126_localSearch").tell(new ReferenceDeleted<Something2Else.FamilyRegisterToInsuranceDatabase, edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase>(incUtil, (Something2Else.FamilyRegisterToInsuranceDatabase) notification.getNotifier(), (edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) notification.getOldValue(), "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase"), getSelf());
