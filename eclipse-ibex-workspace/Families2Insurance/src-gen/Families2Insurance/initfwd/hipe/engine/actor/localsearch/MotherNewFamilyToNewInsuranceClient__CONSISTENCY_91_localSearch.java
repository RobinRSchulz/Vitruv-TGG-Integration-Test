package Families2Insurance.initfwd.hipe.engine.actor.localsearch;
...
public class MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) o).getInsuranceclient();
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) return edge_explorer_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer = new EdgeExplorer(this, 4, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyToInsuranceClient) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCREATE__TRG__insuranceClient(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCREATE__SRC__family(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MemberToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.FamilyRegister) o).getFamilies();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister) return edge_explorer_8_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyRegisterToInsuranceDatabase) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCONTEXT__SRC__familyRegister(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCONTEXT__TRG__insuranceDB(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Family) o).getMother();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Member) o).getFamilyMother();
						edge_explorer_12 = new EdgeExplorer(this, 0, 2, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCREATE__SRC__mother(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.MemberToInsuranceClient) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
						edge_explorer_14 = new CachedEdgeExplorer(this, 7, 3, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyRegisterToInsuranceDatabase) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
						edge_explorer_15 = new CachedEdgeExplorer(this, 5, 1, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCONTEXT__CORR__familyRegisterToInsuranceDB();
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCREATE__CORR__memberToInsuranceClient();
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((Something2Else.MotherNewFamilyToNewInsuranceClient__Marker) o).getCREATE__CORR__familyToInsuranceClient();
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_7_2_orchestration = initializeOrchestration(node.getOrchestrations().get(12).getPlan());
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Family_object_SP7": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
			...
			case "FamilyRegister_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_8_1_orchestration, match_1);
					}
				}
				break;
			case "Member_object_SP7": 
				{
					if(!lazy_initialization) {
						
						// mother
						HMatch match_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
			...
			case "InsuranceClient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_3 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_2_orchestration, match_3);
					}
				}
				break;
			case "InsuranceDatabase_object_SP3": 
				{
					if(!lazy_initialization) {
						
						// insuranceDB
						HMatch match_4 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP3": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_9_1_orchestration, match_5);
				}
				break;
			case "FamilyToInsuranceClient_object_SP1": 
				{
					edge_explorer_3.registerSourceObject(objs[0]);
					edge_explorer_6.registerSourceObject(objs[0]);
					
					// familyToInsuranceClient
					HMatch match_6 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "MemberToInsuranceClient_object_SP1": 
				{
					edge_explorer_7.registerSourceObject(objs[0]);
					edge_explorer_14.registerSourceObject(objs[0]);
					
					// memberToInsuranceClient
					HMatch match_7 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_7_1_orchestration, match_7);
				}
				break;
			case "MotherNewFamilyToNewInsuranceClient__Marker_object": 
				{
					...
					// MotherNewFamilyToNewInsuranceClient_eMoflon_ProtocolNode
					HMatch match_8 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_4_1_orchestration, match_8);
				}
				break;
			case "MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_82_localSearch": 
				{
				...
				break;
			case "MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_85_localSearch": 
				{
				...
				break;
			case "MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_88_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_82_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_85_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_88_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CONSISTENCY_91_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
		...
		case "Something2Else.FamilyToInsuranceClient_target_InsuranceClient": 
			...
			break;
		case "Something2Else.MotherNewFamilyToNewInsuranceClient__Marker_CREATE__TRG__insuranceClient_InsuranceClient": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) {
				{
			...
			break;
		case "Something2Else.MotherNewFamilyToNewInsuranceClient__Marker_CREATE__SRC__family_Family": 
			if(!lazy_initialization) {
		...
		case "Something2Else.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase": 
			...
			break;
		case "Something2Else.MotherNewFamilyToNewInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister": 
			if(!lazy_initialization) {
			...
			break;
		case "Something2Else.MotherNewFamilyToNewInsuranceClient__Marker_CONTEXT__TRG__insuranceDB_InsuranceDatabase": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) {
				{
		...
		case "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member": 
			...
			break;
		case "Something2Else.MotherNewFamilyToNewInsuranceClient__Marker_CREATE__SRC__mother_Member": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.Member) {
				{
		...
		case "Something2Else.FamilyRegisterToInsuranceDatabase_source_FamilyRegister": 
			...
			break;
		case "Something2Else.MotherNewFamilyToNewInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB_FamilyRegisterToInsuranceDatabase": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Something2Else.MotherNewFamilyToNewInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient_MemberToInsuranceClient": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Something2Else.MotherNewFamilyToNewInsuranceClient__Marker_CREATE__CORR__familyToInsuranceClient_FamilyToInsuranceClient": 
			if(!lazy_initialization) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC
		...
		// register MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC
		...
		// register MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC
		...
		// register MotherNewFamilyToNewInsuranceClient_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_0 = new OverlapMatch(1);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[2];
		Collection<HMatch> oMatches_0 = overlap2matches_0.get(oMatch_0);
		...
		// deregister MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_1 = new OverlapMatch(1);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[2];
		Collection<HMatch> oMatches_1 = overlap2matches_1.get(oMatch_1);
		...
		// deregister MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_2 = new OverlapMatch(1);
		Object[] oMatch_Nodes_2 = oMatch_2.getNodes();
		oMatch_Nodes_2[0] = objs[2];
		Collection<HMatch> oMatches_2 = overlap2matches_2.get(oMatch_2);
		...
		// deregister MotherNewFamilyToNewInsuranceClient_eMoflon_ProtocolNode
		Collection<HMatch> matches_8 = obj2matches.get(objs[8]);
		if(matches_8 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		edu.kit.ipd.sdq.metamodels.families.Member mother = (edu.kit.ipd.sdq.metamodels.families.Member) match.getNodes()[2];
		edu.kit.ipd.sdq.metamodels.families.Family family = (edu.kit.ipd.sdq.metamodels.families.Family) match.getNodes()[0];
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Concat csp_6 = new org.emoflon.ibex.tgg.operational.csp.constraints.Concat();
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, mother.getFirstName(), "java.lang.String"));
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, family.getLastName(), "java.lang.String"));
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getName(), "java.lang.String"));
		csp_6.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectFemale csp_7 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.families2insurance.UserDefined_expectFemale();
		csp_7.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, insuranceClient.getGender(), "Enum::Gender"));
		csp_7.solve();
