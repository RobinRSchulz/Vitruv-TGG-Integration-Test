...
public class FatherToInsuranceClient__CONSISTENCY_66_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FamilyRegisterToInsuranceDatabase) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 5, 4, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCONTEXT__SRC__familyRegister(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCONTEXT__TRG__insuranceDB(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MemberToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCREATE__SRC__father(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Member ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCREATE__CORR__memberToInsuranceClient();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FamilyToInsuranceClient) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCREATE__CORR__familyToInsuranceClient();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FamilyToInsuranceClient) o).getSource(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.MemberToInsuranceClient) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Family) o).getFather();
						edge_explorer_15_methods.unique_opposite_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Member) o).getFamilyFather();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCONTEXT__SRC__family(); return (result instanceof edu.kit.ipd.sdq.metamodels.families.Family ? result : null);};
						edge_explorer_16 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCONTEXT__CORR__familyRegisterToInsuranceDB();
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Families2Insurance.FatherToInsuranceClient__Marker) o).getCREATE__TRG__insuranceClient(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient ? result : null);};
						edge_explorer_18 = new CachedEdgeExplorer(this, 8, 3, edge_explorer_18_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FatherToInsuranceClient__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Family_object_SP2": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
			...
			case "FamilyRegister_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_4_2_orchestration, match_1);
					}
				}
				break;
			case "Member_object_SP2": 
				{
					if(!lazy_initialization) {
						
						// father
						HMatch match_2 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
			...
			case "InsuranceClient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_3 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
			...
			case "InsuranceDatabase_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_4 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
			...
			case "FamilyToInsuranceClient_object_SP0": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
			...
			case "MemberToInsuranceClient_object_SP0": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_6_1_orchestration, match_7);
				}
				break;
			case "FatherToInsuranceClient__Marker_object": 
				{
					...
					// FatherToInsuranceClient_eMoflon_ProtocolNode
					HMatch match_8 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_4_1_orchestration, match_8);
				}
				break;
			case "FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_57_localSearch": 
				{
				...
				break;
			case "FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_60_localSearch": 
				{
				...
				break;
			case "FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_63_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC_57_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC_60_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC_63_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("FatherToInsuranceClient__CONSISTENCY_66_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
		...
		case "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase": 
			...
			break;
		case "Families2Insurance.FatherToInsuranceClient__Marker_CONTEXT__SRC__familyRegister_FamilyRegister": 
			if(!lazy_initialization) {
			...
			break;
		case "Families2Insurance.FatherToInsuranceClient__Marker_CONTEXT__TRG__insuranceDB_InsuranceDatabase": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) {
				{
		...
		case "Families2Insurance.MemberToInsuranceClient_source_Member": 
			...
			break;
		case "Families2Insurance.FatherToInsuranceClient__Marker_CREATE__SRC__father_Member": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.Member) {
				{
		...
		case "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister": 
			...
			break;
		case "Families2Insurance.FatherToInsuranceClient__Marker_CREATE__CORR__memberToInsuranceClient_MemberToInsuranceClient": 
			if(!lazy_initialization) {
				{
		...
		case "Families2Insurance.FamilyToInsuranceClient_target_InsuranceClient": 
			...
			break;
		case "Families2Insurance.FatherToInsuranceClient__Marker_CREATE__CORR__familyToInsuranceClient_FamilyToInsuranceClient": 
			if(!lazy_initialization) {
				{
		...
		case "edu.kit.ipd.sdq.metamodels.families.Family_father_Member": 
			...
			break;
		case "Families2Insurance.FatherToInsuranceClient__Marker_CONTEXT__SRC__family_Family": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.Family) {
				{
			...
			break;
		case "Families2Insurance.FatherToInsuranceClient__Marker_CONTEXT__CORR__familyRegisterToInsuranceDB_FamilyRegisterToInsuranceDatabase": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Families2Insurance.FatherToInsuranceClient__Marker_CREATE__TRG__insuranceClient_InsuranceClient": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceClient) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC
		...
		// register FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC
		...
		// register FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC
		...
		// register FatherToInsuranceClient_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister FatherToInsuranceClient_father_sons_incoming_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_0 = new OverlapMatch(1);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[2];
		Collection<HMatch> oMatches_0 = overlap2matches_0.get(oMatch_0);
		...
		// deregister FatherToInsuranceClient_father_daughters_incoming_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_1 = new OverlapMatch(1);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[2];
		Collection<HMatch> oMatches_1 = overlap2matches_1.get(oMatch_1);
		...
		// deregister FatherToInsuranceClient_father_mother_incoming_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_2 = new OverlapMatch(1);
		Object[] oMatch_Nodes_2 = oMatch_2.getNodes();
		oMatch_Nodes_2[0] = objs[2];
		Collection<HMatch> oMatches_2 = overlap2matches_2.get(oMatch_2);
		...
		// deregister FatherToInsuranceClient_eMoflon_ProtocolNode
		Collection<HMatch> matches_8 = obj2matches.get(objs[8]);
		if(matches_8 != null) {
