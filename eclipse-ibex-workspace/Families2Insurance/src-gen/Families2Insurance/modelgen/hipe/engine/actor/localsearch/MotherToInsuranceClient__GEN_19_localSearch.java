...
public class MotherToInsuranceClient__GEN_19_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MotherToInsuranceClient__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "Family_object": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("MotherToInsuranceClient__GEN_19_localSearch", 4);
			...
			case "FamilyRegister_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("MotherToInsuranceClient__GEN_19_localSearch", 4);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MotherToInsuranceClient__GEN_19_localSearch", 4);
			...
			case "InsuranceDatabase_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("MotherToInsuranceClient__GEN_19_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.FamilyRegister_families_Family": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("MotherToInsuranceClient__GEN_19_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
