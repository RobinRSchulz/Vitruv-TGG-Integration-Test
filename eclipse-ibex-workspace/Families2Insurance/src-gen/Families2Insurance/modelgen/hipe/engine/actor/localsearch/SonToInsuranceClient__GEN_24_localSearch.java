...
public class SonToInsuranceClient__GEN_24_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SonToInsuranceClient__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "Family_object": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("SonToInsuranceClient__GEN_24_localSearch", 4);
			...
			case "FamilyRegister_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("SonToInsuranceClient__GEN_24_localSearch", 4);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP1": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("SonToInsuranceClient__GEN_24_localSearch", 4);
			...
			case "InsuranceDatabase_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("SonToInsuranceClient__GEN_24_localSearch", 4);
		...
		case "Families2Insurance.FamilyRegisterToInsuranceDatabase_source_FamilyRegister": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.families.FamilyRegister) {
				{
					...
					HMatch match = new LocalSearchMatch("SonToInsuranceClient__GEN_24_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
