...
public class FatherNewFamilyToNewInsuranceClient__GEN_6_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FatherNewFamilyToNewInsuranceClient__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "FamilyRegister_object_SP1": 
				{
					...
					// familyRegister
					HMatch match_0 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__GEN_6_localSearch", 3);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP1": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__GEN_6_localSearch", 3);
			...
			case "InsuranceDatabase_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_2 = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__GEN_6_localSearch", 3);
		...
		case "Families2Insurance.FamilyRegisterToInsuranceDatabase_target_InsuranceDatabase": 
			if(!lazy_initialization) {
				if(msg.target instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase) {
				{
					...
					HMatch match = new LocalSearchMatch("FatherNewFamilyToNewInsuranceClient__GEN_6_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
