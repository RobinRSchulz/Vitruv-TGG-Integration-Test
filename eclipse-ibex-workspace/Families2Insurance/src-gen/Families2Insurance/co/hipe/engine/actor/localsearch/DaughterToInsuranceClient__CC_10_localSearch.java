...
public class DaughterToInsuranceClient__CC_10_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Member) o).getFamilyDaughter();
						edge_explorer_4_methods.multi_opposite_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Family) o).getDaughters();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.FamilyRegisterToInsuranceDatabase) o).getTarget(); return (result instanceof edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DaughterToInsuranceClient__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Family_object_SP0": 
				{
					...
					// family
					HMatch match_0 = new LocalSearchMatch("DaughterToInsuranceClient__CC_10_localSearch", 6);
			...
			case "FamilyRegister_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// familyRegister
						HMatch match_1 = new LocalSearchMatch("DaughterToInsuranceClient__CC_10_localSearch", 6);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("DaughterToInsuranceClient__CC_10_localSearch", 6);
			...
			case "InsuranceDatabase_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_3 = new LocalSearchMatch("DaughterToInsuranceClient__CC_10_localSearch", 6);
			...
			case "Member_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// daughter
						HMatch match_4 = new LocalSearchMatch("DaughterToInsuranceClient__CC_10_localSearch", 6);
			...
			case "InsuranceClient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_5 = new LocalSearchMatch("DaughterToInsuranceClient__CC_10_localSearch", 6);
		...
		switch(match.creator) {
			...
			case "DaughterToInsuranceClient_daughter_sons_incoming_SRC__FILTER_NAC_SRC_1_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DaughterToInsuranceClient__CC_10_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "DaughterToInsuranceClient_daughter_father_incoming_SRC__FILTER_NAC_SRC_4_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("DaughterToInsuranceClient__CC_10_localSearch", 6);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "DaughterToInsuranceClient_daughter_mother_incoming_SRC__FILTER_NAC_SRC_7_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("DaughterToInsuranceClient__CC_10_localSearch", 6);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.insurance.InsuranceDatabase_insuranceclient_InsuranceClient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DaughterToInsuranceClient__CC_10_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		edu.kit.ipd.sdq.metamodels.families.Member daughter = (edu.kit.ipd.sdq.metamodels.families.Member) match.getNodes()[4];
