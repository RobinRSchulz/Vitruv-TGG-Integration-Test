...
public class MotherNewFamilyToNewInsuranceClient__CC_61_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Family) o).getMother();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Member) o).getFamilyMother();
