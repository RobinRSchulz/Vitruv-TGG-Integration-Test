package Families2Insurance.co.hipe.engine.actor.localsearch;
...
public class MotherNewFamilyToNewInsuranceClient__CC_61_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Family) o).getMother();
						edge_explorer_methods.unique_opposite_lookup = (o) -> ((edu.kit.ipd.sdq.metamodels.families.Member) o).getFamilyMother();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MotherNewFamilyToNewInsuranceClient__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "FamilyRegister_object_SP0": 
				{
					...
					// familyRegister
					HMatch match_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CC_61_localSearch", 6);
			...
			case "FamilyRegisterToInsuranceDatabase_object_SP1": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CC_61_localSearch", 6);
			...
			case "InsuranceDatabase_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// insuranceDB
						HMatch match_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CC_61_localSearch", 6);
			...
			case "Family_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// family
						HMatch match_3 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CC_61_localSearch", 6);
			...
			case "Member_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// mother
						HMatch match_4 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CC_61_localSearch", 6);
			...
			case "InsuranceClient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// insuranceClient
						HMatch match_5 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CC_61_localSearch", 6);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_6_1_orchestration, match_5);
					}
				}
				break;
			case "MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_52_localSearch": 
				{
				...
				break;
			case "MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_55_localSearch": 
				{
				...
				break;
			case "MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_58_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_sons_incoming_SRC__FILTER_NAC_SRC_52_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CC_61_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_daughters_incoming_SRC__FILTER_NAC_SRC_55_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CC_61_localSearch", 6);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "MotherNewFamilyToNewInsuranceClient_mother_father_incoming_SRC__FILTER_NAC_SRC_58_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CC_61_localSearch", 6);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "edu.kit.ipd.sdq.metamodels.families.Family_mother_Member": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("MotherNewFamilyToNewInsuranceClient__CC_61_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		edu.kit.ipd.sdq.metamodels.families.Member mother = (edu.kit.ipd.sdq.metamodels.families.Member) match.getNodes()[4];
