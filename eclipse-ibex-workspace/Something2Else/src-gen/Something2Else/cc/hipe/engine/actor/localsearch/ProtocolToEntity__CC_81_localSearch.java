...
public class ProtocolToEntity__CC_81_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model2.Root) o).getEntities();
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof tools.vitruv.methodologisttemplate.model.model2.Root) return edge_explorer_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ProtocolToEntity__CC_production"), this::returnTrue  , false ));
	}
			...
			case "Root_object_SP0": 
				{
					...
					// root
					HMatch match_0 = new LocalSearchMatch("ProtocolToEntity__CC_81_localSearch", 5);
			...
			case "SystemToRoot_object": 
				{
					...
					// stor
					HMatch match_1 = new LocalSearchMatch("ProtocolToEntity__CC_81_localSearch", 5);
			...
			case "System_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_2 = new LocalSearchMatch("ProtocolToEntity__CC_81_localSearch", 5);
			...
			case "Protocol_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_3 = new LocalSearchMatch("ProtocolToEntity__CC_81_localSearch", 5);
			...
			case "Entity_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_4 = new LocalSearchMatch("ProtocolToEntity__CC_81_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("ProtocolToEntity__CC_81_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
