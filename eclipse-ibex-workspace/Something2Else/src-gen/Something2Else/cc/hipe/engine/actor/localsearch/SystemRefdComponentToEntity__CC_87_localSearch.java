package Something2Else.cc.hipe.engine.actor.localsearch;
...
public class SystemRefdComponentToEntity__CC_87_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model2.Root) o).getEntities();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof tools.vitruv.methodologisttemplate.model.model2.Root) return edge_explorer_5_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
