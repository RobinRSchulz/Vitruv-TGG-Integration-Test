...
public class LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_62_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("LinkToEntity__CC_76_nacjunction"), this::returnTrue , 0  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_production"), this::returnTrue , 1  , false ));
	}
			...
			case "Link_object_SP0": 
				{
					...
					// link
					HMatch match_0 = new LocalSearchMatch("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_62_localSearch", 3);
			...
			case "Protocol_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_1 = new LocalSearchMatch("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_62_localSearch", 3);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
						
						// FILTER_NAC_NODE
						HMatch match_2 = new LocalSearchMatch("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_62_localSearch", 3);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_62_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
