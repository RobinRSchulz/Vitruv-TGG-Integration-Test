package Something2Else.co.hipe.engine.actor.localsearch;
...
public class SystemRefdComponentToEntity__CC_87_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SystemRefdComponentToEntity__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Root_object_SP1": 
				{
					...
					// root
					HMatch match_0 = new LocalSearchMatch("SystemRefdComponentToEntity__CC_87_localSearch", 5);
			...
			case "SystemToRoot_object": 
				{
					...
					// stor
					HMatch match_1 = new LocalSearchMatch("SystemRefdComponentToEntity__CC_87_localSearch", 5);
			...
			case "System_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_2 = new LocalSearchMatch("SystemRefdComponentToEntity__CC_87_localSearch", 5);
			...
			case "Component_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// comp
						HMatch match_3 = new LocalSearchMatch("SystemRefdComponentToEntity__CC_87_localSearch", 5);
			...
			case "Entity_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_4 = new LocalSearchMatch("SystemRefdComponentToEntity__CC_87_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "tools.vitruv.methodologisttemplate.model.model.System_components_Component": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("SystemRefdComponentToEntity__CC_87_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		tools.vitruv.methodologisttemplate.model.model.Component comp = (tools.vitruv.methodologisttemplate.model.model.Component) match.getNodes()[3];
		tools.vitruv.methodologisttemplate.model.model2.Entity entity = (tools.vitruv.methodologisttemplate.model.model2.Entity) match.getNodes()[4];
