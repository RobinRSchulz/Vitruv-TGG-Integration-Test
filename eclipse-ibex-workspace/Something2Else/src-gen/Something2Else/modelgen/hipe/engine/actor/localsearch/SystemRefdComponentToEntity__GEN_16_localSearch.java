...
public class SystemRefdComponentToEntity__GEN_16_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SystemRefdComponentToEntity__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "Root_object": 
				{
					...
					// root
					HMatch match_0 = new LocalSearchMatch("SystemRefdComponentToEntity__GEN_16_localSearch", 3);
			...
			case "SystemToRoot_object": 
				{
					...
					// stor
					HMatch match_1 = new LocalSearchMatch("SystemRefdComponentToEntity__GEN_16_localSearch", 3);
			...
			case "System_object": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_2 = new LocalSearchMatch("SystemRefdComponentToEntity__GEN_16_localSearch", 3);
		...
		case "Something2Else.SystemToRoot_source_System": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.System) {
				{
					...
					HMatch match = new LocalSearchMatch("SystemRefdComponentToEntity__GEN_16_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
