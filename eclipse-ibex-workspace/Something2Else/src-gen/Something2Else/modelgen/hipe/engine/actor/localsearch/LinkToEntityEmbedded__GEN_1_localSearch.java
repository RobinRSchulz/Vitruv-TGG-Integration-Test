package Something2Else.modelgen.hipe.engine.actor.localsearch;
...
public class LinkToEntityEmbedded__GEN_1_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Protocol ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getProtocols();
						...
						edge_explorer_8 = new EdgeExplorer(this, 8, 4, edge_explorer_8_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("LinkToEntityEmbedded__GEN_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Entity_object": 
				{
					...
					// compEntity
					HMatch match_0 = new LocalSearchMatch("LinkToEntityEmbedded__GEN_1_localSearch", 9);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_7_1_orchestration, match_0);
					
					// protEntity
					HMatch match_3 = new LocalSearchMatch("LinkToEntityEmbedded__GEN_1_localSearch", 9);
			...
			case "Component_object": 
				{
					if(!lazy_initialization) {
						...
						// component
						HMatch match_1 = new LocalSearchMatch("LinkToEntityEmbedded__GEN_1_localSearch", 9);
			...
			case "ComponentToEntity_object": 
				{
					...
					// ctoe
					HMatch match_2 = new LocalSearchMatch("LinkToEntityEmbedded__GEN_1_localSearch", 9);
			...
			case "Protocol_object": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_4 = new LocalSearchMatch("LinkToEntityEmbedded__GEN_1_localSearch", 9);
			...
			case "ProtocolToEntity_object": 
				{
					...
					// ptoe
					HMatch match_5 = new LocalSearchMatch("LinkToEntityEmbedded__GEN_1_localSearch", 9);
			...
			case "Root_object": 
				{
					if(!lazy_initialization) {
						...
						// root
						HMatch match_6 = new LocalSearchMatch("LinkToEntityEmbedded__GEN_1_localSearch", 9);
						match_6.getNodes()[6] = objs[0];
						start(edge_explorer_4_2_orchestration, match_6);
					}
				}
				break;
			case "SystemToRoot_object": 
				{
					edge_explorer_4.registerSourceObject(objs[0]);
					edge_explorer_9.registerSourceObject(objs[0]);
					
					// stor
					HMatch match_7 = new LocalSearchMatch("LinkToEntityEmbedded__GEN_1_localSearch", 9);
			...
			case "System_object": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_8 = new LocalSearchMatch("LinkToEntityEmbedded__GEN_1_localSearch", 9);
		...
		case "Something2Else.ComponentToEntity_source_Component": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.Component) {
				{
					...
					HMatch match = new LocalSearchMatch("LinkToEntityEmbedded__GEN_1_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
