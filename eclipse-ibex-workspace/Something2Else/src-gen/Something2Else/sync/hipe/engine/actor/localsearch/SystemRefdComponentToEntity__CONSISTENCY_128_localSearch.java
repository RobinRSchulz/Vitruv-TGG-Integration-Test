...
public class SystemRefdComponentToEntity__CONSISTENCY_128_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCONTEXT__TRG__root(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 6, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model2.Root) o).getEntities();
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof tools.vitruv.methodologisttemplate.model.model2.Root) return edge_explorer_3_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_3 = new EdgeExplorer(this, 3, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 5, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCREATE__TRG__entity(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getComponents();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCREATE__SRC__comp(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCONTEXT__SRC__system(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCONTEXT__CORR__stor();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCREATE__CORR__ctoe();
			...
			case "Component_object_SP0": 
				{
					...
					// comp
					HMatch match_0 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch", 7);
			...
			case "System_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_1 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch", 7);
			...
			case "Entity_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_2 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch", 7);
			...
			case "Root_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// root
						HMatch match_3 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch", 7);
			...
			case "ComponentToEntity_object_SP1": 
				{
					...
					// ctoe
					HMatch match_4 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch", 7);
			...
			case "SystemToRoot_object_SP2": 
				{
					...
					// stor
					HMatch match_5 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch", 7);
			...
			case "SystemRefdComponentToEntity__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch", 7);
		...
		case "Something2Else.SystemRefdComponentToEntity__Marker_CONTEXT__TRG__root_Root": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Root) {
				{
					...
					HMatch match = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
