...
public class SystemToRoot__CONSISTENCY_142_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot__Marker) o).getCREATE__SRC__system(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot__Marker) o).getCREATE__TRG__root(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
			...
			case "System_object_SP1": 
				{
					...
					// system
					HMatch match_0 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_142_localSearch", 4);
			...
			case "Root_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// root
						HMatch match_1 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_142_localSearch", 4);
			...
			case "SystemToRoot_object_SP1": 
				{
					...
					// stor
					HMatch match_2 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_142_localSearch", 4);
			...
			case "SystemToRoot__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_142_localSearch", 4);
		...
		case "Something2Else.SystemToRoot__Marker_CREATE__SRC__system_System": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.System) {
				{
					...
					HMatch match = new LocalSearchMatch("SystemToRoot__CONSISTENCY_142_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
