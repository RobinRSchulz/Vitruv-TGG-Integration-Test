...
public class LinkToEntityEmbedded__FWD_68_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Protocol ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new EdgeExplorer(this, 8, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getProtocols();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof tools.vitruv.methodologisttemplate.model.model.System) return edge_explorer_5_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_5 = new EdgeExplorer(this, 8, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getLinks();
						...
						edge_explorer_10 = new EdgeExplorer(this, 8, 9, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.Link) o).getComponents();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.Link) o).getProtocol();
			...
			case "Entity_object_SP0": 
				{
					...
					// compEntity
					HMatch match_0 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_6_2_orchestration, match_0);
					
					// protEntity
					HMatch match_3 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
			...
			case "Component_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// component
						HMatch match_1 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
			...
			case "ComponentToEntity_object_SP0": 
				{
					...
					// ctoe
					HMatch match_2 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
			...
			case "Protocol_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_4 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_3_2_orchestration, match_4);
					}
				}
				break;
			case "ProtocolToEntity_object_SP1": 
				{
					edge_explorer_3.registerSourceObject(objs[0]);
					edge_explorer_8.registerSourceObject(objs[0]);
					
					// ptoe
					HMatch match_5 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
			...
			case "Root_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// root
						HMatch match_6 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
			...
			case "SystemToRoot_object_SP0": 
				{
					...
					// stor
					HMatch match_7 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
			...
			case "System_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_8 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
			...
			case "Link_object_SP0": 
				{
					...
					// link
					HMatch match_9 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
		...
		switch(match.creator) {
			...
			case "LinkToEntityEmbedded_link_components_outgoing_SRC__FILTER_NAC_SRC_46_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "LinkToEntityEmbedded_link_protocol_outgoing_SRC__FILTER_NAC_SRC_50_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "Something2Else.SystemToRoot_source_System": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.System) {
				{
					...
					HMatch match = new LocalSearchMatch("LinkToEntityEmbedded__FWD_68_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[8] = msg.target;
					currentDepth++;
