...
public class LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_89_localSearch extends GenericLocalSearchActor{
			...
			case "Link_object_SP0": 
				{
					...
					// link
					HMatch match_0 = new LocalSearchMatch("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_89_localSearch", 3);
			...
			case "Protocol_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_1 = new LocalSearchMatch("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_89_localSearch", 3);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
						
						// FILTER_NAC_NODE
						HMatch match_2 = new LocalSearchMatch("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_89_localSearch", 3);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_89_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
