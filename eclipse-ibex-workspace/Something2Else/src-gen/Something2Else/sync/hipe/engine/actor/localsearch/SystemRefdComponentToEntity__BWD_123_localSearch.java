...
public class SystemRefdComponentToEntity__BWD_123_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SystemRefdComponentToEntity__BWD_production"), this::returnTrue  , false ));
	}
			...
			case "Root_object_SP1": 
				{
					...
					// root
					HMatch match_0 = new LocalSearchMatch("SystemRefdComponentToEntity__BWD_123_localSearch", 4);
			...
			case "SystemToRoot_object_SP1": 
				{
					...
					// stor
					HMatch match_1 = new LocalSearchMatch("SystemRefdComponentToEntity__BWD_123_localSearch", 4);
			...
			case "System_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_2 = new LocalSearchMatch("SystemRefdComponentToEntity__BWD_123_localSearch", 4);
			...
			case "Entity_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_3 = new LocalSearchMatch("SystemRefdComponentToEntity__BWD_123_localSearch", 4);
		...
		case "Something2Else.SystemToRoot_source_System": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.System) {
				{
					...
					HMatch match = new LocalSearchMatch("SystemRefdComponentToEntity__BWD_123_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
