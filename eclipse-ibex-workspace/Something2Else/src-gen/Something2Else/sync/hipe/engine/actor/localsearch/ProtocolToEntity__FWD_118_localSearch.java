...
public class ProtocolToEntity__FWD_118_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getProtocols();
			...
			case "Root_object_SP0": 
				{
					...
					// root
					HMatch match_0 = new LocalSearchMatch("ProtocolToEntity__FWD_118_localSearch", 4);
			...
			case "SystemToRoot_object_SP0": 
				{
					...
					// stor
					HMatch match_1 = new LocalSearchMatch("ProtocolToEntity__FWD_118_localSearch", 4);
			...
			case "System_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_2 = new LocalSearchMatch("ProtocolToEntity__FWD_118_localSearch", 4);
			...
			case "Protocol_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_3 = new LocalSearchMatch("ProtocolToEntity__FWD_118_localSearch", 4);
		...
		case "Something2Else.SystemToRoot_target_Root": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Root) {
				{
					...
					HMatch match = new LocalSearchMatch("ProtocolToEntity__FWD_118_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
