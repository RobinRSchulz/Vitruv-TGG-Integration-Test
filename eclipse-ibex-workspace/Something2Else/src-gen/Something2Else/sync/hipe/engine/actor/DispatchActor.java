...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAdd() {
		...
		type2addConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getProtocol(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("Protocol_object_SP2").tell(new ObjectAdded<tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, _protocol), getSelf());
		});
		type2addConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("System_object_SP3").tell(new ObjectAdded<tools.vitruv.methodologisttemplate.model.model.System>(incUtil, _system), getSelf());
		});
		type2addConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getComponentToEntity(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("ComponentToEntity_object_SP0").tell(new ObjectAdded<Something2Else.ComponentToEntity>(incUtil, _componenttoentity), getSelf());
			incUtil.newMessage();
			name2actor.get("ComponentToEntity_object_SP1").tell(new ObjectAdded<Something2Else.ComponentToEntity>(incUtil, _componenttoentity), getSelf());
		});
		...
		type2addConsumer.put(tools.vitruv.methodologisttemplate.model.model2.Model2Package.eINSTANCE.getRoot(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("Root_object_SP3").tell(new ObjectAdded<tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil, _root), getSelf());
		});
		type2addConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemToRoot(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("SystemToRoot_object_SP2").tell(new ObjectAdded<Something2Else.SystemToRoot>(incUtil, _systemtoroot), getSelf());
		});
		...
		type2addConsumer.put(tools.vitruv.methodologisttemplate.model.model2.Model2Package.eINSTANCE.getEntity(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("Entity_object_SP3").tell(new ObjectAdded<tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, _entity), getSelf());
		});
		type2addConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getProtocolToEntity(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity_object_SP0").tell(new ObjectAdded<Something2Else.ProtocolToEntity>(incUtil, _protocoltoentity), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity_object_SP1").tell(new ObjectAdded<Something2Else.ProtocolToEntity>(incUtil, _protocoltoentity), getSelf());
		});
	...
	private void initializeSet() {
		feature2setConsumer.put(tools.vitruv.methodologisttemplate.model.model2.Model2Package.eINSTANCE.getEntity_Name(), notification -> {
			if(notification.getNotifier() instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
				incUtil.newMessage();
				name2actor.get("Entity_object_SP3").tell(new AttributeChanged<tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNotifier(), notification.getOldValue()), getSelf());
			}
			if(notification.getNotifier() instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
				incUtil.newMessage();
	...
	private void initializeAddEdge() {
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CONTEXT__SRC__system(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CONTEXT__SRC__system_System"), getSelf());
		});
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Protocols(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__FWD_118_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntity__Marker_CREATE__SRC__link(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntity__CONSISTENCY_96_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntity__Marker, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil,(Something2Else.LinkToEntity__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNewValue(), "Something2Else.LinkToEntity__Marker_CREATE__SRC__link_Link"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getComponentToEntity_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ComponentToEntity__CONSISTENCY_9_localSearch").tell(new ReferenceAdded<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceAdded<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceAdded<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model2.Model2Package.eINSTANCE.getRoot_Entities(), notification -> {
			incUtil.newMessage();
			name2actor.get("ComponentToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_1_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_linkEntity_entities_incoming_TRG__FILTER_NAC_TRG_16_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_79_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__BWD_105_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__BWD_123_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntity__Marker_CREATE__CORR__ltoe(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntity__CONSISTENCY_96_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntity__Marker, Something2Else.LinkToEntity>(incUtil,(Something2Else.LinkToEntity__Marker) notification.getNotifier(), (Something2Else.LinkToEntity) notification.getNewValue(), "Something2Else.LinkToEntity__Marker_CREATE__CORR__ltoe_LinkToEntity"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemToRoot__Marker_CREATE__CORR__stor(), notification -> {
			incUtil.newMessage();
			name2actor.get("SystemToRoot__CONSISTENCY_142_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot__Marker, Something2Else.SystemToRoot>(incUtil,(Something2Else.SystemToRoot__Marker) notification.getNotifier(), (Something2Else.SystemToRoot) notification.getNewValue(), "Something2Else.SystemToRoot__Marker_CREATE__CORR__stor_SystemToRoot"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getProtocolToEntity__Marker_CREATE__SRC__protocol(), notification -> {
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<Something2Else.ProtocolToEntity__Marker, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(Something2Else.ProtocolToEntity__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "Something2Else.ProtocolToEntity__Marker_CREATE__SRC__protocol_Protocol"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemRefdComponentToEntity__Marker_CONTEXT__CORR__stor(), notification -> {
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceAdded<Something2Else.SystemRefdComponentToEntity__Marker, Something2Else.SystemToRoot>(incUtil,(Something2Else.SystemRefdComponentToEntity__Marker) notification.getNotifier(), (Something2Else.SystemToRoot) notification.getNewValue(), "Something2Else.SystemRefdComponentToEntity__Marker_CONTEXT__CORR__stor_SystemToRoot"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CONTEXT__CORR__stor(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, Something2Else.SystemToRoot>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (Something2Else.SystemToRoot) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CONTEXT__CORR__stor_SystemToRoot"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntity_Target(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntity__CONSISTENCY_96_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntity, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(Something2Else.LinkToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "Something2Else.LinkToEntity_target_Entity"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getLink_Protocol(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_link_protocol_outgoing_SRC__FILTER_NAC_SRC_50_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_link_protocol_outgoing_SRC__FILTER_NAC_SRC_50_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_89_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_89_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity__CONSISTENCY_96_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity__FWD_102_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemToRoot_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__BWD_105_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__FWD_118_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__BWD_123_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__FWD_136_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemToRoot__CONSISTENCY_142_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntity_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntity__CONSISTENCY_96_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntity, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil,(Something2Else.LinkToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNewValue(), "Something2Else.LinkToEntity_source_Link"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemRefdComponentToEntity__Marker_CREATE__SRC__comp(), notification -> {
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceAdded<Something2Else.SystemRefdComponentToEntity__Marker, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.SystemRefdComponentToEntity__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.SystemRefdComponentToEntity__Marker_CREATE__SRC__comp_Component"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CONTEXT__SRC__protocol(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CONTEXT__SRC__protocol_Protocol"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntity__Marker_CONTEXT__SRC__protocol(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntity__CONSISTENCY_96_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntity__Marker, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(Something2Else.LinkToEntity__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "Something2Else.LinkToEntity__Marker_CONTEXT__SRC__protocol_Protocol"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CREATE__SRC__link(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CREATE__SRC__link_Link"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CONTEXT__SRC__component(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CONTEXT__SRC__component_Component"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getProtocolToEntity__Marker_CONTEXT__SRC__system(), notification -> {
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<Something2Else.ProtocolToEntity__Marker, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.ProtocolToEntity__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.ProtocolToEntity__Marker_CONTEXT__SRC__system_System"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getProtocolToEntity_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<Something2Else.ProtocolToEntity, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(Something2Else.ProtocolToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "Something2Else.ProtocolToEntity_source_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceAdded<Something2Else.ProtocolToEntity, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(Something2Else.ProtocolToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "Something2Else.ProtocolToEntity_source_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<Something2Else.ProtocolToEntity, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(Something2Else.ProtocolToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "Something2Else.ProtocolToEntity_source_Protocol"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CREATE__CORR__ltoe(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, Something2Else.LinkToEntity>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (Something2Else.LinkToEntity) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CREATE__CORR__ltoe_LinkToEntity"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemToRoot__Marker_CREATE__SRC__system(), notification -> {
			incUtil.newMessage();
			name2actor.get("SystemToRoot__CONSISTENCY_142_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot__Marker, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot__Marker_CREATE__SRC__system_System"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemRefdComponentToEntity__Marker_CONTEXT__SRC__system(), notification -> {
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceAdded<Something2Else.SystemRefdComponentToEntity__Marker, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemRefdComponentToEntity__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemRefdComponentToEntity__Marker_CONTEXT__SRC__system_System"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemToRoot_Target(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__BWD_105_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__FWD_118_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__BWD_123_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__FWD_136_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemToRoot__CONSISTENCY_142_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
		});
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Links(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_links_Link"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_links_incoming_SRC__FILTER_NAC_SRC_93_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_links_Link"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Components(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ComponentToEntity_comp_components_incoming_SRC__FILTER_NAC_SRC_6_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__FWD_136_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getProtocolToEntity__Marker_CONTEXT__CORR__stor(), notification -> {
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_110_localSearch").tell(new ReferenceAdded<Something2Else.ProtocolToEntity__Marker, Something2Else.SystemToRoot>(incUtil,(Something2Else.ProtocolToEntity__Marker) notification.getNotifier(), (Something2Else.SystemToRoot) notification.getNewValue(), "Something2Else.ProtocolToEntity__Marker_CONTEXT__CORR__stor_SystemToRoot"), getSelf());
		});
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getLink_Components(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_link_components_outgoing_SRC__FILTER_NAC_SRC_46_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_link_components_outgoing_SRC__FILTER_NAC_SRC_46_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_components_outgoing_SRC__FILTER_NAC_SRC_86_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
		});
	...
	private void initializeRemoveEdge() {
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Protocols(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_110_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__FWD_118_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getComponentToEntity_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ComponentToEntity__CONSISTENCY_9_localSearch").tell(new ReferenceDeleted<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceDeleted<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceDeleted<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceDeleted<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model2.Model2Package.eINSTANCE.getRoot_Entities(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_linkEntity_entities_incoming_TRG__FILTER_NAC_TRG_16_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_79_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__BWD_105_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			...
			name2actor.get("SystemRefdComponentToEntity__BWD_123_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getLink_Protocol(), notification -> {
			...
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_89_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_89_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity__CONSISTENCY_96_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity__FWD_102_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
		});
		feature2removeEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemToRoot_Source(), notification -> {
			...
			name2actor.get("ProtocolToEntity__CONSISTENCY_110_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__FWD_118_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__BWD_123_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Links(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_links_Link"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_links_incoming_SRC__FILTER_NAC_SRC_93_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_links_Link"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Components(), notification -> {
			...
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_128_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__FWD_136_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getLink_Components(), notification -> {
			...
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_54_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_68_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_components_outgoing_SRC__FILTER_NAC_SRC_86_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
		});
	...
	private void handleRemoveAdapter(Notification notification) {
		...
		if (node instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
			incUtil.newMessage();
			name2actor.get("Entity_object_SP3").tell(new ObjectDeleted<tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Entity) node), getSelf());
		}
		...
		if (node instanceof tools.vitruv.methodologisttemplate.model.model2.Root) {
			incUtil.newMessage();
			name2actor.get("Root_object_SP3").tell(new ObjectDeleted<tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) node), getSelf());
		}
		...
		if (node instanceof Something2Else.ComponentToEntity) {
			incUtil.newMessage();
			name2actor.get("ComponentToEntity_object_SP0").tell(new ObjectDeleted<Something2Else.ComponentToEntity>(incUtil, (Something2Else.ComponentToEntity) node), getSelf());
		}
		if (node instanceof Something2Else.ComponentToEntity) {
			incUtil.newMessage();
			name2actor.get("ComponentToEntity_object_SP1").tell(new ObjectDeleted<Something2Else.ComponentToEntity>(incUtil, (Something2Else.ComponentToEntity) node), getSelf());
		}
		...
		if (node instanceof Something2Else.SystemToRoot) {
			incUtil.newMessage();
			name2actor.get("SystemToRoot_object_SP2").tell(new ObjectDeleted<Something2Else.SystemToRoot>(incUtil, (Something2Else.SystemToRoot) node), getSelf());
		}
		if (node instanceof Something2Else.ProtocolToEntity) {
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity_object_SP0").tell(new ObjectDeleted<Something2Else.ProtocolToEntity>(incUtil, (Something2Else.ProtocolToEntity) node), getSelf());
		}
		if (node instanceof Something2Else.ProtocolToEntity) {
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity_object_SP1").tell(new ObjectDeleted<Something2Else.ProtocolToEntity>(incUtil, (Something2Else.ProtocolToEntity) node), getSelf());
		}
		...
		if (node instanceof tools.vitruv.methodologisttemplate.model.model.System) {
			incUtil.newMessage();
			name2actor.get("System_object_SP3").tell(new ObjectDeleted<tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) node), getSelf());
		}
		...
		if (node instanceof tools.vitruv.methodologisttemplate.model.model.Protocol) {
			incUtil.newMessage();
			name2actor.get("Protocol_object_SP2").tell(new ObjectDeleted<tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Protocol) node), getSelf());
		}
