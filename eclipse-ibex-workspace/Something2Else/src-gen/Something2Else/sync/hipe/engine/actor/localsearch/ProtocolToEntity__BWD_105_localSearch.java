...
public class ProtocolToEntity__BWD_105_localSearch extends GenericLocalSearchActor{
			...
			case "Root_object_SP2": 
				{
					...
					// root
					HMatch match_0 = new LocalSearchMatch("ProtocolToEntity__BWD_105_localSearch", 4);
			...
			case "SystemToRoot_object_SP1": 
				{
					...
					// stor
					HMatch match_1 = new LocalSearchMatch("ProtocolToEntity__BWD_105_localSearch", 4);
			...
			case "System_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_2 = new LocalSearchMatch("ProtocolToEntity__BWD_105_localSearch", 4);
			...
			case "Entity_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_3 = new LocalSearchMatch("ProtocolToEntity__BWD_105_localSearch", 4);
		...
		case "Something2Else.SystemToRoot_source_System": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.System) {
				{
					...
					HMatch match = new LocalSearchMatch("ProtocolToEntity__BWD_105_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
