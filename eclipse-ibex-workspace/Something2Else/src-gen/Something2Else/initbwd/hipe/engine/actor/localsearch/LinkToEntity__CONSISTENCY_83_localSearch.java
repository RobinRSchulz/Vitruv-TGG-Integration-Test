...
public class LinkToEntity__CONSISTENCY_83_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.LinkToEntity__Marker) o).getCONTEXT__SRC__protocol(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Protocol ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Something2Else.LinkToEntity__Marker) o).getCREATE__CORR__ltoe();
			...
			case "Link_object_SP1": 
				{
					...
					// link
					HMatch match_0 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_83_localSearch", 5);
			...
			case "Protocol_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_1 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_83_localSearch", 5);
			...
			case "Entity_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_2 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_83_localSearch", 5);
			...
			case "LinkToEntity_object": 
				{
					...
					// ltoe
					HMatch match_3 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_83_localSearch", 5);
			...
			case "LinkToEntity__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_83_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_3_1_orchestration, match_4);
				}
				break;
			case "LinkToEntity_link_components_outgoing_SRC__FILTER_NAC_SRC_73_localSearch": 
				{
				...
				break;
			case "LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_76_localSearch": 
				{
				...
				break;
			case "LinkToEntity_link_links_incoming_SRC__FILTER_NAC_SRC_80_localSearch": 
				{
				...
				break;
			case "LinkToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_66_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "LinkToEntity_link_components_outgoing_SRC__FILTER_NAC_SRC_73_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_83_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_76_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_83_localSearch", 5);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "LinkToEntity_link_links_incoming_SRC__FILTER_NAC_SRC_80_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_83_localSearch", 5);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
			...
			case "LinkToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_66_localSearch": 
				if(nac_checker_2.deregister(match)) {
					HMatch acMatch_3 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_83_localSearch", 5);
					Object[] acMatch_nodes_3 = acMatch_3.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("LinkToEntity__CONSISTENCY_83_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
