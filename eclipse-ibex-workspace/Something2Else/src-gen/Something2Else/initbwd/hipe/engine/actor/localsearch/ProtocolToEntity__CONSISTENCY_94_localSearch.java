...
public class ProtocolToEntity__CONSISTENCY_94_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCONTEXT__SRC__system(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Something2Else.ProtocolToEntity__Marker) o).getCREATE__CORR__ptoe();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCONTEXT__TRG__root(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCREATE__SRC__protocol(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Protocol ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Protocol ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCREATE__TRG__entity(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
			...
			case "Protocol_object_SP1": 
				{
					...
					// protocol
					HMatch match_0 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_94_localSearch", 7);
			...
			case "System_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_1 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_94_localSearch", 7);
			...
			case "Entity_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_2 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_94_localSearch", 7);
			...
			case "Root_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// root
						HMatch match_3 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_94_localSearch", 7);
			...
			case "ProtocolToEntity_object": 
				{
					...
					// ptoe
					HMatch match_4 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_94_localSearch", 7);
			...
			case "SystemToRoot_object_SP0": 
				{
					...
					// stor
					HMatch match_5 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_94_localSearch", 7);
			...
			case "ProtocolToEntity__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_94_localSearch", 7);
		...
		case "Something2Else.ProtocolToEntity_target_Entity": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
				{
					...
					HMatch match = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_94_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
