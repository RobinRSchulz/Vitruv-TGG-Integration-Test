...
public class ComponentToEntity__CONSISTENCY_9_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity__Marker) o).getCREATE__SRC__comp(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 3, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity__Marker) o).getCREATE__TRG__entity(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 3, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Something2Else.ComponentToEntity__Marker) o).getCREATE__CORR__ctoe();
			...
			case "Component_object_SP0": 
				{
					...
					// comp
					HMatch match_0 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_9_localSearch", 4);
			...
			case "Entity_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_1 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_9_localSearch", 4);
			...
			case "ComponentToEntity_object_SP0": 
				{
					...
					// ctoe
					HMatch match_2 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_9_localSearch", 4);
			...
			case "ComponentToEntity__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_9_localSearch", 4);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_1_orchestration, match_3);
				}
				break;
			case "ComponentToEntity_comp_components_incoming_SRC__FILTER_NAC_SRC_6_localSearch": 
				{
				...
				break;
			case "ComponentToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_1_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ComponentToEntity_comp_components_incoming_SRC__FILTER_NAC_SRC_6_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_9_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ComponentToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_1_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_9_localSearch", 4);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "Something2Else.ComponentToEntity_source_Component": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.Component) {
				{
					...
					HMatch match = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_9_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
