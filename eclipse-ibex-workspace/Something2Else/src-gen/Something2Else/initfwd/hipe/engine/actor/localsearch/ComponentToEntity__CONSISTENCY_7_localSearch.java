...
public class ComponentToEntity__CONSISTENCY_7_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Something2Else.ComponentToEntity__Marker) o).getCREATE__CORR__ctoe();
						edge_explorer = new CachedEdgeExplorer(this, 3, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity__Marker) o).getCREATE__TRG__entity(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 2, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity__Marker) o).getCREATE__SRC__comp(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ComponentToEntity__CONSISTENCY_production"), this::returnTrue  , false ));
	}
			...
			case "Component_object_SP0": 
				{
					...
					// comp
					HMatch match_0 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_7_localSearch", 4);
			...
			case "Entity_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_1 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_7_localSearch", 4);
			...
			case "ComponentToEntity_object": 
				{
					...
					// ctoe
					HMatch match_2 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_7_localSearch", 4);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_2_orchestration, match_2);
				}
				break;
			case "ComponentToEntity__Marker_object": 
				{
					edge_explorer.registerSourceObject(objs[0]);
					edge_explorer_3.registerSourceObject(objs[0]);
					edge_explorer_6.registerSourceObject(objs[0]);
					
					// ComponentToEntity_eMoflon_ProtocolNode
					HMatch match_3 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_7_localSearch", 4);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "ComponentToEntity_comp_components_incoming_SRC__FILTER_NAC_SRC_1_localSearch": 
				{
				...
				break;
			case "ComponentToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_4_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ComponentToEntity_comp_components_incoming_SRC__FILTER_NAC_SRC_1_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_7_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ComponentToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_4_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_7_localSearch", 4);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Something2Else.ComponentToEntity__Marker_CREATE__CORR__ctoe_ComponentToEntity": 
			if(!lazy_initialization) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_7_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
			...
			break;
		case "Something2Else.ComponentToEntity__Marker_CREATE__TRG__entity_Entity": 
			if(!lazy_initialization) {
		...
		case "Something2Else.ComponentToEntity_source_Component": 
			...
			break;
		case "Something2Else.ComponentToEntity__Marker_CREATE__SRC__comp_Component": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.Component) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ComponentToEntity_comp_components_incoming_SRC__FILTER_NAC_SRC
		...
		// register ComponentToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG
		...
		// register ComponentToEntity_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ComponentToEntity_comp_components_incoming_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_0 = new OverlapMatch(1);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		Collection<HMatch> oMatches_0 = overlap2matches_0.get(oMatch_0);
		...
		// deregister ComponentToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG
		OverlapMatch oMatch_1 = new OverlapMatch(1);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[1];
		Collection<HMatch> oMatches_1 = overlap2matches_1.get(oMatch_1);
		...
		// deregister ComponentToEntity_eMoflon_ProtocolNode
		Collection<HMatch> matches_3 = obj2matches.get(objs[3]);
		if(matches_3 != null) {
