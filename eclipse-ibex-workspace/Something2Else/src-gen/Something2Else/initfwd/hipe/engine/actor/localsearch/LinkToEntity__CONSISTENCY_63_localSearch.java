...
public class LinkToEntity__CONSISTENCY_63_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.LinkToEntity) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 3, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.LinkToEntity__Marker) o).getCREATE__SRC__link(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Link ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 4, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.LinkToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Link ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 3, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Something2Else.LinkToEntity__Marker) o).getCREATE__CORR__ltoe();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.Link) o).getProtocol();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.LinkToEntity__Marker) o).getCREATE__TRG__entity(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
			...
			case "Link_object_SP1": 
				{
					...
					// link
					HMatch match_0 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_63_localSearch", 5);
			...
			case "Protocol_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_1 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_63_localSearch", 5);
			...
			case "Entity_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_2 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_63_localSearch", 5);
			...
			case "LinkToEntity_object": 
				{
					...
					// ltoe
					HMatch match_3 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_63_localSearch", 5);
			...
			case "LinkToEntity__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_63_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "LinkToEntity_link_components_outgoing_SRC__FILTER_NAC_SRC_50_localSearch": 
				{
				...
				break;
			case "LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_53_localSearch": 
				{
				...
				break;
			case "LinkToEntity_link_links_incoming_SRC__FILTER_NAC_SRC_57_localSearch": 
				{
				...
				break;
			case "LinkToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_60_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "LinkToEntity_link_components_outgoing_SRC__FILTER_NAC_SRC_50_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_63_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_53_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_63_localSearch", 5);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "LinkToEntity_link_links_incoming_SRC__FILTER_NAC_SRC_57_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_63_localSearch", 5);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
			...
			case "LinkToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_60_localSearch": 
				if(nac_checker_2.deregister(match)) {
					HMatch acMatch_3 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_63_localSearch", 5);
					Object[] acMatch_nodes_3 = acMatch_3.getNodes();
		...
		case "Something2Else.LinkToEntity__Marker_CONTEXT__SRC__protocol_Protocol": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.Protocol) {
				{
					...
					HMatch match = new LocalSearchMatch("LinkToEntity__CONSISTENCY_63_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
