...
public class ProtocolToEntity__CONSISTENCY_72_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCREATE__TRG__entity(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 6, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCONTEXT__TRG__root(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Something2Else.ProtocolToEntity__Marker) o).getCONTEXT__CORR__stor();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCREATE__SRC__protocol(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Protocol ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Protocol ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model2.Root) o).getEntities();
						edge_explorer_9_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof tools.vitruv.methodologisttemplate.model.model2.Root) return edge_explorer_9_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_9 = new EdgeExplorer(this, 3, 2, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCONTEXT__SRC__system(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Something2Else.ProtocolToEntity__Marker) o).getCREATE__CORR__ptoe();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ProtocolToEntity__CONSISTENCY_production"), this::returnTrue  , false ));
	}
			...
			case "Protocol_object_SP0": 
				{
					...
					// protocol
					HMatch match_0 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_72_localSearch", 7);
			...
			case "System_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_1 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_72_localSearch", 7);
			...
			case "Entity_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_2 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_72_localSearch", 7);
			...
			case "Root_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// root
						HMatch match_3 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_72_localSearch", 7);
			...
			case "ProtocolToEntity_object": 
				{
					...
					// ptoe
					HMatch match_4 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_72_localSearch", 7);
			...
			case "SystemToRoot_object_SP0": 
				{
					...
					// stor
					HMatch match_5 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_72_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_4_1_orchestration, match_5);
				}
				break;
			case "ProtocolToEntity__Marker_object": 
				{
					...
					// ProtocolToEntity_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_72_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Something2Else.ProtocolToEntity__Marker_CREATE__TRG__entity_Entity": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_72_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
			...
			break;
		case "Something2Else.ProtocolToEntity__Marker_CONTEXT__TRG__root_Root": 
			if(!lazy_initialization) {
			...
			break;
		case "Something2Else.ProtocolToEntity__Marker_CONTEXT__CORR__stor_SystemToRoot": 
			if(!lazy_initialization) {
				{
		...
		case "Something2Else.SystemToRoot_source_System": 
			...
			break;
		case "Something2Else.ProtocolToEntity__Marker_CREATE__SRC__protocol_Protocol": 
			if(!lazy_initialization) {
		...
		case "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol": 
			...
			break;
		case "Something2Else.ProtocolToEntity__Marker_CONTEXT__SRC__system_System": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.System) {
				{
			...
			break;
		case "Something2Else.ProtocolToEntity__Marker_CREATE__CORR__ptoe_ProtocolToEntity": 
			if(!lazy_initialization) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register ProtocolToEntity_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister ProtocolToEntity_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
