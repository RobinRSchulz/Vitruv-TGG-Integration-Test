...
public class SystemRefdComponentToEntity__CONSISTENCY_85_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 5, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCREATE__SRC__comp(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCONTEXT__CORR__stor();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getComponents();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof tools.vitruv.methodologisttemplate.model.model.System) return edge_explorer_8_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCREATE__CORR__ctoe();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
			...
			case "Component_object_SP1": 
				{
					...
					// comp
					HMatch match_0 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_85_localSearch", 7);
			...
			case "System_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_1 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_85_localSearch", 7);
			...
			case "Entity_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_2 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_85_localSearch", 7);
			...
			case "Root_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// root
						HMatch match_3 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_85_localSearch", 7);
			...
			case "ComponentToEntity_object": 
				{
					...
					// ctoe
					HMatch match_4 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_85_localSearch", 7);
			...
			case "SystemToRoot_object_SP0": 
				{
					...
					// stor
					HMatch match_5 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_85_localSearch", 7);
			...
			case "SystemRefdComponentToEntity__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_85_localSearch", 7);
		...
		case "Something2Else.SystemToRoot_target_Root": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Root) {
				{
					...
					HMatch match = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_85_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
