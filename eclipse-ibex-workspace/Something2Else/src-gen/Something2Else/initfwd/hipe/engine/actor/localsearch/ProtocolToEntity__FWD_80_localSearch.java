...
public class ProtocolToEntity__FWD_80_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ProtocolToEntity__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Root_object_SP0": 
				{
					...
					// root
					HMatch match_0 = new LocalSearchMatch("ProtocolToEntity__FWD_80_localSearch", 4);
			...
			case "SystemToRoot_object_SP1": 
				{
					...
					// stor
					HMatch match_1 = new LocalSearchMatch("ProtocolToEntity__FWD_80_localSearch", 4);
			...
			case "System_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_2 = new LocalSearchMatch("ProtocolToEntity__FWD_80_localSearch", 4);
			...
			case "Protocol_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_3 = new LocalSearchMatch("ProtocolToEntity__FWD_80_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("ProtocolToEntity__FWD_80_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
