...
public class LinkToEntityEmbedded__FWD_39_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getComponents();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getLinks();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof tools.vitruv.methodologisttemplate.model.model.System) return edge_explorer_6_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_6 = new EdgeExplorer(this, 8, 9, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.Link) o).getComponents();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
						edge_explorer_10 = new CachedEdgeExplorer(this, 2, 1, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getProtocols();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof tools.vitruv.methodologisttemplate.model.model.System) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_12 = new EdgeExplorer(this, 8, 4, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		nac_checker = new NACExplorer(this, Arrays.asList(new Integer[] {1,9}), node.getAllOverlaps().get(0));
		name2explorer.put("nac_checker", nac_checker);
		nac_checker_0 = new NACExplorer(this, Arrays.asList(new Integer[] {4,9}), node.getAllOverlaps().get(1));
	...
	protected void initializeOrchestration() {
		...
		nac_checker_0_orchestration = initializeOrchestration(node.getOrchestrations().get(22).getPlan());
	}
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("LinkToEntityEmbedded__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Entity_object_SP1": 
				{
					...
					// compEntity
					HMatch match_0 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_4_2_orchestration, match_0);
					
					// protEntity
					HMatch match_3 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
			...
			case "Component_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// component
						HMatch match_1 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
			...
			case "ComponentToEntity_object": 
				{
					...
					// ctoe
					HMatch match_2 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
			...
			case "Protocol_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_4 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
			...
			case "ProtocolToEntity_object": 
				{
					...
					// ptoe
					HMatch match_5 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
			...
			case "Root_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// root
						HMatch match_6 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
						match_6.getNodes()[6] = objs[0];
						start(edge_explorer_11_1_orchestration, match_6);
					}
				}
				break;
			case "SystemToRoot_object_SP1": 
				{
					edge_explorer_7.registerSourceObject(objs[0]);
					edge_explorer_11.registerSourceObject(objs[0]);
					
					// stor
					HMatch match_7 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_7_1_orchestration, match_7);
				}
				break;
			case "System_object_SP2": 
				{
					if(!lazy_initialization) {
						
						// system
						HMatch match_8 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
			...
			case "Link_object_SP0": 
				{
					...
					// link
					HMatch match_9 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
		...
		switch(match.creator) {
			...
			case "LinkToEntityEmbedded_link_components_outgoing_SRC__FILTER_NAC_SRC_14_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "LinkToEntityEmbedded_link_protocol_outgoing_SRC__FILTER_NAC_SRC_18_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
					Object[] objs_1 = match.getNodes();
					acMatch_nodes_1[4] = objs_1[1];
					acMatch_nodes_1[9] = objs_1[0];
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "tools.vitruv.methodologisttemplate.model.model.System_components_Component": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("LinkToEntityEmbedded__FWD_39_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
