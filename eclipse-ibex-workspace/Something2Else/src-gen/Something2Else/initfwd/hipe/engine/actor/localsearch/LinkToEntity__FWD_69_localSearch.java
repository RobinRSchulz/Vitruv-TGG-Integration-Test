...
public class LinkToEntity__FWD_69_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("LinkToEntity__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Link_object_SP2": 
				{
					...
					// link
					HMatch match_0 = new LocalSearchMatch("LinkToEntity__FWD_69_localSearch", 2);
			...
			case "Protocol_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_1 = new LocalSearchMatch("LinkToEntity__FWD_69_localSearch", 2);
		...
		switch(match.creator) {
			...
			case "LinkToEntity_link_components_outgoing_SRC__FILTER_NAC_SRC_50_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("LinkToEntity__FWD_69_localSearch", 2);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_53_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("LinkToEntity__FWD_69_localSearch", 2);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			case "LinkToEntity_link_links_incoming_SRC__FILTER_NAC_SRC_57_localSearch": 
				if(nac_checker_1.deregister(match)) {
					HMatch acMatch_2 = new LocalSearchMatch("LinkToEntity__FWD_69_localSearch", 2);
					Object[] acMatch_nodes_2 = acMatch_2.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("LinkToEntity__FWD_69_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
