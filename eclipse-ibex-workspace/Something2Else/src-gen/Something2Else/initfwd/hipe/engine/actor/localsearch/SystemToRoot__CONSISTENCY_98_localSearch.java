...
public class SystemToRoot__CONSISTENCY_98_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Something2Else.SystemToRoot__Marker) o).getCREATE__CORR__stor();
			...
			case "System_object_SP2": 
				{
					...
					// system
					HMatch match_0 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_98_localSearch", 4);
			...
			case "Root_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// root
						HMatch match_1 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_98_localSearch", 4);
			...
			case "SystemToRoot_object_SP0": 
				{
					...
					// stor
					HMatch match_2 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_98_localSearch", 4);
			...
			case "SystemToRoot__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_98_localSearch", 4);
		...
		case "Something2Else.SystemToRoot_target_Root": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Root) {
				{
					...
					HMatch match = new LocalSearchMatch("SystemToRoot__CONSISTENCY_98_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
