...
public class SystemRefdComponentToEntity__CONSISTENCY_186_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCONTEXT__SRC__system(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCREATE__SRC__comp(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCONTEXT__CORR__stor();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCONTEXT__TRG__root(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Something2Else.SystemRefdComponentToEntity__Marker) o).getCREATE__CORR__ctoe();
			...
			case "ComponentToEntity_object_SP0": 
				{
					...
					// ctoe
					HMatch match_4 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch", 7);
			...
			case "SystemRefdComponentToEntity__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "SystemRefdComponentToEntity__FWD_183_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch", 7);
				...
				break;
			case "SystemRefdComponentToEntity__BWD_171_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch", 7);
		...
		case "Something2Else.ComponentToEntity_target_Entity": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
				{
					...
					HMatch match = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SystemRefdComponentToEntity__FWD
		...
		// register SystemRefdComponentToEntity__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SystemRefdComponentToEntity__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister SystemRefdComponentToEntity__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[1];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof tools.vitruv.methodologisttemplate.model.model.Component) {
			HMatch match_0 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch", 7);
		...
		if(obj instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
			HMatch match_2 = new LocalSearchMatch("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_1.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, comp.getName(), "java.lang.String"));
		csp_1.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, entity.getName(), "java.lang.String"));
		csp_1.solve();
