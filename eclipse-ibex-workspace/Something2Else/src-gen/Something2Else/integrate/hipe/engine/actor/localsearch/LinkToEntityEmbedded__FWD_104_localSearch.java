...
public class LinkToEntityEmbedded__FWD_104_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Protocol ? result : null);};
						edge_explorer_7 = new CachedEdgeExplorer(this, 5, 4, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {1,4,8,9}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("LinkToEntityEmbedded__CONSISTENCY_111_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("LinkToEntityEmbedded__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Entity_object_SP0": 
				{
					...
					// compEntity
					HMatch match_0 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_104_localSearch", 10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_4_2_orchestration, match_0);
					
					// protEntity
					HMatch match_3 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_104_localSearch", 10);
			...
			case "ComponentToEntity_object_SP1": 
				{
					...
					// ctoe
					HMatch match_2 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_104_localSearch", 10);
			...
			case "ProtocolToEntity_object": 
				{
					...
					// ptoe
					HMatch match_5 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_104_localSearch", 10);
			...
			case "Root_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// root
						HMatch match_6 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_104_localSearch", 10);
			...
			case "SystemToRoot_object_SP2": 
				{
					...
					// stor
					HMatch match_7 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_104_localSearch", 10);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_3_1_orchestration, match_7);
				}
				break;
			case "LinkToEntityEmbedded__SRC_99_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("LinkToEntityEmbedded__FWD_104_localSearch", 10);
						acMatch_0.getNodes()[1] = objs[0];
						acMatch_0.getNodes()[4] = objs[2];
						acMatch_0.getNodes()[8] = objs[3];
						acMatch_0.getNodes()[9] = objs[1];
		...
		case "Something2Else.ProtocolToEntity_target_Entity": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
				{
					...
					HMatch match = new LocalSearchMatch("LinkToEntityEmbedded__FWD_104_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register LinkToEntityEmbedded__SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister LinkToEntityEmbedded__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[1];
		oMatch_Nodes_0[1] = objs[4];
