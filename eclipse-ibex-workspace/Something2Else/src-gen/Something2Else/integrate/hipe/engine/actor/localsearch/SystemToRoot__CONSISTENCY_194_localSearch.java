...
public class SystemToRoot__CONSISTENCY_194_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot__Marker) o).getCREATE__TRG__root(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 3, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.SystemToRoot__Marker) o).getCREATE__SRC__system(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 3, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Something2Else.SystemToRoot__Marker) o).getCREATE__CORR__stor();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SystemToRoot__CONSISTENCY_production"), this::returnTrue  , false ));
	}
			...
			case "SystemToRoot_object_SP0": 
				{
					...
					// stor
					HMatch match_2 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_194_localSearch", 4);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_1_orchestration, match_2);
				}
				break;
			case "SystemToRoot__Marker_object": 
				{
					edge_explorer_3.registerSourceObject(objs[0]);
					edge_explorer_4.registerSourceObject(objs[0]);
					edge_explorer_5.registerSourceObject(objs[0]);
					
					// SystemToRoot_eMoflon_ProtocolNode
					HMatch match_3 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_194_localSearch", 4);
			...
			case "System_object_SP2": 
				{
					...
					// system
					HMatch match_0 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_194_localSearch", 4);
			...
			case "Root_object_SP2": 
				{
					...
					// root
					HMatch match_1 = new LocalSearchMatch("SystemToRoot__CONSISTENCY_194_localSearch", 4);
		...
		case "Something2Else.SystemToRoot_target_Root": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Root) {
				{
					...
					HMatch match = new LocalSearchMatch("SystemToRoot__CONSISTENCY_194_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
			...
			break;
		case "Something2Else.SystemToRoot__Marker_CREATE__TRG__root_Root": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Root) {
				{
			...
			break;
		case "Something2Else.SystemToRoot__Marker_CREATE__SRC__system_System": 
			if(!lazy_initialization) {
			...
			break;
		case "Something2Else.SystemToRoot__Marker_CREATE__CORR__stor_SystemToRoot": 
			if(!lazy_initialization) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register SystemToRoot_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister SystemToRoot_eMoflon_ProtocolNode
		Collection<HMatch> matches_3 = obj2matches.get(objs[3]);
		if(matches_3 != null) {
