...
public class LinkToEntityEmbedded__SRC_99_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getLinks();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getProtocols();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("LinkToEntityEmbedded__FWD_104_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("LinkToEntityEmbedded__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Component_object_SP1": 
				{
					...
					// component
					HMatch match_0 = new LocalSearchMatch("LinkToEntityEmbedded__SRC_99_localSearch", 4);
			...
			case "Link_object_SP2": 
				{
					...
					// link
					HMatch match_1 = new LocalSearchMatch("LinkToEntityEmbedded__SRC_99_localSearch", 4);
			...
			case "Protocol_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_2 = new LocalSearchMatch("LinkToEntityEmbedded__SRC_99_localSearch", 4);
			...
			case "System_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_3 = new LocalSearchMatch("LinkToEntityEmbedded__SRC_99_localSearch", 4);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_3_1_orchestration, match_3);
					}
				}
				break;
			case "LinkToEntityEmbedded_link_components_outgoing_SRC__FILTER_NAC_SRC_55_localSearch": 
				{
				...
				break;
			case "LinkToEntityEmbedded_link_protocol_outgoing_SRC__FILTER_NAC_SRC_59_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "LinkToEntityEmbedded_link_components_outgoing_SRC__FILTER_NAC_SRC_55_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("LinkToEntityEmbedded__SRC_99_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "LinkToEntityEmbedded_link_protocol_outgoing_SRC__FILTER_NAC_SRC_59_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("LinkToEntityEmbedded__SRC_99_localSearch", 4);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("LinkToEntityEmbedded__SRC_99_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
