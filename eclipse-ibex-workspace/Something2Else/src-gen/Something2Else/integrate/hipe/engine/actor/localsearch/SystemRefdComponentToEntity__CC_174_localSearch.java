...
public class SystemRefdComponentToEntity__CC_174_localSearch extends GenericLocalSearchActor{
			...
			case "Root_object_SP2": 
				{
					...
					// root
					HMatch match_0 = new LocalSearchMatch("SystemRefdComponentToEntity__CC_174_localSearch", 5);
			...
			case "SystemToRoot_object_SP1": 
				{
					...
					// stor
					HMatch match_1 = new LocalSearchMatch("SystemRefdComponentToEntity__CC_174_localSearch", 5);
			...
			case "System_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_2 = new LocalSearchMatch("SystemRefdComponentToEntity__CC_174_localSearch", 5);
			...
			case "Component_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// comp
						HMatch match_3 = new LocalSearchMatch("SystemRefdComponentToEntity__CC_174_localSearch", 5);
			...
			case "Entity_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_4 = new LocalSearchMatch("SystemRefdComponentToEntity__CC_174_localSearch", 5);
		...
		case "Something2Else.SystemToRoot_target_Root": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Root) {
				{
					...
					HMatch match = new LocalSearchMatch("SystemRefdComponentToEntity__CC_174_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
