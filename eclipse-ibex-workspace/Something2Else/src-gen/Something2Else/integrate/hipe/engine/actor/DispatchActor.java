package Something2Else.integrate.hipe.engine.actor;
...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAdd() {
		...
		type2addConsumer.put(tools.vitruv.methodologisttemplate.model.model2.Model2Package.eINSTANCE.getEntity(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("Entity_object_SP4").tell(new ObjectAdded<tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, _entity), getSelf());
		});
	...
	private void initializeSet() {
		feature2setConsumer.put(tools.vitruv.methodologisttemplate.model.model2.Model2Package.eINSTANCE.getEntity_Name(), notification -> {
			if(notification.getNotifier() instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
				incUtil.newMessage();
				name2actor.get("Entity_object_SP4").tell(new AttributeChanged<tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNotifier(), notification.getOldValue()), getSelf());
			}
			if(notification.getNotifier() instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
				incUtil.newMessage();
	...
	private void initializeAddEdge() {
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CONTEXT__SRC__system(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_111_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CONTEXT__SRC__system_System"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getComponentToEntity_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ComponentToEntity__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__FWD_104_localSearch").tell(new ReferenceAdded<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<Something2Else.ComponentToEntity, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.ComponentToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.ComponentToEntity_source_Component"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getLink_Protocol(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_link_protocol_outgoing_SRC__FILTER_NAC_SRC_59_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_link_protocol_outgoing_SRC__FILTER_NAC_SRC_59_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__SRC_99_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_124_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_124_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity__SRC_140_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Protocols(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__SRC_99_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CC_153_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__SRC_159_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getProtocolToEntity__Marker_CREATE__SRC__protocol(), notification -> {
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_165_localSearch").tell(new ReferenceAdded<Something2Else.ProtocolToEntity__Marker, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(Something2Else.ProtocolToEntity__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "Something2Else.ProtocolToEntity__Marker_CREATE__SRC__protocol_Protocol"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemRefdComponentToEntity__Marker_CONTEXT__CORR__stor(), notification -> {
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<Something2Else.SystemRefdComponentToEntity__Marker, Something2Else.SystemToRoot>(incUtil,(Something2Else.SystemRefdComponentToEntity__Marker) notification.getNotifier(), (Something2Else.SystemToRoot) notification.getNewValue(), "Something2Else.SystemRefdComponentToEntity__Marker_CONTEXT__CORR__stor_SystemToRoot"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CONTEXT__CORR__stor(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_111_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, Something2Else.SystemToRoot>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (Something2Else.SystemToRoot) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CONTEXT__CORR__stor_SystemToRoot"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntity_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_111_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntity, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(Something2Else.LinkToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "Something2Else.LinkToEntity_target_Entity"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemToRoot_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__BWD_150_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CC_153_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__FWD_162_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__BWD_171_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CC_174_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__FWD_183_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemToRoot__CONSISTENCY_194_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntity_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_111_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntity, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil,(Something2Else.LinkToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNewValue(), "Something2Else.LinkToEntity_source_Link"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemRefdComponentToEntity__Marker_CREATE__SRC__comp(), notification -> {
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<Something2Else.SystemRefdComponentToEntity__Marker, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.SystemRefdComponentToEntity__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.SystemRefdComponentToEntity__Marker_CREATE__SRC__comp_Component"), getSelf());
		});
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Links(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__SRC_99_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_links_Link"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_links_incoming_SRC__FILTER_NAC_SRC_128_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_links_Link"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CONTEXT__SRC__protocol(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_111_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CONTEXT__SRC__protocol_Protocol"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CREATE__SRC__link(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_111_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CREATE__SRC__link_Link"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CONTEXT__SRC__component(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_111_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CONTEXT__SRC__component_Component"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getProtocolToEntity__Marker_CONTEXT__SRC__system(), notification -> {
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_165_localSearch").tell(new ReferenceAdded<Something2Else.ProtocolToEntity__Marker, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.ProtocolToEntity__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.ProtocolToEntity__Marker_CONTEXT__SRC__system_System"), getSelf());
		});
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getLink_Components(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_link_components_outgoing_SRC__FILTER_NAC_SRC_55_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_link_components_outgoing_SRC__FILTER_NAC_SRC_55_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__SRC_99_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_components_outgoing_SRC__FILTER_NAC_SRC_121_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model2.Model2Package.eINSTANCE.getRoot_Entities(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_linkEntity_entities_incoming_TRG__FILTER_NAC_TRG_19_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_114_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__TRG_147_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CC_153_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__TRG_168_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CC_174_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil,(tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getProtocolToEntity_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_165_localSearch").tell(new ReferenceAdded<Something2Else.ProtocolToEntity, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil,(Something2Else.ProtocolToEntity) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getNewValue(), "Something2Else.ProtocolToEntity_source_Protocol"), getSelf());
		});
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getLinkToEntityEmbedded__Marker_CREATE__CORR__ltoe(), notification -> {
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__CONSISTENCY_111_localSearch").tell(new ReferenceAdded<Something2Else.LinkToEntityEmbedded__Marker, Something2Else.LinkToEntity>(incUtil,(Something2Else.LinkToEntityEmbedded__Marker) notification.getNotifier(), (Something2Else.LinkToEntity) notification.getNewValue(), "Something2Else.LinkToEntityEmbedded__Marker_CREATE__CORR__ltoe_LinkToEntity"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemRefdComponentToEntity__Marker_CONTEXT__SRC__system(), notification -> {
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch").tell(new ReferenceAdded<Something2Else.SystemRefdComponentToEntity__Marker, tools.vitruv.methodologisttemplate.model.model.System>(incUtil,(Something2Else.SystemRefdComponentToEntity__Marker) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getNewValue(), "Something2Else.SystemRefdComponentToEntity__Marker_CONTEXT__SRC__system_System"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Components(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__SRC_99_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CC_174_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__SRC_180_localSearch").tell(new ReferenceAdded<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil,(tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getNewValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemToRoot_Target(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__BWD_150_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CC_153_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__FWD_162_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__BWD_171_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			...
			name2actor.get("SystemRefdComponentToEntity__CC_174_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__FWD_183_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemToRoot__CONSISTENCY_194_localSearch").tell(new ReferenceAdded<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model2.Root>(incUtil,(Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNewValue(), "Something2Else.SystemToRoot_target_Root"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getProtocolToEntity__Marker_CONTEXT__CORR__stor(), notification -> {
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CONSISTENCY_165_localSearch").tell(new ReferenceAdded<Something2Else.ProtocolToEntity__Marker, Something2Else.SystemToRoot>(incUtil,(Something2Else.ProtocolToEntity__Marker) notification.getNotifier(), (Something2Else.SystemToRoot) notification.getNewValue(), "Something2Else.ProtocolToEntity__Marker_CONTEXT__CORR__stor_SystemToRoot"), getSelf());
		});
	...
	private void initializeRemoveEdge() {
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getLink_Protocol(), notification -> {
			...
			name2actor.get("LinkToEntityEmbedded_link_protocol_outgoing_SRC__FILTER_NAC_SRC_59_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__SRC_99_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_124_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_protocol_outgoing_SRC__FILTER_NAC_SRC_124_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity__SRC_140_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_protocol_Protocol"), getSelf());
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Protocols(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__SRC_99_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CC_153_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__SRC_159_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Protocol>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Protocol) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_protocols_Protocol"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Something2Else.Something2ElsePackage.eINSTANCE.getSystemToRoot_Source(), notification -> {
			...
			name2actor.get("LinkToEntityEmbedded__FWD_104_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__BWD_150_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CC_153_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__FWD_162_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__BWD_171_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			...
			name2actor.get("SystemRefdComponentToEntity__CC_174_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__FWD_183_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemToRoot__CONSISTENCY_194_localSearch").tell(new ReferenceDeleted<Something2Else.SystemToRoot, tools.vitruv.methodologisttemplate.model.model.System>(incUtil, (Something2Else.SystemToRoot) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.System) notification.getOldValue(), "Something2Else.SystemToRoot_source_System"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Links(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__SRC_99_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_links_Link"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_links_incoming_SRC__FILTER_NAC_SRC_128_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Link>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Link) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_links_Link"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getLink_Components(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_link_components_outgoing_SRC__FILTER_NAC_SRC_55_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded_link_components_outgoing_SRC__FILTER_NAC_SRC_55_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__SRC_99_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_link_components_outgoing_SRC__FILTER_NAC_SRC_121_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.Link, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.Link) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.Link_components_Component"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model2.Model2Package.eINSTANCE.getRoot_Entities(), notification -> {
			...
			name2actor.get("LinkToEntityEmbedded_linkEntity_entities_incoming_TRG__FILTER_NAC_TRG_19_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("LinkToEntity_entity_entities_incoming_TRG__FILTER_NAC_TRG_114_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__TRG_147_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("ProtocolToEntity__CC_153_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__TRG_168_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CC_174_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model2.Root, tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Root) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model2.Entity) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model2.Root_entities_Entity"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(tools.vitruv.methodologisttemplate.model.model.ModelPackage.eINSTANCE.getSystem_Components(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("LinkToEntityEmbedded__SRC_99_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__CC_174_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
			incUtil.newMessage();
			name2actor.get("SystemRefdComponentToEntity__SRC_180_localSearch").tell(new ReferenceDeleted<tools.vitruv.methodologisttemplate.model.model.System, tools.vitruv.methodologisttemplate.model.model.Component>(incUtil, (tools.vitruv.methodologisttemplate.model.model.System) notification.getNotifier(), (tools.vitruv.methodologisttemplate.model.model.Component) notification.getOldValue(), "tools.vitruv.methodologisttemplate.model.model.System_components_Component"), getSelf());
		});
	...
	private void handleRemoveAdapter(Notification notification) {
		...
		if (node instanceof tools.vitruv.methodologisttemplate.model.model2.Entity) {
			incUtil.newMessage();
			name2actor.get("Entity_object_SP4").tell(new ObjectDeleted<tools.vitruv.methodologisttemplate.model.model2.Entity>(incUtil, (tools.vitruv.methodologisttemplate.model.model2.Entity) node), getSelf());
		}
