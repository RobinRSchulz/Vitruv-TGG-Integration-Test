...
public class ProtocolToEntity__CONSISTENCY_165_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Protocol ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 4, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 4, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCONTEXT__SRC__system(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.System ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCREATE__TRG__entity(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCREATE__SRC__protocol(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Protocol ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ProtocolToEntity__Marker) o).getCONTEXT__TRG__root(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Root ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Something2Else.ProtocolToEntity__Marker) o).getCONTEXT__CORR__stor();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Something2Else.ProtocolToEntity__Marker) o).getCREATE__CORR__ptoe();
			...
			case "ProtocolToEntity_object": 
				{
					...
					// ptoe
					HMatch match_4 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_165_localSearch", 7);
			...
			case "ProtocolToEntity__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_165_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_4_1_orchestration, match_6);
				}
				break;
			case "ProtocolToEntity__FWD_162_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_165_localSearch", 7);
				...
				break;
			case "ProtocolToEntity__BWD_150_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_165_localSearch", 7);
						acMatch_1.getNodes()[1] = objs[2];
						acMatch_1.getNodes()[2] = objs[3];
						acMatch_1.getNodes()[3] = objs[0];
		...
		case "Something2Else.ProtocolToEntity_source_Protocol": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.Protocol) {
				{
					...
					HMatch match = new LocalSearchMatch("ProtocolToEntity__CONSISTENCY_165_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ProtocolToEntity__FWD
		...
		// register ProtocolToEntity__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ProtocolToEntity__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister ProtocolToEntity__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[1];
		oMatch_Nodes_1[1] = objs[2];
