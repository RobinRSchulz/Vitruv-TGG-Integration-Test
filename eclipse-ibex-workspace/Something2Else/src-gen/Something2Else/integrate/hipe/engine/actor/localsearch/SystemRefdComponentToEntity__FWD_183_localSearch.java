...
public class SystemRefdComponentToEntity__FWD_183_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SystemRefdComponentToEntity__CONSISTENCY_186_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("SystemRefdComponentToEntity__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Root_object_SP3": 
				{
					...
					// root
					HMatch match_0 = new LocalSearchMatch("SystemRefdComponentToEntity__FWD_183_localSearch", 4);
			...
			case "SystemToRoot_object_SP2": 
				{
					...
					// stor
					HMatch match_1 = new LocalSearchMatch("SystemRefdComponentToEntity__FWD_183_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_1_orchestration, match_1);
				}
				break;
			case "SystemRefdComponentToEntity__SRC_180_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SystemRefdComponentToEntity__FWD_183_localSearch", 4);
		...
		case "Something2Else.SystemToRoot_source_System": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.System) {
				{
					...
					HMatch match = new LocalSearchMatch("SystemRefdComponentToEntity__FWD_183_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SystemRefdComponentToEntity__SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SystemRefdComponentToEntity__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[2];
		oMatch_Nodes_0[1] = objs[3];
