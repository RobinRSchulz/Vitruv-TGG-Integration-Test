...
public class ComponentToEntity__CONSISTENCY_16_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity__Marker) o).getCREATE__SRC__comp(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Component ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 3, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.ComponentToEntity) o).getTarget(); return (result instanceof tools.vitruv.methodologisttemplate.model.model2.Entity ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Something2Else.ComponentToEntity__Marker) o).getCREATE__CORR__ctoe();
			...
			case "ComponentToEntity_object_SP0": 
				{
					...
					// ctoe
					HMatch match_2 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_16_localSearch", 4);
			...
			case "ComponentToEntity__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_16_localSearch", 4);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "ComponentToEntity__FWD_14_nacjunction": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_16_localSearch", 4);
				...
				break;
			case "ComponentToEntity__BWD_4_nacjunction": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_16_localSearch", 4);
		...
		case "Something2Else.ComponentToEntity__Marker_CREATE__SRC__comp_Component": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.Component) {
				{
					...
					HMatch match = new LocalSearchMatch("ComponentToEntity__CONSISTENCY_16_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ComponentToEntity__FWD
		...
		// register ComponentToEntity__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ComponentToEntity__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(1);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		Collection<HMatch> oMatches_0 = overlap2matches_0.get(oMatch_0);
		...
		// deregister ComponentToEntity__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(1);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[1];
		Collection<HMatch> oMatches_1 = overlap2matches_1.get(oMatch_1);
