...
public class LinkToEntity__CONSISTENCY_144_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.LinkToEntity) o).getSource(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Link ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 3, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Something2Else.LinkToEntity__Marker) o).getCREATE__CORR__ltoe();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Something2Else.LinkToEntity__Marker) o).getCREATE__SRC__link(); return (result instanceof tools.vitruv.methodologisttemplate.model.model.Link ? result : null);};
		...
		pac_explorer_0 = new PACExplorer(this, Arrays.asList(new Integer[] {1,2}), node.getAllOverlaps().get(1));
			...
			case "LinkToEntity_object": 
				{
					...
					// ltoe
					HMatch match_3 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_144_localSearch", 5);
			...
			case "LinkToEntity__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_144_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_3_1_orchestration, match_4);
				}
				break;
			case "LinkToEntity__FWD_143_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_144_localSearch", 5);
				...
				break;
			case "LinkToEntity__BWD_117_junction": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("LinkToEntity__CONSISTENCY_144_localSearch", 5);
		...
		case "Something2Else.LinkToEntity_source_Link": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model.Link) {
				{
					...
					HMatch match = new LocalSearchMatch("LinkToEntity__CONSISTENCY_144_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
