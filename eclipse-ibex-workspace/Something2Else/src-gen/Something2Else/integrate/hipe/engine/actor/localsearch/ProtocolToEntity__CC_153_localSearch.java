...
public class ProtocolToEntity__CC_153_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((tools.vitruv.methodologisttemplate.model.model.System) o).getProtocols();
			...
			case "Root_object_SP3": 
				{
					...
					// root
					HMatch match_0 = new LocalSearchMatch("ProtocolToEntity__CC_153_localSearch", 5);
			...
			case "SystemToRoot_object_SP1": 
				{
					...
					// stor
					HMatch match_1 = new LocalSearchMatch("ProtocolToEntity__CC_153_localSearch", 5);
			...
			case "System_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// system
						HMatch match_2 = new LocalSearchMatch("ProtocolToEntity__CC_153_localSearch", 5);
			...
			case "Protocol_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// protocol
						HMatch match_3 = new LocalSearchMatch("ProtocolToEntity__CC_153_localSearch", 5);
			...
			case "Entity_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// entity
						HMatch match_4 = new LocalSearchMatch("ProtocolToEntity__CC_153_localSearch", 5);
		...
		case "Something2Else.SystemToRoot_target_Root": 
			if(!lazy_initialization) {
				if(msg.target instanceof tools.vitruv.methodologisttemplate.model.model2.Root) {
				{
					...
					HMatch match = new LocalSearchMatch("ProtocolToEntity__CC_153_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
