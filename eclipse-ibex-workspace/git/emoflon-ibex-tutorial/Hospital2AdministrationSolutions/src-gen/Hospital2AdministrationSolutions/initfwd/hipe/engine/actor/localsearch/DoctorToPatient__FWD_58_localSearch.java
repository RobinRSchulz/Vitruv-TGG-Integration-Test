...
public class DoctorToPatient__FWD_58_localSearch extends GenericLocalSearchActor{
			...
			case "Doctor_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__FWD_58_localSearch", 8);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__FWD_58_localSearch", 8);
			...
			case "Department_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// dep
						HMatch match_2 = new LocalSearchMatch("DoctorToPatient__FWD_58_localSearch", 8);
			...
			case "Patient_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_3 = new LocalSearchMatch("DoctorToPatient__FWD_58_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("DoctorToPatient__FWD_58_localSearch", 8);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__FWD_58_localSearch", 8);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_6 = new LocalSearchMatch("DoctorToPatient__FWD_58_localSearch", 8);
			...
			case "Staff_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_7 = new LocalSearchMatch("DoctorToPatient__FWD_58_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Room_lies_Patient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DoctorToPatient__FWD_58_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
