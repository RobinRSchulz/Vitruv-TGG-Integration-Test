...
public class RoomRule__FWD_177_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("RoomRule__FWD_177_localSearch", 2);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_1 = new LocalSearchMatch("RoomRule__FWD_177_localSearch", 2);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Department_rooms_Room": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("RoomRule__FWD_177_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
