...
public class PatientInRoom__CONSISTENCY_156_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitalToAdministration) o).getSource(); return (result instanceof HospitalExample.Hospital ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 7, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.PatientInRoom__Marker) o).getCONTEXT__CORR__htov();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.PatientInRoom__Marker) o).getCREATE__CORR__pTop();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInRoom__Marker) o).getCONTEXT__TRG__v(); return (result instanceof AdministrationExample.Administration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInRoom__Marker) o).getCONTEXT__SRC__d(); return (result instanceof HospitalExample.Department ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInRoom__Marker) o).getCREATE__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11 = new EdgeExplorer(this, 5, 4, edge_explorer_11_methods);
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInRoom__Marker) o).getCREATE__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInRoom__Marker) o).getCONTEXT__SRC__ro(); return (result instanceof HospitalExample.Room ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.multi_lookup = (o) -> ((HospitalExample.Room) o).getLies();
						edge_explorer_16_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Room) return edge_explorer_16_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_16 = new EdgeExplorer(this, 3, 2, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInRoom__Marker) o).getCONTEXT__SRC__h(); return (result instanceof HospitalExample.Hospital ? result : null);};
			...
			case "Department_object_SP2": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
			...
			case "Hospital_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
			...
			case "Patient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_2 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
			...
			case "Administration_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_5 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
			...
			case "HospitalToAdministration_object_SP1": 
				{
					...
					// htov
					HMatch match_6 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pTop
					HMatch match_7 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
			...
			case "PatientInRoom__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_6_1_orchestration, match_8);
				}
				break;
			case "PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_153_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_153_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Hospital_department_Department": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
		...
		case "HospitalExample.Department_rooms_Room": 
			...
			break;
		case "Hospital2AdministrationSolutions.PatientToPatient_target_Patient": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__CORR__htov_HospitalToAdministration": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInRoom__Marker_CREATE__CORR__pTop_PatientToPatient": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__TRG__v_Administration": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__SRC__d_Department": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInRoom__Marker_CREATE__TRG__p2_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Patient) {
				{
			...
			break;
		case "AdministrationExample.Administration_patient_Patient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("PatientInRoom__CONSISTENCY_156_localSearch", 9);
					Object[] objs = match.getNodes();
		...
		case "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration": 
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInRoom__Marker_CREATE__SRC__p1_Patient": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.PatientToPatient_source_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Patient) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__SRC__ro_Room": 
			if(!lazy_initialization) {
		...
		case "HospitalExample.Room_lies_Patient": 
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__SRC__h_Hospital": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Hospital) {
				{
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingPatientID csp_15 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingPatientID();
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getPatientID(), "int"));
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getPatientID(), "int"));
		csp_15.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nametoname csp_16 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nametoname();
		...
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getFirstName(), "java.lang.String"));
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getLastName(), "java.lang.String"));
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getName(), "java.lang.String"));
		csp_16.solve();
