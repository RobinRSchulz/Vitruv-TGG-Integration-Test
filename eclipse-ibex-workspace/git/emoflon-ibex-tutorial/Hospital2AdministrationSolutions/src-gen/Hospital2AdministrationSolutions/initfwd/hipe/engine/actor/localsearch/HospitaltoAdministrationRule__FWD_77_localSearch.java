...
public class HospitaltoAdministrationRule__FWD_77_localSearch extends GenericLocalSearchActor{
			...
			case "Hospital_object_SP2": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("HospitaltoAdministrationRule__FWD_77_localSearch", 2);
			...
			case "Reception_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_1 = new LocalSearchMatch("HospitaltoAdministrationRule__FWD_77_localSearch", 2);
		...
		switch(match.creator) {
			...
			case "HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_67_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("HospitaltoAdministrationRule__FWD_77_localSearch", 2);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Hospital_reception_Reception": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("HospitaltoAdministrationRule__FWD_77_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
