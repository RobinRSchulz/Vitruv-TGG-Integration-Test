...
public class PatientInReception__CONSISTENCY_138_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCONTEXT__SRC__r(); return (result instanceof HospitalExample.Reception ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitalToAdministration) o).getSource(); return (result instanceof HospitalExample.Hospital ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCREATE__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCREATE__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((HospitalExample.Hospital) o).getReception();
						edge_explorer_9_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Hospital) return o.equals(edge_explorer_9_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCONTEXT__CORR__htov();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCREATE__CORR__pTop();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCONTEXT__TRG__v(); return (result instanceof AdministrationExample.Administration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.multi_lookup = (o) -> ((AdministrationExample.Administration) o).getPatient();
			...
			case "Hospital_object_SP1": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__CONSISTENCY_138_localSearch", 8);
			...
			case "Patient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_1 = new LocalSearchMatch("PatientInReception__CONSISTENCY_138_localSearch", 8);
			...
			case "Reception_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_2 = new LocalSearchMatch("PatientInReception__CONSISTENCY_138_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_3 = new LocalSearchMatch("PatientInReception__CONSISTENCY_138_localSearch", 8);
			...
			case "Administration_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_4 = new LocalSearchMatch("PatientInReception__CONSISTENCY_138_localSearch", 8);
			...
			case "HospitalToAdministration_object_SP2": 
				{
					...
					// htov
					HMatch match_5 = new LocalSearchMatch("PatientInReception__CONSISTENCY_138_localSearch", 8);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pTop
					HMatch match_6 = new LocalSearchMatch("PatientInReception__CONSISTENCY_138_localSearch", 8);
			...
			case "PatientInReception__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("PatientInReception__CONSISTENCY_138_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_135_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_135_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInReception__CONSISTENCY_138_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__SRC__r_Reception": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Reception) {
				{
					...
					HMatch match = new LocalSearchMatch("PatientInReception__CONSISTENCY_138_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingPatientID csp_13 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingPatientID();
