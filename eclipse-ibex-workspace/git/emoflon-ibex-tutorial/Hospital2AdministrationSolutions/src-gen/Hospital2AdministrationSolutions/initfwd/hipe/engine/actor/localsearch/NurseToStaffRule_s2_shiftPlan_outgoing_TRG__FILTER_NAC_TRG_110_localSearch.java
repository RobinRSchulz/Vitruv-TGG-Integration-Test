...
public class NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_110_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Staff_object_SP1": 
				{
					...
					// s2
					HMatch match_0 = new LocalSearchMatch("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_110_localSearch", 3);
			...
			case "Shiftplan_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_1 = new LocalSearchMatch("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_110_localSearch", 3);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
						
						// FILTER_NAC_NODE
						HMatch match_2 = new LocalSearchMatch("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_110_localSearch", 3);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "AdministrationExample.Staff_shiftPlan_Shiftplan": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_110_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
