...
public class NurseToRoomRule__CONSISTENCY_91_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__CORR__nToS();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__CORR__pTop();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getTarget(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__TRG__s(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((HospitalExample.Department) o).getRooms();
						edge_explorer_11_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Department) return edge_explorer_11_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_11 = new EdgeExplorer(this, 0, 3, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__n(); return (result instanceof HospitalExample.Nurse ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Nurse ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__dep(); return (result instanceof HospitalExample.Department ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((HospitalExample.Nurse) o).getResponsible();
						edge_explorer_16_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Room) o).getNurses();
						edge_explorer_16 = new EdgeExplorer(this, 1, 3, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__r(); return (result instanceof HospitalExample.Room ? result : null);};
			...
			case "Department_object_SP2": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_91_localSearch", 9);
			...
			case "Nurse_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// n
						HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_91_localSearch", 9);
			...
			case "Patient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_91_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_91_localSearch", 9);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_91_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_91_localSearch", 9);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// nToS
					HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_91_localSearch", 9);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pTop
					HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_91_localSearch", 9);
			...
			case "NurseToRoomRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_91_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__TRG__p2_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Patient) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_91_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
		...
		case "Hospital2AdministrationSolutions.PatientToPatient_target_Patient": 
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__CORR__nToS_StaffToStaff": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__CORR__pTop_PatientToPatient": 
			if(!lazy_initialization) {
				{
		...
		case "Hospital2AdministrationSolutions.StaffToStaff_target_Staff": 
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__TRG__s_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__SRC__p1_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Patient) {
				{
		...
		case "HospitalExample.Department_rooms_Room": 
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__SRC__n_Nurse": 
			if(!lazy_initialization) {
		...
		case "HospitalExample.Room_lies_Patient": 
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__SRC__dep_Department": 
			if(!lazy_initialization) {
		...
		case "HospitalExample.Nurse_responsible_Room": 
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__SRC__r_Room": 
			if(!lazy_initialization) {
