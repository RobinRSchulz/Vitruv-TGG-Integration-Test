...
public class DepartmentRule__CONSISTENCY_1_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DepartmentRule__Marker) o).getCREATE__SRC__d(); return (result instanceof HospitalExample.Department ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 2, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DepartmentRule__Marker) o).getCONTEXT__SRC__h(); return (result instanceof HospitalExample.Hospital ? result : null);};
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Hospital_department_Department": 
			...
			break;
		case "Hospital2AdministrationSolutions.DepartmentRule__Marker_CREATE__SRC__d_Department": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.DepartmentRule__Marker_CONTEXT__SRC__h_Hospital": 
			if(!lazy_initialization) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingDepartmentID csp_0 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingDepartmentID();
