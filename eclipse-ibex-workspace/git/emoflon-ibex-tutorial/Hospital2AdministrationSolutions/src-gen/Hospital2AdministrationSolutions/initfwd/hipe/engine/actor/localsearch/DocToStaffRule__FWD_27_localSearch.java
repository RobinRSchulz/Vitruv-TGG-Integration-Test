...
public class DocToStaffRule__FWD_27_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object_SP3": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DocToStaffRule__FWD_27_localSearch", 5);
			...
			case "Hospital_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("DocToStaffRule__FWD_27_localSearch", 5);
			...
			case "HospitalToAdministration_object_SP1": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("DocToStaffRule__FWD_27_localSearch", 5);
			...
			case "Administration_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_3 = new LocalSearchMatch("DocToStaffRule__FWD_27_localSearch", 5);
			...
			case "Doctor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_4 = new LocalSearchMatch("DocToStaffRule__FWD_27_localSearch", 5);
		...
		case "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Administration) {
				{
					...
					HMatch match = new LocalSearchMatch("DocToStaffRule__FWD_27_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
