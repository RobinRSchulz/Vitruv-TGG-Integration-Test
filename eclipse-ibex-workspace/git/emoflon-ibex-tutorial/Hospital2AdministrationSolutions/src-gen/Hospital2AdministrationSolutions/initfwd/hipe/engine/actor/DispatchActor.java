package Hospital2AdministrationSolutions.initfwd.hipe.engine.actor;
...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAddEdge() {
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__CORR__pToP(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorToPatient__Marker, Hospital2AdministrationSolutions.PatientToPatient>(incUtil,(Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.PatientToPatient) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__CORR__pToP_PatientToPatient"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getRoom_Lies(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_135_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_166_localSearch").tell(new ReferenceAdded<HospitalExample.Room, HospitalExample.Patient>(incUtil,(HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Room_lies_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getHospitaltoAdministrationRule__Marker_CREATE__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_71_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker, Hospital2AdministrationSolutions.HospitalToAdministration>(incUtil,(Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker_CREATE__CORR__htov_HospitalToAdministration"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getStaff_Works(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_27_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__FWD_129_localSearch").tell(new ReferenceAdded<HospitalExample.Staff, HospitalExample.Department>(incUtil,(HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "HospitalExample.Staff_works_Department"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInRoom__Marker, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CREATE__SRC__p1_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__CORR__pTop(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInRoom__Marker, Hospital2AdministrationSolutions.PatientToPatient>(incUtil,(Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.PatientToPatient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CREATE__CORR__pTop_PatientToPatient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__TRG__sp(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker, AdministrationExample.Shiftplan>(incUtil,(Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__TRG__sp_Shiftplan"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientToPatient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CREATE__TRG__t(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorToPatient__Marker, AdministrationExample.Treatment>(incUtil,(Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CREATE__TRG__t_Treatment"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__ro(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorToPatient__Marker, HospitalExample.Room>(incUtil,(Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__SRC__ro_Room"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__SRC__p1_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__SRC__s1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DocToStaffRule__Marker, HospitalExample.Doctor>(incUtil,(Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__SRC__s1_Doctor"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInReception__Marker, Hospital2AdministrationSolutions.HospitalToAdministration>(incUtil,(Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__CORR__htov_HospitalToAdministration"), getSelf());
		});
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getAdministration_Patient(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<AdministrationExample.Administration, AdministrationExample.Patient>(incUtil,(AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "AdministrationExample.Administration_patient_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getNurse_Responsible(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceAdded<HospitalExample.Nurse, HospitalExample.Room>(incUtil,(HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Nurse_responsible_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<HospitalExample.Nurse, HospitalExample.Room>(incUtil,(HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Nurse_responsible_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceAdded<HospitalExample.Nurse, HospitalExample.Room>(incUtil,(HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Nurse_responsible_Room"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__SRC__ro(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInRoom__Marker, HospitalExample.Room>(incUtil,(Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__SRC__ro_Room"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__TRG__sh(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker, AdministrationExample.Shift>(incUtil,(Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__TRG__sh_Shift"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getNurseToRoomRule__Marker_CONTEXT__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.NurseToRoomRule__Marker, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.NurseToRoomRule__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__TRG__p2_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__SRC__r(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInReception__Marker, HospitalExample.Reception>(incUtil,(Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__SRC__r_Reception"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Department(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Department>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "HospitalExample.Hospital_department_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_166_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Department>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getNewValue(), "HospitalExample.Hospital_department_Department"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getDepartment_Rooms(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_166_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("RoomRule__CONSISTENCY_173_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("RoomRule__FWD_177_localSearch").tell(new ReferenceAdded<HospitalExample.Department, HospitalExample.Room>(incUtil,(HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getNewValue(), "HospitalExample.Department_rooms_Room"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInRoom__Marker, Hospital2AdministrationSolutions.HospitalToAdministration>(incUtil,(Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__CORR__htov_HospitalToAdministration"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getHospitalToAdministration_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_27_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			...
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__FWD_129_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			...
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_147_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_166_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__d(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorToPatient__Marker, HospitalExample.Doctor>(incUtil,(Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__SRC__d_Doctor"), getSelf());
		});
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getStaff_ShiftPlan(), notification -> {
			...
			name2actor.get("DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_110_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_110_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__TRG__sp(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DocToStaffRule__Marker, AdministrationExample.Shiftplan>(incUtil,(Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getNewValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__TRG__sp_Shiftplan"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__CORR__stot(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DocToStaffRule__Marker, Hospital2AdministrationSolutions.StaffToStaff>(incUtil,(Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.StaffToStaff) notification.getNewValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__CORR__stot_StaffToStaff"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getNurseToRoomRule__Marker_CONTEXT__CORR__pTop(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.NurseToRoomRule__Marker, Hospital2AdministrationSolutions.PatientToPatient>(incUtil,(Hospital2AdministrationSolutions.NurseToRoomRule__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.PatientToPatient) notification.getNewValue(), "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__CORR__pTop_PatientToPatient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__TRG__p2_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Staff(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Staff>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "HospitalExample.Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_27_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Staff>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "HospitalExample.Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Staff>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "HospitalExample.Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__FWD_129_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Staff>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "HospitalExample.Hospital_staff_Staff"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientToPatient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			...
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getStaffToStaff_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__SRC__s1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker, HospitalExample.Doctor>(incUtil,(Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__SRC__s1_Doctor"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorToPatient__Marker, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__TRG__p2_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Reception(), notification -> {
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_67_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "HospitalExample.Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_67_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "HospitalExample.Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_71_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "HospitalExample.Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__FWD_77_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "HospitalExample.Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "HospitalExample.Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_147_localSearch").tell(new ReferenceAdded<HospitalExample.Hospital, HospitalExample.Reception>(incUtil,(HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getNewValue(), "HospitalExample.Hospital_reception_Reception"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorToPatient__Marker, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__SRC__p1_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInReception__Marker, HospitalExample.Hospital>(incUtil,(Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DocToStaffRule__Marker, HospitalExample.Hospital>(incUtil,(Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getStaffToStaff_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil,(Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__TRG__s(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DoctorToPatient__Marker, AdministrationExample.Staff>(incUtil,(Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Staff) notification.getNewValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__TRG__s_Staff"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInRoom__Marker, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CREATE__TRG__p2_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CONTEXT__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DocToStaffRule__Marker, Hospital2AdministrationSolutions.HospitalToAdministration>(incUtil,(Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNewValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CONTEXT__CORR__htov_HospitalToAdministration"), getSelf());
		});
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getPatient_Doctor(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceAdded<HospitalExample.Patient, HospitalExample.Doctor>(incUtil,(HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "HospitalExample.Patient_doctor_Doctor"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<HospitalExample.Patient, HospitalExample.Doctor>(incUtil,(HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "HospitalExample.Patient_doctor_Doctor"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceAdded<HospitalExample.Patient, HospitalExample.Doctor>(incUtil,(HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getNewValue(), "HospitalExample.Patient_doctor_Doctor"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInRoom__Marker, HospitalExample.Hospital>(incUtil,(Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getStaff_Treatment(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_43_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "AdministrationExample.Staff_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_43_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "AdministrationExample.Staff_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceAdded<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil,(AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getNewValue(), "AdministrationExample.Staff_treatment_Treatment"), getSelf());
		...
		feature2addEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getShiftplan_Shifts(), notification -> {
			...
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "AdministrationExample.Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_114_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "AdministrationExample.Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_114_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "AdministrationExample.Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceAdded<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil,(AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "AdministrationExample.Shiftplan_shifts_Shift"), getSelf());
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CREATE__CORR__pTop(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInReception__Marker, Hospital2AdministrationSolutions.PatientToPatient>(incUtil,(Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.PatientToPatient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CREATE__CORR__pTop_PatientToPatient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getHospitalToAdministration_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_27_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			...
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_147_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_166_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.HospitalToAdministration, AdministrationExample.Administration>(incUtil,(Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getNewValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CREATE__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInReception__Marker, AdministrationExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CREATE__TRG__p2_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getReception_Waits(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceAdded<HospitalExample.Reception, HospitalExample.Patient>(incUtil,(HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Reception_waits_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_147_localSearch").tell(new ReferenceAdded<HospitalExample.Reception, HospitalExample.Patient>(incUtil,(HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Reception_waits_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_153_localSearch").tell(new ReferenceAdded<HospitalExample.Reception, HospitalExample.Patient>(incUtil,(HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "HospitalExample.Reception_waits_Patient"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CREATE__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.PatientInReception__Marker, HospitalExample.Patient>(incUtil,(Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getNewValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CREATE__SRC__p1_Patient"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__TRG__sh(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.DocToStaffRule__Marker, AdministrationExample.Shift>(incUtil,(Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (AdministrationExample.Shift) notification.getNewValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__TRG__sh_Shift"), getSelf());
		});
		feature2addEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getNurseToRoomRule__Marker_CONTEXT__CORR__nToS(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceAdded<Hospital2AdministrationSolutions.NurseToRoomRule__Marker, Hospital2AdministrationSolutions.StaffToStaff>(incUtil,(Hospital2AdministrationSolutions.NurseToRoomRule__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.StaffToStaff) notification.getNewValue(), "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__CORR__nToS_StaffToStaff"), getSelf());
		});
	}
	...
	private void initializeRemoveEdge() {
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__CORR__pToP(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorToPatient__Marker, Hospital2AdministrationSolutions.PatientToPatient>(incUtil, (Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.PatientToPatient) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__CORR__pToP_PatientToPatient"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getRoom_Lies(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_135_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Room_lies_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_166_localSearch").tell(new ReferenceDeleted<HospitalExample.Room, HospitalExample.Patient>(incUtil, (HospitalExample.Room) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Room_lies_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getStaff_Works(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_27_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "HospitalExample.Staff_works_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__FWD_129_localSearch").tell(new ReferenceDeleted<HospitalExample.Staff, HospitalExample.Department>(incUtil, (HospitalExample.Staff) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "HospitalExample.Staff_works_Department"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInRoom__Marker, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CREATE__SRC__p1_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__CORR__pTop(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInRoom__Marker, Hospital2AdministrationSolutions.PatientToPatient>(incUtil, (Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.PatientToPatient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CREATE__CORR__pTop_PatientToPatient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__TRG__sp(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker, AdministrationExample.Shiftplan>(incUtil, (Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__TRG__sp_Shiftplan"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientToPatient_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			...
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_target_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CREATE__TRG__t(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorToPatient__Marker, AdministrationExample.Treatment>(incUtil, (Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CREATE__TRG__t_Treatment"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__ro(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorToPatient__Marker, HospitalExample.Room>(incUtil, (Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__SRC__ro_Room"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__SRC__p1_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__TRG__v(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInRoom__Marker, AdministrationExample.Administration>(incUtil, (Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__TRG__v_Administration"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__SRC__s1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DocToStaffRule__Marker, HospitalExample.Doctor>(incUtil, (Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__SRC__s1_Doctor"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInReception__Marker, Hospital2AdministrationSolutions.HospitalToAdministration>(incUtil, (Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__CORR__htov_HospitalToAdministration"), getSelf());
		});
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getAdministration_Patient(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<AdministrationExample.Administration, AdministrationExample.Patient>(incUtil, (AdministrationExample.Administration) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "AdministrationExample.Administration_patient_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getNurse_Responsible(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceDeleted<HospitalExample.Nurse, HospitalExample.Room>(incUtil, (HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Nurse_responsible_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<HospitalExample.Nurse, HospitalExample.Room>(incUtil, (HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Nurse_responsible_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceDeleted<HospitalExample.Nurse, HospitalExample.Room>(incUtil, (HospitalExample.Nurse) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Nurse_responsible_Room"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__SRC__ro(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInRoom__Marker, HospitalExample.Room>(incUtil, (Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__SRC__ro_Room"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__TRG__sh(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker, AdministrationExample.Shift>(incUtil, (Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__TRG__sh_Shift"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getNurseToRoomRule__Marker_CONTEXT__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.NurseToRoomRule__Marker, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.NurseToRoomRule__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__TRG__p2_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__SRC__r(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInReception__Marker, HospitalExample.Reception>(incUtil, (Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__SRC__r_Reception"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Department(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Department>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "HospitalExample.Hospital_department_Department"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_166_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Department>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "HospitalExample.Hospital_department_Department"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getDepartment_Rooms(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_166_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("RoomRule__CONSISTENCY_173_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Department_rooms_Room"), getSelf());
			incUtil.newMessage();
			name2actor.get("RoomRule__FWD_177_localSearch").tell(new ReferenceDeleted<HospitalExample.Department, HospitalExample.Room>(incUtil, (HospitalExample.Department) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "HospitalExample.Department_rooms_Room"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInRoom__Marker, Hospital2AdministrationSolutions.HospitalToAdministration>(incUtil, (Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__CORR__htov_HospitalToAdministration"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getHospitalToAdministration_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_27_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			...
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_147_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_166_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.HospitalToAdministration, HospitalExample.Hospital>(incUtil, (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__d(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorToPatient__Marker, HospitalExample.Doctor>(incUtil, (Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__SRC__d_Doctor"), getSelf());
		});
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getStaff_ShiftPlan(), notification -> {
			...
			name2actor.get("DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_110_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Shiftplan>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "AdministrationExample.Staff_shiftPlan_Shiftplan"), getSelf());
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__TRG__sp(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DocToStaffRule__Marker, AdministrationExample.Shiftplan>(incUtil, (Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (AdministrationExample.Shiftplan) notification.getOldValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__TRG__sp_Shiftplan"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CONTEXT__TRG__v(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DocToStaffRule__Marker, AdministrationExample.Administration>(incUtil, (Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CONTEXT__TRG__v_Administration"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__CORR__stot(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DocToStaffRule__Marker, Hospital2AdministrationSolutions.StaffToStaff>(incUtil, (Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.StaffToStaff) notification.getOldValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__CORR__stot_StaffToStaff"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getNurseToRoomRule__Marker_CONTEXT__CORR__pTop(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.NurseToRoomRule__Marker, Hospital2AdministrationSolutions.PatientToPatient>(incUtil, (Hospital2AdministrationSolutions.NurseToRoomRule__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.PatientToPatient) notification.getOldValue(), "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__CORR__pTop_PatientToPatient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getShiftplan_Covers(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Patient>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "AdministrationExample.Shiftplan_covers_Patient"), getSelf());
			incUtil.newMessage();
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__TRG__p2_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Staff(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Staff>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "HospitalExample.Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_27_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Staff>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "HospitalExample.Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Staff>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "HospitalExample.Hospital_staff_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__FWD_129_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Staff>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "HospitalExample.Hospital_staff_Staff"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientToPatient_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			...
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientToPatient, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientToPatient) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientToPatient_source_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getNurseToRoomRule__Marker_CONTEXT__TRG__s(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.NurseToRoomRule__Marker, AdministrationExample.Staff>(incUtil, (Hospital2AdministrationSolutions.NurseToRoomRule__Marker) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__TRG__s_Staff"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getStaffToStaff_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, HospitalExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (HospitalExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_source_Staff"), getSelf());
		});
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getPatient_Treatment(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<AdministrationExample.Patient, AdministrationExample.Treatment>(incUtil, (AdministrationExample.Patient) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "AdministrationExample.Patient_treatment_Treatment"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorShiftplanRule__Marker_CONTEXT__SRC__s1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker, HospitalExample.Doctor>(incUtil, (Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__SRC__s1_Doctor"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorToPatient__Marker, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__TRG__p2_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getHospital_Reception(), notification -> {
			...
			name2actor.get("HospitaltoAdministrationRule__CONSISTENCY_71_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Reception>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "HospitalExample.Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("HospitaltoAdministrationRule__FWD_77_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Reception>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "HospitalExample.Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Reception>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "HospitalExample.Hospital_reception_Reception"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_147_localSearch").tell(new ReferenceDeleted<HospitalExample.Hospital, HospitalExample.Reception>(incUtil, (HospitalExample.Hospital) notification.getNotifier(), (HospitalExample.Reception) notification.getOldValue(), "HospitalExample.Hospital_reception_Reception"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorToPatient__Marker, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__SRC__p1_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInReception__Marker, HospitalExample.Hospital>(incUtil, (Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DocToStaffRule__Marker, HospitalExample.Hospital>(incUtil, (Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getNurseToRoomRule__Marker_CONTEXT__SRC__r(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.NurseToRoomRule__Marker, HospitalExample.Room>(incUtil, (Hospital2AdministrationSolutions.NurseToRoomRule__Marker) notification.getNotifier(), (HospitalExample.Room) notification.getOldValue(), "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__SRC__r_Room"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__SRC__dep(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorToPatient__Marker, HospitalExample.Department>(incUtil, (Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (HospitalExample.Department) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__SRC__dep_Department"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getStaffToStaff_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__FWD_101_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule__CONSISTENCY_118_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.StaffToStaff, AdministrationExample.Staff>(incUtil, (Hospital2AdministrationSolutions.StaffToStaff) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.StaffToStaff_target_Staff"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDoctorToPatient__Marker_CONTEXT__TRG__s(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DoctorToPatient__Marker, AdministrationExample.Staff>(incUtil, (Hospital2AdministrationSolutions.DoctorToPatient__Marker) notification.getNotifier(), (AdministrationExample.Staff) notification.getOldValue(), "Hospital2AdministrationSolutions.DoctorToPatient__Marker_CONTEXT__TRG__s_Staff"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CREATE__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInRoom__Marker, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CREATE__TRG__p2_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CONTEXT__CORR__htov(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DocToStaffRule__Marker, Hospital2AdministrationSolutions.HospitalToAdministration>(incUtil, (Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getOldValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CONTEXT__CORR__htov_HospitalToAdministration"), getSelf());
		});
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getPatient_Doctor(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<HospitalExample.Patient, HospitalExample.Doctor>(incUtil, (HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "HospitalExample.Patient_doctor_Doctor"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<HospitalExample.Patient, HospitalExample.Doctor>(incUtil, (HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "HospitalExample.Patient_doctor_Doctor"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__FWD_58_localSearch").tell(new ReferenceDeleted<HospitalExample.Patient, HospitalExample.Doctor>(incUtil, (HospitalExample.Patient) notification.getNotifier(), (HospitalExample.Doctor) notification.getOldValue(), "HospitalExample.Patient_doctor_Doctor"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInRoom__Marker_CONTEXT__SRC__h(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInRoom__Marker, HospitalExample.Hospital>(incUtil, (Hospital2AdministrationSolutions.PatientInRoom__Marker) notification.getNotifier(), (HospitalExample.Hospital) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInRoom__Marker_CONTEXT__SRC__h_Hospital"), getSelf());
		});
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getStaff_Treatment(), notification -> {
			incUtil.newMessage();
			name2actor.get("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_43_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "AdministrationExample.Staff_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_43_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "AdministrationExample.Staff_treatment_Treatment"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorToPatient__CONSISTENCY_47_localSearch").tell(new ReferenceDeleted<AdministrationExample.Staff, AdministrationExample.Treatment>(incUtil, (AdministrationExample.Staff) notification.getNotifier(), (AdministrationExample.Treatment) notification.getOldValue(), "AdministrationExample.Staff_treatment_Treatment"), getSelf());
		});
		feature2removeEdgeConsumer.put(AdministrationExample.AdministrationExamplePackage.eINSTANCE.getShiftplan_Shifts(), notification -> {
			...
			name2actor.get("DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_12_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "AdministrationExample.Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "AdministrationExample.Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("DoctorShiftplanRule__CONSISTENCY_33_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "AdministrationExample.Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "AdministrationExample.Shiftplan_shifts_Shift"), getSelf());
			incUtil.newMessage();
			name2actor.get("NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_114_localSearch").tell(new ReferenceDeleted<AdministrationExample.Shiftplan, AdministrationExample.Shift>(incUtil, (AdministrationExample.Shiftplan) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "AdministrationExample.Shiftplan_shifts_Shift"), getSelf());
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CREATE__CORR__pTop(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInReception__Marker, Hospital2AdministrationSolutions.PatientToPatient>(incUtil, (Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.PatientToPatient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CREATE__CORR__pTop_PatientToPatient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getHospitalToAdministration_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__FWD_27_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			...
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_147_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__CONSISTENCY_156_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom__FWD_166_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.HospitalToAdministration, AdministrationExample.Administration>(incUtil, (Hospital2AdministrationSolutions.HospitalToAdministration) notification.getNotifier(), (AdministrationExample.Administration) notification.getOldValue(), "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CREATE__TRG__p2(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInReception__Marker, AdministrationExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (AdministrationExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CREATE__TRG__p2_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(HospitalExample.HospitalExamplePackage.eINSTANCE.getReception_Waits(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceDeleted<HospitalExample.Reception, HospitalExample.Patient>(incUtil, (HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Reception_waits_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInReception__FWD_147_localSearch").tell(new ReferenceDeleted<HospitalExample.Reception, HospitalExample.Patient>(incUtil, (HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Reception_waits_Patient"), getSelf());
			incUtil.newMessage();
			name2actor.get("PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_153_localSearch").tell(new ReferenceDeleted<HospitalExample.Reception, HospitalExample.Patient>(incUtil, (HospitalExample.Reception) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "HospitalExample.Reception_waits_Patient"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getPatientInReception__Marker_CREATE__SRC__p1(), notification -> {
			incUtil.newMessage();
			name2actor.get("PatientInReception__CONSISTENCY_138_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.PatientInReception__Marker, HospitalExample.Patient>(incUtil, (Hospital2AdministrationSolutions.PatientInReception__Marker) notification.getNotifier(), (HospitalExample.Patient) notification.getOldValue(), "Hospital2AdministrationSolutions.PatientInReception__Marker_CREATE__SRC__p1_Patient"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getDocToStaffRule__Marker_CREATE__TRG__sh(), notification -> {
			incUtil.newMessage();
			name2actor.get("DocToStaffRule__CONSISTENCY_16_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.DocToStaffRule__Marker, AdministrationExample.Shift>(incUtil, (Hospital2AdministrationSolutions.DocToStaffRule__Marker) notification.getNotifier(), (AdministrationExample.Shift) notification.getOldValue(), "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__TRG__sh_Shift"), getSelf());
		});
		feature2removeEdgeConsumer.put(Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage.eINSTANCE.getNurseToRoomRule__Marker_CONTEXT__CORR__nToS(), notification -> {
			incUtil.newMessage();
			name2actor.get("NurseToRoomRule__CONSISTENCY_91_localSearch").tell(new ReferenceDeleted<Hospital2AdministrationSolutions.NurseToRoomRule__Marker, Hospital2AdministrationSolutions.StaffToStaff>(incUtil, (Hospital2AdministrationSolutions.NurseToRoomRule__Marker) notification.getNotifier(), (Hospital2AdministrationSolutions.StaffToStaff) notification.getOldValue(), "Hospital2AdministrationSolutions.NurseToRoomRule__Marker_CONTEXT__CORR__nToS_StaffToStaff"), getSelf());
		});
	}
