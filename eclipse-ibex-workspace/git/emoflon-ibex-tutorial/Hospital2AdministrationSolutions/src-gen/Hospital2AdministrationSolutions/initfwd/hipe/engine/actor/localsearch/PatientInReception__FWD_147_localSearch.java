...
public class PatientInReception__FWD_147_localSearch extends GenericLocalSearchActor{
			...
			case "Hospital_object_SP2": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__FWD_147_localSearch", 5);
			...
			case "HospitalToAdministration_object_SP0": 
				{
					...
					// htov
					HMatch match_1 = new LocalSearchMatch("PatientInReception__FWD_147_localSearch", 5);
			...
			case "Reception_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_2 = new LocalSearchMatch("PatientInReception__FWD_147_localSearch", 5);
			...
			case "Administration_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_3 = new LocalSearchMatch("PatientInReception__FWD_147_localSearch", 5);
			...
			case "Patient_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_4 = new LocalSearchMatch("PatientInReception__FWD_147_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_135_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInReception__FWD_147_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Hospital_reception_Reception": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("PatientInReception__FWD_147_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
