...
public class NurseToRoomRule__FWD_101_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 5, 4, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Nurse ? result : null);};
			...
			case "Department_object_SP3": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__FWD_101_localSearch", 8);
			...
			case "Nurse_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// n
						HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__FWD_101_localSearch", 8);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// nToS
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__FWD_101_localSearch", 8);
			...
			case "Patient_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__FWD_101_localSearch", 8);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__FWD_101_localSearch", 8);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pTop
					HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__FWD_101_localSearch", 8);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__FWD_101_localSearch", 8);
			...
			case "Staff_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__FWD_101_localSearch", 8);
		...
		case "Hospital2AdministrationSolutions.PatientToPatient_target_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Patient) {
				{
					...
					HMatch match = new LocalSearchMatch("NurseToRoomRule__FWD_101_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
