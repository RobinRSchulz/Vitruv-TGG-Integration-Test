package Hospital2AdministrationSolutions.initfwd.hipe.engine.actor.localsearch;
...
public class NurseToStaffRule__CONSISTENCY_118_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToStaffRule__Marker) o).getCREATE__TRG__s2(); return (result instanceof AdministrationExample.Staff ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 9, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToStaffRule__Marker) o).getCREATE__TRG__sh(); return (result instanceof AdministrationExample.Shift ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 9, 4, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Nurse ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitalToAdministration) o).getSource(); return (result instanceof HospitalExample.Hospital ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 7, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToStaffRule__Marker) o).getCONTEXT__SRC__d(); return (result instanceof HospitalExample.Department ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.NurseToStaffRule__Marker) o).getCONTEXT__CORR__htov();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToStaffRule__Marker) o).getCONTEXT__TRG__v(); return (result instanceof AdministrationExample.Administration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new EdgeExplorer(this, 6, 3, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToStaffRule__Marker) o).getCREATE__SRC__s1(); return (result instanceof HospitalExample.Nurse ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitalToAdministration) o).getTarget(); return (result instanceof AdministrationExample.Administration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getTarget(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.multi_lookup = (o) -> ((HospitalExample.Hospital) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
						edge_explorer_14_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Hospital) return edge_explorer_14_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((AdministrationExample.Staff) o).getShiftPlan();
						edge_explorer_15_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Staff) return o.equals(edge_explorer_15_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_15 = new EdgeExplorer(this, 3, 5, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.NurseToStaffRule__Marker) o).getCREATE__CORR__stot();
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToStaffRule__Marker) o).getCREATE__TRG__sp(); return (result instanceof AdministrationExample.Shiftplan ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((HospitalExample.Staff) o).getWorks();
						edge_explorer_18_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
						edge_explorer_18 = new EdgeExplorer(this, 2, 0, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToStaffRule__Marker) o).getCONTEXT__SRC__h(); return (result instanceof HospitalExample.Hospital ? result : null);};
			...
			case "Department_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
			...
			case "Hospital_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
			...
			case "Nurse_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_2 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
			...
			case "Staff_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_3 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
			...
			case "Shift_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_4 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
			...
			case "Shiftplan_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_5 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
			...
			case "Administration_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_6 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
			...
			case "HospitalToAdministration_object_SP0": 
				{
					...
					// htov
					HMatch match_7 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// stot
					HMatch match_8 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
			...
			case "NurseToStaffRule__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_110_localSearch": 
				{
				...
				break;
			case "NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_114_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_110_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_114_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Hospital2AdministrationSolutions.NurseToStaffRule__Marker_CREATE__TRG__s2_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[9] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToStaffRule__Marker_CREATE__TRG__sh_Shift": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Shift) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.StaffToStaff_source_Staff": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToStaffRule__Marker_CONTEXT__SRC__d_Department": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToStaffRule__Marker_CONTEXT__CORR__htov_HospitalToAdministration": 
			if(!lazy_initialization) {
				{
		...
		case "AdministrationExample.Shiftplan_shifts_Shift": 
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToStaffRule__Marker_CONTEXT__TRG__v_Administration": 
			if(!lazy_initialization) {
			...
			break;
		case "AdministrationExample.Administration_staff_Staff": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
					Object[] objs = match.getNodes();
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToStaffRule__Marker_CREATE__SRC__s1_Nurse": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Nurse) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Administration) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.StaffToStaff_target_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
			...
			break;
		case "HospitalExample.Hospital_staff_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Nurse) {
				{
					HMatch match = new LocalSearchMatch("NurseToStaffRule__CONSISTENCY_118_localSearch", 10);
		...
		case "AdministrationExample.Staff_shiftPlan_Shiftplan": 
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToStaffRule__Marker_CREATE__CORR__stot_StaffToStaff": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToStaffRule__Marker_CREATE__TRG__sp_Shiftplan": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Shiftplan) {
				{
		...
		case "HospitalExample.Staff_works_Department": 
			...
			break;
		case "Hospital2AdministrationSolutions.NurseToStaffRule__Marker_CONTEXT__SRC__h_Hospital": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Hospital) {
				{
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingStaffID csp_10 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingStaffID();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nametoname csp_11 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nametoname();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nursesalary csp_12 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nursesalary();
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, s2.getSalary(), "double"));
		csp_12.solve();
