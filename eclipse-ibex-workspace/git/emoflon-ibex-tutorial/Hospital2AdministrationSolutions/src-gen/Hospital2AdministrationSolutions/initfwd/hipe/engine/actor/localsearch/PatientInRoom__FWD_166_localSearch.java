...
public class PatientInRoom__FWD_166_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object_SP3": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__FWD_166_localSearch", 6);
			...
			case "Hospital_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("PatientInRoom__FWD_166_localSearch", 6);
			...
			case "HospitalToAdministration_object_SP2": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__FWD_166_localSearch", 6);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("PatientInRoom__FWD_166_localSearch", 6);
			...
			case "Administration_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_4 = new LocalSearchMatch("PatientInRoom__FWD_166_localSearch", 6);
			...
			case "Patient_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_5 = new LocalSearchMatch("PatientInRoom__FWD_166_localSearch", 6);
		...
		switch(match.creator) {
			...
			case "PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_153_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInRoom__FWD_166_localSearch", 6);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Room_lies_Patient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("PatientInRoom__FWD_166_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
