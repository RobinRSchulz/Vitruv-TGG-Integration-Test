...
public class DoctorToPatient__CONSISTENCY_47_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorToPatient__Marker) o).getCONTEXT__SRC__d(); return (result instanceof HospitalExample.Doctor ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorToPatient__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorToPatient__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.DoctorToPatient__Marker) o).getCONTEXT__CORR__dToS();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorToPatient__Marker) o).getCONTEXT__SRC__ro(); return (result instanceof HospitalExample.Room ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorToPatient__Marker) o).getCREATE__TRG__t(); return (result instanceof AdministrationExample.Treatment ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((AdministrationExample.Patient) o).getTreatment();
						edge_explorer_15_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Patient) return o.equals(edge_explorer_15_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_15 = new EdgeExplorer(this, 4, 6, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorToPatient__Marker) o).getCONTEXT__TRG__s(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.DoctorToPatient__Marker) o).getCONTEXT__CORR__pToP();
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.multi_lookup = (o) -> ((AdministrationExample.Staff) o).getTreatment();
						edge_explorer_18 = new CachedEdgeExplorer(this, 5, 6, edge_explorer_18_methods);
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						...
						edge_explorer_19 = new CachedEdgeExplorer(this, 7, 5, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.multi_lookup = (o) -> ((HospitalExample.Room) o).getLies();
						edge_explorer_20_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Room) return edge_explorer_20_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_20 = new EdgeExplorer(this, 3, 2, edge_explorer_20_methods);
			...
			case "Doctor_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
			...
			case "Department_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// dep
						HMatch match_1 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
			...
			case "Patient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_2 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
			...
			case "Staff_object_SP0": 
				{
					...
					// s
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
			...
			case "Treatment_object": 
				{
					if(!lazy_initialization) {
						...
						// t
						HMatch match_6 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// dToS
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_8 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
			...
			case "DoctorToPatient__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_3_1_orchestration, match_9);
				}
				break;
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_43_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_43_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Patient_doctor_Doctor": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_47_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_carelevelToMedication csp_8 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_carelevelToMedication();
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getLevel(), "Enum::Carelevel"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, t.getMedication(), "Enum::Medication"));
		csp_8.solve();
