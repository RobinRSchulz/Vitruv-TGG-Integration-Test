...
public class DoctorShiftplanRule__CONSISTENCY_33_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 8, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__CORR__pToP();
						edge_explorer_3 = new CachedEdgeExplorer(this, 8, 6, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getTarget(); return (result instanceof AdministrationExample.Staff ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 7, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sh(); return (result instanceof AdministrationExample.Shift ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__s1(); return (result instanceof HospitalExample.Doctor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						...
						edge_explorer_15 = new EdgeExplorer(this, 5, 4, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__s2(); return (result instanceof AdministrationExample.Staff ? result : null);};
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_33_localSearch", 9);
			...
			case "Doctor_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_33_localSearch", 9);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_33_localSearch", 9);
			...
			case "Staff_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_33_localSearch", 9);
			...
			case "Shift_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_33_localSearch", 9);
			...
			case "Shiftplan_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_33_localSearch", 9);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_33_localSearch", 9);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_33_localSearch", 9);
			...
			case "DoctorShiftplanRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_33_localSearch", 9);
		...
		case "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__SRC__p1_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Patient) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_33_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
