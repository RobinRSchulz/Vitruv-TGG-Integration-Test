...
public class NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_129_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToStaffRule__BWD_151_nacjunction"), this::returnTrue , 0  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("NurseToStaffRule__CONSISTENCY_156_localSearch"), this::returnTrue  , false ));
			...
			case "Staff_object_SP2": 
				{
					...
					// s2
					HMatch match_0 = new LocalSearchMatch("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_129_localSearch", 3);
			...
			case "Shiftplan_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_1 = new LocalSearchMatch("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_129_localSearch", 3);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
						
						// FILTER_NAC_NODE
						HMatch match_2 = new LocalSearchMatch("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_129_localSearch", 3);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "AdministrationExample.Staff_shiftPlan_Shiftplan": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_129_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
