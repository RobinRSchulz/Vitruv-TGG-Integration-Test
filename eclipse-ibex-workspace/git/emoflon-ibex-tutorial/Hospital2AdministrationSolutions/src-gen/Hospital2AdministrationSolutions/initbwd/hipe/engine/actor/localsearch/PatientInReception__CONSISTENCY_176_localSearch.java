...
public class PatientInReception__CONSISTENCY_176_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitalToAdministration) o).getTarget(); return (result instanceof AdministrationExample.Administration ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 5, 4, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCONTEXT__SRC__r(); return (result instanceof HospitalExample.Reception ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 7, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCREATE__CORR__pTop();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCONTEXT__TRG__v(); return (result instanceof AdministrationExample.Administration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCONTEXT__CORR__htov();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCREATE__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCREATE__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((AdministrationExample.Administration) o).getPatient();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.multi_lookup = (o) -> ((HospitalExample.Reception) o).getWaits();
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Reception) return edge_explorer_13_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientInReception__Marker) o).getCONTEXT__SRC__h(); return (result instanceof HospitalExample.Hospital ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitalToAdministration) o).getSource(); return (result instanceof HospitalExample.Hospital ? result : null);};
			...
			case "Hospital_object_SP1": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
			...
			case "Patient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_1 = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
			...
			case "Reception_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_2 = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
			...
			case "Patient_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_3 = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
			...
			case "Administration_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_4 = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
			...
			case "HospitalToAdministration_object_SP0": 
				{
					...
					// htov
					HMatch match_5 = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pTop
					HMatch match_6 = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
			...
			case "PatientInReception__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_3_1_orchestration, match_7);
				}
				break;
			case "PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_173_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_173_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Hospital2AdministrationSolutions.HospitalToAdministration_target_Administration": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Administration) {
				{
					...
					HMatch match = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__SRC__r_Reception": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Reception) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInReception__Marker_CREATE__CORR__pTop_PatientToPatient": 
			if(!lazy_initialization) {
				{
		...
		case "Hospital2AdministrationSolutions.PatientToPatient_target_Patient": 
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__TRG__v_Administration": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Administration) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__CORR__htov_HospitalToAdministration": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "HospitalExample.Hospital_reception_Reception": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
					Object[] objs = match.getNodes();
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInReception__Marker_CREATE__SRC__p1_Patient": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInReception__Marker_CREATE__TRG__p2_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Patient) {
				{
		...
		case "AdministrationExample.Administration_patient_Patient": 
			...
			break;
		case "HospitalExample.Reception_waits_Patient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("PatientInReception__CONSISTENCY_176_localSearch", 8);
					Object[] objs = match.getNodes();
			...
			break;
		case "Hospital2AdministrationSolutions.PatientInReception__Marker_CONTEXT__SRC__h_Hospital": 
			if(!lazy_initialization) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingPatientID csp_16 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingPatientID();
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getPatientID(), "int"));
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getPatientID(), "int"));
		csp_16.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nametoname csp_17 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nametoname();
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, " ", "java.lang.String"));
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getFirstName(), "java.lang.String"));
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getLastName(), "java.lang.String"));
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getName(), "java.lang.String"));
		csp_17.solve();
