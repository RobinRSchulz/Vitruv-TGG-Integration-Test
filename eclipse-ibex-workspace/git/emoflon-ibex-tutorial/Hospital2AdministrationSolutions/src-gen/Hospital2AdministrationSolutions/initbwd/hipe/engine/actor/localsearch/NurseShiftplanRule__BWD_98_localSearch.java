...
public class NurseShiftplanRule__BWD_98_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Nurse ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__BWD_98_localSearch", 9);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__BWD_98_localSearch", 9);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__BWD_98_localSearch", 9);
			...
			case "Room_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__BWD_98_localSearch", 9);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__BWD_98_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__BWD_98_localSearch", 9);
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// sToS
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__BWD_98_localSearch", 9);
			...
			case "Shift_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__BWD_98_localSearch", 9);
			...
			case "Shiftplan_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__BWD_98_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Room_lies_Patient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("NurseShiftplanRule__BWD_98_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
