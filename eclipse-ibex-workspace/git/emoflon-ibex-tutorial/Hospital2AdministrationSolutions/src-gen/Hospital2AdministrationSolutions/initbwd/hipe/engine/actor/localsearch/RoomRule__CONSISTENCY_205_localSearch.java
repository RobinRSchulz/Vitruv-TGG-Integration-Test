...
public class RoomRule__CONSISTENCY_205_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.RoomRule__Marker) o).getCREATE__SRC__ro(); return (result instanceof HospitalExample.Room ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 2, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.RoomRule__Marker) o).getCONTEXT__SRC__d(); return (result instanceof HospitalExample.Department ? result : null);};
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("RoomRule__CONSISTENCY_205_localSearch", 3);
			...
			case "Room_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_1 = new LocalSearchMatch("RoomRule__CONSISTENCY_205_localSearch", 3);
			...
			case "RoomRule__Marker_object": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("RoomRule__CONSISTENCY_205_localSearch", 3);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Department_rooms_Room": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("RoomRule__CONSISTENCY_205_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
