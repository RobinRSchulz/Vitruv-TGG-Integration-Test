...
public class PatientInReception__BWD_167_localSearch extends GenericLocalSearchActor{
			...
			case "Hospital_object_SP0": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("PatientInReception__BWD_167_localSearch", 5);
			...
			case "HospitalToAdministration_object_SP2": 
				{
					...
					// htov
					HMatch match_1 = new LocalSearchMatch("PatientInReception__BWD_167_localSearch", 5);
			...
			case "Reception_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_2 = new LocalSearchMatch("PatientInReception__BWD_167_localSearch", 5);
			...
			case "Administration_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_3 = new LocalSearchMatch("PatientInReception__BWD_167_localSearch", 5);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("PatientInReception__BWD_167_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Hospital_reception_Reception": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("PatientInReception__BWD_167_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
