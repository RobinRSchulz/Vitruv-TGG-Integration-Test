...
public class DoctorShiftplanRule__CONSISTENCY_52_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 7, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sp(); return (result instanceof AdministrationExample.Shiftplan ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__CORR__sToS();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sh(); return (result instanceof AdministrationExample.Shift ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new EdgeExplorer(this, 5, 2, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getTarget(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__s2(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((HospitalExample.Patient) o).getDoctor();
						edge_explorer_14_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Doctor) o).getCaresfor();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__CORR__pToP();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__s1(); return (result instanceof HospitalExample.Doctor ? result : null);};
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_52_localSearch", 9);
			...
			case "Doctor_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_52_localSearch", 9);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_52_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_52_localSearch", 9);
			...
			case "Shift_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_52_localSearch", 9);
			...
			case "Shiftplan_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_52_localSearch", 9);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_52_localSearch", 9);
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// sToS
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_52_localSearch", 9);
			...
			case "DoctorShiftplanRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_52_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "AdministrationExample.Staff_shiftPlan_Shiftplan": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_52_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
		...
		case "Hospital2AdministrationSolutions.StaffToStaff_source_Staff": 
			...
			break;
		case "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__SRC__p1_Patient": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__TRG__p2_Patient": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__TRG__sp_Shiftplan": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__CORR__sToS_StaffToStaff": 
			if(!lazy_initialization) {
				{
		...
		case "AdministrationExample.Shiftplan_shifts_Shift": 
			...
			break;
		case "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__TRG__sh_Shift": 
			if(!lazy_initialization) {
		...
		case "Hospital2AdministrationSolutions.StaffToStaff_target_Staff": 
			...
			break;
		case "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__TRG__s2_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
		...
		case "HospitalExample.Patient_doctor_Doctor": 
			...
			break;
		case "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__CORR__pToP_PatientToPatient": 
			if(!lazy_initialization) {
				{
		...
		case "Hospital2AdministrationSolutions.PatientToPatient_source_Patient": 
			...
			break;
		case "Hospital2AdministrationSolutions.DoctorShiftplanRule__Marker_CONTEXT__SRC__s1_Doctor": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Doctor) {
				{
