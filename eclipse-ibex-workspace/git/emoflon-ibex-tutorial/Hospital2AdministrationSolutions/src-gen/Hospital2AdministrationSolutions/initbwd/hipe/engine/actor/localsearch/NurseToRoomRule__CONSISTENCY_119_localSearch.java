...
public class NurseToRoomRule__CONSISTENCY_119_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Nurse ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 6, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__dep(); return (result instanceof HospitalExample.Department ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__CORR__nToS();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__r(); return (result instanceof HospitalExample.Room ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__TRG__s(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__n(); return (result instanceof HospitalExample.Nurse ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__CORR__pTop();
			...
			case "Department_object_SP2": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_119_localSearch", 9);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// n
						HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_119_localSearch", 9);
			...
			case "Patient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_119_localSearch", 9);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_119_localSearch", 9);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_119_localSearch", 9);
			...
			case "Staff_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_119_localSearch", 9);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// nToS
					HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_119_localSearch", 9);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pTop
					HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_119_localSearch", 9);
			...
			case "NurseToRoomRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_119_localSearch", 9);
		...
		case "Hospital2AdministrationSolutions.StaffToStaff_source_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Nurse) {
				{
					...
					HMatch match = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_119_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
