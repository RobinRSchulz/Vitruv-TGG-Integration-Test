...
public class DocToStaffRule__CONSISTENCY_32_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DocToStaffRule__Marker) o).getCREATE__SRC__s1(); return (result instanceof HospitalExample.Doctor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DocToStaffRule__Marker) o).getCREATE__TRG__s2(); return (result instanceof AdministrationExample.Staff ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DocToStaffRule__Marker) o).getCREATE__TRG__sp(); return (result instanceof AdministrationExample.Shiftplan ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 5, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.DocToStaffRule__Marker) o).getCONTEXT__CORR__htov();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitalToAdministration) o).getSource(); return (result instanceof HospitalExample.Hospital ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getTarget(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DocToStaffRule__Marker) o).getCONTEXT__SRC__h(); return (result instanceof HospitalExample.Hospital ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DocToStaffRule__Marker) o).getCREATE__TRG__sh(); return (result instanceof AdministrationExample.Shift ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DocToStaffRule__Marker) o).getCONTEXT__TRG__v(); return (result instanceof AdministrationExample.Administration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitalToAdministration) o).getTarget(); return (result instanceof AdministrationExample.Administration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.DocToStaffRule__Marker) o).getCREATE__CORR__stot();
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.DocToStaffRule__Marker) o).getCONTEXT__SRC__d(); return (result instanceof HospitalExample.Department ? result : null);};
			...
			case "Department_object_SP2": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
			...
			case "Hospital_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
			...
			case "Doctor_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_2 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
			...
			case "Staff_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_3 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
			...
			case "Shift_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_4 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
			...
			case "Shiftplan_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_5 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
			...
			case "Administration_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_6 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
			...
			case "HospitalToAdministration_object_SP2": 
				{
					...
					// htov
					HMatch match_7 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// stot
					HMatch match_8 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
			...
			case "DocToStaffRule__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_5_localSearch": 
				{
				...
				break;
			case "DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_9_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_5_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_9_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__SRC__s1_Doctor": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Doctor) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("DocToStaffRule__CONSISTENCY_32_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[9] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
		...
		case "HospitalExample.Hospital_staff_Staff": 
			...
			break;
		case "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__TRG__s2_Staff": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__TRG__sp_Shiftplan": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CONTEXT__CORR__htov_HospitalToAdministration": 
			if(!lazy_initialization) {
				{
		...
		case "HospitalExample.Staff_works_Department": 
			...
			break;
		case "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CONTEXT__SRC__h_Hospital": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Hospital) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__TRG__sh_Shift": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CONTEXT__TRG__v_Administration": 
			if(!lazy_initialization) {
		...
		case "AdministrationExample.Shiftplan_shifts_Shift": 
			...
			break;
		case "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CREATE__CORR__stot_StaffToStaff": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Hospital2AdministrationSolutions.DocToStaffRule__Marker_CONTEXT__SRC__d_Department": 
			if(!lazy_initialization) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_doctorsalary csp_4 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_doctorsalary();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingStaffID csp_6 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingStaffID();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nametoname csp_7 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nametoname();
