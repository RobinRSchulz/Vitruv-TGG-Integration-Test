...
public class PatientInRoom__BWD_185_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object_SP2": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__BWD_185_localSearch", 6);
			...
			case "Hospital_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("PatientInRoom__BWD_185_localSearch", 6);
			...
			case "HospitalToAdministration_object_SP1": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__BWD_185_localSearch", 6);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("PatientInRoom__BWD_185_localSearch", 6);
			...
			case "Administration_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_4 = new LocalSearchMatch("PatientInRoom__BWD_185_localSearch", 6);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_5 = new LocalSearchMatch("PatientInRoom__BWD_185_localSearch", 6);
		...
		case "Hospital2AdministrationSolutions.HospitalToAdministration_source_Hospital": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Hospital) {
				{
					...
					HMatch match = new LocalSearchMatch("PatientInRoom__BWD_185_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
