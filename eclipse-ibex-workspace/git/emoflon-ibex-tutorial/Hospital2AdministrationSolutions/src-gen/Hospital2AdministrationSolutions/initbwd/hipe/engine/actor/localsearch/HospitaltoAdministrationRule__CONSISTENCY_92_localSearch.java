...
public class HospitaltoAdministrationRule__CONSISTENCY_92_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker) o).getCREATE__TRG__v(); return (result instanceof AdministrationExample.Administration ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 4, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker) o).getCREATE__SRC__h(); return (result instanceof HospitalExample.Hospital ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker) o).getCREATE__SRC__r(); return (result instanceof HospitalExample.Reception ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitalToAdministration) o).getSource(); return (result instanceof HospitalExample.Hospital ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker) o).getCREATE__CORR__htov();
			...
			case "Hospital_object_SP0": 
				{
					...
					// h
					HMatch match_0 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_92_localSearch", 5);
			...
			case "Reception_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_1 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_92_localSearch", 5);
			...
			case "Administration_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_2 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_92_localSearch", 5);
			...
			case "HospitalToAdministration_object_SP0": 
				{
					...
					// htov
					HMatch match_3 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_92_localSearch", 5);
			...
			case "HospitaltoAdministrationRule__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_92_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_88_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_88_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_92_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker_CREATE__TRG__v_Administration": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Administration) {
				{
					...
					HMatch match = new LocalSearchMatch("HospitaltoAdministrationRule__CONSISTENCY_92_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
