...
public class NurseToRoomRule__CONSISTENCY_169_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 8, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__CORR__nToS();
						edge_explorer_3 = new CachedEdgeExplorer(this, 8, 6, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 4, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__TRG__s(); return (result instanceof AdministrationExample.Staff ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 5, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__CORR__pTop();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__n(); return (result instanceof HospitalExample.Nurse ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__dep(); return (result instanceof HospitalExample.Department ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.NurseToRoomRule__Marker) o).getCONTEXT__SRC__r(); return (result instanceof HospitalExample.Room ? result : null);};
