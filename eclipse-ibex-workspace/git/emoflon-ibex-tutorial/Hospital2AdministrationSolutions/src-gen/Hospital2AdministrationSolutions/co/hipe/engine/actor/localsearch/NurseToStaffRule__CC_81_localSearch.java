...
public class NurseToStaffRule__CC_81_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitalToAdministration) o).getTarget(); return (result instanceof AdministrationExample.Administration ? result : null);};
			...
			case "Department_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
			...
			case "Hospital_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
			...
			case "Administration_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_3 = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_4 = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
			...
			case "Staff_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_5 = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
			...
			case "Shift_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_6 = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
			...
			case "Shiftplan_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_7 = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
						match_7.getNodes()[7] = objs[0];
						start(edge_explorer_2_orchestration, match_7);
					}
				}
				break;
			case "NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_73_localSearch": 
				{
				...
				break;
			case "NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_77_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_73_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_77_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "AdministrationExample.Staff_shiftPlan_Shiftplan": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("NurseToStaffRule__CC_81_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[7] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nursesalary csp_10 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nursesalary();
