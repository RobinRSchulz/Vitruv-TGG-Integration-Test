...
public class NurseShiftplanRule__CC_54_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 5, 8, edge_explorer_6_methods);
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__CC_54_localSearch", 9);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__CC_54_localSearch", 9);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__CC_54_localSearch", 9);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__CC_54_localSearch", 9);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__CC_54_localSearch", 9);
			...
			case "Staff_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__CC_54_localSearch", 9);
			...
			case "StaffToStaff_object": 
				{
					...
					// sToS
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__CC_54_localSearch", 9);
			...
			case "Shift_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__CC_54_localSearch", 9);
			...
			case "Shiftplan_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__CC_54_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "AdministrationExample.Shiftplan_covers_Patient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("NurseShiftplanRule__CC_54_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
