...
public class DoctorShiftplanRule__CC_21_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CC_21_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CC_21_localSearch", 8);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CC_21_localSearch", 8);
			...
			case "Doctor_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CC_21_localSearch", 8);
			...
			case "Staff_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CC_21_localSearch", 8);
			...
			case "StaffToStaff_object": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CC_21_localSearch", 8);
			...
			case "Shift_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CC_21_localSearch", 8);
			...
			case "Shiftplan_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CC_21_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "AdministrationExample.Staff_shiftPlan_Shiftplan": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CC_21_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[7] = msg.target;
					currentDepth++;
