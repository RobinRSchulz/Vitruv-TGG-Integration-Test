...
public class DocToStaffRule__CC_12_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
			...
			case "Hospital_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
			...
			case "Administration_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_3 = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
			...
			case "Doctor_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_4 = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
			...
			case "Staff_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_5 = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
			...
			case "Shift_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_6 = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
			...
			case "Shiftplan_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_7 = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
						match_7.getNodes()[7] = objs[0];
						start(edge_explorer_5_1_orchestration, match_7);
					}
				}
				break;
			case "DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_4_localSearch": 
				{
				...
				break;
			case "DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_8_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_4_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_8_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Staff_works_Department": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("DocToStaffRule__CC_12_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingStaffID csp_4 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_incrementingStaffID();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nametoname csp_5 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administrationsolutions.UserDefined_nametoname();
