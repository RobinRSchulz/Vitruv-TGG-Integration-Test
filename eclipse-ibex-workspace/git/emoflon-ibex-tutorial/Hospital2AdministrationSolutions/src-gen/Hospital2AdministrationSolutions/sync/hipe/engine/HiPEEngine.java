package Hospital2AdministrationSolutions.sync.hipe.engine;

import akka.actor.ActorRef;
import akka.actor.Props;

import Hospital2AdministrationSolutions.sync.hipe.engine.actor.NotificationActor;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.DispatchActor;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DepartmentRule__CONSISTENCY_1_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DepartmentRule__FWD_5_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DocToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_12_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DocToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_8_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.junction.DocToStaffRule__BWD_16_junction;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DocToStaffRule__CONSISTENCY_35_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DocToStaffRule__FWD_46_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DoctorShiftplanRule__BWD_52_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DoctorShiftplanRule__CONSISTENCY_61_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_71_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DoctorToPatient__BWD_75_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DoctorToPatient__CONSISTENCY_85_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.DoctorToPatient__FWD_96_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.HospitaltoAdministrationRule_h_reception_outgoing_SRC__FILTER_NAC_SRC_106_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.HospitaltoAdministrationRule__CONSISTENCY_110_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.HospitaltoAdministrationRule__FWD_116_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.NurseShiftplanRule__BWD_119_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.NurseShiftplanRule__CONSISTENCY_129_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.NurseToRoomRule__CONSISTENCY_140_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.NurseToRoomRule__FWD_150_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.NurseToStaffRule_sp_shifts_outgoing_TRG__FILTER_NAC_TRG_163_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.NurseToStaffRule_s2_shiftPlan_outgoing_TRG__FILTER_NAC_TRG_159_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.junction.NurseToStaffRule__BWD_167_junction;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.NurseToStaffRule__CONSISTENCY_186_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.NurseToStaffRule__FWD_197_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.PatientInReception__BWD_203_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.PatientInReception_p1_lies_incoming_SRC__FILTER_NAC_SRC_209_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.PatientInReception__CONSISTENCY_212_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.PatientInReception__FWD_221_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.PatientInRoom__BWD_227_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.PatientInRoom_p1_waits_incoming_SRC__FILTER_NAC_SRC_234_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.PatientInRoom__CONSISTENCY_237_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.PatientInRoom__FWD_247_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.RoomRule__CONSISTENCY_254_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.localsearch.RoomRule__FWD_258_localSearch;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.node.Staff_object_SP0;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.node.Staff_object_SP1;
import Hospital2AdministrationSolutions.sync.hipe.engine.actor.node.Staff_object_SP4;
