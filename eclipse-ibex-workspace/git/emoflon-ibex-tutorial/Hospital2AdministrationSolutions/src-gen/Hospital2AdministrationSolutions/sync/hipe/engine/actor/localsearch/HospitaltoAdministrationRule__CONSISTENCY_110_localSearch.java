...
public class HospitaltoAdministrationRule__CONSISTENCY_110_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker) o).getCREATE__CORR__htov();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker) o).getCREATE__TRG__v(); return (result instanceof AdministrationExample.Administration ? result : null);};
