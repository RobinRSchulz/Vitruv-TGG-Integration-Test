 ...
 * @generated
 */
public class Hospital2AdministrationSolutionsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Hospital2AdministrationSolutionsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Hospital2AdministrationSolutionsPackage.HOSPITAL_TO_ADMINISTRATION: {
				...
				if (result == null) result = caseCorrespondenceNode(hospitalToAdministration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Hospital2AdministrationSolutionsPackage.STAFF_TO_STAFF: {
				StaffToStaff staffToStaff = (StaffToStaff)theEObject;
				T result = caseStaffToStaff(staffToStaff);
				if (result == null) result = caseCorrespondenceNode(staffToStaff);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Hospital2AdministrationSolutionsPackage.PATIENT_TO_PATIENT: {
				PatientToPatient patientToPatient = (PatientToPatient)theEObject;
				T result = casePatientToPatient(patientToPatient);
				if (result == null) result = caseCorrespondenceNode(patientToPatient);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Hospital2AdministrationSolutionsPackage.ROOM_TO_SHIFTPLAN: {
				RoomToShiftplan roomToShiftplan = (RoomToShiftplan)theEObject;
				T result = caseRoomToShiftplan(roomToShiftplan);
				if (result == null) result = caseCorrespondenceNode(roomToShiftplan);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Hospital2AdministrationSolutionsPackage.DOCTOR_TO_STAFF: {
				DoctorToStaff doctorToStaff = (DoctorToStaff)theEObject;
				T result = caseDoctorToStaff(doctorToStaff);
				if (result == null) result = caseCorrespondenceNode(doctorToStaff);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Hospital2AdministrationSolutionsPackage.NURSE_TO_STAFF: {
				NurseToStaff nurseToStaff = (NurseToStaff)theEObject;
				T result = caseNurseToStaff(nurseToStaff);
				if (result == null) result = caseCorrespondenceNode(nurseToStaff);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Hospital2AdministrationSolutionsPackage.DEPARTMENT_RULE_MARKER: {
			...
			case Hospital2AdministrationSolutionsPackage.DOC_TO_STAFF_RULE_MARKER: {
			...
			case Hospital2AdministrationSolutionsPackage.DOCTOR_SHIFTPLAN_RULE_MARKER: {
			...
			case Hospital2AdministrationSolutionsPackage.DOCTOR_TO_PATIENT_MARKER: {
			...
			case Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER: {
			...
			case Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER: {
			...
			case Hospital2AdministrationSolutionsPackage.NURSE_TO_ROOM_RULE_MARKER: {
			...
			case Hospital2AdministrationSolutionsPackage.NURSE_TO_STAFF_RULE_MARKER: {
			...
			case Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER: {
			...
			case Hospital2AdministrationSolutionsPackage.PATIENT_IN_ROOM_MARKER: {
			...
			case Hospital2AdministrationSolutionsPackage.ROOM_RULE_MARKER: {
...
} //Hospital2AdministrationSolutionsSwitch
