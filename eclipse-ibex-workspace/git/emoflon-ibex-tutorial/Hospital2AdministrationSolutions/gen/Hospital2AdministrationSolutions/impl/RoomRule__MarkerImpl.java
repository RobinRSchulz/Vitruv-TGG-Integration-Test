 ...
 * </p>
 * <ul>
 *   <li>{@link Hospital2AdministrationSolutions.impl.RoomRule__MarkerImpl#getCONTEXT__SRC__d <em>CONTEXT SRC d</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.RoomRule__MarkerImpl#getCREATE__SRC__ro <em>CREATE SRC ro</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoomRule__MarkerImpl extends TGGRuleApplicationImpl implements RoomRule__Marker {
	...
	protected EClass eStaticClass() {
		return Hospital2AdministrationSolutionsPackage.Literals.ROOM_RULE_MARKER;
	}
		...
		if (contexT__SRC__d != null && contexT__SRC__d.eIsProxy()) {
			...
			if (contexT__SRC__d != oldCONTEXT__SRC__d) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.ROOM_RULE_MARKER__CONTEXT_SRC_D, oldCONTEXT__SRC__d, contexT__SRC__d));
			}
		}
	...
	public void setCONTEXT__SRC__d(Department newCONTEXT__SRC__d) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.ROOM_RULE_MARKER__CONTEXT_SRC_D, oldCONTEXT__SRC__d, contexT__SRC__d));
	}
	...
	public Room getCREATE__SRC__ro() {
		if (creatE__SRC__ro != null && creatE__SRC__ro.eIsProxy()) {
			...
			if (creatE__SRC__ro != oldCREATE__SRC__ro) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.ROOM_RULE_MARKER__CREATE_SRC_RO, oldCREATE__SRC__ro, creatE__SRC__ro));
			}
		}
	...
	public void setCREATE__SRC__ro(Room newCREATE__SRC__ro) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.ROOM_RULE_MARKER__CREATE_SRC_RO, oldCREATE__SRC__ro, creatE__SRC__ro));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Hospital2AdministrationSolutionsPackage.ROOM_RULE_MARKER__CONTEXT_SRC_D:
				if (resolve) return getCONTEXT__SRC__d();
				return basicGetCONTEXT__SRC__d();
			case Hospital2AdministrationSolutionsPackage.ROOM_RULE_MARKER__CREATE_SRC_RO:
