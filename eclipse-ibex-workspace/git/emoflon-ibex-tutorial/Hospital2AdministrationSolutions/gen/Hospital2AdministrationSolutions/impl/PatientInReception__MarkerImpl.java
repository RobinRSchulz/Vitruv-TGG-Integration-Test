...
import Hospital2AdministrationSolutions.PatientInReception__Marker;
 ...
 * </p>
 * <ul>
 *   <li>{@link Hospital2AdministrationSolutions.impl.PatientInReception__MarkerImpl#getCONTEXT__SRC__h <em>CONTEXT SRC h</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.PatientInReception__MarkerImpl#getCREATE__SRC__p1 <em>CREATE SRC p1</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.PatientInReception__MarkerImpl#getCONTEXT__SRC__r <em>CONTEXT SRC r</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.PatientInReception__MarkerImpl#getCREATE__TRG__p2 <em>CREATE TRG p2</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.PatientInReception__MarkerImpl#getCONTEXT__TRG__v <em>CONTEXT TRG v</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.PatientInReception__MarkerImpl#getCONTEXT__CORR__htov <em>CONTEXT CORR htov</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.PatientInReception__MarkerImpl#getCREATE__CORR__pTop <em>CREATE CORR pTop</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PatientInReception__MarkerImpl extends TGGRuleApplicationImpl implements PatientInReception__Marker {
	...
	protected EClass eStaticClass() {
		return Hospital2AdministrationSolutionsPackage.Literals.PATIENT_IN_RECEPTION_MARKER;
	}
		...
		if (contexT__SRC__h != null && contexT__SRC__h.eIsProxy()) {
			...
			if (contexT__SRC__h != oldCONTEXT__SRC__h) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_SRC_H, oldCONTEXT__SRC__h, contexT__SRC__h));
			}
		}
	...
	public void setCONTEXT__SRC__h(Hospital newCONTEXT__SRC__h) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_SRC_H, oldCONTEXT__SRC__h, contexT__SRC__h));
	}
	...
	public Patient getCREATE__SRC__p1() {
		if (creatE__SRC__p1 != null && creatE__SRC__p1.eIsProxy()) {
			...
			if (creatE__SRC__p1 != oldCREATE__SRC__p1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CREATE_SRC_P1, oldCREATE__SRC__p1, creatE__SRC__p1));
			}
		}
	...
	public void setCREATE__SRC__p1(Patient newCREATE__SRC__p1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CREATE_SRC_P1, oldCREATE__SRC__p1, creatE__SRC__p1));
	}
	...
	public Reception getCONTEXT__SRC__r() {
		if (contexT__SRC__r != null && contexT__SRC__r.eIsProxy()) {
			...
			if (contexT__SRC__r != oldCONTEXT__SRC__r) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_SRC_R, oldCONTEXT__SRC__r, contexT__SRC__r));
			}
		}
	...
	public void setCONTEXT__SRC__r(Reception newCONTEXT__SRC__r) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_SRC_R, oldCONTEXT__SRC__r, contexT__SRC__r));
	}
	...
	public AdministrationExample.Patient getCREATE__TRG__p2() {
		if (creatE__TRG__p2 != null && creatE__TRG__p2.eIsProxy()) {
			...
			if (creatE__TRG__p2 != oldCREATE__TRG__p2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CREATE_TRG_P2, oldCREATE__TRG__p2, creatE__TRG__p2));
			}
		}
	...
	public void setCREATE__TRG__p2(AdministrationExample.Patient newCREATE__TRG__p2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CREATE_TRG_P2, oldCREATE__TRG__p2, creatE__TRG__p2));
	}
	...
	public Administration getCONTEXT__TRG__v() {
		if (contexT__TRG__v != null && contexT__TRG__v.eIsProxy()) {
			...
			if (contexT__TRG__v != oldCONTEXT__TRG__v) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_TRG_V, oldCONTEXT__TRG__v, contexT__TRG__v));
			}
		}
	...
	public void setCONTEXT__TRG__v(Administration newCONTEXT__TRG__v) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_TRG_V, oldCONTEXT__TRG__v, contexT__TRG__v));
	}
	...
	public HospitalToAdministration getCONTEXT__CORR__htov() {
		if (contexT__CORR__htov != null && contexT__CORR__htov.eIsProxy()) {
			...
			if (contexT__CORR__htov != oldCONTEXT__CORR__htov) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_CORR_HTOV, oldCONTEXT__CORR__htov, contexT__CORR__htov));
			}
		}
	...
	public void setCONTEXT__CORR__htov(HospitalToAdministration newCONTEXT__CORR__htov) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_CORR_HTOV, oldCONTEXT__CORR__htov, contexT__CORR__htov));
	}
	...
	public PatientToPatient getCREATE__CORR__pTop() {
		if (creatE__CORR__pTop != null && creatE__CORR__pTop.eIsProxy()) {
			...
			if (creatE__CORR__pTop != oldCREATE__CORR__pTop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CREATE_CORR_PTOP, oldCREATE__CORR__pTop, creatE__CORR__pTop));
			}
		}
	...
	public void setCREATE__CORR__pTop(PatientToPatient newCREATE__CORR__pTop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CREATE_CORR_PTOP, oldCREATE__CORR__pTop, creatE__CORR__pTop));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_SRC_H:
				if (resolve) return getCONTEXT__SRC__h();
				return basicGetCONTEXT__SRC__h();
			case Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CREATE_SRC_P1:
				if (resolve) return getCREATE__SRC__p1();
				return basicGetCREATE__SRC__p1();
			case Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_SRC_R:
				if (resolve) return getCONTEXT__SRC__r();
				return basicGetCONTEXT__SRC__r();
			case Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CREATE_TRG_P2:
				if (resolve) return getCREATE__TRG__p2();
				return basicGetCREATE__TRG__p2();
			case Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_TRG_V:
				if (resolve) return getCONTEXT__TRG__v();
				return basicGetCONTEXT__TRG__v();
			case Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CONTEXT_CORR_HTOV:
				if (resolve) return getCONTEXT__CORR__htov();
				return basicGetCONTEXT__CORR__htov();
			case Hospital2AdministrationSolutionsPackage.PATIENT_IN_RECEPTION_MARKER__CREATE_CORR_PTOP:
