...
import Hospital2AdministrationSolutions.DepartmentRule__Marker;
...
import Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsFactory;
...
import Hospital2AdministrationSolutions.HospitaltoAdministrationRule__Marker;
...
import Hospital2AdministrationSolutions.NurseToStaff;
...
import Hospital2AdministrationSolutions.RoomRule__Marker;
import Hospital2AdministrationSolutions.RoomToShiftplan;
 ...
 * @generated
 */
public class Hospital2AdministrationSolutionsPackageImpl extends EPackageImpl implements Hospital2AdministrationSolutionsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see Hospital2AdministrationSolutions.Hospital2AdministrationSolutionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Hospital2AdministrationSolutionsPackageImpl() {
		super(eNS_URI, Hospital2AdministrationSolutionsFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link Hospital2AdministrationSolutionsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Hospital2AdministrationSolutionsPackage init() {
		if (isInited) return (Hospital2AdministrationSolutionsPackage)EPackage.Registry.INSTANCE.getEPackage(Hospital2AdministrationSolutionsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredHospital2AdministrationSolutionsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Hospital2AdministrationSolutionsPackageImpl theHospital2AdministrationSolutionsPackage = registeredHospital2AdministrationSolutionsPackage instanceof Hospital2AdministrationSolutionsPackageImpl ? (Hospital2AdministrationSolutionsPackageImpl)registeredHospital2AdministrationSolutionsPackage : new Hospital2AdministrationSolutionsPackageImpl();
		...
		theHospital2AdministrationSolutionsPackage.createPackageContents();

		// Initialize created meta-data
		theHospital2AdministrationSolutionsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theHospital2AdministrationSolutionsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Hospital2AdministrationSolutionsPackage.eNS_URI, theHospital2AdministrationSolutionsPackage);
		return theHospital2AdministrationSolutionsPackage;
	}
	 ...
	 */
	@Override
	public Hospital2AdministrationSolutionsFactory getHospital2AdministrationSolutionsFactory() {
		return (Hospital2AdministrationSolutionsFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		hospitalToAdministrationEClass.getESuperTypes().add(theRuntimePackage.getCorrespondenceNode());
		staffToStaffEClass.getESuperTypes().add(theRuntimePackage.getCorrespondenceNode());
		patientToPatientEClass.getESuperTypes().add(theRuntimePackage.getCorrespondenceNode());
		roomToShiftplanEClass.getESuperTypes().add(theRuntimePackage.getCorrespondenceNode());
		doctorToStaffEClass.getESuperTypes().add(theRuntimePackage.getCorrespondenceNode());
		nurseToStaffEClass.getESuperTypes().add(theRuntimePackage.getCorrespondenceNode());
