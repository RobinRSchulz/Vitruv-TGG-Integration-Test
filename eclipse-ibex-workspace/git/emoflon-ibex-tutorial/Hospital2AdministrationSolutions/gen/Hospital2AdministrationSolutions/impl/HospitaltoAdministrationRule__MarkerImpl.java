 ...
 * </p>
 * <ul>
 *   <li>{@link Hospital2AdministrationSolutions.impl.HospitaltoAdministrationRule__MarkerImpl#getCREATE__SRC__h <em>CREATE SRC h</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.HospitaltoAdministrationRule__MarkerImpl#getCREATE__SRC__r <em>CREATE SRC r</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.HospitaltoAdministrationRule__MarkerImpl#getCREATE__TRG__v <em>CREATE TRG v</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.HospitaltoAdministrationRule__MarkerImpl#getCREATE__CORR__htov <em>CREATE CORR htov</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HospitaltoAdministrationRule__MarkerImpl extends TGGRuleApplicationImpl implements HospitaltoAdministrationRule__Marker {
	...
	protected EClass eStaticClass() {
		return Hospital2AdministrationSolutionsPackage.Literals.HOSPITALTO_ADMINISTRATION_RULE_MARKER;
	}
		...
		if (creatE__SRC__h != null && creatE__SRC__h.eIsProxy()) {
			...
			if (creatE__SRC__h != oldCREATE__SRC__h) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_SRC_H, oldCREATE__SRC__h, creatE__SRC__h));
			}
		}
	...
	public void setCREATE__SRC__h(Hospital newCREATE__SRC__h) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_SRC_H, oldCREATE__SRC__h, creatE__SRC__h));
	}
	...
	public Reception getCREATE__SRC__r() {
		if (creatE__SRC__r != null && creatE__SRC__r.eIsProxy()) {
			...
			if (creatE__SRC__r != oldCREATE__SRC__r) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_SRC_R, oldCREATE__SRC__r, creatE__SRC__r));
			}
		}
	...
	public void setCREATE__SRC__r(Reception newCREATE__SRC__r) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_SRC_R, oldCREATE__SRC__r, creatE__SRC__r));
	}
	...
	public Administration getCREATE__TRG__v() {
		if (creatE__TRG__v != null && creatE__TRG__v.eIsProxy()) {
			...
			if (creatE__TRG__v != oldCREATE__TRG__v) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_TRG_V, oldCREATE__TRG__v, creatE__TRG__v));
			}
		}
	...
	public void setCREATE__TRG__v(Administration newCREATE__TRG__v) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_TRG_V, oldCREATE__TRG__v, creatE__TRG__v));
	}
	...
	public HospitalToAdministration getCREATE__CORR__htov() {
		if (creatE__CORR__htov != null && creatE__CORR__htov.eIsProxy()) {
			...
			if (creatE__CORR__htov != oldCREATE__CORR__htov) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_CORR_HTOV, oldCREATE__CORR__htov, creatE__CORR__htov));
			}
		}
	...
	public void setCREATE__CORR__htov(HospitalToAdministration newCREATE__CORR__htov) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_CORR_HTOV, oldCREATE__CORR__htov, creatE__CORR__htov));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_SRC_H:
				if (resolve) return getCREATE__SRC__h();
				return basicGetCREATE__SRC__h();
			case Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_SRC_R:
				if (resolve) return getCREATE__SRC__r();
				return basicGetCREATE__SRC__r();
			case Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_TRG_V:
				if (resolve) return getCREATE__TRG__v();
				return basicGetCREATE__TRG__v();
			case Hospital2AdministrationSolutionsPackage.HOSPITALTO_ADMINISTRATION_RULE_MARKER__CREATE_CORR_HTOV:
