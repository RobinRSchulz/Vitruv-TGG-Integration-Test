 ...
 * </p>
 * <ul>
 *   <li>{@link Hospital2AdministrationSolutions.impl.DepartmentRule__MarkerImpl#getCREATE__SRC__d <em>CREATE SRC d</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.DepartmentRule__MarkerImpl#getCONTEXT__SRC__h <em>CONTEXT SRC h</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepartmentRule__MarkerImpl extends TGGRuleApplicationImpl implements DepartmentRule__Marker {
	...
	protected EClass eStaticClass() {
		return Hospital2AdministrationSolutionsPackage.Literals.DEPARTMENT_RULE_MARKER;
	}
		...
		if (creatE__SRC__d != null && creatE__SRC__d.eIsProxy()) {
			...
			if (creatE__SRC__d != oldCREATE__SRC__d) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.DEPARTMENT_RULE_MARKER__CREATE_SRC_D, oldCREATE__SRC__d, creatE__SRC__d));
			}
		}
	...
	public void setCREATE__SRC__d(Department newCREATE__SRC__d) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.DEPARTMENT_RULE_MARKER__CREATE_SRC_D, oldCREATE__SRC__d, creatE__SRC__d));
	}
	...
	public Hospital getCONTEXT__SRC__h() {
		if (contexT__SRC__h != null && contexT__SRC__h.eIsProxy()) {
			...
			if (contexT__SRC__h != oldCONTEXT__SRC__h) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.DEPARTMENT_RULE_MARKER__CONTEXT_SRC_H, oldCONTEXT__SRC__h, contexT__SRC__h));
			}
		}
	...
	public void setCONTEXT__SRC__h(Hospital newCONTEXT__SRC__h) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.DEPARTMENT_RULE_MARKER__CONTEXT_SRC_H, oldCONTEXT__SRC__h, contexT__SRC__h));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Hospital2AdministrationSolutionsPackage.DEPARTMENT_RULE_MARKER__CREATE_SRC_D:
				if (resolve) return getCREATE__SRC__d();
				return basicGetCREATE__SRC__d();
			case Hospital2AdministrationSolutionsPackage.DEPARTMENT_RULE_MARKER__CONTEXT_SRC_H:
