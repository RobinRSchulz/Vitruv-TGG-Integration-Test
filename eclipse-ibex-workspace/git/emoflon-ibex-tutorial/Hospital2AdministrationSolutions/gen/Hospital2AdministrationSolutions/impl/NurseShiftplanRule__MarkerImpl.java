...
import Hospital2AdministrationSolutions.NurseShiftplanRule__Marker;
import Hospital2AdministrationSolutions.PatientToPatient;
import Hospital2AdministrationSolutions.StaffToStaff;
 ...
 * </p>
 * <ul>
 *   <li>{@link Hospital2AdministrationSolutions.impl.NurseShiftplanRule__MarkerImpl#getCONTEXT__SRC__p1 <em>CONTEXT SRC p1</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.NurseShiftplanRule__MarkerImpl#getCONTEXT__SRC__ro <em>CONTEXT SRC ro</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.NurseShiftplanRule__MarkerImpl#getCONTEXT__SRC__s1 <em>CONTEXT SRC s1</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.NurseShiftplanRule__MarkerImpl#getCONTEXT__TRG__p2 <em>CONTEXT TRG p2</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.NurseShiftplanRule__MarkerImpl#getCONTEXT__TRG__s2 <em>CONTEXT TRG s2</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.NurseShiftplanRule__MarkerImpl#getCONTEXT__TRG__sh <em>CONTEXT TRG sh</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.NurseShiftplanRule__MarkerImpl#getCONTEXT__TRG__sp <em>CONTEXT TRG sp</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.NurseShiftplanRule__MarkerImpl#getCONTEXT__CORR__pToP <em>CONTEXT CORR pTo P</em>}</li>
 *   <li>{@link Hospital2AdministrationSolutions.impl.NurseShiftplanRule__MarkerImpl#getCONTEXT__CORR__sToS <em>CONTEXT CORR sTo S</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NurseShiftplanRule__MarkerImpl extends TGGRuleApplicationImpl implements NurseShiftplanRule__Marker {
	...
	protected EClass eStaticClass() {
		return Hospital2AdministrationSolutionsPackage.Literals.NURSE_SHIFTPLAN_RULE_MARKER;
	}
		...
		if (contexT__SRC__p1 != null && contexT__SRC__p1.eIsProxy()) {
			...
			if (contexT__SRC__p1 != oldCONTEXT__SRC__p1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_SRC_P1, oldCONTEXT__SRC__p1, contexT__SRC__p1));
			}
		}
	...
	public void setCONTEXT__SRC__p1(Patient newCONTEXT__SRC__p1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_SRC_P1, oldCONTEXT__SRC__p1, contexT__SRC__p1));
	}
	...
	public Room getCONTEXT__SRC__ro() {
		if (contexT__SRC__ro != null && contexT__SRC__ro.eIsProxy()) {
			...
			if (contexT__SRC__ro != oldCONTEXT__SRC__ro) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_SRC_RO, oldCONTEXT__SRC__ro, contexT__SRC__ro));
			}
		}
	...
	public void setCONTEXT__SRC__ro(Room newCONTEXT__SRC__ro) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_SRC_RO, oldCONTEXT__SRC__ro, contexT__SRC__ro));
	}
	...
	public Nurse getCONTEXT__SRC__s1() {
		if (contexT__SRC__s1 != null && contexT__SRC__s1.eIsProxy()) {
			...
			if (contexT__SRC__s1 != oldCONTEXT__SRC__s1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_SRC_S1, oldCONTEXT__SRC__s1, contexT__SRC__s1));
			}
		}
	...
	public void setCONTEXT__SRC__s1(Nurse newCONTEXT__SRC__s1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_SRC_S1, oldCONTEXT__SRC__s1, contexT__SRC__s1));
	}
	...
	public AdministrationExample.Patient getCONTEXT__TRG__p2() {
		if (contexT__TRG__p2 != null && contexT__TRG__p2.eIsProxy()) {
			...
			if (contexT__TRG__p2 != oldCONTEXT__TRG__p2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_P2, oldCONTEXT__TRG__p2, contexT__TRG__p2));
			}
		}
	...
	public void setCONTEXT__TRG__p2(AdministrationExample.Patient newCONTEXT__TRG__p2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_P2, oldCONTEXT__TRG__p2, contexT__TRG__p2));
	}
	...
	public Staff getCONTEXT__TRG__s2() {
		if (contexT__TRG__s2 != null && contexT__TRG__s2.eIsProxy()) {
			...
			if (contexT__TRG__s2 != oldCONTEXT__TRG__s2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_S2, oldCONTEXT__TRG__s2, contexT__TRG__s2));
			}
		}
	...
	public void setCONTEXT__TRG__s2(Staff newCONTEXT__TRG__s2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_S2, oldCONTEXT__TRG__s2, contexT__TRG__s2));
	}
	...
	public Shift getCONTEXT__TRG__sh() {
		if (contexT__TRG__sh != null && contexT__TRG__sh.eIsProxy()) {
			...
			if (contexT__TRG__sh != oldCONTEXT__TRG__sh) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_SH, oldCONTEXT__TRG__sh, contexT__TRG__sh));
			}
		}
	...
	public void setCONTEXT__TRG__sh(Shift newCONTEXT__TRG__sh) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_SH, oldCONTEXT__TRG__sh, contexT__TRG__sh));
	}
	...
	public Shiftplan getCONTEXT__TRG__sp() {
		if (contexT__TRG__sp != null && contexT__TRG__sp.eIsProxy()) {
			...
			if (contexT__TRG__sp != oldCONTEXT__TRG__sp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_SP, oldCONTEXT__TRG__sp, contexT__TRG__sp));
			}
		}
	...
	public void setCONTEXT__TRG__sp(Shiftplan newCONTEXT__TRG__sp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_SP, oldCONTEXT__TRG__sp, contexT__TRG__sp));
	}
	...
	public PatientToPatient getCONTEXT__CORR__pToP() {
		if (contexT__CORR__pToP != null && contexT__CORR__pToP.eIsProxy()) {
			...
			if (contexT__CORR__pToP != oldCONTEXT__CORR__pToP) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_CORR_PTO_P, oldCONTEXT__CORR__pToP, contexT__CORR__pToP));
			}
		}
	...
	public void setCONTEXT__CORR__pToP(PatientToPatient newCONTEXT__CORR__pToP) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_CORR_PTO_P, oldCONTEXT__CORR__pToP, contexT__CORR__pToP));
	}
	...
	public StaffToStaff getCONTEXT__CORR__sToS() {
		if (contexT__CORR__sToS != null && contexT__CORR__sToS.eIsProxy()) {
			...
			if (contexT__CORR__sToS != oldCONTEXT__CORR__sToS) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_CORR_STO_S, oldCONTEXT__CORR__sToS, contexT__CORR__sToS));
			}
		}
	...
	public void setCONTEXT__CORR__sToS(StaffToStaff newCONTEXT__CORR__sToS) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_CORR_STO_S, oldCONTEXT__CORR__sToS, contexT__CORR__sToS));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_SRC_P1:
				if (resolve) return getCONTEXT__SRC__p1();
				return basicGetCONTEXT__SRC__p1();
			case Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_SRC_RO:
				if (resolve) return getCONTEXT__SRC__ro();
				return basicGetCONTEXT__SRC__ro();
			case Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_SRC_S1:
				if (resolve) return getCONTEXT__SRC__s1();
				return basicGetCONTEXT__SRC__s1();
			case Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_P2:
				if (resolve) return getCONTEXT__TRG__p2();
				return basicGetCONTEXT__TRG__p2();
			case Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_S2:
				if (resolve) return getCONTEXT__TRG__s2();
				return basicGetCONTEXT__TRG__s2();
			case Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_SH:
				if (resolve) return getCONTEXT__TRG__sh();
				return basicGetCONTEXT__TRG__sh();
			case Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_TRG_SP:
				if (resolve) return getCONTEXT__TRG__sp();
				return basicGetCONTEXT__TRG__sp();
			case Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_CORR_PTO_P:
				if (resolve) return getCONTEXT__CORR__pToP();
				return basicGetCONTEXT__CORR__pToP();
			case Hospital2AdministrationSolutionsPackage.NURSE_SHIFTPLAN_RULE_MARKER__CONTEXT_CORR_STO_S:
