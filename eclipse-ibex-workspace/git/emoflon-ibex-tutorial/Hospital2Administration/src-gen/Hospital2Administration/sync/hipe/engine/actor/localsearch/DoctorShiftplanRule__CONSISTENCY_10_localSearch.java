...
public class DoctorShiftplanRule__CONSISTENCY_10_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__s1(); return (result instanceof HospitalExample.Doctor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sp(); return (result instanceof AdministrationExample.Shiftplan ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sh(); return (result instanceof AdministrationExample.Shift ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__CORR__pToP();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__CORR__sToS();
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Doctor ? result : null);};
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_10_localSearch", 9);
			...
			case "Doctor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_10_localSearch", 9);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_10_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_10_localSearch", 9);
			...
			case "Shift_object": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_10_localSearch", 9);
			...
			case "Shiftplan_object": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_10_localSearch", 9);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_10_localSearch", 9);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_10_localSearch", 9);
			...
			case "DoctorShiftplanRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_10_localSearch", 9);
		...
		case "Hospital2Administration.DoctorShiftplanRule__Marker_CONTEXT__SRC__p1_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Patient) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_10_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
