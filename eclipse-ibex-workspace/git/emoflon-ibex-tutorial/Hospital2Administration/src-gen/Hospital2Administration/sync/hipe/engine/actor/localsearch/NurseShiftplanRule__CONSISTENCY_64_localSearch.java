...
public class NurseShiftplanRule__CONSISTENCY_64_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__s1(); return (result instanceof HospitalExample.Nurse ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__CORR__sToS();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__sh(); return (result instanceof AdministrationExample.Shift ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__ro(); return (result instanceof HospitalExample.Room ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__s2(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getShifts();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Shiftplan) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_12 = new EdgeExplorer(this, 6, 5, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__sp(); return (result instanceof AdministrationExample.Shiftplan ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getCovers();
						edge_explorer_18_methods.multi_opposite_lookup = (o) -> ((AdministrationExample.Patient) o).getCoveredBy();
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
			...
			case "Staff_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
			...
			case "Shift_object": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
			...
			case "Shiftplan_object": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// sToS
					HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
			...
			case "NurseShiftplanRule__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Hospital2Administration.StaffToStaff_target_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
					...
					HMatch match = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_64_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
		...
		case "HospitalExample.Nurse_responsible_Room": 
			...
			break;
		case "Hospital2Administration.NurseShiftplanRule__Marker_CONTEXT__SRC__s1_Nurse": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2Administration.NurseShiftplanRule__Marker_CONTEXT__CORR__sToS_StaffToStaff": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Hospital2Administration.NurseShiftplanRule__Marker_CONTEXT__TRG__sh_Shift": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2Administration.NurseShiftplanRule__Marker_CONTEXT__CORR__pToP_PatientToPatient": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Hospital2Administration.NurseShiftplanRule__Marker_CONTEXT__SRC__ro_Room": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2Administration.NurseShiftplanRule__Marker_CONTEXT__TRG__s2_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
		...
		case "Hospital2Administration.PatientToPatient_source_Patient": 
			...
			break;
		case "Hospital2Administration.NurseShiftplanRule__Marker_CONTEXT__TRG__sp_Shiftplan": 
			if(!lazy_initialization) {
		...
		case "AdministrationExample.Staff_shiftPlan_Shiftplan": 
			...
			break;
		case "Hospital2Administration.NurseShiftplanRule__Marker_CONTEXT__SRC__p1_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Patient) {
				{
		...
		case "AdministrationExample.Shiftplan_covers_Patient": 
			...
			break;
		case "Hospital2Administration.NurseShiftplanRule__Marker_CONTEXT__TRG__p2_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Patient) {
				{
