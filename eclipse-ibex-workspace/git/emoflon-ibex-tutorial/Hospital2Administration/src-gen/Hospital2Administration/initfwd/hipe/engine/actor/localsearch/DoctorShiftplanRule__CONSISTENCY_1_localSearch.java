...
public class DoctorShiftplanRule__CONSISTENCY_1_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__s2(); return (result instanceof AdministrationExample.Staff ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 8, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 8, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sh(); return (result instanceof AdministrationExample.Shift ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sp(); return (result instanceof AdministrationExample.Shiftplan ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12 = new EdgeExplorer(this, 5, 4, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((AdministrationExample.Staff) o).getShiftPlan();
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof AdministrationExample.Staff) return o.equals(edge_explorer_13_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__s1(); return (result instanceof HospitalExample.Doctor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						...
						edge_explorer_16 = new EdgeExplorer(this, 5, 2, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__CORR__pToP();
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_1_localSearch", 9);
			...
			case "Doctor_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_1_localSearch", 9);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_1_localSearch", 9);
			...
			case "Staff_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_1_localSearch", 9);
			...
			case "Shift_object": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_1_localSearch", 9);
			...
			case "Shiftplan_object": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_1_localSearch", 9);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_1_localSearch", 9);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// sToS
					HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_1_localSearch", 9);
			...
			case "DoctorShiftplanRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_1_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Hospital2Administration.StaffToStaff_target_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_1_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
			...
			break;
		case "Hospital2Administration.DoctorShiftplanRule__Marker_CONTEXT__TRG__s2_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
			...
			break;
		case "Hospital2Administration.DoctorShiftplanRule__Marker_CONTEXT__SRC__p1_Patient": 
			if(!lazy_initialization) {
		...
		case "Hospital2Administration.PatientToPatient_source_Patient": 
			...
			break;
		case "Hospital2Administration.DoctorShiftplanRule__Marker_CONTEXT__TRG__sh_Shift": 
			if(!lazy_initialization) {
		...
		case "HospitalExample.Patient_doctor_Doctor": 
			...
			break;
		case "Hospital2Administration.DoctorShiftplanRule__Marker_CONTEXT__CORR__sToS_StaffToStaff": 
			if(!lazy_initialization) {
				{
		...
		case "Hospital2Administration.StaffToStaff_source_Staff": 
			...
			break;
		case "Hospital2Administration.DoctorShiftplanRule__Marker_CONTEXT__TRG__sp_Shiftplan": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2Administration.DoctorShiftplanRule__Marker_CONTEXT__TRG__p2_Patient": 
			if(!lazy_initialization) {
		...
		case "Hospital2Administration.PatientToPatient_target_Patient": 
			...
			break;
		case "Hospital2Administration.DoctorShiftplanRule__Marker_CONTEXT__SRC__s1_Doctor": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Doctor) {
				{
		...
		case "AdministrationExample.Shiftplan_covers_Patient": 
			...
			break;
		case "Hospital2Administration.DoctorShiftplanRule__Marker_CONTEXT__CORR__pToP_PatientToPatient": 
			if(!lazy_initialization) {
				{
