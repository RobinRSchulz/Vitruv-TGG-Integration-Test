...
public class DoctorToPatient__FWD_26_localSearch extends GenericLocalSearchActor{
			...
			case "Doctor_object": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__FWD_26_localSearch", 8);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__FWD_26_localSearch", 8);
			...
			case "Department_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// dep
						HMatch match_2 = new LocalSearchMatch("DoctorToPatient__FWD_26_localSearch", 8);
			...
			case "Patient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_3 = new LocalSearchMatch("DoctorToPatient__FWD_26_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("DoctorToPatient__FWD_26_localSearch", 8);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__FWD_26_localSearch", 8);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_6 = new LocalSearchMatch("DoctorToPatient__FWD_26_localSearch", 8);
			...
			case "Staff_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_7 = new LocalSearchMatch("DoctorToPatient__FWD_26_localSearch", 8);
		...
		case "Hospital2Administration.PatientToPatient_source_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Patient) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorToPatient__FWD_26_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
