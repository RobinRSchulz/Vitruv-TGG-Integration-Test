...
public class NurseShiftplanRule__CONSISTENCY_35_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__s1(); return (result instanceof HospitalExample.Nurse ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 9, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__ro(); return (result instanceof HospitalExample.Room ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__sp(); return (result instanceof AdministrationExample.Shiftplan ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__s2(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((HospitalExample.Nurse) o).getResponsible();
						edge_explorer_10_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Room) o).getNurses();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__TRG__sh(); return (result instanceof AdministrationExample.Shift ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getTarget(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__CORR__sToS();
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseShiftplanRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						...
						edge_explorer_18 = new EdgeExplorer(this, 6, 5, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.multi_lookup = (o) -> ((AdministrationExample.Shiftplan) o).getCovers();
						edge_explorer_19_methods.multi_opposite_lookup = (o) -> ((AdministrationExample.Patient) o).getCoveredBy();
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
			...
			case "Staff_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
			...
			case "Shift_object": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
			...
			case "Shiftplan_object": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
			...
			case "NurseShiftplanRule__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
		...
		case "Hospital2Administration.NurseShiftplanRule__Marker_CONTEXT__SRC__s1_Nurse": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Nurse) {
				{
					...
					HMatch match = new LocalSearchMatch("NurseShiftplanRule__CONSISTENCY_35_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[9] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
