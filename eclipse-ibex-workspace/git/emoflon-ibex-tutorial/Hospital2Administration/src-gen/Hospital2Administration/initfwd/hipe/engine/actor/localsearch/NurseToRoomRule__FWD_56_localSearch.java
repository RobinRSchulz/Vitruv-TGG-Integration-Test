...
public class NurseToRoomRule__FWD_56_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object_SP1": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__FWD_56_localSearch", 8);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// n
						HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__FWD_56_localSearch", 8);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// nToS
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__FWD_56_localSearch", 8);
			...
			case "Patient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__FWD_56_localSearch", 8);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__FWD_56_localSearch", 8);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pTop
					HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__FWD_56_localSearch", 8);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__FWD_56_localSearch", 8);
			...
			case "Staff_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__FWD_56_localSearch", 8);
		...
		case "Hospital2Administration.StaffToStaff_source_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Nurse) {
				{
					...
					HMatch match = new LocalSearchMatch("NurseToRoomRule__FWD_56_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
