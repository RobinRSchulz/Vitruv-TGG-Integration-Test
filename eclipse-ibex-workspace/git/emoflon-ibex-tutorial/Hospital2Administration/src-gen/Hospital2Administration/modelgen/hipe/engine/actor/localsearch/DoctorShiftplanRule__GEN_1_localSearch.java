...
public class DoctorShiftplanRule__GEN_1_localSearch extends GenericLocalSearchActor{
			...
			case "Patient_object": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__GEN_1_localSearch", 8);
			...
			case "Patient_1_object": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__GEN_1_localSearch", 8);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__GEN_1_localSearch", 8);
			...
			case "Doctor_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__GEN_1_localSearch", 8);
			...
			case "Staff_object": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__GEN_1_localSearch", 8);
			...
			case "StaffToStaff_object": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__GEN_1_localSearch", 8);
			...
			case "Shift_object": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__GEN_1_localSearch", 8);
			...
			case "Shiftplan_object": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__GEN_1_localSearch", 8);
		...
		case "Hospital2Administration.StaffToStaff_target_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorShiftplanRule__GEN_1_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
