...
public class PatientInRoom__GEN_38_localSearch extends GenericLocalSearchActor{
			...
			case "Department_object": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__GEN_38_localSearch", 5);
			...
			case "Hospital_object": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("PatientInRoom__GEN_38_localSearch", 5);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__GEN_38_localSearch", 5);
			...
			case "Room_object": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("PatientInRoom__GEN_38_localSearch", 5);
			...
			case "Administration_object": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_4 = new LocalSearchMatch("PatientInRoom__GEN_38_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Department_rooms_Room": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("PatientInRoom__GEN_38_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
