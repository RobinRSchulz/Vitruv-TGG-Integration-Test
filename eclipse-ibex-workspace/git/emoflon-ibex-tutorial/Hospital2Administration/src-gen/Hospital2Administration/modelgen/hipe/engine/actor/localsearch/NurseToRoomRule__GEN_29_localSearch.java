...
public class NurseToRoomRule__GEN_29_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getSource(); return (result instanceof HospitalExample.Nurse ? result : null);};
			...
			case "Department_object": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__GEN_29_localSearch", 8);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// n
						HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__GEN_29_localSearch", 8);
			...
			case "StaffToStaff_object": 
				{
					...
					// nToS
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__GEN_29_localSearch", 8);
			...
			case "Patient_object": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__GEN_29_localSearch", 8);
			...
			case "Patient_1_object": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__GEN_29_localSearch", 8);
			...
			case "PatientToPatient_object": 
				{
					...
					// pTop
					HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__GEN_29_localSearch", 8);
			...
			case "Room_object": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__GEN_29_localSearch", 8);
			...
			case "Staff_object": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__GEN_29_localSearch", 8);
		...
		case "Hospital2Administration.StaffToStaff_target_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
					...
					HMatch match = new LocalSearchMatch("NurseToRoomRule__GEN_29_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[7] = msg.target;
					currentDepth++;
