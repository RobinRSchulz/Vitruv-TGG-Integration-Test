...
public class DoctorToPatient__GEN_10_localSearch extends GenericLocalSearchActor{
			...
			case "Doctor_object": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__GEN_10_localSearch", 8);
			...
			case "StaffToStaff_object": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__GEN_10_localSearch", 8);
			...
			case "Department_object": 
				{
					if(!lazy_initialization) {
						...
						// dep
						HMatch match_2 = new LocalSearchMatch("DoctorToPatient__GEN_10_localSearch", 8);
			...
			case "Patient_object": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_3 = new LocalSearchMatch("DoctorToPatient__GEN_10_localSearch", 8);
			...
			case "Patient_1_object": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("DoctorToPatient__GEN_10_localSearch", 8);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__GEN_10_localSearch", 8);
			...
			case "Room_object": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_6 = new LocalSearchMatch("DoctorToPatient__GEN_10_localSearch", 8);
			...
			case "Staff_object": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_7 = new LocalSearchMatch("DoctorToPatient__GEN_10_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Department_rooms_Room": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DoctorToPatient__GEN_10_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
