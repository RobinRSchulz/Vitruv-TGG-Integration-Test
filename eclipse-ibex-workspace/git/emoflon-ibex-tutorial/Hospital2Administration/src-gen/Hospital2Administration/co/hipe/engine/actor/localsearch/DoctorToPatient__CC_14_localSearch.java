...
public class DoctorToPatient__CC_14_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getTarget(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new EdgeExplorer(this, 4, 8, edge_explorer_9_methods);
			...
			case "Doctor_object": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
			...
			case "StaffToStaff_object": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
			...
			case "Department_object": 
				{
					if(!lazy_initialization) {
						...
						// dep
						HMatch match_2 = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
			...
			case "Patient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_3 = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
			...
			case "Room_object": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_6 = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
			...
			case "Treatment_object": 
				{
					if(!lazy_initialization) {
						...
						// t
						HMatch match_8 = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
						match_8.getNodes()[8] = objs[0];
						start(edge_explorer_2_orchestration, match_8);
					}
				}
				break;
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_10_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_10_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorToPatient__CC_14_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[8] = msg.target;
					currentDepth++;
