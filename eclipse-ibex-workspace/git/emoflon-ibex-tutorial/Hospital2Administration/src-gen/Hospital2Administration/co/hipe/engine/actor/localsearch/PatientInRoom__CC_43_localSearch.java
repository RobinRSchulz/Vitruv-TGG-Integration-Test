...
public class PatientInRoom__CC_43_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.HospitalToAdministration) o).getTarget(); return (result instanceof AdministrationExample.Administration ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 2, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.HospitalToAdministration) o).getSource(); return (result instanceof HospitalExample.Hospital ? result : null);};
			...
			case "Department_object": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__CC_43_localSearch", 7);
			...
			case "Hospital_object": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("PatientInRoom__CC_43_localSearch", 7);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__CC_43_localSearch", 7);
			...
			case "Room_object": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("PatientInRoom__CC_43_localSearch", 7);
			...
			case "Administration_object": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_4 = new LocalSearchMatch("PatientInRoom__CC_43_localSearch", 7);
			...
			case "Patient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_5 = new LocalSearchMatch("PatientInRoom__CC_43_localSearch", 7);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_6 = new LocalSearchMatch("PatientInRoom__CC_43_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Hospital_department_Department": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("PatientInRoom__CC_43_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
