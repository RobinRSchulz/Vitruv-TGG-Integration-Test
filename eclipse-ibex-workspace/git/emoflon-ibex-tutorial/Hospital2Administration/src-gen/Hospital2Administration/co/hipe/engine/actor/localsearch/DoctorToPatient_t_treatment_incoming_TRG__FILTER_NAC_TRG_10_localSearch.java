...
public class DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_10_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorToPatient__CC_14_localSearch"), this::returnTrue  , false ));
			...
			case "Treatment_object": 
				{
					...
					// t
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_10_localSearch", 3);
			...
			case "Staff_object_SP0": 
				{
					...
					// s
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_10_localSearch", 3);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					edge_explorer.registerSourceObject(objs[0]);
					
					// FILTER_NAC_NODE
					HMatch match_2 = new LocalSearchMatch("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_10_localSearch", 3);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_10_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
