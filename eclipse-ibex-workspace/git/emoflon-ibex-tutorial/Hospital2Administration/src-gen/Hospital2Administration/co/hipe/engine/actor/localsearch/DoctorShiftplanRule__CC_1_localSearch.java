...
public class DoctorShiftplanRule__CC_1_localSearch extends GenericLocalSearchActor{
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CC_1_localSearch", 8);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CC_1_localSearch", 8);
			...
			case "PatientToPatient_object": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CC_1_localSearch", 8);
			...
			case "Doctor_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CC_1_localSearch", 8);
			...
			case "Staff_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CC_1_localSearch", 8);
			...
			case "StaffToStaff_object": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CC_1_localSearch", 8);
			...
			case "Shift_object": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CC_1_localSearch", 8);
			...
			case "Shiftplan_object": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CC_1_localSearch", 8);
		...
		case "Hospital2Administration.PatientToPatient_target_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Patient) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CC_1_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
