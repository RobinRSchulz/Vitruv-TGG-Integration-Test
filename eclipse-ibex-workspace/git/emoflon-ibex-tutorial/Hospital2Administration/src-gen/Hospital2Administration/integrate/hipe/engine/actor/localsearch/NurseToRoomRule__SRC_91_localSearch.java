...
public class NurseToRoomRule__SRC_91_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToRoomRule__FWD_96_localSearch"), this::returnTrue  , false ));
			...
			case "Department_object_SP0": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__SRC_91_localSearch", 4);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// n
						HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__SRC_91_localSearch", 4);
			...
			case "Patient_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__SRC_91_localSearch", 4);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__SRC_91_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Department_rooms_Room": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("NurseToRoomRule__SRC_91_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
