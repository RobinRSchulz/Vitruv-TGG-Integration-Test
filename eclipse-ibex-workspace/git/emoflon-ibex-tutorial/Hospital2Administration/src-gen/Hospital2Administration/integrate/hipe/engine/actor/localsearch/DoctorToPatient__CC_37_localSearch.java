...
public class DoctorToPatient__CC_37_localSearch extends GenericLocalSearchActor{
			...
			case "Doctor_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
			...
			case "Department_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// dep
						HMatch match_2 = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
			...
			case "Patient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_3 = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_6 = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					...
					// s
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
			...
			case "Treatment_object": 
				{
					if(!lazy_initialization) {
						...
						// t
						HMatch match_8 = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
						match_8.getNodes()[8] = objs[0];
						start(edge_explorer_8_1_orchestration, match_8);
					}
				}
				break;
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_22_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_22_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Department_rooms_Room": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DoctorToPatient__CC_37_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
