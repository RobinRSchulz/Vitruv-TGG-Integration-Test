...
public class NurseShiftplanRule__CC_70_localSearch extends GenericLocalSearchActor{
			...
			case "Patient_object_SP0": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__CC_70_localSearch", 9);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_1 = new LocalSearchMatch("NurseShiftplanRule__CC_70_localSearch", 9);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__CC_70_localSearch", 9);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__CC_70_localSearch", 9);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__CC_70_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_5 = new LocalSearchMatch("NurseShiftplanRule__CC_70_localSearch", 9);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// sToS
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__CC_70_localSearch", 9);
			...
			case "Shift_object": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_7 = new LocalSearchMatch("NurseShiftplanRule__CC_70_localSearch", 9);
			...
			case "Shiftplan_object": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_8 = new LocalSearchMatch("NurseShiftplanRule__CC_70_localSearch", 9);
		...
		case "Hospital2Administration.StaffToStaff_source_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Nurse) {
				{
					...
					HMatch match = new LocalSearchMatch("NurseShiftplanRule__CC_70_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
