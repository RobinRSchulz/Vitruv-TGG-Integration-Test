...
public class DoctorShiftplanRule__CONSISTENCY_20_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sp(); return (result instanceof AdministrationExample.Shiftplan ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__sh(); return (result instanceof AdministrationExample.Shift ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorShiftplanRule__Marker) o).getCONTEXT__SRC__s1(); return (result instanceof HospitalExample.Doctor ? result : null);};
			...
			case "DoctorShiftplanRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_20_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "DoctorShiftplanRule__BWD_6_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_20_localSearch", 9);
		...
		case "Hospital2Administration.DoctorShiftplanRule__Marker_CONTEXT__TRG__sp_Shiftplan": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Shiftplan) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CONSISTENCY_20_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
