...
public class DoctorToPatient__SRC_47_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorToPatient__FWD_52_localSearch"), this::returnTrue  , false ));
			...
			case "Doctor_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__SRC_47_localSearch", 4);
			...
			case "Department_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// dep
						HMatch match_1 = new LocalSearchMatch("DoctorToPatient__SRC_47_localSearch", 4);
			...
			case "Patient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_2 = new LocalSearchMatch("DoctorToPatient__SRC_47_localSearch", 4);
			...
			case "Room_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("DoctorToPatient__SRC_47_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Staff_works_Department": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("DoctorToPatient__SRC_47_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
