...
public class PatientInRoom__CONSISTENCY_127_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__CORR__htov();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__SRC__d(); return (result instanceof HospitalExample.Department ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientInRoom__Marker) o).getCREATE__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__SRC__h(); return (result instanceof HospitalExample.Hospital ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Hospital2Administration.PatientInRoom__Marker) o).getCREATE__CORR__pTop();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__SRC__ro(); return (result instanceof HospitalExample.Room ? result : null);};
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pTop
					HMatch match_7 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_127_localSearch", 9);
			...
			case "PatientInRoom__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_127_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "PatientInRoom__FWD_124_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_127_localSearch", 9);
				...
				break;
			case "PatientInRoom__BWD_106_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_127_localSearch", 9);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("PatientInRoom__CONSISTENCY_127_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof AdministrationExample.Patient) {
			HMatch match_4 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_127_localSearch", 9);
		...
		if(obj instanceof HospitalExample.Patient) {
			HMatch match_2 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_127_localSearch", 9);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID csp_5 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_incrementingPatientID();
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getPatientID(), "int"));
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getPatientID(), "int"));
		csp_5.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname csp_6 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_nametoname();
		...
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getFirstName(), "java.lang.String"));
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p2.getLastName(), "java.lang.String"));
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getName(), "java.lang.String"));
		csp_6.solve();
