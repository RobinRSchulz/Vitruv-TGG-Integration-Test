...
public class DoctorToPatient__TRG_26_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorToPatient__BWD_30_localSearch"), this::returnTrue  , false ));
			...
			case "Patient_1_object_SP2": 
				{
					...
					// p2
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__TRG_26_localSearch", 3);
			...
			case "Staff_object_SP2": 
				{
					...
					// s
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__TRG_26_localSearch", 3);
			...
			case "Treatment_object": 
				{
					if(!lazy_initialization) {
						...
						// t
						HMatch match_2 = new LocalSearchMatch("DoctorToPatient__TRG_26_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_22_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__TRG_26_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "AdministrationExample.Patient_treatment_Treatment": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DoctorToPatient__TRG_26_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
