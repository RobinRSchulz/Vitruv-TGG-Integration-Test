...
public class DoctorToPatient__FWD_52_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorToPatient__CONSISTENCY_57_localSearch"), this::returnTrue  , false ));
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__FWD_52_localSearch", 8);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("DoctorToPatient__FWD_52_localSearch", 8);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__FWD_52_localSearch", 8);
			...
			case "Staff_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_7 = new LocalSearchMatch("DoctorToPatient__FWD_52_localSearch", 8);
						match_7.getNodes()[7] = objs[0];
						start(edge_explorer_2_orchestration, match_7);
					}
				}
				break;
			case "DoctorToPatient__SRC_47_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__FWD_52_localSearch", 8);
		...
		case "Hospital2Administration.StaffToStaff_target_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorToPatient__FWD_52_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[7] = msg.target;
					currentDepth++;
