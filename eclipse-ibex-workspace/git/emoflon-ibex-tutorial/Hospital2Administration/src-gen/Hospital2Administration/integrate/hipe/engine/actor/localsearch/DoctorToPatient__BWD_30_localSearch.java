...
public class DoctorToPatient__BWD_30_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("DoctorToPatient__CONSISTENCY_57_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Doctor_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__BWD_30_localSearch", 9);
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// dToS
					HMatch match_1 = new LocalSearchMatch("DoctorToPatient__BWD_30_localSearch", 9);
			...
			case "Department_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// dep
						HMatch match_2 = new LocalSearchMatch("DoctorToPatient__BWD_30_localSearch", 9);
			...
			case "Patient_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_3 = new LocalSearchMatch("DoctorToPatient__BWD_30_localSearch", 9);
			...
			case "PatientToPatient_object_SP2": 
				{
					...
					// pToP
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__BWD_30_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_6 = new LocalSearchMatch("DoctorToPatient__BWD_30_localSearch", 9);
						match_6.getNodes()[6] = objs[0];
						start(edge_explorer_6_1_orchestration, match_6);
					}
				}
				break;
			case "DoctorToPatient__TRG_26_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__BWD_30_localSearch", 9);
		...
		case "Hospital2Administration.StaffToStaff_target_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Staff) {
				{
					...
					HMatch match = new LocalSearchMatch("DoctorToPatient__BWD_30_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[7] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof AdministrationExample.Treatment) {
			HMatch match_8 = new LocalSearchMatch("DoctorToPatient__BWD_30_localSearch", 9);
