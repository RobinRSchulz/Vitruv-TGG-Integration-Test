...
public class DoctorShiftplanRule__TRG_1_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("DoctorShiftplanRule__BWD_6_localSearch"), this::returnTrue  , false ));
			...
			case "Patient_1_object_SP0": 
				{
					...
					// p2
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__TRG_1_localSearch", 4);
			...
			case "Staff_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__TRG_1_localSearch", 4);
			...
			case "Shift_object": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__TRG_1_localSearch", 4);
			...
			case "Shiftplan_object": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__TRG_1_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "AdministrationExample.Shiftplan_covers_Patient": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DoctorShiftplanRule__TRG_1_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
