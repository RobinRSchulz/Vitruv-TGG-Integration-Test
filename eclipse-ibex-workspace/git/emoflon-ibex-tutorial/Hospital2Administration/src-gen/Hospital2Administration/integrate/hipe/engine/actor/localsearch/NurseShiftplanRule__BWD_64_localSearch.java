...
public class NurseShiftplanRule__BWD_64_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("NurseShiftplanRule__CONSISTENCY_80_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Patient_object_SP2": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("NurseShiftplanRule__BWD_64_localSearch", 9);
			...
			case "PatientToPatient_object_SP2": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("NurseShiftplanRule__BWD_64_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("NurseShiftplanRule__BWD_64_localSearch", 9);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_4 = new LocalSearchMatch("NurseShiftplanRule__BWD_64_localSearch", 9);
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// sToS
					HMatch match_6 = new LocalSearchMatch("NurseShiftplanRule__BWD_64_localSearch", 9);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "NurseShiftplanRule__TRG_59_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("NurseShiftplanRule__BWD_64_localSearch", 9);
		...
		case "Hospital2Administration.StaffToStaff_source_Staff": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Nurse) {
				{
					...
					HMatch match = new LocalSearchMatch("NurseShiftplanRule__BWD_64_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
