...
public class NurseToRoomRule__FWD_96_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("NurseToRoomRule__CONSISTENCY_101_localSearch"), this::returnTrue  , false ));
			...
			case "StaffToStaff_object_SP2": 
				{
					...
					// nToS
					HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__FWD_96_localSearch", 8);
			...
			case "Patient_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__FWD_96_localSearch", 8);
			...
			case "PatientToPatient_object_SP2": 
				{
					...
					// pTop
					HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__FWD_96_localSearch", 8);
			...
			case "Staff_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__FWD_96_localSearch", 8);
						match_7.getNodes()[7] = objs[0];
						start(edge_explorer_4_1_orchestration, match_7);
					}
				}
				break;
			case "NurseToRoomRule__SRC_91_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("NurseToRoomRule__FWD_96_localSearch", 8);
		...
		case "Hospital2Administration.PatientToPatient_target_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Patient) {
				{
					...
					HMatch match = new LocalSearchMatch("NurseToRoomRule__FWD_96_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
