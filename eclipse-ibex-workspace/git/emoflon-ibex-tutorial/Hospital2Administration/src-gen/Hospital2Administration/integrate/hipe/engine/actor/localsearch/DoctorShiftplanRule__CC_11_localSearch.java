...
public class DoctorShiftplanRule__CC_11_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getTarget(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 7, 1, edge_explorer_8_methods);
			...
			case "Patient_object_SP1": 
				{
					...
					// p1
					HMatch match_0 = new LocalSearchMatch("DoctorShiftplanRule__CC_11_localSearch", 8);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_1 = new LocalSearchMatch("DoctorShiftplanRule__CC_11_localSearch", 8);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_2 = new LocalSearchMatch("DoctorShiftplanRule__CC_11_localSearch", 8);
			...
			case "Doctor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s1
						HMatch match_3 = new LocalSearchMatch("DoctorShiftplanRule__CC_11_localSearch", 8);
			...
			case "Staff_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s2
						HMatch match_4 = new LocalSearchMatch("DoctorShiftplanRule__CC_11_localSearch", 8);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// sToS
					HMatch match_5 = new LocalSearchMatch("DoctorShiftplanRule__CC_11_localSearch", 8);
			...
			case "Shift_object": 
				{
					if(!lazy_initialization) {
						...
						// sh
						HMatch match_6 = new LocalSearchMatch("DoctorShiftplanRule__CC_11_localSearch", 8);
			...
			case "Shiftplan_object": 
				{
					if(!lazy_initialization) {
						...
						// sp
						HMatch match_7 = new LocalSearchMatch("DoctorShiftplanRule__CC_11_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Patient_doctor_Doctor": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DoctorShiftplanRule__CC_11_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
