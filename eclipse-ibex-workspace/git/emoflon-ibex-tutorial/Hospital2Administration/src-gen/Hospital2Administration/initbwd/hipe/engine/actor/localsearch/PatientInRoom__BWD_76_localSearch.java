...
public class PatientInRoom__BWD_76_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.HospitalToAdministration) o).getTarget(); return (result instanceof AdministrationExample.Administration ? result : null);};
			...
			case "Department_object_SP1": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__BWD_76_localSearch", 6);
			...
			case "Hospital_object": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("PatientInRoom__BWD_76_localSearch", 6);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_2 = new LocalSearchMatch("PatientInRoom__BWD_76_localSearch", 6);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("PatientInRoom__BWD_76_localSearch", 6);
			...
			case "Administration_object": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_4 = new LocalSearchMatch("PatientInRoom__BWD_76_localSearch", 6);
			...
			case "Patient_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_5 = new LocalSearchMatch("PatientInRoom__BWD_76_localSearch", 6);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "HospitalExample.Hospital_department_Department": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("PatientInRoom__BWD_76_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
