...
import Hospital2Administration.initbwd.hipe.engine.actor.localsearch.DoctorShiftplanRule__BWD_1_localSearch;
import Hospital2Administration.initbwd.hipe.engine.actor.localsearch.DoctorShiftplanRule__CONSISTENCY_10_localSearch;
import Hospital2Administration.initbwd.hipe.engine.actor.localsearch.DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_20_localSearch;
import Hospital2Administration.initbwd.hipe.engine.actor.localsearch.DoctorToPatient__BWD_24_localSearch;
import Hospital2Administration.initbwd.hipe.engine.actor.localsearch.DoctorToPatient__CONSISTENCY_34_localSearch;
import Hospital2Administration.initbwd.hipe.engine.actor.localsearch.NurseShiftplanRule__BWD_45_localSearch;
import Hospital2Administration.initbwd.hipe.engine.actor.localsearch.NurseShiftplanRule__CONSISTENCY_55_localSearch;
import Hospital2Administration.initbwd.hipe.engine.actor.localsearch.NurseToRoomRule__CONSISTENCY_66_localSearch;
import Hospital2Administration.initbwd.hipe.engine.actor.localsearch.PatientInRoom__BWD_76_localSearch;
import Hospital2Administration.initbwd.hipe.engine.actor.localsearch.PatientInRoom__CONSISTENCY_83_localSearch;
...
public class HiPEEngine extends IHiPEEngine{
	...
	public void createJunctionNodes() {
		...
		classes.put("NurseShiftplanRule__BWD_45_localSearch", NurseShiftplanRule__BWD_45_localSearch.class);
		classes.put("NurseShiftplanRule__CONSISTENCY_55_localSearch", NurseShiftplanRule__CONSISTENCY_55_localSearch.class);
		classes.put("NurseToRoomRule__CONSISTENCY_66_localSearch", NurseToRoomRule__CONSISTENCY_66_localSearch.class);
		classes.put("PatientInRoom__BWD_76_localSearch", PatientInRoom__BWD_76_localSearch.class);
		classes.put("PatientInRoom__CONSISTENCY_83_localSearch", PatientInRoom__CONSISTENCY_83_localSearch.class);
	}
