...
public class DoctorToPatient__CONSISTENCY_34_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__d(); return (result instanceof HospitalExample.Doctor ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 4, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__CORR__pToP();
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 8, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__dep(); return (result instanceof HospitalExample.Department ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new CachedEdgeExplorer(this, 5, 6, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__ro(); return (result instanceof HospitalExample.Room ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__TRG__s(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorToPatient__Marker) o).getCREATE__TRG__t(); return (result instanceof AdministrationExample.Treatment ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((HospitalExample.Department) o).getRooms();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof HospitalExample.Department) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_12 = new EdgeExplorer(this, 1, 3, edge_explorer_12_methods);
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getTarget(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Hospital2Administration.DoctorToPatient__Marker) o).getCONTEXT__CORR__dToS();
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> ((HospitalExample.Staff) o).getWorks();
						edge_explorer_20_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Doctor).collect(Collectors.toList());
						edge_explorer_20 = new EdgeExplorer(this, 0, 1, edge_explorer_20_methods);
			...
			case "Doctor_object": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
			...
			case "Department_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// dep
						HMatch match_1 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
			...
			case "Patient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_2 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
			...
			case "Room_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
			...
			case "Staff_object_SP0": 
				{
					...
					// s
					HMatch match_5 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
			...
			case "Treatment_object": 
				{
					if(!lazy_initialization) {
						...
						// t
						HMatch match_6 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
			...
			case "StaffToStaff_object_SP1": 
				{
					...
					// dToS
					HMatch match_7 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pToP
					HMatch match_8 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
			...
			case "DoctorToPatient__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
		...
		switch(match.creator) {
			...
			case "DoctorToPatient_t_treatment_incoming_TRG__FILTER_NAC_TRG_20_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "AdministrationExample.Patient_treatment_Treatment": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("DoctorToPatient__CONSISTENCY_34_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
			...
			break;
		case "Hospital2Administration.DoctorToPatient__Marker_CONTEXT__SRC__d_Doctor": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2Administration.DoctorToPatient__Marker_CONTEXT__TRG__p2_Patient": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2Administration.DoctorToPatient__Marker_CONTEXT__CORR__pToP_PatientToPatient": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Hospital2Administration.DoctorToPatient__Marker_CONTEXT__SRC__dep_Department": 
			if(!lazy_initialization) {
		...
		case "AdministrationExample.Staff_treatment_Treatment": 
			...
			break;
		case "Hospital2Administration.DoctorToPatient__Marker_CONTEXT__SRC__ro_Room": 
			if(!lazy_initialization) {
		...
		case "Hospital2Administration.PatientToPatient_source_Patient": 
			...
			break;
		case "Hospital2Administration.DoctorToPatient__Marker_CONTEXT__TRG__s_Staff": 
			if(!lazy_initialization) {
			...
			break;
		case "Hospital2Administration.DoctorToPatient__Marker_CREATE__TRG__t_Treatment": 
			if(!lazy_initialization) {
		...
		case "HospitalExample.Room_lies_Patient": 
			...
			break;
		case "Hospital2Administration.DoctorToPatient__Marker_CONTEXT__SRC__p1_Patient": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Patient) {
				{
		...
		case "Hospital2Administration.PatientToPatient_target_Patient": 
			...
			break;
		case "Hospital2Administration.DoctorToPatient__Marker_CONTEXT__CORR__dToS_StaffToStaff": 
			if(!lazy_initialization) {
				{
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication csp_1 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.hospital2administration.UserDefined_carelevelToMedication();
		csp_1.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, p1.getLevel(), "Enum::Carelevel"));
		csp_1.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, t.getMedication(), "Enum::Medication"));
		csp_1.solve();
