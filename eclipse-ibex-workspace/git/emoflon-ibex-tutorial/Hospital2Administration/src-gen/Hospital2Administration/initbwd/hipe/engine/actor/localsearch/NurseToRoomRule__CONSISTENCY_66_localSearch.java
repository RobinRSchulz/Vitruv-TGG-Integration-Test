...
public class NurseToRoomRule__CONSISTENCY_66_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__SRC__dep(); return (result instanceof HospitalExample.Department ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 8, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__TRG__p2(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__TRG__s(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new EdgeExplorer(this, 1, 3, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientToPatient) o).getTarget(); return (result instanceof AdministrationExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.StaffToStaff) o).getTarget(); return (result instanceof AdministrationExample.Staff ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__SRC__r(); return (result instanceof HospitalExample.Room ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__CORR__pTop();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__CORR__nToS();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.NurseToRoomRule__Marker) o).getCONTEXT__SRC__n(); return (result instanceof HospitalExample.Nurse ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						...
						edge_explorer_14_methods.multi_opposite_lookup = (o) -> ((HospitalExample.Department) o).getStaff().stream().filter(obj -> obj instanceof HospitalExample.Nurse).collect(Collectors.toList());
			...
			case "Department_object_SP0": 
				{
					...
					// dep
					HMatch match_0 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_66_localSearch", 9);
			...
			case "Nurse_object": 
				{
					if(!lazy_initialization) {
						...
						// n
						HMatch match_1 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_66_localSearch", 9);
			...
			case "Patient_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_2 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_66_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// r
						HMatch match_3 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_66_localSearch", 9);
			...
			case "Patient_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_66_localSearch", 9);
			...
			case "Staff_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// s
						HMatch match_5 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_66_localSearch", 9);
			...
			case "StaffToStaff_object_SP0": 
				{
					...
					// nToS
					HMatch match_6 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_66_localSearch", 9);
			...
			case "PatientToPatient_object_SP0": 
				{
					...
					// pTop
					HMatch match_7 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_66_localSearch", 9);
			...
			case "NurseToRoomRule__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_66_localSearch", 9);
		...
		case "Hospital2Administration.NurseToRoomRule__Marker_CONTEXT__SRC__dep_Department": 
			if(!lazy_initialization) {
				if(msg.target instanceof HospitalExample.Department) {
				{
					...
					HMatch match = new LocalSearchMatch("NurseToRoomRule__CONSISTENCY_66_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
