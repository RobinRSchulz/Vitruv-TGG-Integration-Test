...
public class PatientInRoom__CONSISTENCY_83_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__TRG__v(); return (result instanceof AdministrationExample.Administration ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 8, 5, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__SRC__ro(); return (result instanceof HospitalExample.Room ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__SRC__h(); return (result instanceof HospitalExample.Hospital ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.HospitalToAdministration) o).getSource(); return (result instanceof HospitalExample.Hospital ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientToPatient) o).getSource(); return (result instanceof HospitalExample.Patient ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientInRoom__Marker) o).getCONTEXT__SRC__d(); return (result instanceof HospitalExample.Department ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.HospitalToAdministration) o).getTarget(); return (result instanceof AdministrationExample.Administration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Hospital2Administration.PatientInRoom__Marker) o).getCREATE__SRC__p1(); return (result instanceof HospitalExample.Patient ? result : null);};
			...
			case "Department_object_SP0": 
				{
					...
					// d
					HMatch match_0 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_83_localSearch", 9);
			...
			case "Hospital_object": 
				{
					if(!lazy_initialization) {
						...
						// h
						HMatch match_1 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_83_localSearch", 9);
			...
			case "Patient_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// p1
						HMatch match_2 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_83_localSearch", 9);
			...
			case "Room_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// ro
						HMatch match_3 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_83_localSearch", 9);
			...
			case "Patient_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// p2
						HMatch match_4 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_83_localSearch", 9);
			...
			case "Administration_object": 
				{
					if(!lazy_initialization) {
						...
						// v
						HMatch match_5 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_83_localSearch", 9);
			...
			case "HospitalToAdministration_object": 
				{
					...
					// htov
					HMatch match_6 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_83_localSearch", 9);
			...
			case "PatientToPatient_object_SP1": 
				{
					...
					// pTop
					HMatch match_7 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_83_localSearch", 9);
			...
			case "PatientInRoom__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("PatientInRoom__CONSISTENCY_83_localSearch", 9);
		...
		case "Hospital2Administration.PatientInRoom__Marker_CONTEXT__TRG__v_Administration": 
			if(!lazy_initialization) {
				if(msg.target instanceof AdministrationExample.Administration) {
				{
					...
					HMatch match = new LocalSearchMatch("PatientInRoom__CONSISTENCY_83_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
