...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@6977e516 (name: shiftlpan)] which does the following:
...
public class FindShiftplanPattern extends GraphTransformationPattern<FindShiftplanMatch, FindShiftplanPattern> {
	...
	public String toString() {
		...
		s += "	shiftlpan --> " + parameters.get("shiftlpan") + java.lang.System.lineSeparator();
		s += "}";
		return s;
	}
}
