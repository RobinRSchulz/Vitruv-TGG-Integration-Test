...
public class PatientCoveredRule extends GraphTransformationRule<PatientCoveredMatch, PatientCoveredRule> {
	...
	public String toString() {
		...
		s += "	earlyshift --> " + parameters.get("earlyshift") + java.lang.System.lineSeparator();
		s += "	lateshift --> " + parameters.get("lateshift") + java.lang.System.lineSeparator();
		s += "	nightshift --> " + parameters.get("nightshift") + java.lang.System.lineSeparator();
		s += "	patient --> " + parameters.get("patient") + java.lang.System.lineSeparator();
		s += "	s --> " + parameters.get("s") + java.lang.System.lineSeparator();
		s += "	s1 --> " + parameters.get("s1") + java.lang.System.lineSeparator();
		s += "	shiftPlan --> " + parameters.get("shiftPlan") + java.lang.System.lineSeparator();
		s += "	shiftPlan2 --> " + parameters.get("shiftPlan2") + java.lang.System.lineSeparator();
		s += "	t --> " + parameters.get("t") + java.lang.System.lineSeparator();
		s += "}";
		return s;
	}
}
