...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@95a5b08 (name: person)] which does the following:
...
public class FindPersonPattern extends GraphTransformationPattern<FindPersonMatch, FindPersonPattern> {
	...
	public String toString() {
		...
		s += "	person --> " + parameters.get("person") + java.lang.System.lineSeparator();
		s += "}";
		return s;
	}
}
