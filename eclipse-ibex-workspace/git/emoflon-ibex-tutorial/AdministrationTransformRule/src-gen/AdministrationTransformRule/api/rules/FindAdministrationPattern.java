...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@6d780b93 (name: administration)] which does the following:
...
public class FindAdministrationPattern extends GraphTransformationPattern<FindAdministrationMatch, FindAdministrationPattern> {
	...
	public String toString() {
		...
		s += "	administration --> " + parameters.get("administration") + java.lang.System.lineSeparator();
		s += "}";
		return s;
	}
}
