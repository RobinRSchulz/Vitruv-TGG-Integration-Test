...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@2be61950 (name: staff)] which does the following:
...
public class FindStaffPattern extends GraphTransformationPattern<FindStaffMatch, FindStaffPattern> {
	...
	public String toString() {
		...
		s += "	staff --> " + parameters.get("staff") + java.lang.System.lineSeparator();
		s += "}";
		return s;
	}
}
