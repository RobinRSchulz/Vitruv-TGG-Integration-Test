...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@70bf8e54 (name: someStaff), org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@164f372a (name: treatment)] which does the following:
...
public class FindTreatmentPattern extends GraphTransformationPattern<FindTreatmentMatch, FindTreatmentPattern> {
	...
	public String toString() {
		...
		s += "	someStaff --> " + parameters.get("someStaff") + java.lang.System.lineSeparator();
		s += "	treatment --> " + parameters.get("treatment") + java.lang.System.lineSeparator();
		s += "}";
		return s;
	}
}
