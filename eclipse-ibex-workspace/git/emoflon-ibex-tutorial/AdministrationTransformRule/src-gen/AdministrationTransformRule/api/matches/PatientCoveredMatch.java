...
public class PatientCoveredMatch extends GraphTransformationMatch<PatientCoveredMatch, PatientCoveredRule> {
	...
	public String toString() {
		...
		s += "	earlyshift --> " + varEarlyshift + java.lang.System.lineSeparator();
		s += "	lateshift --> " + varLateshift + java.lang.System.lineSeparator();
		s += "	nightshift --> " + varNightshift + java.lang.System.lineSeparator();
		s += "	patient --> " + varPatient + java.lang.System.lineSeparator();
		s += "	s --> " + varS + java.lang.System.lineSeparator();
		s += "	s1 --> " + varS1 + java.lang.System.lineSeparator();
		s += "	shiftPlan --> " + varShiftPlan + java.lang.System.lineSeparator();
		s += "	shiftPlan2 --> " + varShiftPlan2 + java.lang.System.lineSeparator();
		s += "	t --> " + varT + java.lang.System.lineSeparator();
		s += "} for " + getPattern();
		return s;
	}
}
