 ...
 * @generated
 */
public class HospitalExampleSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case HospitalExamplePackage.STAFF: {
			...
			case HospitalExamplePackage.DOCTOR: {
				...
				if (result == null) result = caseStaff(doctor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HospitalExamplePackage.NURSE: {
				...
				if (result == null) result = caseStaff(nurse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
