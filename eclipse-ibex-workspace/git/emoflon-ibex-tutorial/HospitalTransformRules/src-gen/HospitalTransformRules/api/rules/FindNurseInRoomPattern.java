...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@30a2aa3b (name: room), org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@7002034e (name: somenurse)] which does the following:
...
public class FindNurseInRoomPattern extends GraphTransformationPattern<FindNurseInRoomMatch, FindNurseInRoomPattern> {
	...
	public String toString() {
		...
		s += "	somenurse --> " + parameters.get("somenurse") + java.lang.System.lineSeparator();
		s += "}";
		return s;
	}
}
