...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@7660026e (name: doctor), org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@47f1ad65 (name: somepatient)] which does the following:
...
public class FindOccupiedDocPattern extends GraphTransformationPattern<FindOccupiedDocMatch, FindOccupiedDocPattern> {
	...
	public String toString() {
		...
		s += "	doctor --> " + parameters.get("doctor") + java.lang.System.lineSeparator();
		s += "	somepatient --> " + parameters.get("somepatient") + java.lang.System.lineSeparator();
		s += "}";
		return s;
	}
}
