...
public DoctorRule setStaffID(final int value) {
	...
	public String toString() {
		...
		s += "	hospital --> " + parameters.get("hospital") + java.lang.System.lineSeparator();
		s += "	capacity --> " + parameters.get("capacity") + java.lang.System.lineSeparator();
		s += "	name --> " + parameters.get("name") + java.lang.System.lineSeparator();
		s += "	staffID --> " + parameters.get("staffID") + java.lang.System.lineSeparator();
		s += "}";
		return s;
	}
}
