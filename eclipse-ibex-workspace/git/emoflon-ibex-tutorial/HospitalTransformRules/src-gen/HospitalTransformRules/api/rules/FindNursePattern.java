...
/**
 * The pattern [org.emoflon.ibex.patternmodel.IBeXPatternModel.impl.IBeXNodeImpl@24386cdd (name: nurse)] which does the following:
...
public class FindNursePattern extends GraphTransformationPattern<FindNurseMatch, FindNursePattern> {
	...
	public String toString() {
		...
		s += "	nurse --> " + parameters.get("nurse") + java.lang.System.lineSeparator();
		s += "}";
		return s;
	}
}
