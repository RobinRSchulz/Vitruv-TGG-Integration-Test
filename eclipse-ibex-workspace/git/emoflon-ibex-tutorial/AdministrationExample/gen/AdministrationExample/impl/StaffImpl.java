...
public class StaffImpl extends PersonImpl implements Staff {
	...
	public void setStaffID(int newStaffID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdministrationExamplePackage.STAFF__STAFF_ID, oldStaffID, staffID));
	}
	...
	public void setSalary(double newSalary) {
		...
		salary = newSalary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdministrationExamplePackage.STAFF__SALARY, oldSalary, salary));
	}
	...
	public NotificationChain basicSetShiftPlan(Shiftplan newShiftPlan, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdministrationExamplePackage.STAFF__SHIFT_PLAN, oldShiftPlan, newShiftPlan);
	...
	public void setShiftPlan(Shiftplan newShiftPlan) {
		if (newShiftPlan != shiftPlan) {
			...
			if (shiftPlan != null)
				msgs = ((InternalEObject)shiftPlan).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdministrationExamplePackage.STAFF__SHIFT_PLAN, null, msgs);
			if (newShiftPlan != null)
				msgs = ((InternalEObject)newShiftPlan).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdministrationExamplePackage.STAFF__SHIFT_PLAN, null, msgs);
			msgs = basicSetShiftPlan(newShiftPlan, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdministrationExamplePackage.STAFF__SHIFT_PLAN, newShiftPlan, newShiftPlan));
	}
	...
	public void setDInt(int newDInt) {
		...
		dInt = newDInt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdministrationExamplePackage.STAFF__DINT, oldDInt, dInt));
	}
	...
	public EList<Treatment> getTreatment() {
		if (treatment == null) {
			treatment = new EObjectResolvingEList<Treatment>(Treatment.class, this, AdministrationExamplePackage.STAFF__TREATMENT);
		}
		return treatment;
	}
