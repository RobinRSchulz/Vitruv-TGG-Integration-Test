 ...
 * @generated
 */
public class AdministrationImpl extends MinimalEObjectImpl.Container implements Administration {
	/**
	...
	public EList<Staff> getStaff() {
		if (staff == null) {
			staff = new EObjectContainmentEList<Staff>(Staff.class, this, AdministrationExamplePackage.ADMINISTRATION__STAFF);
		}
		return staff;
	}
	...
	public EList<Patient> getPatient() {
		if (patient == null) {
			patient = new EObjectContainmentEList<Patient>(Patient.class, this, AdministrationExamplePackage.ADMINISTRATION__PATIENT);
		}
		return patient;
	}
