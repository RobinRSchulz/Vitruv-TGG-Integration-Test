 ...
 * @generated
 */
public class ShiftplanImpl extends MinimalEObjectImpl.Container implements Shiftplan {
	/**
	...
	public EList<Patient> getCovers() {
		if (covers == null) {
			covers = new EObjectWithInverseResolvingEList.ManyInverse<Patient>(Patient.class, this, AdministrationExamplePackage.SHIFTPLAN__COVERS, AdministrationExamplePackage.PATIENT__COVERED_BY);
		}
		return covers;
	}
	...
	public EList<Shift> getShifts() {
		if (shifts == null) {
			shifts = new EObjectContainmentEList<Shift>(Shift.class, this, AdministrationExamplePackage.SHIFTPLAN__SHIFTS);
		}
		return shifts;
	}
