...
public class AdministrationExampleFactoryImpl extends EFactoryImpl implements AdministrationExampleFactory {
	...
	public static AdministrationExampleFactory init() {
		try {
			AdministrationExampleFactory theAdministrationExampleFactory = (AdministrationExampleFactory)EPackage.Registry.INSTANCE.getEFactory(AdministrationExamplePackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AdministrationExamplePackage.ADMINISTRATION: return createAdministration();
			case AdministrationExamplePackage.SHIFT: return createShift();
			case AdministrationExamplePackage.STAFF: return createStaff();
			case AdministrationExamplePackage.PERSON: return createPerson();
			case AdministrationExamplePackage.TREATMENT: return createTreatment();
			case AdministrationExamplePackage.SHIFTPLAN: return createShiftplan();
			case AdministrationExamplePackage.PATIENT: return createPatient();
			default:
