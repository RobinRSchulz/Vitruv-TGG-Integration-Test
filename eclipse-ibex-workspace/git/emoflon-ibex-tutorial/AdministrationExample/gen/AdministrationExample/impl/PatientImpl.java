...
public class PatientImpl extends PersonImpl implements Patient {
	...
	public void setPatientID(int newPatientID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdministrationExamplePackage.PATIENT__PATIENT_ID, oldPatientID, patientID));
	}
	...
	public NotificationChain basicSetTreatment(Treatment newTreatment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdministrationExamplePackage.PATIENT__TREATMENT, oldTreatment, newTreatment);
	...
	public void setTreatment(Treatment newTreatment) {
		if (newTreatment != treatment) {
			...
			if (treatment != null)
				msgs = ((InternalEObject)treatment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdministrationExamplePackage.PATIENT__TREATMENT, null, msgs);
			if (newTreatment != null)
				msgs = ((InternalEObject)newTreatment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdministrationExamplePackage.PATIENT__TREATMENT, null, msgs);
			msgs = basicSetTreatment(newTreatment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdministrationExamplePackage.PATIENT__TREATMENT, newTreatment, newTreatment));
	}
	...
	public EList<Shiftplan> getCoveredBy() {
		if (coveredBy == null) {
			coveredBy = new EObjectWithInverseResolvingEList.ManyInverse<Shiftplan>(Shiftplan.class, this, AdministrationExamplePackage.PATIENT__COVERED_BY, AdministrationExamplePackage.SHIFTPLAN__COVERS);
		}
		return coveredBy;
	}
