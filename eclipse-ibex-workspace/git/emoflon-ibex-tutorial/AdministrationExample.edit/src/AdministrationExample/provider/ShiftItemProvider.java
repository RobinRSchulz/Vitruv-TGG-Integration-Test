...
/**
 * This is the item provider adapter for a {@link AdministrationExample.Shift} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ShiftItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Shift_time_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Shift_time_feature", "_UI_Shift_type"),
				 AdministrationExamplePackage.Literals.SHIFT__TIME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Daytime labelValue = ((Shift)object).getTime();
