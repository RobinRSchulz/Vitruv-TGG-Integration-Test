...
public class UserDefined_expectPublic extends RuntimeTGGAttributeConstraint {
	...
	public void solve() {
		...
		String bindingStates = getBindingStates(v0);
	  	...
	  	switch(bindingStates) {
	  		case "F": {
		  		v0.bindToValue(VisibilityKind.PUBLIC_LITERAL);
	  			setSatisfied(true);
		  		break;
		  	}
	  		case "B": {
		  		setSatisfied(((VisibilityKind)v0.getValue()).equals(VisibilityKind.PUBLIC_LITERAL));
		  		break;
		  	}
