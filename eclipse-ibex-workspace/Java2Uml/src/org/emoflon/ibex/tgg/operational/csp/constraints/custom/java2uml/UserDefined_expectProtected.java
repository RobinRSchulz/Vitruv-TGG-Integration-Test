...
public class UserDefined_expectProtected extends RuntimeTGGAttributeConstraint {
	...
	public void solve() {
		...
		String bindingStates = getBindingStates(v0);
	  	...
	  	switch(bindingStates) {
	  		case "F": {
		  		v0.bindToValue(VisibilityKind.PROTECTED_LITERAL);
	  			setSatisfied(true);
		  		break;
		  	}
	  		case "B": {
		  		setSatisfied(((VisibilityKind)v0.getValue()).equals(VisibilityKind.PROTECTED_LITERAL));
		  		break;
		  	}
