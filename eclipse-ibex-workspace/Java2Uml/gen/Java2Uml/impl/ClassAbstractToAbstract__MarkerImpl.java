...
public class ClassAbstractToAbstract__MarkerImpl extends SmartObject implements Java2Uml.ClassAbstractToAbstract__Marker {
	...
	protected ClassAbstractToAbstract__MarkerImpl() {
		super(Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER);
	}
    ...
    public void setCONTEXT__SRC__javaConcreteClassifier(org.emftext.language.java.classifiers.Class value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__SR_C__JAVA_CONCRETE_CLASSIFIER, oldValue, value, -1));
    	        	
    	        	if(Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__SR_C__JAVA_CONCRETE_CLASSIFIER.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__SR_C__JAVA_CONCRETE_CLASSIFIER.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__SR_C__JAVA_CONCRETE_CLASSIFIER.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void setCREATE__SRC__modifier(org.emftext.language.java.modifiers.Abstract value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CREAT_E__SR_C__MODIFIER, oldValue, value, -1));
    	        	
    	        	if(Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CREAT_E__SR_C__MODIFIER.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CREAT_E__SR_C__MODIFIER.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CREAT_E__SR_C__MODIFIER.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void setCONTEXT__TRG__umlClassifier(org.eclipse.uml2.uml.Class value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__TR_G__UML_CLASSIFIER, oldValue, value, -1));
    	        	
    	        	if(Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__TR_G__UML_CLASSIFIER.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__TR_G__UML_CLASSIFIER.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__TR_G__UML_CLASSIFIER.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void setCONTEXT__CORR__javaClassifierToUmlClassifier(Java2Uml.JavaClassifierToUmlClassifier value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__COR_R__JAVA_CLASSIFIER_TO_UML_CLASSIFIER, oldValue, value, -1));
    	        	
    	        	if(Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__COR_R__JAVA_CLASSIFIER_TO_UML_CLASSIFIER.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__COR_R__JAVA_CLASSIFIER_TO_UML_CLASSIFIER.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__COR_R__JAVA_CLASSIFIER_TO_UML_CLASSIFIER.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void eSet(EStructuralFeature eFeature, Object newValue){
    	...
    	if (Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__SR_C__JAVA_CONCRETE_CLASSIFIER.equals(eFeature)) {
    		setCONTEXT__SRC__javaConcreteClassifier((org.emftext.language.java.classifiers.Class) newValue); 
    		return;
    	}
    	if (Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CREAT_E__SR_C__MODIFIER.equals(eFeature)) {
    		setCREATE__SRC__modifier((org.emftext.language.java.modifiers.Abstract) newValue); 
    		return;
    	}
    	if (Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__TR_G__UML_CLASSIFIER.equals(eFeature)) {
    		setCONTEXT__TRG__umlClassifier((org.eclipse.uml2.uml.Class) newValue); 
    		return;
    	}
    	if (Java2UmlPackage.Literals.CLASS_ABSTRACT_TO_ABSTRACT___MARKER__CONTEX_T__COR_R__JAVA_CLASSIFIER_TO_UML_CLASSIFIER.equals(eFeature)) {
