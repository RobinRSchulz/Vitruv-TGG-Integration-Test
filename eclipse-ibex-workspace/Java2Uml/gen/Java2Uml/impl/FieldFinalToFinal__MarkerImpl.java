...
public class FieldFinalToFinal__MarkerImpl extends SmartObject implements Java2Uml.FieldFinalToFinal__Marker {
	...
	protected FieldFinalToFinal__MarkerImpl() {
		super(Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER);
	}
    ...
    public void setCONTEXT__SRC__javaField(org.emftext.language.java.members.Field value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__SR_C__JAVA_FIELD, oldValue, value, -1));
    	        	
    	        	if(Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__SR_C__JAVA_FIELD.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__SR_C__JAVA_FIELD.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__SR_C__JAVA_FIELD.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void setCREATE__SRC__modifier(org.emftext.language.java.modifiers.Final value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CREAT_E__SR_C__MODIFIER, oldValue, value, -1));
    	        	
    	        	if(Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CREAT_E__SR_C__MODIFIER.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CREAT_E__SR_C__MODIFIER.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CREAT_E__SR_C__MODIFIER.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void setCONTEXT__TRG__umlProperty(org.eclipse.uml2.uml.Property value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__TR_G__UML_PROPERTY, oldValue, value, -1));
    	        	
    	        	if(Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__TR_G__UML_PROPERTY.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__TR_G__UML_PROPERTY.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__TR_G__UML_PROPERTY.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void setCONTEXT__CORR__javaClassifierToUmlProperty(Java2Uml.JavaAttributeToUmlProperty value) {
    	...
    	if(value != null && value.equals(oldValue))
    		return;
    	        	...
    	        	sendNotification(SmartEMFNotification.createSetNotification(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__COR_R__JAVA_CLASSIFIER_TO_UML_PROPERTY, oldValue, value, -1));
    	        	
    	        	if(Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__COR_R__JAVA_CLASSIFIER_TO_UML_PROPERTY.getEOpposite() != null) {
    	        		if(oldValue != null) {
    	        			((SmartObject) oldValue).eInverseRemove(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__COR_R__JAVA_CLASSIFIER_TO_UML_PROPERTY.getEOpposite());
    	        		}
    	        		if(value != null) {
    	        		    ((SmartObject) value).eInverseAdd(this, Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__COR_R__JAVA_CLASSIFIER_TO_UML_PROPERTY.getEOpposite());
    	        		}
    	        	}
    }
    ...
    public void eSet(EStructuralFeature eFeature, Object newValue){
    	...
    	if (Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__SR_C__JAVA_FIELD.equals(eFeature)) {
    		setCONTEXT__SRC__javaField((org.emftext.language.java.members.Field) newValue); 
    		return;
    	}
    	if (Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CREAT_E__SR_C__MODIFIER.equals(eFeature)) {
    		setCREATE__SRC__modifier((org.emftext.language.java.modifiers.Final) newValue); 
    		return;
    	}
    	if (Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__TR_G__UML_PROPERTY.equals(eFeature)) {
    		setCONTEXT__TRG__umlProperty((org.eclipse.uml2.uml.Property) newValue); 
    		return;
    	}
    	if (Java2UmlPackage.Literals.FIELD_FINAL_TO_FINAL___MARKER__CONTEX_T__COR_R__JAVA_CLASSIFIER_TO_UML_PROPERTY.equals(eFeature)) {
