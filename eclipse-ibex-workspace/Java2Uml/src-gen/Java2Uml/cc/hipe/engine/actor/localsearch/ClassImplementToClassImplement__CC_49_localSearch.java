...
public class ClassImplementToClassImplement__CC_49_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassImplementToClassImplement__CC_production"), this::returnTrue  , false ));
	}
			...
			case "Class_object_SP0": 
				{
					...
					// javaClass
					HMatch match_0 = new LocalSearchMatch("ClassImplementToClassImplement__CC_49_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP5": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ClassImplementToClassImplement__CC_49_localSearch", 7);
			...
			case "Class_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_2 = new LocalSearchMatch("ClassImplementToClassImplement__CC_49_localSearch", 7);
			...
			case "Interface_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// interface
						HMatch match_3 = new LocalSearchMatch("ClassImplementToClassImplement__CC_49_localSearch", 7);
			...
			case "ClassifierReference_object_SP2": 
				{
					...
					// interfaceTypeRef
					HMatch match_4 = new LocalSearchMatch("ClassImplementToClassImplement__CC_49_localSearch", 7);
			...
			case "Interface_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_5 = new LocalSearchMatch("ClassImplementToClassImplement__CC_49_localSearch", 7);
			...
			case "InterfaceRealization_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ClassImplementToClassImplement__CC_49_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "ClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_41_localSearch": 
				{
				...
				break;
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_45_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_41_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassImplementToClassImplement__CC_49_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
					Object[] objs_0 = match.getNodes();
					acMatch_nodes_0[3] = objs_0[1];
					acMatch_nodes_0[4] = objs_0[0];
					start(nac_checker_orchestration, acMatch_0);
				}
				break;
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_45_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ClassImplementToClassImplement__CC_49_localSearch", 7);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
					Object[] objs_1 = match.getNodes();
					acMatch_nodes_1[5] = objs_1[1];
					acMatch_nodes_1[6] = objs_1[0];
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassImplementToClassImplement__CC_49_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
