...
public class VariableLengthConstructorParameterToParameter__CC_505_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((org.emftext.language.java.parameters.Parametrizable) o).getParameters().stream().filter(obj -> obj instanceof org.emftext.language.java.parameters.VariableLengthParameter).collect(Collectors.toList());
			...
			case "JavaConstructorToOperation_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_505_localSearch", 6);
			...
			case "Constructor_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_505_localSearch", 6);
			...
			case "Operation_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_505_localSearch", 6);
			...
			case "VariableLengthParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_3 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_505_localSearch", 6);
			...
			case "Parameter_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_4 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_505_localSearch", 6);
			...
			case "LiteralUnlimitedNatural_object": 
				{
					if(!lazy_initialization) {
						...
						// upperValue
						HMatch match_5 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_505_localSearch", 6);
		...
		case "Java2Uml.JavaConstructorToOperation_source_Constructor": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Constructor) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_505_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_62.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 0, "java.lang.String"));
		csp_62.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getLower(), "int"));
		csp_62.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_63.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, -1, "java.lang.String"));
		csp_63.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, upperValue.getValue(), "int"));
		csp_63.solve();
