...
public class ClassConstructorToConstructor__CC_30_localSearch extends GenericLocalSearchActor{
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "JavaClassifierToUmlClassifier_object_SP3": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("ClassConstructorToConstructor__CC_30_localSearch", 5);
			...
			case "Operation_object_SP0": 
				...
				break;
			case "ClassConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_27_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_27_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassConstructorToConstructor__CC_30_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_3.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, constructor.getName(), "java.lang.String"));
		csp_3.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_3.solve();
