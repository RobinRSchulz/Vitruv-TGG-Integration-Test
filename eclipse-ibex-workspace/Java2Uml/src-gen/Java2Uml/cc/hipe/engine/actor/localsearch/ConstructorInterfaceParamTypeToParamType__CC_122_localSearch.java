package Java2Uml.cc.hipe.engine.actor.localsearch;
...
public class ConstructorInterfaceParamTypeToParamType__CC_122_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11 = new CachedEdgeExplorer(this, 2, 7, edge_explorer_11_methods);
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12 = new EdgeExplorer(this, 7, 8, edge_explorer_12_methods);
			...
			case "Interface_1_object_SP2": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP2": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
			...
			case "JavaConstructorToOperation_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
			...
			case "Constructor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
			...
			case "Parameter_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
			...
			case "Interface_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
			...
			case "Operation_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
			...
			case "Parameter_1_object_SP2": 
				{
					...
					// umlParameter
					HMatch match_8 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
			...
			case "ClassifierReference_object_SP8": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_7_1_orchestration, match_9);
				}
				break;
			case "ConstructorInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_118_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ConstructorInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_118_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaParameterToParameter_source_Parameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.parameters.Parameter) {
				{
					...
					HMatch match = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
