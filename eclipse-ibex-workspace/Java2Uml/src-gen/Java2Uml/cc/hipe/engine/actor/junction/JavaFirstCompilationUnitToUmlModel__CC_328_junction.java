...
public class JavaFirstCompilationUnitToUmlModel__CC_328_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionLeft(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaFirstCompilationUnitToUmlModel__CC_326_junction"), this::returnTrue , 0  , false ));
	}
