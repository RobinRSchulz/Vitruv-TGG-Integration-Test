...
public class ExistingClassImplementToClassImplement__CC_200_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Implementor) o).getImplements().stream().filter(obj -> obj instanceof org.emftext.language.java.types.ClassifierReference).collect(Collectors.toList());
			...
			case "Interface_1_object_SP4": 
				{
					...
					// interface
					HMatch match_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
			...
			case "Class_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaClass
						HMatch match_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
					...
					HMatch match_3 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
			...
			case "Class_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_4 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
			...
			case "Interface_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_5 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
			...
			case "ClassifierReference_object_SP3": 
				{
					...
					// interfaceTypeRef
					HMatch match_6 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
			...
			case "InterfaceRealization_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_192_localSearch": 
				{
				...
				break;
			case "ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_196_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_192_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_196_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_200_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
