...
public class InterfaceAbstractToAbstract__CC_247_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP3": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceAbstractToAbstract__CC_247_localSearch", 4);
			...
			case "Interface_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceAbstractToAbstract__CC_247_localSearch", 4);
			...
			case "Interface_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceAbstractToAbstract__CC_247_localSearch", 4);
			...
			case "Abstract_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("InterfaceAbstractToAbstract__CC_247_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAbstractToAbstract__CC_247_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
