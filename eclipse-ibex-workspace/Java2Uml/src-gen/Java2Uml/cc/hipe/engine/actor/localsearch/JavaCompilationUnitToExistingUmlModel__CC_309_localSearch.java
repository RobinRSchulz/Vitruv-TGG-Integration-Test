...
public class JavaCompilationUnitToExistingUmlModel__CC_309_localSearch extends GenericLocalSearchActor{
			...
			case "CompilationUnit_object_SP1": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch", 5);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_2_orchestration, match_0);
					
					// newCompilationUnit
					HMatch match_4 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch", 5);
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch", 5);
			...
			case "Package_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch", 5);
			...
			case "Model_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlModel
						HMatch match_3 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch", 5);
		...
		case "Java2Uml.JavaCompilationUnitToUmlModel_source_CompilationUnit": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.containers.CompilationUnit) {
				{
					...
					HMatch match = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "UML_MODEL", "java.lang.String"));
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlModel.getName(), "java.lang.String"));
		csp_32.solve();
