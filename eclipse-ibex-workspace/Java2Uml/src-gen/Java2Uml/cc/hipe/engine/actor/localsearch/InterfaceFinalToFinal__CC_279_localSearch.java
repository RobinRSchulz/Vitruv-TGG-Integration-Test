...
public class InterfaceFinalToFinal__CC_279_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP7": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceFinalToFinal__CC_279_localSearch", 4);
			...
			case "Interface_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceFinalToFinal__CC_279_localSearch", 4);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceFinalToFinal__CC_279_localSearch", 4);
			...
			case "Final_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("InterfaceFinalToFinal__CC_279_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceFinalToFinal__CC_279_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
