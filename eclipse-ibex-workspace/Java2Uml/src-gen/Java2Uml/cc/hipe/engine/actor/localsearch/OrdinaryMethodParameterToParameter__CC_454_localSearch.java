...
public class OrdinaryMethodParameterToParameter__CC_454_localSearch extends GenericLocalSearchActor{
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CC_454_localSearch", 5);
			...
			case "ClassMethod_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CC_454_localSearch", 5);
			...
			case "Operation_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CC_454_localSearch", 5);
			...
			case "OrdinaryParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_3 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CC_454_localSearch", 5);
			...
			case "Parameter_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_4 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CC_454_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CC_454_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
