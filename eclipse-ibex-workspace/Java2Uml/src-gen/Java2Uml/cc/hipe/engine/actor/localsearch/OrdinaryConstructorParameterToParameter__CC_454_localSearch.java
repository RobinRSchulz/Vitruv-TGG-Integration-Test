...
public class OrdinaryConstructorParameterToParameter__CC_454_localSearch extends GenericLocalSearchActor{
			...
			case "JavaConstructorToOperation_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CC_454_localSearch", 5);
			...
			case "Constructor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CC_454_localSearch", 5);
			...
			case "Operation_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CC_454_localSearch", 5);
			...
			case "OrdinaryParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_3 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CC_454_localSearch", 5);
			...
			case "Parameter_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_4 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CC_454_localSearch", 5);
		...
		case "Java2Uml.JavaConstructorToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CC_454_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_57.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_57.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_57.solve();
