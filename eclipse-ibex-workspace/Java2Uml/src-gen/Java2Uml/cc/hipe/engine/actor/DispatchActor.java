package Java2Uml.cc.hipe.engine.actor;
...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAdd() {
		...
		type2addConsumer.put(org.emftext.language.java.members.MembersPackage.eINSTANCE.getClassMethod(), obj -> {
			...
			incUtil.newMessage();
			name2actor.get("ClassMethod_object_SP3").tell(new ObjectAdded<org.emftext.language.java.members.ClassMethod>(incUtil, _classmethod), getSelf());
		});
	...
	private void initializeSet() {
		...
		feature2setConsumer.put(org.emftext.language.java.commons.CommonsPackage.eINSTANCE.getNamedElement_Name(), notification -> {
			...
			if(notification.getNotifier() instanceof org.emftext.language.java.members.ClassMethod) {
				incUtil.newMessage();
				name2actor.get("ClassMethod_object_SP3").tell(new AttributeChanged<org.emftext.language.java.commons.NamedElement>(incUtil, (org.emftext.language.java.commons.NamedElement) notification.getNotifier(), notification.getOldValue()), getSelf());
			}
			if(notification.getNotifier() instanceof org.emftext.language.java.classifiers.Interface) {
				incUtil.newMessage();
	...
	private void initializeAddEdge() {
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaParameterToParameter_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<Java2Uml.JavaParameterToParameter, org.emftext.language.java.parameters.Parameter>(incUtil,(Java2Uml.JavaParameterToParameter) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "Java2Uml.JavaParameterToParameter_source_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<Java2Uml.JavaParameterToParameter, org.emftext.language.java.parameters.Parameter>(incUtil,(Java2Uml.JavaParameterToParameter) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "Java2Uml.JavaParameterToParameter_source_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<Java2Uml.JavaParameterToParameter, org.emftext.language.java.parameters.Parameter>(incUtil,(Java2Uml.JavaParameterToParameter) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "Java2Uml.JavaParameterToParameter_source_Parameter"), getSelf());
		});
		feature2addEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getGeneralization_General(), notification -> {
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_207_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_207_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass__CC_211_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_224_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_224_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_471_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_471_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass__CC_475_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_487_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_487_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_general_Classifier"), getSelf());
		});
		feature2addEdgeConsumer.put(org.emftext.language.java.containers.ContainersPackage.eINSTANCE.getPackage_CompilationUnits(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("EnumToUmlEnum__CC_179_localSearch").tell(new ReferenceAdded<org.emftext.language.java.containers.Package, org.emftext.language.java.containers.CompilationUnit>(incUtil,(org.emftext.language.java.containers.Package) notification.getNotifier(), (org.emftext.language.java.containers.CompilationUnit) notification.getNewValue(), "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceToUmlInterface__CC_302_localSearch").tell(new ReferenceAdded<org.emftext.language.java.containers.Package, org.emftext.language.java.containers.CompilationUnit>(incUtil,(org.emftext.language.java.containers.Package) notification.getNotifier(), (org.emftext.language.java.containers.CompilationUnit) notification.getNewValue(), "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit"), getSelf());
			incUtil.newMessage();
			name2actor.get("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch").tell(new ReferenceAdded<org.emftext.language.java.containers.Package, org.emftext.language.java.containers.CompilationUnit>(incUtil,(org.emftext.language.java.containers.Package) notification.getNotifier(), (org.emftext.language.java.containers.CompilationUnit) notification.getNewValue(), "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit"), getSelf());
			incUtil.newMessage();
			name2actor.get("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch").tell(new ReferenceAdded<org.emftext.language.java.containers.Package, org.emftext.language.java.containers.CompilationUnit>(incUtil,(org.emftext.language.java.containers.Package) notification.getNotifier(), (org.emftext.language.java.containers.CompilationUnit) notification.getNewValue(), "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getTypedElement_Type(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceAdded<uml.TypedElement, uml.Type>(incUtil,(uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getNewValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<uml.TypedElement, uml.Type>(incUtil,(uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getNewValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceAdded<uml.TypedElement, uml.Type>(incUtil,(uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getNewValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<uml.TypedElement, uml.Type>(incUtil,(uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getNewValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceAdded<uml.TypedElement, uml.Type>(incUtil,(uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getNewValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<uml.TypedElement, uml.Type>(incUtil,(uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getNewValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceAdded<uml.TypedElement, uml.Type>(incUtil,(uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getNewValue(), "uml.TypedElement_type_Type"), getSelf());
		});
		feature2addEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getClass_OwnedOperation(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("InterfaceConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_264_localSearch").tell(new ReferenceAdded<uml.Class, uml.Operation>(incUtil,(uml.Class) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "uml.Class_ownedOperation_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_278_localSearch").tell(new ReferenceAdded<uml.Class, uml.Operation>(incUtil,(uml.Class) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "uml.Class_ownedOperation_Operation"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaConstructorToOperation_Target(), notification -> {
			...
			name2actor.get("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch").tell(new ReferenceAdded<Java2Uml.JavaConstructorToOperation, uml.Operation>(incUtil,(Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaConstructorToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryConstructorParameterToParameter__CC_448_localSearch").tell(new ReferenceAdded<Java2Uml.JavaConstructorToOperation, uml.Operation>(incUtil,(Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaConstructorToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthConstructorParameterToParameter__CC_499_localSearch").tell(new ReferenceAdded<Java2Uml.JavaConstructorToOperation, uml.Operation>(incUtil,(Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaConstructorToOperation_target_Operation"), getSelf());
		});
		feature2addEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getBehavioralFeature_OwnedParameter(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<uml.BehavioralFeature, uml.Parameter>(incUtil,(uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceAdded<uml.BehavioralFeature, uml.Parameter>(incUtil,(uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<uml.BehavioralFeature, uml.Parameter>(incUtil,(uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceAdded<uml.BehavioralFeature, uml.Parameter>(incUtil,(uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<uml.BehavioralFeature, uml.Parameter>(incUtil,(uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceAdded<uml.BehavioralFeature, uml.Parameter>(incUtil,(uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryConstructorParameterToParameter__CC_448_localSearch").tell(new ReferenceAdded<uml.BehavioralFeature, uml.Parameter>(incUtil,(uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryMethodParameterToParameter__CC_454_localSearch").tell(new ReferenceAdded<uml.BehavioralFeature, uml.Parameter>(incUtil,(uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthConstructorParameterToParameter__CC_499_localSearch").tell(new ReferenceAdded<uml.BehavioralFeature, uml.Parameter>(incUtil,(uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthMethodParameterToParameter__CC_506_localSearch").tell(new ReferenceAdded<uml.BehavioralFeature, uml.Parameter>(incUtil,(uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
		});
		feature2addEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getBehavioredClassifier_InterfaceRealization(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement__CC_194_localSearch").tell(new ReferenceAdded<uml.BehavioredClassifier, uml.InterfaceRealization>(incUtil,(uml.BehavioredClassifier) notification.getNotifier(), (uml.InterfaceRealization) notification.getNewValue(), "uml.BehavioredClassifier_interfaceRealization_InterfaceRealization"), getSelf());
		});
		feature2addEdgeConsumer.put(org.emftext.language.java.modifiers.ModifiersPackage.eINSTANCE.getAnnotableAndModifiable_AnnotationsAndModifiers(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("EnumFinalToFinal__CC_159_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumPrivateToPrivate__CC_164_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumProtectedToProtected__CC_169_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumPublicToPublic__CC_174_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("FieldFinalToFinal__CC_237_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("FieldStaticToStatic__CC_242_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAbstractToAbstract__CC_247_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceFinalToFinal__CC_273_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePrivateToPrivate__CC_287_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceProtectedToProtected__CC_292_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePublicToPublic__CC_297_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodAbstractToAbstract__CC_349_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodFinalToFinal__CC_410_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodStaticToStatic__CC_443_localSearch").tell(new ReferenceAdded<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil,(org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getNewValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
		});
		feature2addEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getPackage_PackagedElement(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("EnumToUmlEnum__CC_179_localSearch").tell(new ReferenceAdded<uml.Package, uml.PackageableElement>(incUtil,(uml.Package) notification.getNotifier(), (uml.PackageableElement) notification.getNewValue(), "uml.Package_packagedElement_PackageableElement"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceToUmlInterface__CC_302_localSearch").tell(new ReferenceAdded<uml.Package, uml.PackageableElement>(incUtil,(uml.Package) notification.getNotifier(), (uml.PackageableElement) notification.getNewValue(), "uml.Package_packagedElement_PackageableElement"), getSelf());
		});
		feature2addEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getInterfaceRealization_Contract(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_190_localSearch").tell(new ReferenceAdded<uml.InterfaceRealization, uml.Interface>(incUtil,(uml.InterfaceRealization) notification.getNotifier(), (uml.Interface) notification.getNewValue(), "uml.InterfaceRealization_contract_Interface"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_190_localSearch").tell(new ReferenceAdded<uml.InterfaceRealization, uml.Interface>(incUtil,(uml.InterfaceRealization) notification.getNotifier(), (uml.Interface) notification.getNewValue(), "uml.InterfaceRealization_contract_Interface"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement__CC_194_localSearch").tell(new ReferenceAdded<uml.InterfaceRealization, uml.Interface>(incUtil,(uml.InterfaceRealization) notification.getNotifier(), (uml.Interface) notification.getNewValue(), "uml.InterfaceRealization_contract_Interface"), getSelf());
		});
		feature2addEdgeConsumer.put(org.emftext.language.java.types.TypesPackage.eINSTANCE.getTypedElement_TypeReference(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil,(org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getNewValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil,(org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getNewValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil,(org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getNewValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil,(org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getNewValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil,(org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getNewValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil,(org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getNewValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil,(org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getNewValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaMethodToOperation_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("MethodAbstractToAbstract__CC_349_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodFinalToFinal__CC_410_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodStaticToStatic__CC_443_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryMethodParameterToParameter__CC_454_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthMethodParameterToParameter__CC_506_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaMethodToOperation_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("MethodAbstractToAbstract__CC_349_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodFinalToFinal__CC_410_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodStaticToStatic__CC_443_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryMethodParameterToParameter__CC_454_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthMethodParameterToParameter__CC_506_localSearch").tell(new ReferenceAdded<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil,(Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaPackageToUmlPackage_Target(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("EnumToUmlEnum__CC_179_localSearch").tell(new ReferenceAdded<Java2Uml.JavaPackageToUmlPackage, uml.Package>(incUtil,(Java2Uml.JavaPackageToUmlPackage) notification.getNotifier(), (uml.Package) notification.getNewValue(), "Java2Uml.JavaPackageToUmlPackage_target_Package"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceToUmlInterface__CC_302_localSearch").tell(new ReferenceAdded<Java2Uml.JavaPackageToUmlPackage, uml.Package>(incUtil,(Java2Uml.JavaPackageToUmlPackage) notification.getNotifier(), (uml.Package) notification.getNewValue(), "Java2Uml.JavaPackageToUmlPackage_target_Package"), getSelf());
		});
		feature2addEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getType_Package(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("RootJavaPackageToUmlPackage_umlPackage_package_incoming_TRG__FILTER_NAC_TRG_460_localSearch").tell(new ReferenceAdded<uml.Type, uml.Package>(incUtil,(uml.Type) notification.getNotifier(), (uml.Package) notification.getNewValue(), "uml.Type_package_Package"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaConstructorToOperation_Source(), notification -> {
			...
			name2actor.get("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch").tell(new ReferenceAdded<Java2Uml.JavaConstructorToOperation, org.emftext.language.java.members.Constructor>(incUtil,(Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (org.emftext.language.java.members.Constructor) notification.getNewValue(), "Java2Uml.JavaConstructorToOperation_source_Constructor"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryConstructorParameterToParameter__CC_448_localSearch").tell(new ReferenceAdded<Java2Uml.JavaConstructorToOperation, org.emftext.language.java.members.Constructor>(incUtil,(Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (org.emftext.language.java.members.Constructor) notification.getNewValue(), "Java2Uml.JavaConstructorToOperation_source_Constructor"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthConstructorParameterToParameter__CC_499_localSearch").tell(new ReferenceAdded<Java2Uml.JavaConstructorToOperation, org.emftext.language.java.members.Constructor>(incUtil,(Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (org.emftext.language.java.members.Constructor) notification.getNewValue(), "Java2Uml.JavaConstructorToOperation_source_Constructor"), getSelf());
		});
		feature2addEdgeConsumer.put(org.emftext.language.java.parameters.ParametersPackage.eINSTANCE.getParametrizable_Parameters(), notification -> {
			...
			name2actor.get("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch").tell(new ReferenceAdded<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil,(org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil,(org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil,(org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil,(org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryConstructorParameterToParameter__CC_448_localSearch").tell(new ReferenceAdded<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil,(org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryMethodParameterToParameter__CC_454_localSearch").tell(new ReferenceAdded<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil,(org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthConstructorParameterToParameter__CC_499_localSearch").tell(new ReferenceAdded<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil,(org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthMethodParameterToParameter__CC_506_localSearch").tell(new ReferenceAdded<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil,(org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getNewValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaClassifierToUmlClassifier_Source(), notification -> {
			...
			name2actor.get("EnumAttributeTypeToPropertyType__CC_151_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumFinalToFinal__CC_159_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumPrivateToPrivate__CC_164_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumProtectedToProtected__CC_169_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			...
			name2actor.get("ExistingSuperClassToSuperClass__CC_211_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAbstractToAbstract__CC_247_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceConstructorToConstructor__CC_267_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceFinalToFinal__CC_273_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceMethodToMethod__CC_281_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePrivateToPrivate__CC_287_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceProtectedToProtected__CC_292_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePublicToPublic__CC_297_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass__CC_475_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
		});
		feature2addEdgeConsumer.put(org.emftext.language.java.classifiers.ClassifiersPackage.eINSTANCE.getImplementor_Implements(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement__CC_194_localSearch").tell(new ReferenceAdded<org.emftext.language.java.classifiers.Implementor, org.emftext.language.java.types.TypeReference>(incUtil,(org.emftext.language.java.classifiers.Implementor) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getNewValue(), "org.emftext.language.java.classifiers.Implementor_implements_TypeReference"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaClassifierToUmlClassifier_Target(), notification -> {
			...
			name2actor.get("EnumAttributeTypeToPropertyType__CC_151_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumFinalToFinal__CC_159_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumPrivateToPrivate__CC_164_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumProtectedToProtected__CC_169_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			...
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAbstractToAbstract__CC_247_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceConstructorToConstructor__CC_267_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceFinalToFinal__CC_273_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceMethodToMethod__CC_281_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePrivateToPrivate__CC_287_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceProtectedToProtected__CC_292_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePublicToPublic__CC_297_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass__CC_475_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceAdded<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil,(Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaAttributeToUmlProperty_Target(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("FieldFinalToFinal__CC_237_localSearch").tell(new ReferenceAdded<Java2Uml.JavaAttributeToUmlProperty, uml.Property>(incUtil,(Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (uml.Property) notification.getNewValue(), "Java2Uml.JavaAttributeToUmlProperty_target_Property"), getSelf());
			incUtil.newMessage();
			name2actor.get("FieldStaticToStatic__CC_242_localSearch").tell(new ReferenceAdded<Java2Uml.JavaAttributeToUmlProperty, uml.Property>(incUtil,(Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (uml.Property) notification.getNewValue(), "Java2Uml.JavaAttributeToUmlProperty_target_Property"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceAdded<Java2Uml.JavaAttributeToUmlProperty, uml.Property>(incUtil,(Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (uml.Property) notification.getNewValue(), "Java2Uml.JavaAttributeToUmlProperty_target_Property"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaAttributeToUmlProperty_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("FieldFinalToFinal__CC_237_localSearch").tell(new ReferenceAdded<Java2Uml.JavaAttributeToUmlProperty, org.emftext.language.java.members.Field>(incUtil,(Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (org.emftext.language.java.members.Field) notification.getNewValue(), "Java2Uml.JavaAttributeToUmlProperty_source_Field"), getSelf());
			incUtil.newMessage();
			name2actor.get("FieldStaticToStatic__CC_242_localSearch").tell(new ReferenceAdded<Java2Uml.JavaAttributeToUmlProperty, org.emftext.language.java.members.Field>(incUtil,(Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (org.emftext.language.java.members.Field) notification.getNewValue(), "Java2Uml.JavaAttributeToUmlProperty_source_Field"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceAdded<Java2Uml.JavaAttributeToUmlProperty, org.emftext.language.java.members.Field>(incUtil,(Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (org.emftext.language.java.members.Field) notification.getNewValue(), "Java2Uml.JavaAttributeToUmlProperty_source_Field"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(org.emftext.language.java.members.MembersPackage.eINSTANCE.getMemberContainer_Members(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("InterfaceConstructorToConstructor__CC_267_localSearch").tell(new ReferenceAdded<org.emftext.language.java.members.MemberContainer, org.emftext.language.java.members.Member>(incUtil,(org.emftext.language.java.members.MemberContainer) notification.getNotifier(), (org.emftext.language.java.members.Member) notification.getNewValue(), "org.emftext.language.java.members.MemberContainer_members_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceMethodToMethod__CC_281_localSearch").tell(new ReferenceAdded<org.emftext.language.java.members.MemberContainer, org.emftext.language.java.members.Member>(incUtil,(org.emftext.language.java.members.MemberContainer) notification.getNotifier(), (org.emftext.language.java.members.Member) notification.getNewValue(), "org.emftext.language.java.members.MemberContainer_members_Member"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaCompilationUnitToUmlModel_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch").tell(new ReferenceAdded<Java2Uml.JavaCompilationUnitToUmlModel, org.emftext.language.java.containers.CompilationUnit>(incUtil,(Java2Uml.JavaCompilationUnitToUmlModel) notification.getNotifier(), (org.emftext.language.java.containers.CompilationUnit) notification.getNewValue(), "Java2Uml.JavaCompilationUnitToUmlModel_source_CompilationUnit"), getSelf());
		});
		feature2addEdgeConsumer.put(org.emftext.language.java.containers.ContainersPackage.eINSTANCE.getCompilationUnit_Classifiers(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("EnumToUmlEnum__CC_179_localSearch").tell(new ReferenceAdded<org.emftext.language.java.containers.CompilationUnit, org.emftext.language.java.classifiers.ConcreteClassifier>(incUtil,(org.emftext.language.java.containers.CompilationUnit) notification.getNotifier(), (org.emftext.language.java.classifiers.ConcreteClassifier) notification.getNewValue(), "org.emftext.language.java.containers.CompilationUnit_classifiers_ConcreteClassifier"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getInterface_OwnedOperation(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("InterfaceConstructorToConstructor__CC_267_localSearch").tell(new ReferenceAdded<uml.Interface, uml.Operation>(incUtil,(uml.Interface) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "uml.Interface_ownedOperation_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceMethodToMethod__CC_281_localSearch").tell(new ReferenceAdded<uml.Interface, uml.Operation>(incUtil,(uml.Interface) notification.getNotifier(), (uml.Operation) notification.getNewValue(), "uml.Interface_ownedOperation_Operation"), getSelf());
		});
		feature2addEdgeConsumer.put(org.emftext.language.java.types.TypesPackage.eINSTANCE.getClassifierReference_Target(), notification -> {
			...
			name2actor.get("EnumAttributeTypeToPropertyType__CC_151_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_186_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_186_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement__CC_194_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_203_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_203_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass__CC_211_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_220_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_220_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_252_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_252_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_354_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_354_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_369_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_369_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_382_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_382_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_397_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_397_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_415_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_415_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_430_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_430_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_467_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_467_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass__CC_475_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_483_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_483_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceAdded<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil,(org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getNewValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaParameterToParameter_Target(), notification -> {
			...
			name2actor.get("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch").tell(new ReferenceAdded<Java2Uml.JavaParameterToParameter, uml.Parameter>(incUtil,(Java2Uml.JavaParameterToParameter) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "Java2Uml.JavaParameterToParameter_target_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceAdded<Java2Uml.JavaParameterToParameter, uml.Parameter>(incUtil,(Java2Uml.JavaParameterToParameter) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "Java2Uml.JavaParameterToParameter_target_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceAdded<Java2Uml.JavaParameterToParameter, uml.Parameter>(incUtil,(Java2Uml.JavaParameterToParameter) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "Java2Uml.JavaParameterToParameter_target_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceAdded<Java2Uml.JavaParameterToParameter, uml.Parameter>(incUtil,(Java2Uml.JavaParameterToParameter) notification.getNotifier(), (uml.Parameter) notification.getNewValue(), "Java2Uml.JavaParameterToParameter_target_Parameter"), getSelf());
		});
		feature2addEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getGeneralization_Specific(), notification -> {
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass__CC_211_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_specific_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_specific_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass__CC_475_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_specific_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceAdded<uml.Generalization, uml.Classifier>(incUtil,(uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getNewValue(), "uml.Generalization_specific_Classifier"), getSelf());
		});
		...
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaCompilationUnitToUmlModel_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch").tell(new ReferenceAdded<Java2Uml.JavaCompilationUnitToUmlModel, uml.Model>(incUtil,(Java2Uml.JavaCompilationUnitToUmlModel) notification.getNotifier(), (uml.Model) notification.getNewValue(), "Java2Uml.JavaCompilationUnitToUmlModel_target_Model"), getSelf());
		});
		feature2addEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaPackageToUmlPackage_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("EnumToUmlEnum__CC_179_localSearch").tell(new ReferenceAdded<Java2Uml.JavaPackageToUmlPackage, org.emftext.language.java.containers.Package>(incUtil,(Java2Uml.JavaPackageToUmlPackage) notification.getNotifier(), (org.emftext.language.java.containers.Package) notification.getNewValue(), "Java2Uml.JavaPackageToUmlPackage_source_Package"), getSelf());
			incUtil.newMessage();
		...
		feature2addEdgeConsumer.put(org.emftext.language.java.classifiers.ClassifiersPackage.eINSTANCE.getInterface_Extends(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceAdded<org.emftext.language.java.classifiers.Interface, org.emftext.language.java.types.TypeReference>(incUtil,(org.emftext.language.java.classifiers.Interface) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getNewValue(), "org.emftext.language.java.classifiers.Interface_extends_TypeReference"), getSelf());
		});
	}
	...
	private void initializeRemoveEdge() {
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaParameterToParameter_Source(), notification -> {
			...
			name2actor.get("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaParameterToParameter, org.emftext.language.java.parameters.Parameter>(incUtil, (Java2Uml.JavaParameterToParameter) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getOldValue(), "Java2Uml.JavaParameterToParameter_source_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaParameterToParameter, org.emftext.language.java.parameters.Parameter>(incUtil, (Java2Uml.JavaParameterToParameter) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getOldValue(), "Java2Uml.JavaParameterToParameter_source_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaParameterToParameter, org.emftext.language.java.parameters.Parameter>(incUtil, (Java2Uml.JavaParameterToParameter) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getOldValue(), "Java2Uml.JavaParameterToParameter_source_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaParameterToParameter, org.emftext.language.java.parameters.Parameter>(incUtil, (Java2Uml.JavaParameterToParameter) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getOldValue(), "Java2Uml.JavaParameterToParameter_source_Parameter"), getSelf());
		});
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getGeneralization_General(), notification -> {
			...
			name2actor.get("ExistingSuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_207_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass__CC_211_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_224_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_224_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_471_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_471_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass__CC_475_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_487_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_487_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_general_Classifier"), getSelf());
		});
		feature2removeEdgeConsumer.put(org.emftext.language.java.containers.ContainersPackage.eINSTANCE.getPackage_CompilationUnits(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("EnumToUmlEnum__CC_179_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.containers.Package, org.emftext.language.java.containers.CompilationUnit>(incUtil, (org.emftext.language.java.containers.Package) notification.getNotifier(), (org.emftext.language.java.containers.CompilationUnit) notification.getOldValue(), "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceToUmlInterface__CC_302_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.containers.Package, org.emftext.language.java.containers.CompilationUnit>(incUtil, (org.emftext.language.java.containers.Package) notification.getNotifier(), (org.emftext.language.java.containers.CompilationUnit) notification.getOldValue(), "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit"), getSelf());
			incUtil.newMessage();
			name2actor.get("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.containers.Package, org.emftext.language.java.containers.CompilationUnit>(incUtil, (org.emftext.language.java.containers.Package) notification.getNotifier(), (org.emftext.language.java.containers.CompilationUnit) notification.getOldValue(), "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit"), getSelf());
			incUtil.newMessage();
			name2actor.get("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.containers.Package, org.emftext.language.java.containers.CompilationUnit>(incUtil, (org.emftext.language.java.containers.Package) notification.getNotifier(), (org.emftext.language.java.containers.CompilationUnit) notification.getOldValue(), "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getMultiplicityElement_UpperValue(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("VariableLengthMethodParameterToParameter__CC_506_localSearch").tell(new ReferenceDeleted<uml.MultiplicityElement, uml.ValueSpecification>(incUtil, (uml.MultiplicityElement) notification.getNotifier(), (uml.ValueSpecification) notification.getOldValue(), "uml.MultiplicityElement_upperValue_ValueSpecification"), getSelf());
		});
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getTypedElement_Type(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceDeleted<uml.TypedElement, uml.Type>(incUtil, (uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getOldValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceDeleted<uml.TypedElement, uml.Type>(incUtil, (uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getOldValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceDeleted<uml.TypedElement, uml.Type>(incUtil, (uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getOldValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceDeleted<uml.TypedElement, uml.Type>(incUtil, (uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getOldValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceDeleted<uml.TypedElement, uml.Type>(incUtil, (uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getOldValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<uml.TypedElement, uml.Type>(incUtil, (uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getOldValue(), "uml.TypedElement_type_Type"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceDeleted<uml.TypedElement, uml.Type>(incUtil, (uml.TypedElement) notification.getNotifier(), (uml.Type) notification.getOldValue(), "uml.TypedElement_type_Type"), getSelf());
		});
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getClass_OwnedOperation(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("InterfaceConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_264_localSearch").tell(new ReferenceDeleted<uml.Class, uml.Operation>(incUtil, (uml.Class) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "uml.Class_ownedOperation_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_278_localSearch").tell(new ReferenceDeleted<uml.Class, uml.Operation>(incUtil, (uml.Class) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "uml.Class_ownedOperation_Operation"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaConstructorToOperation_Target(), notification -> {
			...
			name2actor.get("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaConstructorToOperation, uml.Operation>(incUtil, (Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaConstructorToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryConstructorParameterToParameter__CC_448_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaConstructorToOperation, uml.Operation>(incUtil, (Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaConstructorToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthConstructorParameterToParameter__CC_499_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaConstructorToOperation, uml.Operation>(incUtil, (Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaConstructorToOperation_target_Operation"), getSelf());
		});
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getBehavioralFeature_OwnedParameter(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceDeleted<uml.BehavioralFeature, uml.Parameter>(incUtil, (uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceDeleted<uml.BehavioralFeature, uml.Parameter>(incUtil, (uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceDeleted<uml.BehavioralFeature, uml.Parameter>(incUtil, (uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceDeleted<uml.BehavioralFeature, uml.Parameter>(incUtil, (uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<uml.BehavioralFeature, uml.Parameter>(incUtil, (uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceDeleted<uml.BehavioralFeature, uml.Parameter>(incUtil, (uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryConstructorParameterToParameter__CC_448_localSearch").tell(new ReferenceDeleted<uml.BehavioralFeature, uml.Parameter>(incUtil, (uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryMethodParameterToParameter__CC_454_localSearch").tell(new ReferenceDeleted<uml.BehavioralFeature, uml.Parameter>(incUtil, (uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthConstructorParameterToParameter__CC_499_localSearch").tell(new ReferenceDeleted<uml.BehavioralFeature, uml.Parameter>(incUtil, (uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthMethodParameterToParameter__CC_506_localSearch").tell(new ReferenceDeleted<uml.BehavioralFeature, uml.Parameter>(incUtil, (uml.BehavioralFeature) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "uml.BehavioralFeature_ownedParameter_Parameter"), getSelf());
		});
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getBehavioredClassifier_InterfaceRealization(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement__CC_194_localSearch").tell(new ReferenceDeleted<uml.BehavioredClassifier, uml.InterfaceRealization>(incUtil, (uml.BehavioredClassifier) notification.getNotifier(), (uml.InterfaceRealization) notification.getOldValue(), "uml.BehavioredClassifier_interfaceRealization_InterfaceRealization"), getSelf());
		});
		feature2removeEdgeConsumer.put(org.emftext.language.java.modifiers.ModifiersPackage.eINSTANCE.getAnnotableAndModifiable_AnnotationsAndModifiers(), notification -> {
			...
			name2actor.get("EnumAbstractToAbstract__CC_133_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumFinalToFinal__CC_159_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumPrivateToPrivate__CC_164_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumProtectedToProtected__CC_169_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			...
			name2actor.get("EnumPublicToPublic__CC_174_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("FieldFinalToFinal__CC_237_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("FieldStaticToStatic__CC_242_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAbstractToAbstract__CC_247_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceFinalToFinal__CC_273_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePrivateToPrivate__CC_287_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceProtectedToProtected__CC_292_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePublicToPublic__CC_297_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodAbstractToAbstract__CC_349_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodFinalToFinal__CC_410_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodStaticToStatic__CC_443_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.modifiers.AnnotableAndModifiable, org.emftext.language.java.modifiers.AnnotationInstanceOrModifier>(incUtil, (org.emftext.language.java.modifiers.AnnotableAndModifiable) notification.getNotifier(), (org.emftext.language.java.modifiers.AnnotationInstanceOrModifier) notification.getOldValue(), "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier"), getSelf());
		...
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getPackage_PackagedElement(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("EnumToUmlEnum__CC_179_localSearch").tell(new ReferenceDeleted<uml.Package, uml.PackageableElement>(incUtil, (uml.Package) notification.getNotifier(), (uml.PackageableElement) notification.getOldValue(), "uml.Package_packagedElement_PackageableElement"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceToUmlInterface__CC_302_localSearch").tell(new ReferenceDeleted<uml.Package, uml.PackageableElement>(incUtil, (uml.Package) notification.getNotifier(), (uml.PackageableElement) notification.getOldValue(), "uml.Package_packagedElement_PackageableElement"), getSelf());
		});
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getInterfaceRealization_Contract(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_190_localSearch").tell(new ReferenceDeleted<uml.InterfaceRealization, uml.Interface>(incUtil, (uml.InterfaceRealization) notification.getNotifier(), (uml.Interface) notification.getOldValue(), "uml.InterfaceRealization_contract_Interface"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_190_localSearch").tell(new ReferenceDeleted<uml.InterfaceRealization, uml.Interface>(incUtil, (uml.InterfaceRealization) notification.getNotifier(), (uml.Interface) notification.getOldValue(), "uml.InterfaceRealization_contract_Interface"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingClassImplementToClassImplement__CC_194_localSearch").tell(new ReferenceDeleted<uml.InterfaceRealization, uml.Interface>(incUtil, (uml.InterfaceRealization) notification.getNotifier(), (uml.Interface) notification.getOldValue(), "uml.InterfaceRealization_contract_Interface"), getSelf());
		});
		feature2removeEdgeConsumer.put(org.emftext.language.java.types.TypesPackage.eINSTANCE.getTypedElement_TypeReference(), notification -> {
			...
			name2actor.get("EnumAttributeTypeToPropertyType__CC_151_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil, (org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getOldValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil, (org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getOldValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil, (org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getOldValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil, (org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getOldValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil, (org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getOldValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil, (org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getOldValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil, (org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getOldValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.TypedElement, org.emftext.language.java.types.TypeReference>(incUtil, (org.emftext.language.java.types.TypedElement) notification.getNotifier(), (org.emftext.language.java.types.TypeReference) notification.getOldValue(), "org.emftext.language.java.types.TypedElement_typeReference_TypeReference"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaMethodToOperation_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("MethodAbstractToAbstract__CC_349_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodFinalToFinal__CC_410_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodStaticToStatic__CC_443_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryMethodParameterToParameter__CC_454_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthMethodParameterToParameter__CC_506_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, org.emftext.language.java.members.Method>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (org.emftext.language.java.members.Method) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_source_Method"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaMethodToOperation_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("MethodAbstractToAbstract__CC_349_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodFinalToFinal__CC_410_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			...
			incUtil.newMessage();
			name2actor.get("MethodStaticToStatic__CC_443_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryMethodParameterToParameter__CC_454_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthMethodParameterToParameter__CC_506_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaMethodToOperation, uml.Operation>(incUtil, (Java2Uml.JavaMethodToOperation) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "Java2Uml.JavaMethodToOperation_target_Operation"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaPackageToUmlPackage_Target(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("EnumToUmlEnum__CC_179_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaPackageToUmlPackage, uml.Package>(incUtil, (Java2Uml.JavaPackageToUmlPackage) notification.getNotifier(), (uml.Package) notification.getOldValue(), "Java2Uml.JavaPackageToUmlPackage_target_Package"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceToUmlInterface__CC_302_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaPackageToUmlPackage, uml.Package>(incUtil, (Java2Uml.JavaPackageToUmlPackage) notification.getNotifier(), (uml.Package) notification.getOldValue(), "Java2Uml.JavaPackageToUmlPackage_target_Package"), getSelf());
		});
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getType_Package(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("RootJavaPackageToUmlPackage_umlPackage_package_incoming_TRG__FILTER_NAC_TRG_460_localSearch").tell(new ReferenceDeleted<uml.Type, uml.Package>(incUtil, (uml.Type) notification.getNotifier(), (uml.Package) notification.getOldValue(), "uml.Type_package_Package"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaConstructorToOperation_Source(), notification -> {
			...
			name2actor.get("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaConstructorToOperation, org.emftext.language.java.members.Constructor>(incUtil, (Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (org.emftext.language.java.members.Constructor) notification.getOldValue(), "Java2Uml.JavaConstructorToOperation_source_Constructor"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryConstructorParameterToParameter__CC_448_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaConstructorToOperation, org.emftext.language.java.members.Constructor>(incUtil, (Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (org.emftext.language.java.members.Constructor) notification.getOldValue(), "Java2Uml.JavaConstructorToOperation_source_Constructor"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthConstructorParameterToParameter__CC_499_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaConstructorToOperation, org.emftext.language.java.members.Constructor>(incUtil, (Java2Uml.JavaConstructorToOperation) notification.getNotifier(), (org.emftext.language.java.members.Constructor) notification.getOldValue(), "Java2Uml.JavaConstructorToOperation_source_Constructor"), getSelf());
		});
		feature2removeEdgeConsumer.put(org.emftext.language.java.parameters.ParametersPackage.eINSTANCE.getParametrizable_Parameters(), notification -> {
			...
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil, (org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getOldValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryConstructorParameterToParameter__CC_448_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil, (org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getOldValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("OrdinaryMethodParameterToParameter__CC_454_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil, (org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getOldValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthConstructorParameterToParameter__CC_499_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil, (org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getOldValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("VariableLengthMethodParameterToParameter__CC_506_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.parameters.Parametrizable, org.emftext.language.java.parameters.Parameter>(incUtil, (org.emftext.language.java.parameters.Parametrizable) notification.getNotifier(), (org.emftext.language.java.parameters.Parameter) notification.getOldValue(), "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaClassifierToUmlClassifier_Source(), notification -> {
			...
			name2actor.get("EnumAttributeTypeToPropertyType__CC_151_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumFinalToFinal__CC_159_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumPrivateToPrivate__CC_164_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumProtectedToProtected__CC_169_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			...
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAbstractToAbstract__CC_247_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceConstructorToConstructor__CC_267_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceFinalToFinal__CC_273_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceMethodToMethod__CC_281_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePrivateToPrivate__CC_287_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceProtectedToProtected__CC_292_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePublicToPublic__CC_297_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass__CC_475_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, org.emftext.language.java.classifiers.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaClassifierToUmlClassifier_Target(), notification -> {
			...
			name2actor.get("EnumAttributeTypeToPropertyType__CC_151_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumFinalToFinal__CC_159_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumPrivateToPrivate__CC_164_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("EnumProtectedToProtected__CC_169_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			...
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAbstractToAbstract__CC_247_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceConstructorToConstructor__CC_267_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceFinalToFinal__CC_273_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceMethodToMethod__CC_281_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePrivateToPrivate__CC_287_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceProtectedToProtected__CC_292_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfacePublicToPublic__CC_297_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassReturnTypeToReturnType__CC_373_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumReturnTypeToReturnType__CC_401_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass__CC_475_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaClassifierToUmlClassifier, uml.Classifier>(incUtil, (Java2Uml.JavaClassifierToUmlClassifier) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaAttributeToUmlProperty_Target(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("FieldFinalToFinal__CC_237_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaAttributeToUmlProperty, uml.Property>(incUtil, (Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (uml.Property) notification.getOldValue(), "Java2Uml.JavaAttributeToUmlProperty_target_Property"), getSelf());
			incUtil.newMessage();
			name2actor.get("FieldStaticToStatic__CC_242_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaAttributeToUmlProperty, uml.Property>(incUtil, (Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (uml.Property) notification.getOldValue(), "Java2Uml.JavaAttributeToUmlProperty_target_Property"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaAttributeToUmlProperty, uml.Property>(incUtil, (Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (uml.Property) notification.getOldValue(), "Java2Uml.JavaAttributeToUmlProperty_target_Property"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaAttributeToUmlProperty_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("FieldFinalToFinal__CC_237_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaAttributeToUmlProperty, org.emftext.language.java.members.Field>(incUtil, (Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (org.emftext.language.java.members.Field) notification.getOldValue(), "Java2Uml.JavaAttributeToUmlProperty_source_Field"), getSelf());
			incUtil.newMessage();
			name2actor.get("FieldStaticToStatic__CC_242_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaAttributeToUmlProperty, org.emftext.language.java.members.Field>(incUtil, (Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (org.emftext.language.java.members.Field) notification.getOldValue(), "Java2Uml.JavaAttributeToUmlProperty_source_Field"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaAttributeToUmlProperty, org.emftext.language.java.members.Field>(incUtil, (Java2Uml.JavaAttributeToUmlProperty) notification.getNotifier(), (org.emftext.language.java.members.Field) notification.getOldValue(), "Java2Uml.JavaAttributeToUmlProperty_source_Field"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(org.emftext.language.java.members.MembersPackage.eINSTANCE.getMemberContainer_Members(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("InterfaceConstructorToConstructor__CC_267_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.members.MemberContainer, org.emftext.language.java.members.Member>(incUtil, (org.emftext.language.java.members.MemberContainer) notification.getNotifier(), (org.emftext.language.java.members.Member) notification.getOldValue(), "org.emftext.language.java.members.MemberContainer_members_Member"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceMethodToMethod__CC_281_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.members.MemberContainer, org.emftext.language.java.members.Member>(incUtil, (org.emftext.language.java.members.MemberContainer) notification.getNotifier(), (org.emftext.language.java.members.Member) notification.getOldValue(), "org.emftext.language.java.members.MemberContainer_members_Member"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaCompilationUnitToUmlModel_Source(), notification -> {
			incUtil.newMessage();
			name2actor.get("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaCompilationUnitToUmlModel, org.emftext.language.java.containers.CompilationUnit>(incUtil, (Java2Uml.JavaCompilationUnitToUmlModel) notification.getNotifier(), (org.emftext.language.java.containers.CompilationUnit) notification.getOldValue(), "Java2Uml.JavaCompilationUnitToUmlModel_source_CompilationUnit"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getInterface_OwnedOperation(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("InterfaceConstructorToConstructor__CC_267_localSearch").tell(new ReferenceDeleted<uml.Interface, uml.Operation>(incUtil, (uml.Interface) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "uml.Interface_ownedOperation_Operation"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceMethodToMethod__CC_281_localSearch").tell(new ReferenceDeleted<uml.Interface, uml.Operation>(incUtil, (uml.Interface) notification.getNotifier(), (uml.Operation) notification.getOldValue(), "uml.Interface_ownedOperation_Operation"), getSelf());
		});
		feature2removeEdgeConsumer.put(org.emftext.language.java.types.TypesPackage.eINSTANCE.getClassifierReference_Target(), notification -> {
			...
			name2actor.get("ExistingClassImplementToClassImplement__CC_194_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_203_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_203_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass__CC_211_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			...
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_252_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_252_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("InterfaceAttributeTypeToPropertyType__CC_256_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			...
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_430_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_430_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			...
			name2actor.get("SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_483_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceDeleted<org.emftext.language.java.types.ClassifierReference, org.emftext.language.java.classifiers.Classifier>(incUtil, (org.emftext.language.java.types.ClassifierReference) notification.getNotifier(), (org.emftext.language.java.classifiers.Classifier) notification.getOldValue(), "org.emftext.language.java.types.ClassifierReference_target_Classifier"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaParameterToParameter_Target(), notification -> {
			...
			name2actor.get("ConstructorInterfaceParamTypeToParamType__CC_122_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaParameterToParameter, uml.Parameter>(incUtil, (Java2Uml.JavaParameterToParameter) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "Java2Uml.JavaParameterToParameter_target_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodClassParamTypeToParamType__CC_358_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaParameterToParameter, uml.Parameter>(incUtil, (Java2Uml.JavaParameterToParameter) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "Java2Uml.JavaParameterToParameter_target_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodEnumParamTypeToParamType__CC_386_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaParameterToParameter, uml.Parameter>(incUtil, (Java2Uml.JavaParameterToParameter) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "Java2Uml.JavaParameterToParameter_target_Parameter"), getSelf());
			incUtil.newMessage();
			name2actor.get("MethodInterfaceParamTypeToParamType__CC_419_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaParameterToParameter, uml.Parameter>(incUtil, (Java2Uml.JavaParameterToParameter) notification.getNotifier(), (uml.Parameter) notification.getOldValue(), "Java2Uml.JavaParameterToParameter_target_Parameter"), getSelf());
		});
		feature2removeEdgeConsumer.put(uml.UmlPackage.eINSTANCE.getGeneralization_Specific(), notification -> {
			incUtil.newMessage();
			name2actor.get("ExistingSuperClassToSuperClass__CC_211_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_specific_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_228_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_specific_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperClassToSuperClass__CC_475_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_specific_Classifier"), getSelf());
			incUtil.newMessage();
			name2actor.get("SuperInterfaceToSuperInterface__CC_491_localSearch").tell(new ReferenceDeleted<uml.Generalization, uml.Classifier>(incUtil, (uml.Generalization) notification.getNotifier(), (uml.Classifier) notification.getOldValue(), "uml.Generalization_specific_Classifier"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaCompilationUnitToUmlModel_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("JavaCompilationUnitToExistingUmlModel__CC_309_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaCompilationUnitToUmlModel, uml.Model>(incUtil, (Java2Uml.JavaCompilationUnitToUmlModel) notification.getNotifier(), (uml.Model) notification.getOldValue(), "Java2Uml.JavaCompilationUnitToUmlModel_target_Model"), getSelf());
		});
		feature2removeEdgeConsumer.put(Java2Uml.Java2UmlPackage.eINSTANCE.getJavaPackageToUmlPackage_Source(), notification -> {
			...
			incUtil.newMessage();
			name2actor.get("EnumToUmlEnum__CC_179_localSearch").tell(new ReferenceDeleted<Java2Uml.JavaPackageToUmlPackage, org.emftext.language.java.containers.Package>(incUtil, (Java2Uml.JavaPackageToUmlPackage) notification.getNotifier(), (org.emftext.language.java.containers.Package) notification.getOldValue(), "Java2Uml.JavaPackageToUmlPackage_source_Package"), getSelf());
			incUtil.newMessage();
