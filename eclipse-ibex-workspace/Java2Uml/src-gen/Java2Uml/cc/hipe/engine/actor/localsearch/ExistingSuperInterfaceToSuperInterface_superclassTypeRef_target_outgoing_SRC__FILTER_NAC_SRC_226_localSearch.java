...
public class ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_226_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ExistingSuperInterfaceToSuperInterface__CC_234_localSearch"), this::returnTrue  , false ));
			...
			case "ClassifierReference_object_SP8": 
				{
					...
					// superclassTypeRef
					HMatch match_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_226_localSearch", 3);
			...
			case "Interface_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// superclassifier
						HMatch match_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_226_localSearch", 3);
			...
			case "Classifier_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// FILTER_NAC_NODE
						HMatch match_2 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_226_localSearch", 3);
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_226_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
