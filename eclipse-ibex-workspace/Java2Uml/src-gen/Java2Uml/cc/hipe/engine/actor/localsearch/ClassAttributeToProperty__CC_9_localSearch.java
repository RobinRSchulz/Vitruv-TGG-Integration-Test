...
public class ClassAttributeToProperty__CC_9_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassAttributeToProperty__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					// classToUmlClass
					HMatch match_0 = new LocalSearchMatch("ClassAttributeToProperty__CC_9_localSearch", 5);
			...
			case "Class_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("ClassAttributeToProperty__CC_9_localSearch", 5);
			...
			case "Class_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassAttributeToProperty__CC_9_localSearch", 5);
			...
			case "Field_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_3 = new LocalSearchMatch("ClassAttributeToProperty__CC_9_localSearch", 5);
			...
			case "Property_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_4 = new LocalSearchMatch("ClassAttributeToProperty__CC_9_localSearch", 5);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_3_1_orchestration, match_4);
					}
				}
				break;
			case "ClassAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_6_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_6_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassAttributeToProperty__CC_9_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassAttributeToProperty__CC_9_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
