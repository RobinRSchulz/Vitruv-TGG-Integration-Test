...
public class ExistingSuperClassToSuperClass__CC_217_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP2": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
					...
					HMatch match_2 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
			...
			case "Class_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_1_orchestration, match_1);
						
						// superclassifier
						HMatch match_3 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
			...
			case "Class_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_4_1_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
			...
			case "ClassifierReference_object_SP5": 
				{
					...
					// superclassTypeRef
					HMatch match_6 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
			...
			case "Generalization_object_SP0": 
				{
					...
					// generalization
					HMatch match_7 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_6_1_orchestration, match_7);
				}
				break;
			case "ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_209_localSearch": 
				{
				...
				break;
			case "ExistingSuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_213_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_209_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ExistingSuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_213_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.classifiers.Class_extends_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("ExistingSuperClassToSuperClass__CC_217_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
