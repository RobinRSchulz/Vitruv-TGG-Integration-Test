...
public class EnumAttributeTypeToPropertyType__CC_151_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumAttributeTypeToPropertyType__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaAttributeToUmlProperty_object_SP1": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CC_151_localSearch", 7);
			...
			case "Enumeration_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CC_151_localSearch", 7);
			...
			case "Field_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_2 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CC_151_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP5": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CC_151_localSearch", 7);
			...
			case "Property_object_SP2": 
				{
					...
					// property
					HMatch match_4 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CC_151_localSearch", 7);
			...
			case "Enumeration_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CC_151_localSearch", 7);
			...
			case "ClassifierReference_object_SP1": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CC_151_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_4_1_orchestration, match_6);
				}
				break;
			case "EnumAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_147_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "EnumAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_147_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CC_151_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaAttributeToUmlProperty_target_Property": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Property) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CC_151_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_15.solve();
