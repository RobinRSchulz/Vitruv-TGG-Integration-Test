...
public class ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_203_localSearch extends GenericLocalSearchActor{
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// superclassTypeRef
					HMatch match_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_203_localSearch", 3);
			...
			case "Class_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// superclassifier
						HMatch match_1 = new LocalSearchMatch("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_203_localSearch", 3);
			...
			case "Classifier_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// FILTER_NAC_NODE
						HMatch match_2 = new LocalSearchMatch("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_203_localSearch", 3);
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_203_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
