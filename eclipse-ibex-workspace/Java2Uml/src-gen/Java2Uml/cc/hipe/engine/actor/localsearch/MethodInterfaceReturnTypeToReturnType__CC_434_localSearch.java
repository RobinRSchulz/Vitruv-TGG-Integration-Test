...
public class MethodInterfaceReturnTypeToReturnType__CC_434_localSearch extends GenericLocalSearchActor{
			...
			case "Interface_1_object_SP2": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch", 8);
			...
			case "ClassMethod_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch", 8);
			...
			case "JavaMethodToOperation_object_SP1": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch", 8);
			...
			case "Interface_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch", 8);
			...
			case "Operation_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch", 8);
			...
			case "ClassifierReference_object_SP3": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch", 8);
			...
			case "Parameter_1_object_SP0": 
				{
					...
					// umlReturnParameter
					HMatch match_7 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_2_orchestration, match_7);
				}
				break;
			case "MethodInterfaceReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_430_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodInterfaceReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_430_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CC_434_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[7] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_53.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_53.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_53.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_54.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_54.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_54.solve();
