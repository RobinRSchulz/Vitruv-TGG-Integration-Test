...
public class ExistingClassImplementToClassImplement__FWD_520_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ExistingClassImplementToClassImplement__CONSISTENCY_525_localSearch"), this::returnTrue  , false ));
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_520_localSearch", 7);
					...
					HMatch match_3 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_520_localSearch", 7);
			...
			case "Class_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_4 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_520_localSearch", 7);
			...
			case "Interface_object_SP11": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_5 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_520_localSearch", 7);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_2_orchestration, match_5);
					}
				}
				break;
			case "ExistingClassImplementToClassImplement__SRC_516_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_520_localSearch", 7);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_520_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
