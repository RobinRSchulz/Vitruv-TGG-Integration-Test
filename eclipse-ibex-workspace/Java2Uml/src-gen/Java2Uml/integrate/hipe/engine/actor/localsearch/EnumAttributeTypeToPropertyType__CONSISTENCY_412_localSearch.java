...
public class EnumAttributeTypeToPropertyType__CONSISTENCY_412_localSearch extends GenericLocalSearchActor{
			...
			case "EnumAttributeTypeToPropertyType__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CONSISTENCY_412_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "EnumAttributeTypeToPropertyType__FWD_407_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CONSISTENCY_412_localSearch", 8);
				...
				break;
			case "EnumAttributeTypeToPropertyType__BWD_386_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CONSISTENCY_412_localSearch", 8);
		...
		case "Java2Uml.EnumAttributeTypeToPropertyType__Marker_CONTEXT__TRG__umlClassifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CONSISTENCY_412_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register EnumAttributeTypeToPropertyType__FWD
		...
		// register EnumAttributeTypeToPropertyType__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister EnumAttributeTypeToPropertyType__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(7);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister EnumAttributeTypeToPropertyType__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(6);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.members.Field) {
			HMatch match_1 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CONSISTENCY_412_localSearch", 8);
		...
		if(obj instanceof uml.Property) {
			HMatch match_3 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__CONSISTENCY_412_localSearch", 8);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_47.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_47.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_47.solve();
