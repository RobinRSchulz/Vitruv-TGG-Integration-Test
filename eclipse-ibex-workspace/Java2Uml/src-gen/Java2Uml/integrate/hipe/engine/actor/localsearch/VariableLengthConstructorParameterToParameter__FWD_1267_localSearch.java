...
public class VariableLengthConstructorParameterToParameter__FWD_1267_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VariableLengthConstructorParameterToParameter__CONSISTENCY_1270_localSearch"), this::returnTrue  , false ));
			...
			case "JavaConstructorToOperation_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__FWD_1267_localSearch", 4);
			...
			case "Operation_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__FWD_1267_localSearch", 4);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_3_1_orchestration, match_2);
					}
				}
				break;
			case "VariableLengthConstructorParameterToParameter__SRC_1264_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__FWD_1267_localSearch", 4);
		...
		case "Java2Uml.JavaConstructorToOperation_source_Constructor": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Constructor) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__FWD_1267_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
