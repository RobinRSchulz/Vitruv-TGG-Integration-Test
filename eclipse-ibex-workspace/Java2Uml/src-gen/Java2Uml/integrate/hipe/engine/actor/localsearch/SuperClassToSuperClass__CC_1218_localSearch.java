...
public class SuperClassToSuperClass__CC_1218_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((uml.Generalization) o).getSpecific(); return (result instanceof uml.Class ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SuperClassToSuperClass__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP20": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperClassToSuperClass__CC_1218_localSearch", 7);
			...
			case "Class_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("SuperClassToSuperClass__CC_1218_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_4_1_orchestration, match_1);
						
						// superclassifier
						HMatch match_4 = new LocalSearchMatch("SuperClassToSuperClass__CC_1218_localSearch", 7);
			...
			case "Class_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("SuperClassToSuperClass__CC_1218_localSearch", 7);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_2_orchestration, match_2);
						
						// umlGeneralClassifier
						HMatch match_6 = new LocalSearchMatch("SuperClassToSuperClass__CC_1218_localSearch", 7);
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// superclassTypeRef
					HMatch match_3 = new LocalSearchMatch("SuperClassToSuperClass__CC_1218_localSearch", 7);
			...
			case "Generalization_object_SP2": 
				{
					...
					// generalization
					HMatch match_5 = new LocalSearchMatch("SuperClassToSuperClass__CC_1218_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_3_1_orchestration, match_5);
				}
				break;
			case "SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1214_localSearch": 
				{
				...
				break;
			case "SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1203_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1214_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperClassToSuperClass__CC_1218_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1203_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SuperClassToSuperClass__CC_1218_localSearch", 7);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperClassToSuperClass__CC_1218_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		uml.Class umlGeneralClassifier = (uml.Class) match.getNodes()[6];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_193 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_193.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, superclassifier.getName(), "java.lang.String"));
		csp_193.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlGeneralClassifier.getName(), "java.lang.String"));
		csp_193.solve();
		
		boolean predicate = csp_193.isSatisfied();
		return predicate;
	}
