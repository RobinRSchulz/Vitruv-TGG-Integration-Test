...
public class MethodInterfaceReturnTypeToReturnType__SRC_1102_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodInterfaceReturnTypeToReturnType__FWD_1106_localSearch"), this::returnTrue  , false ));
			...
			case "Interface_1_object_SP5": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__SRC_1102_localSearch", 3);
			...
			case "ClassMethod_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_1 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__SRC_1102_localSearch", 3);
			...
			case "ClassifierReference_object_SP5": 
				{
					...
					// typeReference
					HMatch match_2 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__SRC_1102_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "MethodInterfaceReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_1089_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__SRC_1102_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__SRC_1102_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
