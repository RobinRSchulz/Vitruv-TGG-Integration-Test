...
public class EnumToUmlEnum__CONSISTENCY_487_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP25": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_487_localSearch", 8);
			...
			case "EnumToUmlEnum__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_487_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "EnumToUmlEnum__FWD_484_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_487_localSearch", 8);
				...
				break;
			case "EnumToUmlEnum__BWD_469_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_487_localSearch", 8);
		...
		case "Java2Uml.EnumToUmlEnum__Marker_CREATE__TRG__umlClassifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_487_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Enumeration) {
			HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_487_localSearch", 8);
		...
		if(obj instanceof org.emftext.language.java.classifiers.Enumeration) {
			HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_487_localSearch", 8);
