...
public class SuperClassToSuperClass__CC_1197_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP20": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperClassToSuperClass__CC_1197_localSearch", 7);
			...
			case "Class_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("SuperClassToSuperClass__CC_1197_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
						
						// superclassifier
						HMatch match_4 = new LocalSearchMatch("SuperClassToSuperClass__CC_1197_localSearch", 7);
			...
			case "Class_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("SuperClassToSuperClass__CC_1197_localSearch", 7);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_5_2_orchestration, match_2);
						
						// umlGeneralClassifier
						HMatch match_6 = new LocalSearchMatch("SuperClassToSuperClass__CC_1197_localSearch", 7);
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// superclassTypeRef
					HMatch match_3 = new LocalSearchMatch("SuperClassToSuperClass__CC_1197_localSearch", 7);
			...
			case "Generalization_object_SP2": 
				{
					...
					// generalization
					HMatch match_5 = new LocalSearchMatch("SuperClassToSuperClass__CC_1197_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_5_1_orchestration, match_5);
				}
				break;
			case "SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1193_localSearch": 
				{
				...
				break;
			case "SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1182_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1193_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperClassToSuperClass__CC_1197_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1182_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SuperClassToSuperClass__CC_1197_localSearch", 7);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperClassToSuperClass__CC_1197_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_191.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, superclassifier.getName(), "java.lang.String"));
		csp_191.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlGeneralClassifier.getName(), "java.lang.String"));
		csp_191.solve();
		
		boolean predicate = csp_191.isSatisfied();
		return predicate;
	}
