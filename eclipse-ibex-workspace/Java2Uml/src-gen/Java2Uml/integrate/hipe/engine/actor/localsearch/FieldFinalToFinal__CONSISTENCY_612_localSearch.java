...
public class FieldFinalToFinal__CONSISTENCY_612_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Java2Uml.FieldFinalToFinal__Marker) o).getCONTEXT__CORR__javaClassifierToUmlProperty();
			...
			case "FieldFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_612_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "FieldFinalToFinal__FWD_609_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_612_localSearch", 5);
		...
		case "Java2Uml.FieldFinalToFinal__Marker_CREATE__SRC__modifier_Final": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.modifiers.Final) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_612_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register FieldFinalToFinal__FWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister FieldFinalToFinal__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Property) {
			HMatch match_2 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_612_localSearch", 5);
