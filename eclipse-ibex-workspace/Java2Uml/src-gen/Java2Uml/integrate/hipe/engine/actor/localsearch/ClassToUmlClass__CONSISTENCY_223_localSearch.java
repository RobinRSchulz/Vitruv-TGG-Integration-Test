...
public class ClassToUmlClass__CONSISTENCY_223_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCREATE__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Java2Uml.ClassToUmlClass__Marker) o).getCONTEXT__CORR__javaPackToUmlPack();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCREATE__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
			...
			case "JavaClassifierToUmlClassifier_object_SP26": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_223_localSearch", 8);
			...
			case "ClassToUmlClass__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_223_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "ClassToUmlClass__FWD_220_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_223_localSearch", 8);
				...
				break;
			case "ClassToUmlClass__BWD_205_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_223_localSearch", 8);
		...
		case "Java2Uml.ClassToUmlClass__Marker_CONTEXT__SRC__compilationUnit_CompilationUnit": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.containers.CompilationUnit) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_223_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ClassToUmlClass__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister ClassToUmlClass__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(5);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[1];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Class) {
			HMatch match_3 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_223_localSearch", 8);
		...
		if(obj instanceof org.emftext.language.java.classifiers.Class) {
			HMatch match_0 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_223_localSearch", 8);
