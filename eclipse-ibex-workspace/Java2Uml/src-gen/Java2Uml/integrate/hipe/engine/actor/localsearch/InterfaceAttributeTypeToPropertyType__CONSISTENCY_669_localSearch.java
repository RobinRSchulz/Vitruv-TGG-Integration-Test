...
public class InterfaceAttributeTypeToPropertyType__CONSISTENCY_669_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__SRC__field(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
			...
			case "InterfaceAttributeTypeToPropertyType__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_669_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "InterfaceAttributeTypeToPropertyType__FWD_664_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_669_localSearch", 8);
				...
				break;
			case "InterfaceAttributeTypeToPropertyType__BWD_643_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_669_localSearch", 8);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_669_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.members.Field) {
			HMatch match_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_669_localSearch", 8);
		...
		if(obj instanceof uml.Property) {
			HMatch match_3 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_669_localSearch", 8);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_74.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_74.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_74.solve();
