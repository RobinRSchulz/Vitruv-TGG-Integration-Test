...
public class JavaFirstCompilationUnitToUmlModel__FWD_883_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_884_localSearch"), this::returnTrue  , false ));
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "JavaFirstCompilationUnitToUmlModel__SRC_880_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__FWD_883_localSearch", 2);
