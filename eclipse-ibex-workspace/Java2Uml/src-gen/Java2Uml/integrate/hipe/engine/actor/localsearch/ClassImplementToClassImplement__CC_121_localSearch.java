...
public class ClassImplementToClassImplement__CC_121_localSearch extends GenericLocalSearchActor{
			...
			case "Class_object_SP2": 
				{
					...
					// javaClass
					HMatch match_0 = new LocalSearchMatch("ClassImplementToClassImplement__CC_121_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP14": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ClassImplementToClassImplement__CC_121_localSearch", 7);
			...
			case "Class_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_2 = new LocalSearchMatch("ClassImplementToClassImplement__CC_121_localSearch", 7);
			...
			case "Interface_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// interface
						HMatch match_3 = new LocalSearchMatch("ClassImplementToClassImplement__CC_121_localSearch", 7);
			...
			case "ClassifierReference_object_SP3": 
				{
					...
					// interfaceTypeRef
					HMatch match_4 = new LocalSearchMatch("ClassImplementToClassImplement__CC_121_localSearch", 7);
			...
			case "Interface_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_5 = new LocalSearchMatch("ClassImplementToClassImplement__CC_121_localSearch", 7);
			...
			case "InterfaceRealization_object_SP0": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ClassImplementToClassImplement__CC_121_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "ClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_117_localSearch": 
				{
				...
				break;
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_106_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_117_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassImplementToClassImplement__CC_121_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_106_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ClassImplementToClassImplement__CC_121_localSearch", 7);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.classifiers.Implementor_implements_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("ClassImplementToClassImplement__CC_121_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
