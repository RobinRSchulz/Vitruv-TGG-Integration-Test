...
public class MethodEnumReturnTypeToReturnType__FWD_1040_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,2,6}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodEnumReturnTypeToReturnType__CONSISTENCY_1045_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("MethodEnumReturnTypeToReturnType__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP12": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1040_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP7": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1040_localSearch", 7);
			...
			case "Enumeration_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1040_localSearch", 7);
			...
			case "Operation_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1040_localSearch", 7);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_5_1_orchestration, match_5);
					}
				}
				break;
			case "MethodEnumReturnTypeToReturnType__SRC_1036_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1040_localSearch", 7);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1040_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register MethodEnumReturnTypeToReturnType__SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister MethodEnumReturnTypeToReturnType__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[2];
