...
public class VariableLengthConstructorParameterToParameter__BWD_1275_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("VariableLengthConstructorParameterToParameter__CONSISTENCY_1291_localSearch"), this::returnTrue  , false ));
	}
			...
			case "JavaConstructorToOperation_object_SP4": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1275_localSearch", 5);
			...
			case "Constructor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1275_localSearch", 5);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
					}
				}
				break;
			case "VariableLengthConstructorParameterToParameter__TRG_1271_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1275_localSearch", 5);
		...
		case "Java2Uml.JavaConstructorToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1275_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_3 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1275_localSearch", 5);
		...
		if(obj instanceof uml.LiteralUnlimitedNatural) {
			HMatch match_4 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1275_localSearch", 5);
