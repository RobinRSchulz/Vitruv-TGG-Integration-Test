...
public class MethodClassReturnTypeToReturnType__CONSISTENCY_971_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.MethodClassReturnTypeToReturnType__Marker) o).getCREATE__CORR__javaTypeReferenceToUmlReturnParameter();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Java2Uml.MethodClassReturnTypeToReturnType__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodClassReturnTypeToReturnType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
			...
			case "JavaTypeReferenceToUmlReturnParameter_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_971_localSearch", 10);
			...
			case "MethodClassReturnTypeToReturnType__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_971_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_3_1_orchestration, match_9);
				}
				break;
			case "MethodClassReturnTypeToReturnType__FWD_966_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_971_localSearch", 10);
				...
				break;
			case "MethodClassReturnTypeToReturnType__BWD_944_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_971_localSearch", 10);
		...
		case "Java2Uml.JavaTypeReferenceToUmlReturnParameter_target_Parameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Parameter) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_971_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_5 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_971_localSearch", 10);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_155 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_155.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_155.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_155.solve();
		
		boolean predicate = csp_155.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_156 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_156.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_156.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_156.solve();
		
		boolean predicate = csp_156.isSatisfied();
		return predicate;
	}
