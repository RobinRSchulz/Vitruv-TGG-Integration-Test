...
public class MethodEnumParamTypeToParamType__FWD_984_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodEnumParamTypeToParamType__CONSISTENCY_991_localSearch"), this::returnTrue  , false ));
			...
			case "JavaClassifierToUmlClassifier_object_SP9": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_984_localSearch", 10);
			...
			case "JavaMethodToOperation_object_SP4": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_984_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP2": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_984_localSearch", 10);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_984_localSearch", 10);
			...
			case "Operation_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_984_localSearch", 10);
			...
			case "Parameter_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_8 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_984_localSearch", 10);
						match_8.getNodes()[8] = objs[0];
						start(edge_explorer_3_2_orchestration, match_8);
					}
				}
				break;
			case "MethodEnumParamTypeToParamType__SRC_979_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_984_localSearch", 10);
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_984_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[7] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.parameters.Parameter) {
			HMatch match_4 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_984_localSearch", 10);
