...
public class MethodInterfaceReturnTypeToReturnType__SRC_1123_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodInterfaceReturnTypeToReturnType__FWD_1127_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("MethodInterfaceReturnTypeToReturnType__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Interface_1_object_SP5": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__SRC_1123_localSearch", 3);
			...
			case "ClassMethod_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_1 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__SRC_1123_localSearch", 3);
			...
			case "ClassifierReference_object_SP5": 
				{
					...
					// typeReference
					HMatch match_2 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__SRC_1123_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "MethodInterfaceReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_1110_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__SRC_1123_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.types.TypedElement_typeReference_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__SRC_1123_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
