...
public class MethodEnumReturnTypeToReturnType__CC_1027_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodEnumReturnTypeToReturnType__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Enumeration_object_SP4": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CC_1027_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP11": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CC_1027_localSearch", 8);
			...
			case "ClassMethod_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CC_1027_localSearch", 8);
			...
			case "JavaMethodToOperation_object_SP6": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CC_1027_localSearch", 8);
			...
			case "Enumeration_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CC_1027_localSearch", 8);
			...
			case "Operation_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CC_1027_localSearch", 8);
			...
			case "ClassifierReference_object_SP11": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CC_1027_localSearch", 8);
			...
			case "Parameter_1_object_SP2": 
				{
					...
					// umlReturnParameter
					HMatch match_7 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CC_1027_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_6_1_orchestration, match_7);
				}
				break;
			case "MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_1023_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_1023_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CC_1027_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CC_1027_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_165 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_165.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_165.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_165.solve();
		
		boolean predicate = csp_165.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_166 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_166.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_166.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_166.solve();
		
		boolean predicate = csp_166.isSatisfied();
		return predicate;
	}
