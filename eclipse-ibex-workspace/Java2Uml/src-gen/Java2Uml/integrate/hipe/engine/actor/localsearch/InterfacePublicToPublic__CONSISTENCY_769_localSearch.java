...
public class InterfacePublicToPublic__CONSISTENCY_769_localSearch extends GenericLocalSearchActor{
			...
			case "InterfacePublicToPublic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_769_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "InterfacePublicToPublic__FWD_766_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_769_localSearch", 5);
		...
		case "Java2Uml.InterfacePublicToPublic__Marker_CONTEXT__SRC__javaConcreteClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_769_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Interface) {
			HMatch match_2 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_769_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic csp_90 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic();
		csp_90.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_90.solve();
