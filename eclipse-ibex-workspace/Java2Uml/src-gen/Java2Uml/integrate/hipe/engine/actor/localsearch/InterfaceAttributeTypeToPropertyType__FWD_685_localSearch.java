...
public class InterfaceAttributeTypeToPropertyType__FWD_685_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceAttributeTypeToPropertyType__CONSISTENCY_690_localSearch"), this::returnTrue  , false ));
			...
			case "JavaAttributeToUmlProperty_object_SP2": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_685_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP13": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_685_localSearch", 7);
			...
			case "Property_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_4 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_685_localSearch", 7);
			...
			case "Interface_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_685_localSearch", 7);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_4_2_orchestration, match_5);
					}
				}
				break;
			case "InterfaceAttributeTypeToPropertyType__SRC_681_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_685_localSearch", 7);
		...
		case "Java2Uml.JavaAttributeToUmlProperty_source_Field": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Field) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_685_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.members.Field) {
			HMatch match_2 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_685_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_75.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_75.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_75.solve();
