...
public class InterfaceMethodToMethod__TRG_711_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceMethodToMethod__BWD_714_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("InterfaceMethodToMethod__TRG_production"), this::returnTrue  , false ));
	}
			...
			case "Interface_object_SP2": 
				{
					...
					// umlClassifier
					HMatch match_0 = new LocalSearchMatch("InterfaceMethodToMethod__TRG_711_localSearch", 2);
			...
			case "Operation_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_1 = new LocalSearchMatch("InterfaceMethodToMethod__TRG_711_localSearch", 2);
		...
		switch(match.creator) {
			...
			case "InterfaceMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_708_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("InterfaceMethodToMethod__TRG_711_localSearch", 2);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.Interface_ownedOperation_Operation": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("InterfaceMethodToMethod__TRG_711_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
