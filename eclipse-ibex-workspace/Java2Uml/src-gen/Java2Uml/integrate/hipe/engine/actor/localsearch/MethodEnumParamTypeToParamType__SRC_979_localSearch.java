...
public class MethodEnumParamTypeToParamType__SRC_979_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodEnumParamTypeToParamType__FWD_984_localSearch"), this::returnTrue  , false ));
			...
			case "Enumeration_object_SP2": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodEnumParamTypeToParamType__SRC_979_localSearch", 4);
			...
			case "ClassMethod_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("MethodEnumParamTypeToParamType__SRC_979_localSearch", 4);
			...
			case "Parameter_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_2 = new LocalSearchMatch("MethodEnumParamTypeToParamType__SRC_979_localSearch", 4);
			...
			case "ClassifierReference_object_SP10": 
				{
					...
					// typeReference
					HMatch match_3 = new LocalSearchMatch("MethodEnumParamTypeToParamType__SRC_979_localSearch", 4);
		...
		switch(match.creator) {
			...
			case "MethodEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_964_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodEnumParamTypeToParamType__SRC_979_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumParamTypeToParamType__SRC_979_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
