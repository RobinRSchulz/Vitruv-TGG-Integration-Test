...
public class InterfacePrivateToPrivate__CC_753_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfacePrivateToPrivate__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP22": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfacePrivateToPrivate__CC_753_localSearch", 4);
			...
			case "Interface_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfacePrivateToPrivate__CC_753_localSearch", 4);
			...
			case "Interface_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfacePrivateToPrivate__CC_753_localSearch", 4);
			...
			case "Private_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("InterfacePrivateToPrivate__CC_753_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfacePrivateToPrivate__CC_753_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
