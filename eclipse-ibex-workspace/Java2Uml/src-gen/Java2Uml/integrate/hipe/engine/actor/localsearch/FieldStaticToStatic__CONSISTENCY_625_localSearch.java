...
public class FieldStaticToStatic__CONSISTENCY_625_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.FieldStaticToStatic__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Static ? result : null);};
			...
			case "FieldStaticToStatic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_625_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "FieldStaticToStatic__FWD_622_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_625_localSearch", 5);
		...
		case "Java2Uml.FieldStaticToStatic__Marker_CREATE__SRC__modifier_Static": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.modifiers.Static) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_625_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register FieldStaticToStatic__FWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister FieldStaticToStatic__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Property) {
			HMatch match_2 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_625_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_67.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_67.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlProperty.isIsStatic(), "boolean"));
		csp_67.solve();
