...
public class InterfaceAttributeTypeToPropertyType__CC_673_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 4, 5, edge_explorer_5_methods);
		...
		nac_checker = new NACExplorer(this, Arrays.asList(new Integer[] {1,6}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceAttributeTypeToPropertyType__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaAttributeToUmlProperty_object_SP1": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CC_673_localSearch", 7);
			...
			case "Interface_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CC_673_localSearch", 7);
			...
			case "Field_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_2 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CC_673_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP12": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CC_673_localSearch", 7);
			...
			case "Property_object_SP2": 
				{
					...
					// property
					HMatch match_4 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CC_673_localSearch", 7);
			...
			case "Interface_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CC_673_localSearch", 7);
			...
			case "ClassifierReference_object_SP13": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CC_673_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_6_2_orchestration, match_6);
				}
				break;
			case "InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_669_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_669_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CC_673_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CC_673_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
