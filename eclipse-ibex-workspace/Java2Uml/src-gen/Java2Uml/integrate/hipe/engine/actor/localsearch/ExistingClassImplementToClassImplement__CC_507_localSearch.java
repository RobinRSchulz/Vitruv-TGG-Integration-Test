...
public class ExistingClassImplementToClassImplement__CC_507_localSearch extends GenericLocalSearchActor{
			...
			case "Interface_1_object_SP8": 
				{
					...
					// interface
					HMatch match_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
			...
			case "Class_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// javaClass
						HMatch match_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
					...
					HMatch match_3 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
			...
			case "Class_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_4 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
			...
			case "Interface_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_5 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
			...
			case "ClassifierReference_object_SP4": 
				{
					...
					// interfaceTypeRef
					HMatch match_6 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
			...
			case "InterfaceRealization_object_SP1": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_7_1_orchestration, match_7);
				}
				break;
			case "ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_503_localSearch": 
				{
				...
				break;
			case "ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_490_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_503_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_490_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__CC_507_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
