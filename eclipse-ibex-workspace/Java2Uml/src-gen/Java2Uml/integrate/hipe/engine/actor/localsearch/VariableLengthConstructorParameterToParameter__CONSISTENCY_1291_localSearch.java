...
public class VariableLengthConstructorParameterToParameter__CONSISTENCY_1291_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthConstructorParameterToParameter__Marker) o).getCREATE__TRG__upperValue(); return (result instanceof uml.LiteralUnlimitedNatural ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.VariableLengthConstructorParameterToParameter__Marker) o).getCREATE__CORR__parameterToParameter();
