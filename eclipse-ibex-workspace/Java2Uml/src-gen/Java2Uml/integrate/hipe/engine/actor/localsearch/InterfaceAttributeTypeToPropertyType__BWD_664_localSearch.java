...
public class InterfaceAttributeTypeToPropertyType__BWD_664_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceAttributeTypeToPropertyType__BWD_production"), this::returnTrue , 0  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("InterfaceAttributeTypeToPropertyType__CONSISTENCY_690_localSearch"), this::returnTrue  , false ));
	}
			...
			case "JavaAttributeToUmlProperty_object_SP0": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_664_localSearch", 6);
			...
			case "Interface_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_664_localSearch", 6);
			...
			case "Field_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_2 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_664_localSearch", 6);
			...
			case "JavaClassifierToUmlClassifier_object_SP11": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_664_localSearch", 6);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "InterfaceAttributeTypeToPropertyType__TRG_661_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_664_localSearch", 6);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_664_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register InterfaceAttributeTypeToPropertyType__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister InterfaceAttributeTypeToPropertyType__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[4];
		oMatch_Nodes_0[1] = objs[5];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Property) {
			HMatch match_4 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_664_localSearch", 6);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_73.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_73.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_73.solve();
