...
public class InterfaceMethodToMethod__SRC_744_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceMethodToMethod__FWD_747_localSearch"), this::returnTrue  , false ));
			...
			case "Interface_1_object_SP2": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceMethodToMethod__SRC_744_localSearch", 2);
			...
			case "ClassMethod_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// method
						HMatch match_1 = new LocalSearchMatch("InterfaceMethodToMethod__SRC_744_localSearch", 2);
