...
public class JavaCompilationUnitToExistingUmlModel__CONSISTENCY_808_localSearch extends GenericLocalSearchActor{
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_808_localSearch", 7);
					...
					HMatch match_5 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_808_localSearch", 7);
			...
			case "JavaCompilationUnitToExistingUmlModel__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_808_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "JavaCompilationUnitToExistingUmlModel__FWD_805_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_808_localSearch", 7);
		...
		case "Java2Uml.JavaCompilationUnitToExistingUmlModel__Marker_CONTEXT__TRG__umlModel_Model": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Model) {
				{
					...
					HMatch match = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_808_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Model) {
			HMatch match_3 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_808_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_95.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "UML_MODEL", "java.lang.String"));
		csp_95.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlModel.getName(), "java.lang.String"));
		csp_95.solve();
