...
public class JavaCompilationUnitToExistingUmlModel__SRC_822_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaCompilationUnitToExistingUmlModel__FWD_826_localSearch"), this::returnTrue  , false ));
			...
			case "Package_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_1 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__SRC_822_localSearch", 3);
