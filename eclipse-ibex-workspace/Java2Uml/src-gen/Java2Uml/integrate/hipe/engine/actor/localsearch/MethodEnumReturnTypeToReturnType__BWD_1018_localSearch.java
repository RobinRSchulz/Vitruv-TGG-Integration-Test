...
public class MethodEnumReturnTypeToReturnType__BWD_1018_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("MethodEnumReturnTypeToReturnType__CONSISTENCY_1045_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Enumeration_object_SP3": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_1018_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP10": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_1018_localSearch", 7);
			...
			case "ClassMethod_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_1018_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP5": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_1018_localSearch", 7);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_1_orchestration, match_3);
				}
				break;
			case "MethodEnumReturnTypeToReturnType__TRG_1014_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_1018_localSearch", 7);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_1018_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register MethodEnumReturnTypeToReturnType__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister MethodEnumReturnTypeToReturnType__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[4];
		oMatch_Nodes_0[1] = objs[5];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_6 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_1018_localSearch", 7);
