...
public class InterfaceToUmlInterface__BWD_795_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("InterfaceToUmlInterface__CONSISTENCY_813_localSearch"), this::returnTrue  , false ));
	}
			...
			case "CompilationUnit_object_SP2": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("InterfaceToUmlInterface__BWD_795_localSearch", 5);
			...
			case "JavaPackageToUmlPackage_object_SP0": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("InterfaceToUmlInterface__BWD_795_localSearch", 5);
			...
			case "Package_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("InterfaceToUmlInterface__BWD_795_localSearch", 5);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_2_orchestration, match_2);
					}
				}
				break;
			case "InterfaceToUmlInterface__TRG_792_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceToUmlInterface__BWD_795_localSearch", 5);
		...
		case "Java2Uml.JavaPackageToUmlPackage_source_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.containers.Package) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceToUmlInterface__BWD_795_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register InterfaceToUmlInterface__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister InterfaceToUmlInterface__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[3];
		oMatch_Nodes_0[1] = objs[4];
