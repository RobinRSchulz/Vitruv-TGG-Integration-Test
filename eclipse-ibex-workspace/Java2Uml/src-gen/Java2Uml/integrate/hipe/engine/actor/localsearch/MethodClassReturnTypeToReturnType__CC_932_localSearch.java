...
public class MethodClassReturnTypeToReturnType__CC_932_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new CachedEdgeExplorer(this, 1, 4, edge_explorer_8_methods);
	...
	protected void initializeOrchestration() {
		...
		nac_checker_orchestration = initializeOrchestration(node.getOrchestrations().get(16).getPlan());
	}
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodClassReturnTypeToReturnType__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Class_object_SP5": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CC_932_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP5": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CC_932_localSearch", 8);
			...
			case "ClassMethod_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CC_932_localSearch", 8);
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CC_932_localSearch", 8);
			...
			case "Class_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CC_932_localSearch", 8);
			...
			case "Operation_object_SP12": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CC_932_localSearch", 8);
			...
			case "ClassifierReference_object_SP5": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CC_932_localSearch", 8);
			...
			case "Parameter_1_object_SP5": 
				{
					...
					// umlReturnParameter
					HMatch match_7 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CC_932_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_2_orchestration, match_7);
				}
				break;
			case "MethodClassReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_928_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodClassReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_928_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CC_932_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CC_932_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[7] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			...
			if(formerMatches_7 != null) {
				...
				formerMatches_7 = formerMatches_7.stream().filter(m -> !constraint_checker.check(m) || !constraint_checker_0.check(m)).collect(Collectors.toList());
	...
	public boolean constraint_checker_method(HMatch match) {
		uml.Parameter umlReturnParameter = (uml.Parameter) match.getNodes()[7];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_151 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_151.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_151.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_151.solve();
		
		boolean predicate = csp_151.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_152 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_152.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_152.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_152.solve();
		
		boolean predicate = csp_152.isSatisfied();
		return predicate;
	}
