...
public class VariableLengthMethodParameterToParameter__TRG_1273_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VariableLengthMethodParameterToParameter__BWD_1277_localSearch"), this::returnTrue  , false ));
			...
			case "Operation_object_SP9": 
				{
					...
					// umlOperation
					HMatch match_0 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__TRG_1273_localSearch", 3);
			...
			case "Parameter_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_1 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__TRG_1273_localSearch", 3);
			...
			case "LiteralUnlimitedNatural_object": 
				{
					if(!lazy_initialization) {
						...
						// upperValue
						HMatch match_2 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__TRG_1273_localSearch", 3);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.MultiplicityElement_upperValue_ValueSpecification": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("VariableLengthMethodParameterToParameter__TRG_1273_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_205.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 0, "java.lang.String"));
		csp_205.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getLower(), "int"));
		csp_205.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_206.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, -1, "java.lang.String"));
		csp_206.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, upperValue.getValue(), "int"));
		csp_206.solve();
