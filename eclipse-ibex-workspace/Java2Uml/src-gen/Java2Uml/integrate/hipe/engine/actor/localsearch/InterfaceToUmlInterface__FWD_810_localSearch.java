...
public class InterfaceToUmlInterface__FWD_810_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceToUmlInterface__CONSISTENCY_813_localSearch"), this::returnTrue  , false ));
			...
			case "JavaPackageToUmlPackage_object_SP2": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("InterfaceToUmlInterface__FWD_810_localSearch", 5);
			...
			case "Package_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("InterfaceToUmlInterface__FWD_810_localSearch", 5);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_3_1_orchestration, match_3);
					}
				}
				break;
			case "InterfaceToUmlInterface__SRC_806_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceToUmlInterface__FWD_810_localSearch", 5);
		...
		case "Java2Uml.JavaPackageToUmlPackage_source_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.containers.Package) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceToUmlInterface__FWD_810_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
