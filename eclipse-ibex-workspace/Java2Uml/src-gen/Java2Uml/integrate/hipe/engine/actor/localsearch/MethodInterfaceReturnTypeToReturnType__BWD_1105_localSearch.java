...
public class MethodInterfaceReturnTypeToReturnType__BWD_1105_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {4,5,6}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodInterfaceReturnTypeToReturnType__BWD_production"), this::returnTrue , 0  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("MethodInterfaceReturnTypeToReturnType__CONSISTENCY_1132_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Interface_1_object_SP2": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1105_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP16": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1105_localSearch", 7);
			...
			case "ClassMethod_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1105_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP5": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1105_localSearch", 7);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_4_1_orchestration, match_3);
				}
				break;
			case "MethodInterfaceReturnTypeToReturnType__TRG_1101_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1105_localSearch", 7);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1105_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register MethodInterfaceReturnTypeToReturnType__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister MethodInterfaceReturnTypeToReturnType__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[4];
		oMatch_Nodes_0[1] = objs[5];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_6 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1105_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		uml.Parameter umlReturnParameter = (uml.Parameter) match.getNodes()[6];
