...
public class MethodInterfaceReturnTypeToReturnType__CONSISTENCY_1111_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceReturnTypeToReturnType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceReturnTypeToReturnType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
			...
			case "JavaTypeReferenceToUmlReturnParameter_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CONSISTENCY_1111_localSearch", 10);
			...
			case "MethodInterfaceReturnTypeToReturnType__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CONSISTENCY_1111_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "MethodInterfaceReturnTypeToReturnType__FWD_1106_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CONSISTENCY_1111_localSearch", 10);
				...
				break;
			case "MethodInterfaceReturnTypeToReturnType__BWD_1084_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CONSISTENCY_1111_localSearch", 10);
		...
		case "Java2Uml.MethodInterfaceReturnTypeToReturnType__Marker_CONTEXT__SRC__classifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CONSISTENCY_1111_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[9] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_5 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__CONSISTENCY_1111_localSearch", 10);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_180 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_180.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_180.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_180.solve();
		
		boolean predicate = csp_180.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_181 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_181.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_181.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_181.solve();
		
		boolean predicate = csp_181.isSatisfied();
		return predicate;
	}
