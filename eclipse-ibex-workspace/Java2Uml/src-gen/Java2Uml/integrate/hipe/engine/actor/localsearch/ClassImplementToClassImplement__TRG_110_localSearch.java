...
public class ClassImplementToClassImplement__TRG_110_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassImplementToClassImplement__BWD_114_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ClassImplementToClassImplement__TRG_production"), this::returnTrue  , false ));
	}
			...
			case "Class_1_object_SP0": 
				{
					...
					// umlClass
					HMatch match_0 = new LocalSearchMatch("ClassImplementToClassImplement__TRG_110_localSearch", 3);
			...
			case "Interface_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_1 = new LocalSearchMatch("ClassImplementToClassImplement__TRG_110_localSearch", 3);
			...
			case "InterfaceRealization_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ClassImplementToClassImplement__TRG_110_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_106_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassImplementToClassImplement__TRG_110_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassImplementToClassImplement__TRG_110_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
