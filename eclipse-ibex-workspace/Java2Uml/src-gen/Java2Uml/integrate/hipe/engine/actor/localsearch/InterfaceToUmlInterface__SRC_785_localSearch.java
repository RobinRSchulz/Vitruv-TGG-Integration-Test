...
public class InterfaceToUmlInterface__SRC_785_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceToUmlInterface__FWD_789_localSearch"), this::returnTrue  , false ));
			...
			case "Interface_1_object_SP10": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("InterfaceToUmlInterface__SRC_785_localSearch", 3);
			...
			case "CompilationUnit_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// compilationUnit
						HMatch match_1 = new LocalSearchMatch("InterfaceToUmlInterface__SRC_785_localSearch", 3);
			...
			case "Package_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("InterfaceToUmlInterface__SRC_785_localSearch", 3);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.CompilationUnit_classifiers_ConcreteClassifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("InterfaceToUmlInterface__SRC_785_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
