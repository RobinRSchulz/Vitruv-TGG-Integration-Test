...
public class MethodInterfaceParamTypeToParamType__CC_1076_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new EdgeExplorer(this, 7, 8, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new EdgeExplorer(this, 4, 9, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new CachedEdgeExplorer(this, 5, 8, edge_explorer_10_methods);
	...
	protected void initializeOrchestration() {
		...
		nac_checker_orchestration = initializeOrchestration(node.getOrchestrations().get(21).getPlan());
	}
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodInterfaceParamTypeToParamType__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Interface_1_object_SP12": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP14": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
			...
			case "JavaMethodToOperation_object_SP3": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
			...
			case "ClassMethod_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP4": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
			...
			case "Interface_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
			...
			case "Operation_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
			...
			case "Parameter_1_object_SP4": 
				{
					...
					// umlParameter
					HMatch match_8 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
			...
			case "ClassifierReference_object_SP0": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_7_1_orchestration, match_9);
				}
				break;
			case "MethodInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_1072_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_1072_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
					Object[] objs_0 = match.getNodes();
					acMatch_nodes_0[0] = objs_0[1];
					acMatch_nodes_0[9] = objs_0[0];
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1076_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[8] = msg.target;
					currentDepth++;
