...
public class OrdinaryConstructorParameterToParameter__BWD_1130_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("OrdinaryConstructorParameterToParameter__CONSISTENCY_1145_localSearch"), this::returnTrue  , false ));
	}
			...
			case "JavaConstructorToOperation_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__BWD_1130_localSearch", 4);
			...
			case "Constructor_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__BWD_1130_localSearch", 4);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
					}
				}
				break;
			case "OrdinaryConstructorParameterToParameter__TRG_1127_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__BWD_1130_localSearch", 4);
		...
		case "Java2Uml.JavaConstructorToOperation_source_Constructor": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Constructor) {
				{
					...
					HMatch match = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__BWD_1130_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
