...
public class MethodClassReturnTypeToReturnType__TRG_919_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodClassReturnTypeToReturnType__BWD_923_localSearch"), this::returnTrue  , false ));
			...
			case "Class_1_object_SP3": 
				{
					...
					// umlClassifier
					HMatch match_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__TRG_919_localSearch", 3);
			...
			case "Operation_object_SP11": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_1 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__TRG_919_localSearch", 3);
			...
			case "Parameter_1_object_SP4": 
				{
					...
					// umlReturnParameter
					HMatch match_2 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__TRG_919_localSearch", 3);
		...
		case "uml.TypedElement_type_Type": 
			if(!lazy_initialization) {
				...
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodClassReturnTypeToReturnType__TRG_919_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_147.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_147.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_147.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_148.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_148.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_148.solve();
