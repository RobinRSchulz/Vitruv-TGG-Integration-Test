...
public class SuperInterfaceToSuperInterface__CC_1231_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP24": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1231_localSearch", 7);
			...
			case "Interface_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1231_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_1_orchestration, match_1);
						
						// superclassifier
						HMatch match_4 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1231_localSearch", 7);
			...
			case "Interface_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1231_localSearch", 7);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_6_1_orchestration, match_2);
						
						// umlGeneralClassifier
						HMatch match_6 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1231_localSearch", 7);
			...
			case "ClassifierReference_object_SP9": 
				{
					...
					// superclassTypeRef
					HMatch match_3 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1231_localSearch", 7);
			...
			case "Generalization_object_SP2": 
				{
					...
					// generalization
					HMatch match_5 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1231_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_3_1_orchestration, match_5);
				}
				break;
			case "SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1227_localSearch": 
				{
				...
				break;
			case "SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1216_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1227_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1231_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1216_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1231_localSearch", 7);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.classifiers.Interface_extends_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1231_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
