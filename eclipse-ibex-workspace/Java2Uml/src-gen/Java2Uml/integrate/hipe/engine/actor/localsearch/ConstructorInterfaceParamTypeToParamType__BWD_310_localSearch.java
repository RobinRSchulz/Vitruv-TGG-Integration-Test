...
public class ConstructorInterfaceParamTypeToParamType__BWD_310_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_344_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Interface_1_object_SP3": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__BWD_310_localSearch", 9);
			...
			case "JavaClassifierToUmlClassifier_object_SP5": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__BWD_310_localSearch", 9);
			...
			case "JavaConstructorToOperation_object_SP2": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__BWD_310_localSearch", 9);
			...
			case "Constructor_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__BWD_310_localSearch", 9);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__BWD_310_localSearch", 9);
			...
			case "JavaParameterToParameter_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__BWD_310_localSearch", 9);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_1_orchestration, match_5);
				}
				break;
			case "ConstructorInterfaceParamTypeToParamType__TRG_306_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__BWD_310_localSearch", 9);
		...
		case "Java2Uml.JavaParameterToParameter_target_Parameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Parameter) {
				{
					...
					HMatch match = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__BWD_310_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[8] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ConstructorInterfaceParamTypeToParamType__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ConstructorInterfaceParamTypeToParamType__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[6];
		oMatch_Nodes_0[1] = objs[7];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_8 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__BWD_310_localSearch", 9);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_35.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_35.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_35.solve();
