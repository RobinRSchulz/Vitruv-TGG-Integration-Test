...
public class MethodClassReturnTypeToReturnType__BWD_944_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("MethodClassReturnTypeToReturnType__CONSISTENCY_971_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Class_object_SP4": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_944_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP4": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_944_localSearch", 7);
			...
			case "ClassMethod_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_944_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP7": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_944_localSearch", 7);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_1_orchestration, match_3);
				}
				break;
			case "MethodClassReturnTypeToReturnType__TRG_940_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_944_localSearch", 7);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_944_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register MethodClassReturnTypeToReturnType__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister MethodClassReturnTypeToReturnType__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[4];
		oMatch_Nodes_0[1] = objs[5];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_6 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_944_localSearch", 7);
