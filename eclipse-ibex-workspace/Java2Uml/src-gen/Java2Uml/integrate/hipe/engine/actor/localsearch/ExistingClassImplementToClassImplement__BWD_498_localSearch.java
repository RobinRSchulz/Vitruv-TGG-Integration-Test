...
public class ExistingClassImplementToClassImplement__BWD_498_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ExistingClassImplementToClassImplement__CONSISTENCY_525_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Interface_1_object_SP7": 
				{
					...
					// interface
					HMatch match_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_498_localSearch", 7);
			...
			case "Class_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// javaClass
						HMatch match_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_498_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP26": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_498_localSearch", 7);
					...
					HMatch match_3 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_498_localSearch", 7);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "ExistingClassImplementToClassImplement__TRG_494_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_498_localSearch", 7);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_498_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
