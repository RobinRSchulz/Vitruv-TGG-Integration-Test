...
public class MethodInterfaceReturnTypeToReturnType__BWD_1084_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("MethodInterfaceReturnTypeToReturnType__CONSISTENCY_1111_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Interface_1_object_SP2": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1084_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP16": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1084_localSearch", 7);
			...
			case "ClassMethod_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1084_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP5": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1084_localSearch", 7);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "MethodInterfaceReturnTypeToReturnType__TRG_1080_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1084_localSearch", 7);
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1084_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_6 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_1084_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_176 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_176.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_176.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_176.solve();
		
		boolean predicate = csp_176.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_177 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_177.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_177.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_177.solve();
		
		boolean predicate = csp_177.isSatisfied();
		return predicate;
	}
