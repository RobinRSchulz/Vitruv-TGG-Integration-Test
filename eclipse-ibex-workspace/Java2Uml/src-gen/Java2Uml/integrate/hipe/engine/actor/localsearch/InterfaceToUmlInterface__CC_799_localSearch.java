...
public class InterfaceToUmlInterface__CC_799_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceToUmlInterface__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "CompilationUnit_object_SP3": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("InterfaceToUmlInterface__CC_799_localSearch", 6);
			...
			case "JavaPackageToUmlPackage_object_SP1": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("InterfaceToUmlInterface__CC_799_localSearch", 6);
			...
			case "Package_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("InterfaceToUmlInterface__CC_799_localSearch", 6);
			...
			case "Package_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("InterfaceToUmlInterface__CC_799_localSearch", 6);
			...
			case "Interface_1_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_4 = new LocalSearchMatch("InterfaceToUmlInterface__CC_799_localSearch", 6);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("InterfaceToUmlInterface__CC_799_localSearch", 6);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.Package_packagedElement_PackageableElement": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("InterfaceToUmlInterface__CC_799_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.classifiers.Interface classifier = (org.emftext.language.java.classifiers.Interface) match.getNodes()[4];
		uml.Interface umlClassifier = (uml.Interface) match.getNodes()[5];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_93 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_93.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_93.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_93.solve();
