...
public class ClassAttributeToProperty__CC_23_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP3": 
				{
					...
					// classToUmlClass
					HMatch match_0 = new LocalSearchMatch("ClassAttributeToProperty__CC_23_localSearch", 5);
			...
			case "Class_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("ClassAttributeToProperty__CC_23_localSearch", 5);
			...
			case "Class_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassAttributeToProperty__CC_23_localSearch", 5);
			...
			case "Field_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_3 = new LocalSearchMatch("ClassAttributeToProperty__CC_23_localSearch", 5);
			...
			case "Property_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_4 = new LocalSearchMatch("ClassAttributeToProperty__CC_23_localSearch", 5);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_3_1_orchestration, match_4);
					}
				}
				break;
			case "ClassAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_14_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_14_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassAttributeToProperty__CC_23_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassAttributeToProperty__CC_23_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
