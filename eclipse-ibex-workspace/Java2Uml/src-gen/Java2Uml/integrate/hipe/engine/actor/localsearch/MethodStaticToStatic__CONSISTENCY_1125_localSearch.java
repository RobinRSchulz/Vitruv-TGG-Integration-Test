...
public class MethodStaticToStatic__CONSISTENCY_1125_localSearch extends GenericLocalSearchActor{
			...
			case "MethodStaticToStatic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_1125_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "MethodStaticToStatic__FWD_1122_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_1125_localSearch", 5);
		...
		case "Java2Uml.MethodStaticToStatic__Marker_CREATE__SRC__modifier_Static": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.modifiers.Static) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_1125_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Operation) {
			HMatch match_2 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_1125_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_184 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_184.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_184.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsStatic(), "boolean"));
		csp_184.solve();
		
		boolean predicate = csp_184.isSatisfied();
		return predicate;
	}
