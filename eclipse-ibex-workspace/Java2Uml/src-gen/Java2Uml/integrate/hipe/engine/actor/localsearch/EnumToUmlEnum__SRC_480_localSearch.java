...
public class EnumToUmlEnum__SRC_480_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumToUmlEnum__FWD_484_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("EnumToUmlEnum__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Enumeration_object_SP6": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__SRC_480_localSearch", 3);
			...
			case "CompilationUnit_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// compilationUnit
						HMatch match_1 = new LocalSearchMatch("EnumToUmlEnum__SRC_480_localSearch", 3);
			...
			case "Package_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("EnumToUmlEnum__SRC_480_localSearch", 3);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__SRC_480_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
