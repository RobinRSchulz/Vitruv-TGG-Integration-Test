...
public class InterfaceConstructorToConstructor__CONSISTENCY_713_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCREATE__SRC__constructor(); return (result instanceof org.emftext.language.java.members.Constructor ? result : null);};
			...
			case "JavaConstructorToOperation_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_713_localSearch", 7);
			...
			case "InterfaceConstructorToConstructor__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_713_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "InterfaceConstructorToConstructor__FWD_710_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_713_localSearch", 7);
				...
				break;
			case "InterfaceConstructorToConstructor__BWD_698_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_713_localSearch", 7);
		...
		case "Java2Uml.JavaConstructorToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_713_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Operation) {
			HMatch match_3 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_713_localSearch", 7);
		...
		if(obj instanceof org.emftext.language.java.members.Constructor) {
			HMatch match_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_713_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_78.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, constructor.getName(), "java.lang.String"));
		csp_78.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_78.solve();
