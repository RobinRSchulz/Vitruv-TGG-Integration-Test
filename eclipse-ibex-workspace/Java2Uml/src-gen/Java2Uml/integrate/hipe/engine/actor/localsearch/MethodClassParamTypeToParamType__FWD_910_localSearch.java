...
public class MethodClassParamTypeToParamType__FWD_910_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodClassParamTypeToParamType__CONSISTENCY_917_localSearch"), this::returnTrue  , false ));
			...
			case "JavaClassifierToUmlClassifier_object_SP3": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_910_localSearch", 10);
			...
			case "JavaMethodToOperation_object_SP6": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_910_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP5": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_910_localSearch", 10);
			...
			case "Class_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_910_localSearch", 10);
			...
			case "Operation_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_910_localSearch", 10);
			...
			case "Parameter_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_8 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_910_localSearch", 10);
						match_8.getNodes()[8] = objs[0];
						start(edge_explorer_2_orchestration, match_8);
					}
				}
				break;
			case "MethodClassParamTypeToParamType__SRC_905_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_910_localSearch", 10);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_910_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[8] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.parameters.Parameter) {
			HMatch match_4 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_910_localSearch", 10);
