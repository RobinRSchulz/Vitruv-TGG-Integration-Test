...
public class MethodInterfaceParamTypeToParamType__CONSISTENCY_1078_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 10, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
			...
			case "MethodInterfaceParamTypeToParamType__Marker_object": 
				{
					...
					HMatch match_10 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_1078_localSearch", 11);
					match_10.getNodes()[10] = objs[0];
					start(edge_explorer_1_orchestration, match_10);
				}
				break;
			case "MethodInterfaceParamTypeToParamType__FWD_1071_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_1078_localSearch", 11);
				...
				break;
			case "MethodInterfaceParamTypeToParamType__BWD_1044_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_1078_localSearch", 11);
		...
		case "Java2Uml.MethodInterfaceParamTypeToParamType__Marker_CONTEXT__SRC__classifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_1078_localSearch", 11);
					Object[] objs = match.getNodes();
					objs[10] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.parameters.Parameter) {
			HMatch match_2 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_1078_localSearch", 11);
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_6 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_1078_localSearch", 11);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_173 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_173.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_173.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_173.solve();
		
		boolean predicate = csp_173.isSatisfied();
		return predicate;
	}
