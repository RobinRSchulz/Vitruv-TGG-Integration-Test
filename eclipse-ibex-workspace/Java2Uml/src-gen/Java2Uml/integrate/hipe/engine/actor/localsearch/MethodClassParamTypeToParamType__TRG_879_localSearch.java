...
public class MethodClassParamTypeToParamType__TRG_879_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodClassParamTypeToParamType__BWD_883_localSearch"), this::returnTrue  , false ));
			...
			case "Class_1_object_SP0": 
				{
					...
					// umlClassifier
					HMatch match_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__TRG_879_localSearch", 3);
			...
			case "Operation_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_1 = new LocalSearchMatch("MethodClassParamTypeToParamType__TRG_879_localSearch", 3);
			...
			case "Parameter_1_object_SP1": 
				{
					...
					// umlParameter
					HMatch match_2 = new LocalSearchMatch("MethodClassParamTypeToParamType__TRG_879_localSearch", 3);
		...
		case "uml.TypedElement_type_Type": 
			if(!lazy_initialization) {
				...
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodClassParamTypeToParamType__TRG_879_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
