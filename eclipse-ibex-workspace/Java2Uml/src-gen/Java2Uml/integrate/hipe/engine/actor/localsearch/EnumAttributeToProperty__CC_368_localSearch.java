...
public class EnumAttributeToProperty__CC_368_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((uml.DataType) o).getOwnedAttribute();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((uml.Property) o).getDatatype(); return (result instanceof uml.Enumeration ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumAttributeToProperty__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP11": 
				{
					...
					// classToUmlClass
					HMatch match_0 = new LocalSearchMatch("EnumAttributeToProperty__CC_368_localSearch", 5);
			...
			case "Enumeration_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("EnumAttributeToProperty__CC_368_localSearch", 5);
			...
			case "Enumeration_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumAttributeToProperty__CC_368_localSearch", 5);
			...
			case "Field_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_3 = new LocalSearchMatch("EnumAttributeToProperty__CC_368_localSearch", 5);
			...
			case "Property_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_4 = new LocalSearchMatch("EnumAttributeToProperty__CC_368_localSearch", 5);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_5_1_orchestration, match_4);
					}
				}
				break;
			case "EnumAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_359_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "EnumAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_359_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("EnumAttributeToProperty__CC_368_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumAttributeToProperty__CC_368_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.members.Field field = (org.emftext.language.java.members.Field) match.getNodes()[3];
