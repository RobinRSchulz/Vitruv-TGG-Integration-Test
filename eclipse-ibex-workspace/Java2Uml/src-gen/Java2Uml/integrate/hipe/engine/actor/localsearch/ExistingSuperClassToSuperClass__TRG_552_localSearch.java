...
public class ExistingSuperClassToSuperClass__TRG_552_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ExistingSuperClassToSuperClass__BWD_556_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ExistingSuperClassToSuperClass__TRG_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Generalization_object_SP0": 
				{
					...
					// generalization
					HMatch match_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass__TRG_552_localSearch", 3);
			...
			case "Class_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_1 = new LocalSearchMatch("ExistingSuperClassToSuperClass__TRG_552_localSearch", 3);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
						
						// umlGeneralClassifier
						HMatch match_2 = new LocalSearchMatch("ExistingSuperClassToSuperClass__TRG_552_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "ExistingSuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_548_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass__TRG_552_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.Generalization_specific_Classifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("ExistingSuperClassToSuperClass__TRG_552_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
