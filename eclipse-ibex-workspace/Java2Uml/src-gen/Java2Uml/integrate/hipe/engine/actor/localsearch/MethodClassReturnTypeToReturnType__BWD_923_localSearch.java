...
public class MethodClassReturnTypeToReturnType__BWD_923_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("MethodClassReturnTypeToReturnType__CONSISTENCY_950_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Class_object_SP4": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_923_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP4": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_923_localSearch", 7);
			...
			case "ClassMethod_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_923_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP7": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_923_localSearch", 7);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "MethodClassReturnTypeToReturnType__TRG_919_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_923_localSearch", 7);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_923_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_6 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__BWD_923_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_149 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_149.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_149.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_149.solve();
		
		boolean predicate = csp_149.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_150 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_150.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_150.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_150.solve();
		
		boolean predicate = csp_150.isSatisfied();
		return predicate;
	}
