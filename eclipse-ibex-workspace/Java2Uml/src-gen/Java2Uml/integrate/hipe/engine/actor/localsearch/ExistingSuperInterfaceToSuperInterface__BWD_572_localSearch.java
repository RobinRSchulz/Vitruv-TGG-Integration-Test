...
public class ExistingSuperInterfaceToSuperInterface__BWD_572_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_599_localSearch"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_572_localSearch", 7);
					...
					HMatch match_2 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_572_localSearch", 7);
			...
			case "Interface_1_object_SP11": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_572_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
						
						// superclassifier
						HMatch match_3 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_572_localSearch", 7);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_3_2_orchestration, match_3);
					}
				}
				break;
			case "ExistingSuperInterfaceToSuperInterface__TRG_568_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_572_localSearch", 7);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_572_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
