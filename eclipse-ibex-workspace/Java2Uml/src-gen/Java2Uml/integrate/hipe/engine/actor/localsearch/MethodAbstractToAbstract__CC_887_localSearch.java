...
public class MethodAbstractToAbstract__CC_887_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodAbstractToAbstract__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "ClassMethod_object_SP2": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodAbstractToAbstract__CC_887_localSearch", 4);
			...
			case "JavaMethodToOperation_object_SP2": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodAbstractToAbstract__CC_887_localSearch", 4);
			...
			case "Operation_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodAbstractToAbstract__CC_887_localSearch", 4);
			...
			case "Abstract_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("MethodAbstractToAbstract__CC_887_localSearch", 4);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodAbstractToAbstract__CC_887_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
