...
public class MethodClassReturnTypeToReturnType__FWD_945_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodClassReturnTypeToReturnType__CONSISTENCY_950_localSearch"), this::returnTrue  , false ));
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_945_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP1": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_945_localSearch", 7);
			...
			case "Class_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_945_localSearch", 7);
			...
			case "Operation_object_SP13": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_945_localSearch", 7);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_2_orchestration, match_5);
					}
				}
				break;
			case "MethodClassReturnTypeToReturnType__SRC_941_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_945_localSearch", 7);
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_945_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
