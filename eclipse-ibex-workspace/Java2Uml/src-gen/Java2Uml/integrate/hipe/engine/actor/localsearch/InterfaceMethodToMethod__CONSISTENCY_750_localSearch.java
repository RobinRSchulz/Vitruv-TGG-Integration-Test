...
public class InterfaceMethodToMethod__CONSISTENCY_750_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceMethodToMethod__Marker) o).getCREATE__SRC__method(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceMethodToMethod__Marker) o).getCONTEXT__CORR__j();
			...
			case "JavaMethodToOperation_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_750_localSearch", 7);
			...
			case "InterfaceMethodToMethod__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_750_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "InterfaceMethodToMethod__FWD_747_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_750_localSearch", 7);
				...
				break;
			case "InterfaceMethodToMethod__BWD_735_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_750_localSearch", 7);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_750_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Operation) {
			HMatch match_3 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_750_localSearch", 7);
		...
		if(obj instanceof org.emftext.language.java.members.ClassMethod) {
			HMatch match_1 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_750_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_83.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, method.getName(), "java.lang.String"));
		csp_83.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_83.solve();
