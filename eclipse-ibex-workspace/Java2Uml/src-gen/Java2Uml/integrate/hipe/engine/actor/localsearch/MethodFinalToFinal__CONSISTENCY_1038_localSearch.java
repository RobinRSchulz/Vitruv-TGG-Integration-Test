...
public class MethodFinalToFinal__CONSISTENCY_1038_localSearch extends GenericLocalSearchActor{
			...
			case "MethodFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_1038_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "MethodFinalToFinal__FWD_1035_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_1038_localSearch", 5);
		...
		case "Java2Uml.MethodFinalToFinal__Marker_CONTEXT__SRC__javaMethod_ClassMethod": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_1038_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Operation) {
			HMatch match_2 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_1038_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_169 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_169.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_169.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsLeaf(), "boolean"));
		csp_169.solve();
		
		boolean predicate = csp_169.isSatisfied();
		return predicate;
	}
