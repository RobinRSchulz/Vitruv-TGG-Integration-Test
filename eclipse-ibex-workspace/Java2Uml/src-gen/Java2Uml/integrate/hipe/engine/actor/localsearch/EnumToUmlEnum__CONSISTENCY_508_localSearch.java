...
public class EnumToUmlEnum__CONSISTENCY_508_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumToUmlEnum__Marker) o).getCONTEXT__TRG__umlPackage(); return (result instanceof uml.Package ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 7, 4, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumToUmlEnum__Marker) o).getCREATE__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
