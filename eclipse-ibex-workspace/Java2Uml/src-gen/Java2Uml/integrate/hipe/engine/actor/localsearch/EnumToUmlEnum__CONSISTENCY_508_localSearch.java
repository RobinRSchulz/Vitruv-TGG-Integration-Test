...
public class EnumToUmlEnum__CONSISTENCY_508_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumToUmlEnum__Marker) o).getCONTEXT__SRC__compilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
			...
			case "JavaClassifierToUmlClassifier_object_SP27": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_508_localSearch", 8);
			...
			case "EnumToUmlEnum__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_508_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_3_1_orchestration, match_7);
				}
				break;
			case "EnumToUmlEnum__FWD_505_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_508_localSearch", 8);
				...
				break;
			case "EnumToUmlEnum__BWD_490_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_508_localSearch", 8);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_508_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Enumeration) {
			HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_508_localSearch", 8);
		...
		if(obj instanceof org.emftext.language.java.classifiers.Enumeration) {
			HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_508_localSearch", 8);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_63.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_63.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_63.solve();
