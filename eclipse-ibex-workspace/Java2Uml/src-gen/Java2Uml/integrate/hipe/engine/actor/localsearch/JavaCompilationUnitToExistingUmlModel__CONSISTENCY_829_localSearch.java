...
public class JavaCompilationUnitToExistingUmlModel__CONSISTENCY_829_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToExistingUmlModel__Marker) o).getCREATE__SRC__newCompilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Java2Uml.JavaCompilationUnitToExistingUmlModel__Marker) o).getCONTEXT__CORR__javaCompUnitToUmlModel();
						edge_explorer_9 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,2,3,4}), node.getAllOverlaps().get(0));
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_829_localSearch", 7);
					...
					HMatch match_5 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_829_localSearch", 7);
			...
			case "JavaCompilationUnitToExistingUmlModel__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_829_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "JavaCompilationUnitToExistingUmlModel__FWD_826_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_829_localSearch", 7);
		...
		case "Java2Uml.JavaCompilationUnitToExistingUmlModel__Marker_CONTEXT__SRC__javaPackage_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.containers.Package) {
				{
					...
					HMatch match = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_829_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register JavaCompilationUnitToExistingUmlModel__FWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister JavaCompilationUnitToExistingUmlModel__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Model) {
			HMatch match_3 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_829_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_97.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "UML_MODEL", "java.lang.String"));
		csp_97.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlModel.getName(), "java.lang.String"));
		csp_97.solve();
