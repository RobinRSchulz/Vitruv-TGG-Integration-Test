...
public class EnumProtectedToProtected__CONSISTENCY_472_localSearch extends GenericLocalSearchActor{
			...
			case "EnumProtectedToProtected__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_472_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "EnumProtectedToProtected__FWD_469_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_472_localSearch", 5);
		...
		case "Java2Uml.EnumProtectedToProtected__Marker_CONTEXT__TRG__umlClassifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_472_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Enumeration) {
			HMatch match_2 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_472_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected csp_58 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected();
