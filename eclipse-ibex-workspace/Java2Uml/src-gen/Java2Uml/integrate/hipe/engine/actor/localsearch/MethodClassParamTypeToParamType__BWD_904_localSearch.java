...
public class MethodClassParamTypeToParamType__BWD_904_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("MethodClassParamTypeToParamType__CONSISTENCY_938_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Class_object_SP0": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_904_localSearch", 9);
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_904_localSearch", 9);
			...
			case "JavaMethodToOperation_object_SP4": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_904_localSearch", 9);
			...
			case "ClassMethod_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_904_localSearch", 9);
			...
			case "Parameter_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_904_localSearch", 9);
			...
			case "JavaParameterToParameter_object_SP3": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_904_localSearch", 9);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_3_1_orchestration, match_5);
				}
				break;
			case "MethodClassParamTypeToParamType__TRG_900_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_904_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_904_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register MethodClassParamTypeToParamType__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister MethodClassParamTypeToParamType__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[6];
		oMatch_Nodes_0[1] = objs[7];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_8 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_904_localSearch", 9);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_145 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_145.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_145.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_145.solve();
		
		boolean predicate = csp_145.isSatisfied();
		return predicate;
	}
