...
public class SuperInterfaceToSuperInterface__BWD_1224_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP23": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1224_localSearch", 5);
			...
			case "Interface_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1224_localSearch", 5);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
					}
				}
				break;
			case "SuperInterfaceToSuperInterface__TRG_1220_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1224_localSearch", 5);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1224_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
