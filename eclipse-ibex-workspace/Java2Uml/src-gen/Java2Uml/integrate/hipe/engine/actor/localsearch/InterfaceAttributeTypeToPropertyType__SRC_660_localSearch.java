...
public class InterfaceAttributeTypeToPropertyType__SRC_660_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceAttributeTypeToPropertyType__FWD_664_localSearch"), this::returnTrue  , false ));
			...
			case "Interface_1_object_SP7": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__SRC_660_localSearch", 3);
			...
			case "Field_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__SRC_660_localSearch", 3);
			...
			case "ClassifierReference_object_SP1": 
				{
					...
					// typeReference
					HMatch match_2 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__SRC_660_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_648_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__SRC_660_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.types.TypedElement_typeReference_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__SRC_660_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
