...
public class ConstructorEnumParamTypeToParamType__CC_281_localSearch extends GenericLocalSearchActor{
			...
			case "Enumeration_object_SP1": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_281_localSearch", 10);
			...
			case "JavaConstructorToOperation_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_281_localSearch", 10);
			...
			case "Constructor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_281_localSearch", 10);
			...
			case "Operation_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_281_localSearch", 10);
			...
			case "ClassifierReference_object_SP9": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_281_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_5_1_orchestration, match_9);
				}
				break;
			case "ConstructorEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_277_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ConstructorEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_277_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_281_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_32.solve();
