...
public class MethodEnumParamTypeToParamType__CONSISTENCY_991_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Java2Uml.MethodEnumParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
			...
			case "MethodEnumParamTypeToParamType__Marker_object": 
				{
					...
					HMatch match_10 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_991_localSearch", 11);
					match_10.getNodes()[10] = objs[0];
					start(edge_explorer_1_orchestration, match_10);
				}
				break;
			case "MethodEnumParamTypeToParamType__FWD_984_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_991_localSearch", 11);
				...
				break;
			case "MethodEnumParamTypeToParamType__BWD_957_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_991_localSearch", 11);
		...
		case "Java2Uml.MethodEnumParamTypeToParamType__Marker_CONTEXT__TRG__umlParameter_Parameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Parameter) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_991_localSearch", 11);
					Object[] objs = match.getNodes();
					objs[10] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.parameters.Parameter) {
			HMatch match_2 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_991_localSearch", 11);
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_6 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_991_localSearch", 11);
