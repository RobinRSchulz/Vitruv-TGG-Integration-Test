...
public class ExistingSuperInterfaceToSuperInterface__TRG_589_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ExistingSuperInterfaceToSuperInterface__BWD_593_localSearch"), this::returnTrue  , false ));
			...
			case "Generalization_object_SP0": 
				{
					...
					// generalization
					HMatch match_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__TRG_589_localSearch", 3);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__TRG_589_localSearch", 3);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
						
						// umlGeneralClassifier
						HMatch match_2 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__TRG_589_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_585_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__TRG_589_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "uml.Generalization_general_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__TRG_589_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
