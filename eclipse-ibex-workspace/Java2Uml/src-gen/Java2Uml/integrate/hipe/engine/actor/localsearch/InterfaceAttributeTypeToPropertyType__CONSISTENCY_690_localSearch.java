...
public class InterfaceAttributeTypeToPropertyType__CONSISTENCY_690_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 7, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__TRG__property(); return (result instanceof uml.Property ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 7, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__SRC__field(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
			...
			case "InterfaceAttributeTypeToPropertyType__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_690_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "InterfaceAttributeTypeToPropertyType__FWD_685_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_690_localSearch", 8);
				...
				break;
			case "InterfaceAttributeTypeToPropertyType__BWD_664_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_690_localSearch", 8);
		...
		case "Java2Uml.InterfaceAttributeTypeToPropertyType__Marker_CREATE__SRC__typeReference_ClassifierReference": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.types.ClassifierReference) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_690_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register InterfaceAttributeTypeToPropertyType__FWD
		...
		// register InterfaceAttributeTypeToPropertyType__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister InterfaceAttributeTypeToPropertyType__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(7);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister InterfaceAttributeTypeToPropertyType__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(6);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.members.Field) {
			HMatch match_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_690_localSearch", 8);
		...
		if(obj instanceof uml.Property) {
			HMatch match_3 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_690_localSearch", 8);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_76.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_76.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_76.solve();
