...
public class InterfaceMethodToMethod__SRC_723_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceMethodToMethod__FWD_726_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("InterfaceMethodToMethod__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Interface_1_object_SP2": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceMethodToMethod__SRC_723_localSearch", 2);
			...
			case "ClassMethod_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// method
						HMatch match_1 = new LocalSearchMatch("InterfaceMethodToMethod__SRC_723_localSearch", 2);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.members.MemberContainer_members_Member": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("InterfaceMethodToMethod__SRC_723_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
