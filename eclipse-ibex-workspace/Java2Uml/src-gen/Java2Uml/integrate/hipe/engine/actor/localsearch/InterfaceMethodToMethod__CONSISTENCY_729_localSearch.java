...
public class InterfaceMethodToMethod__CONSISTENCY_729_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceMethodToMethod__Marker) o).getCREATE__CORR__javaMethodToOperation();
			...
			case "JavaMethodToOperation_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_729_localSearch", 7);
			...
			case "InterfaceMethodToMethod__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_729_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "InterfaceMethodToMethod__FWD_726_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_729_localSearch", 7);
				...
				break;
			case "InterfaceMethodToMethod__BWD_714_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_729_localSearch", 7);
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_729_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register InterfaceMethodToMethod__FWD
		...
		// register InterfaceMethodToMethod__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister InterfaceMethodToMethod__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister InterfaceMethodToMethod__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Operation) {
			HMatch match_3 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_729_localSearch", 7);
		...
		if(obj instanceof org.emftext.language.java.members.ClassMethod) {
			HMatch match_1 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_729_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_81.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, method.getName(), "java.lang.String"));
		csp_81.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_81.solve();
