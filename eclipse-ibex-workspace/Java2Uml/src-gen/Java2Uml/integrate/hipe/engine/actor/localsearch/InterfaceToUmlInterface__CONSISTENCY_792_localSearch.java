...
public class InterfaceToUmlInterface__CONSISTENCY_792_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__CORR__javaClassToUmlClass();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__TRG__umlPackage(); return (result instanceof uml.Package ? result : null);};
			...
			case "JavaClassifierToUmlClassifier_object_SP0": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_792_localSearch", 8);
			...
			case "InterfaceToUmlInterface__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_792_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "InterfaceToUmlInterface__FWD_789_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_792_localSearch", 8);
				...
				break;
			case "InterfaceToUmlInterface__BWD_774_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_792_localSearch", 8);
		...
		case "Java2Uml.InterfaceToUmlInterface__Marker_CREATE__SRC__classifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_792_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.classifiers.Interface) {
			HMatch match_0 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_792_localSearch", 8);
		...
		if(obj instanceof uml.Interface) {
			HMatch match_3 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_792_localSearch", 8);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_92.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_92.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_92.solve();
