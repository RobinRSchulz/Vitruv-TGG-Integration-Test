...
public class ConstructorInterfaceParamTypeToParamType__FWD_337_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_344_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ConstructorInterfaceParamTypeToParamType__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP7": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_337_localSearch", 10);
			...
			case "JavaConstructorToOperation_object_SP4": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_337_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP2": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_337_localSearch", 10);
			...
			case "Interface_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_337_localSearch", 10);
			...
			case "Operation_object_SP14": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_337_localSearch", 10);
			...
			case "Parameter_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_8 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_337_localSearch", 10);
						match_8.getNodes()[8] = objs[0];
						start(edge_explorer_4_2_orchestration, match_8);
					}
				}
				break;
			case "ConstructorInterfaceParamTypeToParamType__SRC_332_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_337_localSearch", 10);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_337_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ConstructorInterfaceParamTypeToParamType__SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ConstructorInterfaceParamTypeToParamType__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[3];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.parameters.Parameter) {
			HMatch match_4 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_337_localSearch", 10);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_37.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_37.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_37.solve();
