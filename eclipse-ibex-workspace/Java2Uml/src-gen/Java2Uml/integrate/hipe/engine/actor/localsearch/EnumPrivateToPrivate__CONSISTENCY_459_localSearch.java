...
public class EnumPrivateToPrivate__CONSISTENCY_459_localSearch extends GenericLocalSearchActor{
			...
			case "EnumPrivateToPrivate__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_459_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "EnumPrivateToPrivate__FWD_456_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_459_localSearch", 5);
		...
		case "Java2Uml.EnumPrivateToPrivate__Marker_CREATE__SRC__modifier_Private": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.modifiers.Private) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_459_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Enumeration) {
			HMatch match_2 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_459_localSearch", 5);
