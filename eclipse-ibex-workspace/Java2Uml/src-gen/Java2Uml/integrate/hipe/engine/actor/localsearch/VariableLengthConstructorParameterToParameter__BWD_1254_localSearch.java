...
public class VariableLengthConstructorParameterToParameter__BWD_1254_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {2,3,4}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("VariableLengthConstructorParameterToParameter__CONSISTENCY_1270_localSearch"), this::returnTrue  , false ));
	}
			...
			case "JavaConstructorToOperation_object_SP4": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1254_localSearch", 5);
			...
			case "Constructor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1254_localSearch", 5);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
					}
				}
				break;
			case "VariableLengthConstructorParameterToParameter__TRG_1250_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1254_localSearch", 5);
		...
		case "Java2Uml.JavaConstructorToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1254_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register VariableLengthConstructorParameterToParameter__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister VariableLengthConstructorParameterToParameter__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[2];
		oMatch_Nodes_0[1] = objs[3];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.LiteralUnlimitedNatural) {
			HMatch match_4 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1254_localSearch", 5);
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_3 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_1254_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_197 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_197.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 0, "java.lang.String"));
		csp_197.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getLower(), "int"));
		csp_197.solve();
		
		boolean predicate = csp_197.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_198 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_198.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, -1, "java.lang.String"));
		csp_198.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, upperValue.getValue(), "int"));
		csp_198.solve();
		
		boolean predicate = csp_198.isSatisfied();
		return predicate;
	}
