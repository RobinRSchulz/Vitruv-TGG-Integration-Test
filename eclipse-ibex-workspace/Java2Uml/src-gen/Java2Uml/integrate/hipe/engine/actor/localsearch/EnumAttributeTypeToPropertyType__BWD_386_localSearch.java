...
public class EnumAttributeTypeToPropertyType__BWD_386_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("EnumAttributeTypeToPropertyType__CONSISTENCY_412_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Enumeration_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__BWD_386_localSearch", 6);
			...
			case "EnumAttributeTypeToPropertyType__TRG_383_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__BWD_386_localSearch", 6);
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register EnumAttributeTypeToPropertyType__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister EnumAttributeTypeToPropertyType__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[4];
		oMatch_Nodes_0[1] = objs[5];
