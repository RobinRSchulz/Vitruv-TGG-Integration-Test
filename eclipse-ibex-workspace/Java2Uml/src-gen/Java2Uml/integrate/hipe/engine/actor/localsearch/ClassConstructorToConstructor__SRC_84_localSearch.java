...
public class ClassConstructorToConstructor__SRC_84_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassConstructorToConstructor__FWD_87_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ClassConstructorToConstructor__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Class_object_SP11": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ClassConstructorToConstructor__SRC_84_localSearch", 2);
			...
			case "Constructor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// constructor
						HMatch match_1 = new LocalSearchMatch("ClassConstructorToConstructor__SRC_84_localSearch", 2);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.members.MemberContainer_members_Member": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("ClassConstructorToConstructor__SRC_84_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
