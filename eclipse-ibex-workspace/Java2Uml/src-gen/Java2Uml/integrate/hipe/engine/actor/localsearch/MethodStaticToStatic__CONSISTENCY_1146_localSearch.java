...
public class MethodStaticToStatic__CONSISTENCY_1146_localSearch extends GenericLocalSearchActor{
			...
			case "MethodStaticToStatic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_1146_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "MethodStaticToStatic__FWD_1143_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_1146_localSearch", 5);
		...
		case "Java2Uml.MethodStaticToStatic__Marker_CONTEXT__TRG__umlOperation_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_1146_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register MethodStaticToStatic__FWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister MethodStaticToStatic__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Operation) {
			HMatch match_2 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_1146_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_186.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_186.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsStatic(), "boolean"));
		csp_186.solve();
