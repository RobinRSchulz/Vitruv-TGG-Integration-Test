...
public class MethodInterfaceParamTypeToParamType__CC_1055_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 7, 8, edge_explorer_8_methods);
			...
			case "Interface_1_object_SP12": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP14": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
			...
			case "JavaMethodToOperation_object_SP3": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
			...
			case "ClassMethod_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP4": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
			...
			case "Interface_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
			...
			case "Operation_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
			...
			case "Parameter_1_object_SP4": 
				{
					...
					// umlParameter
					HMatch match_8 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
			...
			case "ClassifierReference_object_SP0": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_6_1_orchestration, match_9);
				}
				break;
			case "MethodInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_1051_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_1051_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "uml.TypedElement_type_Type": 
			if(!lazy_initialization) {
				...
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CC_1055_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_171 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_171.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_171.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_171.solve();
		
		boolean predicate = csp_171.isSatisfied();
		return predicate;
	}
