...
public class SuperClassToSuperClass__CONSISTENCY_1212_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__CORR__javaSuperClassifierToUmlSuperClassifier();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__CORR__classRefToGeneralization();
			...
			case "JavaClassifierReferenceToUmlGeneralization_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP21": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
					...
					HMatch match_8 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
			...
			case "SuperClassToSuperClass__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "SuperClassToSuperClass__FWD_1209_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
				...
				break;
			case "SuperClassToSuperClass__BWD_1190_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[9] = msg.source;
					objs[8] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Class) {
			HMatch match_4 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
			...
			HMatch match_5 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
		...
		if(obj instanceof org.emftext.language.java.classifiers.Class) {
			HMatch match_0 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
			...
			HMatch match_2 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1212_localSearch", 10);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_192 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_192.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, superclassifier.getName(), "java.lang.String"));
		csp_192.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlGeneralClassifier.getName(), "java.lang.String"));
		csp_192.solve();
		
		boolean predicate = csp_192.isSatisfied();
		return predicate;
	}
