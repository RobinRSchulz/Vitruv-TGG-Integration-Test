...
public class EnumConstantToEnumConstant__CC_420_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumConstantToEnumConstant__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP17": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("EnumConstantToEnumConstant__CC_420_localSearch", 5);
			...
			case "Enumeration_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// javaEnum
						HMatch match_1 = new LocalSearchMatch("EnumConstantToEnumConstant__CC_420_localSearch", 5);
			...
			case "Enumeration_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlEnum
						HMatch match_2 = new LocalSearchMatch("EnumConstantToEnumConstant__CC_420_localSearch", 5);
			...
			case "EnumConstant_object": 
				{
					if(!lazy_initialization) {
						...
						// javaConstant
						HMatch match_3 = new LocalSearchMatch("EnumConstantToEnumConstant__CC_420_localSearch", 5);
			...
			case "EnumerationLiteral_object": 
				{
					if(!lazy_initialization) {
						...
						// umlLiteral
						HMatch match_4 = new LocalSearchMatch("EnumConstantToEnumConstant__CC_420_localSearch", 5);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumConstantToEnumConstant__CC_420_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.members.EnumConstant javaConstant = (org.emftext.language.java.members.EnumConstant) match.getNodes()[3];
		uml.EnumerationLiteral umlLiteral = (uml.EnumerationLiteral) match.getNodes()[4];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_48 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_48.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, javaConstant.getName(), "java.lang.String"));
		csp_48.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlLiteral.getName(), "java.lang.String"));
		csp_48.solve();
