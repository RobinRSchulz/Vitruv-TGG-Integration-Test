...
public class ClassFinalToFinal__CONSISTENCY_104_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassFinalToFinal__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
			...
			case "ClassFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("ClassFinalToFinal__CONSISTENCY_104_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "ClassFinalToFinal__FWD_101_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ClassFinalToFinal__CONSISTENCY_104_localSearch", 5);
		...
		case "Java2Uml.ClassFinalToFinal__Marker_CONTEXT__SRC__javaConcreteClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassFinalToFinal__CONSISTENCY_104_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ClassFinalToFinal__FWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ClassFinalToFinal__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Class) {
			HMatch match_2 = new LocalSearchMatch("ClassFinalToFinal__CONSISTENCY_104_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.isIsFinalSpecialization(), "boolean"));
		csp_13.solve();
