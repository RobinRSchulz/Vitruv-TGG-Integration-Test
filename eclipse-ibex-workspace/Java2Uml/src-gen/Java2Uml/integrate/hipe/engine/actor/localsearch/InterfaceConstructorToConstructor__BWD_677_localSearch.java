...
public class InterfaceConstructorToConstructor__BWD_677_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("InterfaceConstructorToConstructor__CONSISTENCY_692_localSearch"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP13": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__BWD_677_localSearch", 4);
			...
			case "Interface_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceConstructorToConstructor__BWD_677_localSearch", 4);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
					}
				}
				break;
			case "InterfaceConstructorToConstructor__TRG_674_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__BWD_677_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceConstructorToConstructor__BWD_677_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
