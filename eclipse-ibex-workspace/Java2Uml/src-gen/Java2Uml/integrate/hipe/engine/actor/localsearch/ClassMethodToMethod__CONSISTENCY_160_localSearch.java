...
public class ClassMethodToMethod__CONSISTENCY_160_localSearch extends GenericLocalSearchActor{
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_160_localSearch", 7);
			...
			case "ClassMethodToMethod__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_160_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "ClassMethodToMethod__FWD_157_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_160_localSearch", 7);
				...
				break;
			case "ClassMethodToMethod__BWD_145_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_160_localSearch", 7);
		...
		case "Java2Uml.ClassMethodToMethod__Marker_CONTEXT__TRG__umlClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_160_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ClassMethodToMethod__FWD
		...
		// register ClassMethodToMethod__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ClassMethodToMethod__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister ClassMethodToMethod__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Operation) {
			HMatch match_3 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_160_localSearch", 7);
		...
		if(obj instanceof org.emftext.language.java.members.ClassMethod) {
			HMatch match_1 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_160_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, method.getName(), "java.lang.String"));
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_15.solve();
