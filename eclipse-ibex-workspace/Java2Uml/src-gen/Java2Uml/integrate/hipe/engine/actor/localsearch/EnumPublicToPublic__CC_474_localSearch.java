...
public class EnumPublicToPublic__CC_474_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP25": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumPublicToPublic__CC_474_localSearch", 4);
			...
			case "Enumeration_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("EnumPublicToPublic__CC_474_localSearch", 4);
			...
			case "Enumeration_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumPublicToPublic__CC_474_localSearch", 4);
			...
			case "Public_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("EnumPublicToPublic__CC_474_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumPublicToPublic__CC_474_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
