...
public class JavaFirstCompilationUnitToUmlModel__SRC_859_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaFirstCompilationUnitToUmlModel__FWD_862_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("JavaFirstCompilationUnitToUmlModel__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Package_object_SP3": 
				{
					...
					// javaPackage
					HMatch match_0 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__SRC_859_localSearch", 2);
			...
			case "CompilationUnit_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// compilationUnit
						HMatch match_1 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__SRC_859_localSearch", 2);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__SRC_859_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
