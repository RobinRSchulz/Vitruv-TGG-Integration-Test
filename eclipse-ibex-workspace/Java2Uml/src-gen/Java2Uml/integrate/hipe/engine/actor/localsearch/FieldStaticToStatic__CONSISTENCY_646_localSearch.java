...
public class FieldStaticToStatic__CONSISTENCY_646_localSearch extends GenericLocalSearchActor{
			...
			case "FieldStaticToStatic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_646_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "FieldStaticToStatic__FWD_643_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_646_localSearch", 5);
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Property) {
			HMatch match_2 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_646_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_69.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlProperty.isIsStatic(), "boolean"));
		csp_69.solve();
