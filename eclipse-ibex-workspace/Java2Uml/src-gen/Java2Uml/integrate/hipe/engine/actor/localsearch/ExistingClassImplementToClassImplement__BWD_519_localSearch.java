...
public class ExistingClassImplementToClassImplement__BWD_519_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ExistingClassImplementToClassImplement__CONSISTENCY_546_localSearch"), this::returnTrue  , false ));
	}
			...
			case "Interface_1_object_SP7": 
				{
					...
					// interface
					HMatch match_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_519_localSearch", 7);
			...
			case "Class_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// javaClass
						HMatch match_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_519_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_519_localSearch", 7);
					...
					HMatch match_3 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_519_localSearch", 7);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_4_1_orchestration, match_3);
				}
				break;
			case "ExistingClassImplementToClassImplement__TRG_515_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_519_localSearch", 7);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_519_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ExistingClassImplementToClassImplement__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ExistingClassImplementToClassImplement__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[4];
		oMatch_Nodes_0[1] = objs[5];
