...
public class MethodEnumReturnTypeToReturnType__FWD_1019_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodEnumReturnTypeToReturnType__CONSISTENCY_1024_localSearch"), this::returnTrue  , false ));
			...
			case "JavaClassifierToUmlClassifier_object_SP12": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1019_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP7": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1019_localSearch", 7);
			...
			case "Enumeration_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1019_localSearch", 7);
			...
			case "Operation_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1019_localSearch", 7);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_2_orchestration, match_5);
					}
				}
				break;
			case "MethodEnumReturnTypeToReturnType__SRC_1015_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1019_localSearch", 7);
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_1019_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
