...
public class JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__CORR__javaCompUnitToUmlModel();
						edge_explorer_5 = new CachedEdgeExplorer(this, 14, 13, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__longType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_6 = new CachedEdgeExplorer(this, 14, 8, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__charType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_7 = new CachedEdgeExplorer(this, 14, 4, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToUmlModel) o).getSource(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
						edge_explorer_9 = new CachedEdgeExplorer(this, 13, 0, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__booleanType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_10 = new CachedEdgeExplorer(this, 14, 2, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
						edge_explorer_11 = new CachedEdgeExplorer(this, 14, 1, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__floatType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_12 = new CachedEdgeExplorer(this, 14, 6, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__shortType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_13 = new CachedEdgeExplorer(this, 14, 9, edge_explorer_13_methods);
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__stringType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_15 = new CachedEdgeExplorer(this, 14, 10, edge_explorer_15_methods);
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__SRC__compilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
						edge_explorer_17 = new CachedEdgeExplorer(this, 14, 0, edge_explorer_17_methods);
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_13 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
			...
			case "JavaFirstCompilationUnitToUmlModel__Marker_object": 
				{
					...
					HMatch match_14 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
					match_14.getNodes()[14] = objs[0];
					start(edge_explorer_3_1_orchestration, match_14);
				}
				break;
			case "JavaFirstCompilationUnitToUmlModel__FWD_862_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
				...
				break;
			case "JavaFirstCompilationUnitToUmlModel__BWD_823_junction": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
		...
		case "Java2Uml.JavaCompilationUnitToUmlModel_target_Model": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Model) {
				{
					...
					HMatch match = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
					Object[] objs = match.getNodes();
					objs[13] = msg.source;
					objs[11] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.PrimitiveType) {
			HMatch match_2 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
			...
			HMatch match_3 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
			...
			HMatch match_4 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
			...
			HMatch match_5 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
			...
			HMatch match_6 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
			...
			HMatch match_7 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
			...
			HMatch match_8 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
			...
			HMatch match_9 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
			...
			HMatch match_10 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
			...
			HMatch match_12 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
		...
		if(obj instanceof uml.Model) {
			HMatch match_11 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch", 15);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_129.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "UML_MODEL", "java.lang.String"));
		csp_129.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlModel.getName(), "java.lang.String"));
		csp_129.solve();
		
		boolean predicate = csp_129.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_130.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, booleanType.getName(), "java.lang.String"));
		csp_130.solve();
		
		boolean predicate = csp_130.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_131.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_131.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, byteType.getName(), "java.lang.String"));
		csp_131.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		csp_132.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, charType.getName(), "java.lang.String"));
		csp_132.solve();
	...
	public boolean constraint_checker_3_method(HMatch match) {
		...
		csp_133.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, floatType.getName(), "java.lang.String"));
		csp_133.solve();
	...
	public boolean constraint_checker_4_method(HMatch match) {
		...
		csp_134.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, doubleType.getName(), "java.lang.String"));
		csp_134.solve();
	...
	public boolean constraint_checker_5_method(HMatch match) {
		...
		csp_135.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, intType.getName(), "java.lang.String"));
		csp_135.solve();
	...
	public boolean constraint_checker_6_method(HMatch match) {
		...
		csp_136.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, longType.getName(), "java.lang.String"));
		csp_136.solve();
	...
	public boolean constraint_checker_7_method(HMatch match) {
		...
		csp_137.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, shortType.getName(), "java.lang.String"));
		csp_137.solve();
	...
	public boolean constraint_checker_8_method(HMatch match) {
		...
		csp_138.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, stringType.getName(), "java.lang.String"));
		csp_138.solve();
	...
	public boolean constraint_checker_9_method(HMatch match) {
		...
		csp_139.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, voidType.getName(), "java.lang.String"));
		csp_139.solve();
