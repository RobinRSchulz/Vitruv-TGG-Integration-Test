...
public class ExistingSuperClassToSuperClass__BWD_556_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ExistingSuperClassToSuperClass__CONSISTENCY_583_localSearch"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP3": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass__BWD_556_localSearch", 7);
					...
					HMatch match_2 = new LocalSearchMatch("ExistingSuperClassToSuperClass__BWD_556_localSearch", 7);
			...
			case "Class_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ExistingSuperClassToSuperClass__BWD_556_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
						
						// superclassifier
						HMatch match_3 = new LocalSearchMatch("ExistingSuperClassToSuperClass__BWD_556_localSearch", 7);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_5_1_orchestration, match_3);
					}
				}
				break;
			case "ExistingSuperClassToSuperClass__TRG_552_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass__BWD_556_localSearch", 7);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperClassToSuperClass__BWD_556_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
