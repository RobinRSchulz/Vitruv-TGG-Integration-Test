...
public class VariableLengthMethodParameterToParameter__CC_1301_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VariableLengthMethodParameterToParameter__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaMethodToOperation_object_SP6": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CC_1301_localSearch", 6);
			...
			case "ClassMethod_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CC_1301_localSearch", 6);
			...
			case "Operation_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CC_1301_localSearch", 6);
			...
			case "VariableLengthParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_3 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CC_1301_localSearch", 6);
			...
			case "Parameter_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_4 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CC_1301_localSearch", 6);
			...
			case "LiteralUnlimitedNatural_object": 
				{
					if(!lazy_initialization) {
						...
						// upperValue
						HMatch match_5 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CC_1301_localSearch", 6);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CC_1301_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_211 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_211.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 0, "java.lang.String"));
		csp_211.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getLower(), "int"));
		csp_211.solve();
		
		boolean predicate = csp_211.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_212.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, -1, "java.lang.String"));
		csp_212.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, upperValue.getValue(), "int"));
		csp_212.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_213.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_213.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_213.solve();
