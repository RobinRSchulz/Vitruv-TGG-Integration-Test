...
public class InterfaceAbstractToAbstract__SRC_653_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceAbstractToAbstract__FWD_656_localSearch"), this::returnTrue  , false ));
			...
			case "Interface_1_object_SP3": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceAbstractToAbstract__SRC_653_localSearch", 2);
			...
			case "Abstract_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("InterfaceAbstractToAbstract__SRC_653_localSearch", 2);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("InterfaceAbstractToAbstract__SRC_653_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
