...
public class ExistingClassImplementToClassImplement__SRC_537_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ExistingClassImplementToClassImplement__FWD_541_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ExistingClassImplementToClassImplement__SRC_production"), this::returnTrue  , false ));
	}
			...
			case "Interface_1_object_SP10": 
				{
					...
					// interface
					HMatch match_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__SRC_537_localSearch", 3);
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// interfaceTypeRef
					HMatch match_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__SRC_537_localSearch", 3);
			...
			case "Class_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// javaClass
						HMatch match_2 = new LocalSearchMatch("ExistingClassImplementToClassImplement__SRC_537_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_524_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__SRC_537_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.classifiers.Implementor_implements_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__SRC_537_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
