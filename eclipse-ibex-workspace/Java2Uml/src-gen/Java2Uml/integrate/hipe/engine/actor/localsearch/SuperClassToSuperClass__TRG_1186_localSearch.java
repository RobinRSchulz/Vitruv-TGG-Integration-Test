...
public class SuperClassToSuperClass__TRG_1186_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SuperClassToSuperClass__BWD_1190_localSearch"), this::returnTrue  , false ));
			...
			case "Generalization_object_SP0": 
				{
					...
					// generalization
					HMatch match_0 = new LocalSearchMatch("SuperClassToSuperClass__TRG_1186_localSearch", 3);
			...
			case "Class_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_1 = new LocalSearchMatch("SuperClassToSuperClass__TRG_1186_localSearch", 3);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
						
						// umlGeneralClassifier
						HMatch match_2 = new LocalSearchMatch("SuperClassToSuperClass__TRG_1186_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1182_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperClassToSuperClass__TRG_1186_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "uml.Generalization_general_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperClassToSuperClass__TRG_1186_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
