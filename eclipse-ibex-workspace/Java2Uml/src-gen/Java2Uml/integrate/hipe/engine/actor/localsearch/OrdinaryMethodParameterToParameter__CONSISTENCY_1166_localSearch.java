...
public class OrdinaryMethodParameterToParameter__CONSISTENCY_1166_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.OrdinaryMethodParameterToParameter__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
			...
			case "JavaParameterToParameter_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_1166_localSearch", 7);
			...
			case "OrdinaryMethodParameterToParameter__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_1166_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "OrdinaryMethodParameterToParameter__FWD_1163_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_1166_localSearch", 7);
				...
				break;
			case "OrdinaryMethodParameterToParameter__BWD_1151_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_1166_localSearch", 7);
		...
		case "Java2Uml.JavaParameterToParameter_target_Parameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Parameter) {
				{
					...
					HMatch match = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_1166_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register OrdinaryMethodParameterToParameter__FWD
		...
		// register OrdinaryMethodParameterToParameter__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister OrdinaryMethodParameterToParameter__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister OrdinaryMethodParameterToParameter__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.parameters.OrdinaryParameter) {
			HMatch match_1 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_1166_localSearch", 7);
		...
		if(obj instanceof uml.Parameter) {
			HMatch match_3 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_1166_localSearch", 7);
