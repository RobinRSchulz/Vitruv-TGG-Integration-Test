...
public class JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer = new EdgeExplorer(this, 7, 9, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 2, 9, edge_explorer_3_methods);
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new EdgeExplorer(this, 3, 9, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new EdgeExplorer(this, 10, 9, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 0, 9, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new EdgeExplorer(this, 5, 9, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 8, 9, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new EdgeExplorer(this, 6, 9, edge_explorer_9_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new EdgeExplorer(this, 4, 9, edge_explorer_10_methods);
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11 = new EdgeExplorer(this, 1, 9, edge_explorer_11_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaFirstCompilationUnitToUmlModel__BWD_844_junction"), this::returnTrue , 0  , false ));
			...
			case "PrimitiveType_object_SP0": 
				{
					...
					// booleanType
					HMatch match_0 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_6_1_orchestration, match_0);
					
					// byteType
					HMatch match_1 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_11_1_orchestration, match_1);
					
					// charType
					HMatch match_2 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_3_1_orchestration, match_2);
					
					// doubleType
					HMatch match_3 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_4_1_orchestration, match_3);
					
					// floatType
					HMatch match_4 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_10_1_orchestration, match_4);
					
					// intType
					HMatch match_5 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_7_1_orchestration, match_5);
					
					// longType
					HMatch match_6 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_9_1_orchestration, match_6);
					
					// shortType
					HMatch match_7 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
					
					// stringType
					HMatch match_8 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_8_1_orchestration, match_8);
					
					// voidType
					HMatch match_10 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
			...
			case "Model_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlModel
						HMatch match_9 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.Type_package_Package": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__TRG_832_localSearch", 11);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[9] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_109.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "UML_MODEL", "java.lang.String"));
		csp_109.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlModel.getName(), "java.lang.String"));
		csp_109.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_110.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, booleanType.getName(), "java.lang.String"));
		csp_110.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_111.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, byteType.getName(), "java.lang.String"));
		csp_111.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		csp_112.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, charType.getName(), "java.lang.String"));
		csp_112.solve();
	...
	public boolean constraint_checker_3_method(HMatch match) {
		...
		csp_113.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, floatType.getName(), "java.lang.String"));
		csp_113.solve();
	...
	public boolean constraint_checker_4_method(HMatch match) {
		...
		csp_114.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, doubleType.getName(), "java.lang.String"));
		csp_114.solve();
	...
	public boolean constraint_checker_5_method(HMatch match) {
		...
		csp_115.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, intType.getName(), "java.lang.String"));
		csp_115.solve();
	...
	public boolean constraint_checker_6_method(HMatch match) {
		...
		csp_116.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, longType.getName(), "java.lang.String"));
		csp_116.solve();
	...
	public boolean constraint_checker_7_method(HMatch match) {
		...
		csp_117.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, shortType.getName(), "java.lang.String"));
		csp_117.solve();
	...
	public boolean constraint_checker_8_method(HMatch match) {
		...
		csp_118.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_118.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, stringType.getName(), "java.lang.String"));
		csp_118.solve();
		
		boolean predicate = csp_118.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_9_method(HMatch match) {
		...
		csp_119.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, voidType.getName(), "java.lang.String"));
		csp_119.solve();
		
		boolean predicate = csp_119.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_10_method(HMatch match) {
		...
		csp_98.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "UML_MODEL", "java.lang.String"));
		csp_98.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlModel.getName(), "java.lang.String"));
		csp_98.solve();
	...
	public boolean constraint_checker_11_method(HMatch match) {
		...
		csp_99.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, booleanType.getName(), "java.lang.String"));
		csp_99.solve();
	...
	public boolean constraint_checker_12_method(HMatch match) {
		...
		csp_100.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, byteType.getName(), "java.lang.String"));
		csp_100.solve();
	...
	public boolean constraint_checker_13_method(HMatch match) {
		...
		csp_101.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, charType.getName(), "java.lang.String"));
		csp_101.solve();
	...
	public boolean constraint_checker_14_method(HMatch match) {
		...
		csp_102.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, floatType.getName(), "java.lang.String"));
		csp_102.solve();
	...
	public boolean constraint_checker_15_method(HMatch match) {
		...
		csp_103.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, doubleType.getName(), "java.lang.String"));
		csp_103.solve();
	...
	public boolean constraint_checker_16_method(HMatch match) {
		...
		csp_104.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, intType.getName(), "java.lang.String"));
		csp_104.solve();
	...
	public boolean constraint_checker_17_method(HMatch match) {
		...
		csp_105.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, longType.getName(), "java.lang.String"));
		csp_105.solve();
	...
	public boolean constraint_checker_18_method(HMatch match) {
		...
		csp_106.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, shortType.getName(), "java.lang.String"));
		csp_106.solve();
	...
	public boolean constraint_checker_19_method(HMatch match) {
		...
		csp_107.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_107.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, stringType.getName(), "java.lang.String"));
		csp_107.solve();
	...
	public boolean constraint_checker_20_method(HMatch match) {
		...
		csp_108.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, voidType.getName(), "java.lang.String"));
		csp_108.solve();
