...
public class JavaCompilationUnitToExistingUmlModel__CC_795_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaCompilationUnitToExistingUmlModel__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "CompilationUnit_object_SP1": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_795_localSearch", 5);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_3_2_orchestration, match_0);
					
					// newCompilationUnit
					HMatch match_4 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_795_localSearch", 5);
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_795_localSearch", 5);
			...
			case "Package_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_795_localSearch", 5);
			...
			case "Model_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlModel
						HMatch match_3 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_795_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CC_795_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_93.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "UML_MODEL", "java.lang.String"));
		csp_93.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlModel.getName(), "java.lang.String"));
		csp_93.solve();
