...
public class OrdinaryMethodParameterToParameter__FWD_1163_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("OrdinaryMethodParameterToParameter__CONSISTENCY_1166_localSearch"), this::returnTrue  , false ));
			...
			case "JavaMethodToOperation_object_SP4": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__FWD_1163_localSearch", 4);
			...
			case "Operation_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__FWD_1163_localSearch", 4);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_3_1_orchestration, match_2);
					}
				}
				break;
			case "OrdinaryMethodParameterToParameter__SRC_1160_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__FWD_1163_localSearch", 4);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("OrdinaryMethodParameterToParameter__FWD_1163_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
