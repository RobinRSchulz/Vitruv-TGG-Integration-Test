...
public class InterfaceMethodToMethod__CC_738_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP20": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("InterfaceMethodToMethod__CC_738_localSearch", 5);
			...
			case "Interface_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceMethodToMethod__CC_738_localSearch", 5);
			...
			case "Interface_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceMethodToMethod__CC_738_localSearch", 5);
			...
			case "InterfaceMethod_object": 
				{
					if(!lazy_initialization) {
						...
						// method
						HMatch match_3 = new LocalSearchMatch("InterfaceMethodToMethod__CC_738_localSearch", 5);
			...
			case "Operation_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_4 = new LocalSearchMatch("InterfaceMethodToMethod__CC_738_localSearch", 5);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_4_1_orchestration, match_4);
					}
				}
				break;
			case "InterfaceMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_729_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "InterfaceMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_729_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("InterfaceMethodToMethod__CC_738_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceMethodToMethod__CC_738_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.members.InterfaceMethod method = (org.emftext.language.java.members.InterfaceMethod) match.getNodes()[3];
		...
		csp_82.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, method.getName(), "java.lang.String"));
		csp_82.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_82.solve();
