...
public class VariableLengthConstructorParameterToParameter__CC_1257_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VariableLengthConstructorParameterToParameter__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaConstructorToOperation_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_1257_localSearch", 6);
			...
			case "Constructor_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_1257_localSearch", 6);
			...
			case "Operation_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_1257_localSearch", 6);
			...
			case "VariableLengthParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_3 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_1257_localSearch", 6);
			...
			case "Parameter_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_4 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_1257_localSearch", 6);
			...
			case "LiteralUnlimitedNatural_object": 
				{
					if(!lazy_initialization) {
						...
						// upperValue
						HMatch match_5 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_1257_localSearch", 6);
		...
		case "Java2Uml.JavaConstructorToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__CC_1257_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Parameter) {
			...
			if(formerMatches_4 != null) {
				...
				formerMatches_4 = formerMatches_4.stream().filter(m -> !constraint_checker.check(m) || !constraint_checker_1.check(m)).collect(Collectors.toList());
	...
	public boolean constraint_checker_method(HMatch match) {
		uml.Parameter umlParameter = (uml.Parameter) match.getNodes()[4];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_199 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_199.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 0, "java.lang.String"));
		csp_199.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getLower(), "int"));
		csp_199.solve();
		
		boolean predicate = csp_199.isSatisfied();
		return predicate;
	}
	
	public boolean constraint_checker_0_method(HMatch match) {
		uml.LiteralUnlimitedNatural upperValue = (uml.LiteralUnlimitedNatural) match.getNodes()[5];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_200 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_200.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, -1, "java.lang.String"));
		csp_200.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, upperValue.getValue(), "int"));
		csp_200.solve();
		
		boolean predicate = csp_200.isSatisfied();
		return predicate;
	}
	
	public boolean constraint_checker_1_method(HMatch match) {
		org.emftext.language.java.parameters.VariableLengthParameter parameter = (org.emftext.language.java.parameters.VariableLengthParameter) match.getNodes()[3];
		uml.Parameter umlParameter = (uml.Parameter) match.getNodes()[4];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_201 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_201.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_201.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_201.solve();
		
		boolean predicate = csp_201.isSatisfied();
		return predicate;
	}
