...
public class FieldFinalToFinal__CC_601_localSearch extends GenericLocalSearchActor{
			...
			case "JavaAttributeToUmlProperty_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("FieldFinalToFinal__CC_601_localSearch", 4);
			...
			case "Field_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaField
						HMatch match_1 = new LocalSearchMatch("FieldFinalToFinal__CC_601_localSearch", 4);
			...
			case "Property_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlProperty
						HMatch match_2 = new LocalSearchMatch("FieldFinalToFinal__CC_601_localSearch", 4);
			...
			case "Final_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("FieldFinalToFinal__CC_601_localSearch", 4);
		...
		case "Java2Uml.JavaAttributeToUmlProperty_target_Property": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Property) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldFinalToFinal__CC_601_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_62.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlProperty.isIsReadOnly(), "boolean"));
		csp_62.solve();
