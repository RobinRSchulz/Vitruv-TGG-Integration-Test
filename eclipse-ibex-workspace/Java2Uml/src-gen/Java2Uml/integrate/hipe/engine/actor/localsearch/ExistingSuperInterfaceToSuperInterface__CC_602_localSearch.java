...
public class ExistingSuperInterfaceToSuperInterface__CC_602_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 7, 4, edge_explorer_3_methods);
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((uml.Generalization) o).getGeneral(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new CachedEdgeExplorer(this, 0, 4, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new CachedEdgeExplorer(this, 2, 5, edge_explorer_9_methods);
			...
			case "JavaClassifierToUmlClassifier_object_SP7": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
					...
					HMatch match_2 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
			...
			case "Interface_1_object_SP12": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
						
						// superclassifier
						HMatch match_3 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
			...
			case "Interface_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_3_2_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
			...
			case "ClassifierReference_object_SP10": 
				{
					...
					// superclassTypeRef
					HMatch match_6 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
			...
			case "Generalization_object_SP2": 
				{
					...
					// generalization
					HMatch match_7 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_3_1_orchestration, match_7);
				}
				break;
			case "ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_598_localSearch": 
				{
				...
				break;
			case "ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_585_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_598_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_585_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CC_602_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
