...
public class JavaFirstCompilationUnitToUmlModel__FWD_862_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_863_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("JavaFirstCompilationUnitToUmlModel__FWD_production"), this::returnTrue  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "JavaFirstCompilationUnitToUmlModel__SRC_859_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__FWD_862_localSearch", 2);
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register JavaFirstCompilationUnitToUmlModel__SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister JavaFirstCompilationUnitToUmlModel__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
