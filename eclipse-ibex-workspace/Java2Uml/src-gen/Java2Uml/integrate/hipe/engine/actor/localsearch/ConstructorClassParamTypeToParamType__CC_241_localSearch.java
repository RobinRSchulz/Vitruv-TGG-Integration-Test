...
public class ConstructorClassParamTypeToParamType__CC_241_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((uml.TypedElement) o).getType(); return (result instanceof uml.Class ? result : null);};
			...
			case "Class_object_SP3": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP0": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
			...
			case "JavaConstructorToOperation_object_SP2": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
			...
			case "Constructor_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
			...
			case "Class_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
			...
			case "Operation_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
			...
			case "Parameter_1_object_SP1": 
				{
					...
					// umlParameter
					HMatch match_8 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_6_1_orchestration, match_9);
				}
				break;
			case "ConstructorClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_237_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ConstructorClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_237_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaParameterToParameter_source_Parameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.parameters.Parameter) {
				{
					...
					HMatch match = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CC_241_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
