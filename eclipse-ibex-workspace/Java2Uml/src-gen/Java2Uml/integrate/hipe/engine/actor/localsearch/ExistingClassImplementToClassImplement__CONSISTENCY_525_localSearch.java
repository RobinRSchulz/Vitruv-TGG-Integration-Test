...
public class ExistingClassImplementToClassImplement__CONSISTENCY_525_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCONTEXT__SRC__interface(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCONTEXT__SRC__javaClass(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
			...
			case "ExistingClassImplementToClassImplement__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_525_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "ExistingClassImplementToClassImplement__FWD_520_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_525_localSearch", 9);
				...
				break;
			case "ExistingClassImplementToClassImplement__BWD_498_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_525_localSearch", 9);
		...
		case "Java2Uml.ExistingClassImplementToClassImplement__Marker_CONTEXT__TRG__umlInterface_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_525_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
