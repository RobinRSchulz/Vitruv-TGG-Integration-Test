...
public class EnumAbstractToAbstract__CC_346_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumAbstractToAbstract__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP9": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumAbstractToAbstract__CC_346_localSearch", 4);
			...
			case "Enumeration_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("EnumAbstractToAbstract__CC_346_localSearch", 4);
			...
			case "Enumeration_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumAbstractToAbstract__CC_346_localSearch", 4);
			...
			case "Abstract_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("EnumAbstractToAbstract__CC_346_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumAbstractToAbstract__CC_346_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_39.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.isIsAbstract(), "boolean"));
		csp_39.solve();
