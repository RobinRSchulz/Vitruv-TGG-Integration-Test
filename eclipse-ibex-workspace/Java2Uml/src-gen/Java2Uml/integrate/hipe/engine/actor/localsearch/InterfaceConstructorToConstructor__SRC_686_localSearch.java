...
public class InterfaceConstructorToConstructor__SRC_686_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceConstructorToConstructor__FWD_689_localSearch"), this::returnTrue  , false ));
			...
			case "Interface_1_object_SP10": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__SRC_686_localSearch", 2);
			...
			case "Constructor_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// constructor
						HMatch match_1 = new LocalSearchMatch("InterfaceConstructorToConstructor__SRC_686_localSearch", 2);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.members.MemberContainer_members_Member": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("InterfaceConstructorToConstructor__SRC_686_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
