...
public class VariableLengthMethodParameterToParameter__BWD_1298_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("VariableLengthMethodParameterToParameter__CONSISTENCY_1314_localSearch"), this::returnTrue  , false ));
	}
			...
			case "JavaMethodToOperation_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__BWD_1298_localSearch", 5);
			...
			case "ClassMethod_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__BWD_1298_localSearch", 5);
			...
			case "VariableLengthMethodParameterToParameter__TRG_1294_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__BWD_1298_localSearch", 5);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthMethodParameterToParameter__BWD_1298_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
