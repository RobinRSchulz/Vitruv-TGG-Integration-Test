...
public class ClassAttributeTypeToPropertyType__CC_50_localSearch extends GenericLocalSearchActor{
			...
			case "JavaAttributeToUmlProperty_object_SP2": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__CC_50_localSearch", 7);
			...
			case "Class_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__CC_50_localSearch", 7);
			...
			case "Field_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_2 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__CC_50_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__CC_50_localSearch", 7);
			...
			case "Property_object_SP4": 
				{
					...
					// property
					HMatch match_4 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__CC_50_localSearch", 7);
			...
			case "Class_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__CC_50_localSearch", 7);
			...
			case "ClassifierReference_object_SP0": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__CC_50_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_2_orchestration, match_6);
				}
				break;
			case "ClassAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_46_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_46_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__CC_50_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.types.TypedElement_typeReference_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("ClassAttributeTypeToPropertyType__CC_50_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_6.solve();
