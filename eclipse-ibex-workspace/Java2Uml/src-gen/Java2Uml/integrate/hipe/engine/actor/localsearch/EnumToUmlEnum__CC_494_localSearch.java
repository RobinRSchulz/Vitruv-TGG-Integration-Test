...
public class EnumToUmlEnum__CC_494_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((uml.Package) o).getPackagedElement().stream().filter(obj -> obj instanceof uml.Enumeration).collect(Collectors.toList());
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumToUmlEnum__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "CompilationUnit_object_SP0": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__CC_494_localSearch", 6);
			...
			case "JavaPackageToUmlPackage_object_SP1": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("EnumToUmlEnum__CC_494_localSearch", 6);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
				}
				break;
			case "Package_object_SP4": 
				{
					if(!lazy_initialization) {
						
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("EnumToUmlEnum__CC_494_localSearch", 6);
			...
			case "Package_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__CC_494_localSearch", 6);
			...
			case "Enumeration_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_4 = new LocalSearchMatch("EnumToUmlEnum__CC_494_localSearch", 6);
			...
			case "Enumeration_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("EnumToUmlEnum__CC_494_localSearch", 6);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.Package_packagedElement_PackageableElement": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__CC_494_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.classifiers.Enumeration classifier = (org.emftext.language.java.classifiers.Enumeration) match.getNodes()[4];
		uml.Enumeration umlClassifier = (uml.Enumeration) match.getNodes()[5];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_62 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_62.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_62.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_62.solve();
