...
public class EnumAttributeToProperty__CONSISTENCY_380_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.EnumAttributeToProperty__Marker) o).getCREATE__CORR__attributeToProperty();
			...
			case "JavaAttributeToUmlProperty_object_SP0": 
				{
					...
					// attributeToProperty
					HMatch match_4 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_380_localSearch", 7);
			...
			case "EnumAttributeToProperty__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_380_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "EnumAttributeToProperty__FWD_377_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_380_localSearch", 7);
				...
				break;
			case "EnumAttributeToProperty__BWD_365_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_380_localSearch", 7);
		...
		case "Java2Uml.EnumAttributeToProperty__Marker_CREATE__TRG__property_Property": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Property) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_380_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register EnumAttributeToProperty__FWD
		...
		// register EnumAttributeToProperty__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister EnumAttributeToProperty__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister EnumAttributeToProperty__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.members.Field) {
			HMatch match_1 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_380_localSearch", 7);
		...
		if(obj instanceof uml.Property) {
			HMatch match_2 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_380_localSearch", 7);
