...
public class MethodClassParamTypeToParamType__SRC_905_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodClassParamTypeToParamType__FWD_910_localSearch"), this::returnTrue  , false ));
			...
			case "Class_object_SP3": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__SRC_905_localSearch", 4);
			...
			case "ClassMethod_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("MethodClassParamTypeToParamType__SRC_905_localSearch", 4);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_2 = new LocalSearchMatch("MethodClassParamTypeToParamType__SRC_905_localSearch", 4);
			...
			case "ClassifierReference_object_SP4": 
				{
					...
					// typeReference
					HMatch match_3 = new LocalSearchMatch("MethodClassParamTypeToParamType__SRC_905_localSearch", 4);
		...
		switch(match.creator) {
			...
			case "MethodClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_890_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__SRC_905_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodClassParamTypeToParamType__SRC_905_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
