...
public class SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__SRC__superclassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 9, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__SRC__superclassTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierReferenceToUmlGeneralization) o).getSource(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__TRG__generalization(); return (result instanceof uml.Generalization ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__CORR__classRefToGeneralization();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,2,4,7}), node.getAllOverlaps().get(0));
		name2explorer.put("pac_explorer", pac_explorer);
		pac_explorer_0 = new PACExplorer(this, Arrays.asList(new Integer[] {0,3,4,5,7}), node.getAllOverlaps().get(1));
			...
			case "JavaClassifierReferenceToUmlGeneralization_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP25": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
					...
					HMatch match_8 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
			...
			case "SuperInterfaceToSuperInterface__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "SuperInterfaceToSuperInterface__FWD_1264_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
						acMatch_0.getNodes()[0] = objs[1];
						acMatch_0.getNodes()[1] = objs[3];
						acMatch_0.getNodes()[2] = objs[4];
						acMatch_0.getNodes()[4] = objs[2];
						acMatch_0.getNodes()[7] = objs[0];
				...
				break;
			case "SuperInterfaceToSuperInterface__BWD_1245_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
						acMatch_1.getNodes()[0] = objs[1];
						acMatch_1.getNodes()[3] = objs[3];
						acMatch_1.getNodes()[4] = objs[2];
						acMatch_1.getNodes()[5] = objs[4];
						acMatch_1.getNodes()[7] = objs[0];
		...
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CREATE__SRC__superclassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[9] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SuperInterfaceToSuperInterface__FWD
		...
		// register SuperInterfaceToSuperInterface__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SuperInterfaceToSuperInterface__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister SuperInterfaceToSuperInterface__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(5);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[3];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.classifiers.Interface) {
			HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
			...
			HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
		...
		if(obj instanceof uml.Interface) {
			HMatch match_4 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
			...
			HMatch match_5 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1267_localSearch", 10);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_196 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_196.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, superclassifier.getName(), "java.lang.String"));
		csp_196.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlGeneralClassifier.getName(), "java.lang.String"));
		csp_196.solve();
		
		boolean predicate = csp_196.isSatisfied();
		return predicate;
	}
