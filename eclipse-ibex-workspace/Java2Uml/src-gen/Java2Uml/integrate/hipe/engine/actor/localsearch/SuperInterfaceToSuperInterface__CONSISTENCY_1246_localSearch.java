...
public class SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__TRG__umlGeneralClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__SRC__superclassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
			...
			case "JavaClassifierReferenceToUmlGeneralization_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP25": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
					...
					HMatch match_8 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
			...
			case "SuperInterfaceToSuperInterface__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "SuperInterfaceToSuperInterface__FWD_1243_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
				...
				break;
			case "SuperInterfaceToSuperInterface__BWD_1224_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
		...
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CONTEXT__SRC__javaConcreteClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[9] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.classifiers.Interface) {
			HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
			...
			HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
		...
		if(obj instanceof uml.Interface) {
			HMatch match_4 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
			...
			HMatch match_5 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1246_localSearch", 10);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_194 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_194.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, superclassifier.getName(), "java.lang.String"));
		csp_194.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlGeneralClassifier.getName(), "java.lang.String"));
		csp_194.solve();
		
		boolean predicate = csp_194.isSatisfied();
		return predicate;
	}
