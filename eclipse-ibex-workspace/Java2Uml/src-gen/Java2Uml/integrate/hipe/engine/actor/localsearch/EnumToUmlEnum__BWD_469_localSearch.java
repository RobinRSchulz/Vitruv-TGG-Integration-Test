...
public class EnumToUmlEnum__BWD_469_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("EnumToUmlEnum__CONSISTENCY_487_localSearch"), this::returnTrue  , false ));
	}
			...
			case "CompilationUnit_object_SP3": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__BWD_469_localSearch", 5);
			...
			case "JavaPackageToUmlPackage_object_SP0": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("EnumToUmlEnum__BWD_469_localSearch", 5);
			...
			case "Package_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("EnumToUmlEnum__BWD_469_localSearch", 5);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_3_1_orchestration, match_2);
					}
				}
				break;
			case "EnumToUmlEnum__TRG_466_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("EnumToUmlEnum__BWD_469_localSearch", 5);
		...
		case "Java2Uml.JavaPackageToUmlPackage_target_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Package) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__BWD_469_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
