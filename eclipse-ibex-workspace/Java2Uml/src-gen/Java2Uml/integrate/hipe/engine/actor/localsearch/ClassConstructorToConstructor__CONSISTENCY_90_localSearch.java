...
public class ClassConstructorToConstructor__CONSISTENCY_90_localSearch extends GenericLocalSearchActor{
			...
			case "JavaConstructorToOperation_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_90_localSearch", 7);
			...
			case "ClassConstructorToConstructor__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_90_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "ClassConstructorToConstructor__FWD_87_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_90_localSearch", 7);
				...
				break;
			case "ClassConstructorToConstructor__BWD_75_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_90_localSearch", 7);
		...
		case "Java2Uml.ClassConstructorToConstructor__Marker_CREATE__SRC__constructor_Constructor": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Constructor) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_90_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ClassConstructorToConstructor__FWD
		...
		// register ClassConstructorToConstructor__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ClassConstructorToConstructor__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister ClassConstructorToConstructor__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[1];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Operation) {
			HMatch match_3 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_90_localSearch", 7);
		...
		if(obj instanceof org.emftext.language.java.members.Constructor) {
			HMatch match_0 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_90_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, constructor.getName(), "java.lang.String"));
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_10.solve();
