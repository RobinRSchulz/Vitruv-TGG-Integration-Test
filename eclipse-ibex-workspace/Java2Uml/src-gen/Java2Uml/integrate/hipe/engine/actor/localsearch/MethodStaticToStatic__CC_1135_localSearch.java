...
public class MethodStaticToStatic__CC_1135_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodStaticToStatic__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "ClassMethod_object_SP8": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodStaticToStatic__CC_1135_localSearch", 4);
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodStaticToStatic__CC_1135_localSearch", 4);
			...
			case "Operation_object_SP13": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodStaticToStatic__CC_1135_localSearch", 4);
			...
			case "Static_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("MethodStaticToStatic__CC_1135_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodStaticToStatic__CC_1135_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
