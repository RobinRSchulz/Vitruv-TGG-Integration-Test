...
public class SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1227_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SuperInterfaceToSuperInterface__CC_1231_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("SuperInterfaceToSuperInterface__SRC_1239_localSearch"), this::returnTrue  , false ));
			...
			case "ClassifierReference_object_SP10": 
				{
					...
					// superclassTypeRef
					HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1227_localSearch", 3);
			...
			case "Interface_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// superclassifier
						HMatch match_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1227_localSearch", 3);
			...
			case "Classifier_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// FILTER_NAC_NODE
						HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1227_localSearch", 3);
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1227_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
