...
public class ClassImplementToClassImplement__CONSISTENCY_136_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCREATE__SRC__interface(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCREATE__SRC__interfaceTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCONTEXT__TRG__umlClass(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCREATE__CORR__javaSuperClassifierToUmlSuperClassifier();
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,2,3,6}), node.getAllOverlaps().get(0));
			...
			case "JavaClassifierToUmlClassifier_object_SP15": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_136_localSearch", 9);
					...
					HMatch match_7 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_136_localSearch", 9);
			...
			case "ClassImplementToClassImplement__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_136_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "ClassImplementToClassImplement__FWD_133_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_136_localSearch", 9);
				...
				break;
			case "ClassImplementToClassImplement__BWD_114_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_136_localSearch", 9);
		...
		case "Java2Uml.ClassImplementToClassImplement__Marker_CREATE__SRC__interface_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_136_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ClassImplementToClassImplement__FWD
		...
		// register ClassImplementToClassImplement__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ClassImplementToClassImplement__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister ClassImplementToClassImplement__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(5);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[2];
		oMatch_Nodes_1[1] = objs[3];
