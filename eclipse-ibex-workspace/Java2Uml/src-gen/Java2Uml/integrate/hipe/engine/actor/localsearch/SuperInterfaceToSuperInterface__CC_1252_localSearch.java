...
public class SuperInterfaceToSuperInterface__CC_1252_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new EdgeExplorer(this, 5, 2, edge_explorer_4_methods);
		...
		nac_checker_0 = new NACExplorer(this, Arrays.asList(new Integer[] {5,6}), node.getAllOverlaps().get(1));
	...
	protected void initializeOrchestration() {
		...
		nac_checker_0_orchestration = initializeOrchestration(node.getOrchestrations().get(14).getPlan());
	}
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SuperInterfaceToSuperInterface__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP24": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1252_localSearch", 7);
			...
			case "Interface_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1252_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
						
						// superclassifier
						HMatch match_4 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1252_localSearch", 7);
			...
			case "Interface_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1252_localSearch", 7);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_4_2_orchestration, match_2);
						
						// umlGeneralClassifier
						HMatch match_6 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1252_localSearch", 7);
			...
			case "ClassifierReference_object_SP9": 
				{
					...
					// superclassTypeRef
					HMatch match_3 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1252_localSearch", 7);
			...
			case "Generalization_object_SP2": 
				{
					...
					// generalization
					HMatch match_5 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1252_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_4_1_orchestration, match_5);
				}
				break;
			case "SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1248_localSearch": 
				{
				...
				break;
			case "SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1237_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1248_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1252_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1237_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1252_localSearch", 7);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__CC_1252_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		oMatch_Nodes_1[0] = objs[5];
		oMatch_Nodes_1[1] = objs[6];
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		uml.Interface umlGeneralClassifier = (uml.Interface) match.getNodes()[6];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_195 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_195.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, superclassifier.getName(), "java.lang.String"));
		csp_195.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlGeneralClassifier.getName(), "java.lang.String"));
		csp_195.solve();
		
		boolean predicate = csp_195.isSatisfied();
		return predicate;
	}
