...
public class InterfaceConstructorToConstructor__CONSISTENCY_692_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCREATE__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCONTEXT__CORR__j();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		pac_explorer_0 = new PACExplorer(this, Arrays.asList(new Integer[] {1,2,3,4}), node.getAllOverlaps().get(1));
			...
			case "JavaConstructorToOperation_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_692_localSearch", 7);
			...
			case "InterfaceConstructorToConstructor__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_692_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "InterfaceConstructorToConstructor__FWD_689_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_692_localSearch", 7);
				...
				break;
			case "InterfaceConstructorToConstructor__BWD_677_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_692_localSearch", 7);
		...
		case "Java2Uml.InterfaceConstructorToConstructor__Marker_CONTEXT__TRG__umlClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_692_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register InterfaceConstructorToConstructor__FWD
		...
		// register InterfaceConstructorToConstructor__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister InterfaceConstructorToConstructor__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister InterfaceConstructorToConstructor__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[1];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.members.Constructor) {
			HMatch match_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_692_localSearch", 7);
		...
		if(obj instanceof uml.Operation) {
			HMatch match_3 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_692_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_76.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, constructor.getName(), "java.lang.String"));
		csp_76.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_76.solve();
