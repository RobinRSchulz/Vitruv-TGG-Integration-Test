...
public class EnumFinalToFinal__CONSISTENCY_425_localSearch extends GenericLocalSearchActor{
			...
			case "EnumFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_425_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "EnumFinalToFinal__FWD_422_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_425_localSearch", 5);
		...
		case "Java2Uml.EnumFinalToFinal__Marker_CONTEXT__SRC__javaConcreteClassifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_425_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Enumeration) {
			HMatch match_2 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_425_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_50.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_50.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.isIsFinalSpecialization(), "boolean"));
		csp_50.solve();
