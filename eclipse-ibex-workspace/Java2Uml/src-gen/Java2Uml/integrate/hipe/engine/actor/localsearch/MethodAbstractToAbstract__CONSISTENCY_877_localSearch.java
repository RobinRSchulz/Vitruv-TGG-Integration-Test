...
public class MethodAbstractToAbstract__CONSISTENCY_877_localSearch extends GenericLocalSearchActor{
			...
			case "MethodAbstractToAbstract__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_877_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "MethodAbstractToAbstract__FWD_874_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_877_localSearch", 5);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_877_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Operation) {
			HMatch match_2 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_877_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_142 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_142.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_142.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsAbstract(), "boolean"));
		csp_142.solve();
		
		boolean predicate = csp_142.isSatisfied();
		return predicate;
	}
