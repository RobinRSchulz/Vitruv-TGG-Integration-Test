...
public class MethodAbstractToAbstract__CONSISTENCY_898_localSearch extends GenericLocalSearchActor{
			...
			case "MethodAbstractToAbstract__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_898_localSearch", 5);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_1_orchestration, match_4);
				}
				break;
			case "MethodAbstractToAbstract__FWD_895_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_898_localSearch", 5);
		...
		case "Java2Uml.MethodAbstractToAbstract__Marker_CONTEXT__SRC__javaMethod_ClassMethod": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_898_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register MethodAbstractToAbstract__FWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister MethodAbstractToAbstract__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Operation) {
			HMatch match_2 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_898_localSearch", 5);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_144.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_144.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsAbstract(), "boolean"));
		csp_144.solve();
