...
public class InterfaceToUmlInterface__CONSISTENCY_813_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__TRG__umlPackage(); return (result instanceof uml.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__CORR__javaPackToUmlPack();
		...
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {0,1,2,4,6}), node.getAllOverlaps().get(0));
		name2explorer.put("pac_explorer", pac_explorer);
		pac_explorer_0 = new PACExplorer(this, Arrays.asList(new Integer[] {1,2,3,4,6}), node.getAllOverlaps().get(1));
			...
			case "JavaClassifierToUmlClassifier_object_SP0": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_813_localSearch", 8);
			...
			case "InterfaceToUmlInterface__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_813_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_3_1_orchestration, match_7);
				}
				break;
			case "InterfaceToUmlInterface__FWD_810_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_813_localSearch", 8);
				...
				break;
			case "InterfaceToUmlInterface__BWD_795_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_813_localSearch", 8);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_813_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register InterfaceToUmlInterface__FWD
		...
		// register InterfaceToUmlInterface__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister InterfaceToUmlInterface__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(5);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister InterfaceToUmlInterface__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(5);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[1];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.classifiers.Interface) {
			HMatch match_0 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_813_localSearch", 8);
		...
		if(obj instanceof uml.Interface) {
			HMatch match_3 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_813_localSearch", 8);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_94.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_94.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_94.solve();
