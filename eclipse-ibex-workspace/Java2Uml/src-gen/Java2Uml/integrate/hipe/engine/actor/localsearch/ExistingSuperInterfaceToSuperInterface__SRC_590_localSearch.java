...
public class ExistingSuperInterfaceToSuperInterface__SRC_590_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ExistingSuperInterfaceToSuperInterface__FWD_594_localSearch"), this::returnTrue  , false ));
			...
			case "Interface_1_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__SRC_590_localSearch", 3);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_3_1_orchestration, match_0);
					
					// superclassifier
					HMatch match_2 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__SRC_590_localSearch", 3);
			...
			case "ClassifierReference_object_SP12": 
				{
					...
					// superclassTypeRef
					HMatch match_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__SRC_590_localSearch", 3);
		...
		switch(match.creator) {
			...
			case "ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_577_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__SRC_590_localSearch", 3);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__SRC_590_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
