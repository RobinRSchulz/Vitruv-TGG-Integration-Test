...
public class InterfaceMethodToMethod__FWD_535_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((org.emftext.language.java.members.MemberContainer) o).getMembers().stream().filter(obj -> obj instanceof org.emftext.language.java.members.InterfaceMethod).collect(Collectors.toList());
			...
			case "JavaClassifierToUmlClassifier_object_SP17": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("InterfaceMethodToMethod__FWD_535_localSearch", 4);
			...
			case "Interface_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceMethodToMethod__FWD_535_localSearch", 4);
			...
			case "Interface_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceMethodToMethod__FWD_535_localSearch", 4);
			...
			case "InterfaceMethod_object": 
				{
					if(!lazy_initialization) {
						...
						// method
						HMatch match_3 = new LocalSearchMatch("InterfaceMethodToMethod__FWD_535_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceMethodToMethod__FWD_535_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
