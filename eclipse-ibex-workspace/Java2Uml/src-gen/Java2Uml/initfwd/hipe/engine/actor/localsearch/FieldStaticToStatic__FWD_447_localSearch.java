...
public class FieldStaticToStatic__FWD_447_localSearch extends GenericLocalSearchActor{
			...
			case "JavaAttributeToUmlProperty_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("FieldStaticToStatic__FWD_447_localSearch", 4);
			...
			case "Field_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaField
						HMatch match_1 = new LocalSearchMatch("FieldStaticToStatic__FWD_447_localSearch", 4);
			...
			case "Property_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlProperty
						HMatch match_2 = new LocalSearchMatch("FieldStaticToStatic__FWD_447_localSearch", 4);
			...
			case "Static_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("FieldStaticToStatic__FWD_447_localSearch", 4);
		...
		case "Java2Uml.JavaAttributeToUmlProperty_target_Property": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Property) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldStaticToStatic__FWD_447_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
