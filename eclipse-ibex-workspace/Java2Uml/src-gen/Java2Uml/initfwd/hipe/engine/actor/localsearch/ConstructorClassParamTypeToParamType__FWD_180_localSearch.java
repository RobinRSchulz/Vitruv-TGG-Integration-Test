...
public class ConstructorClassParamTypeToParamType__FWD_180_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new CachedEdgeExplorer(this, 2, 3, edge_explorer_10_methods);
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11 = new EdgeExplorer(this, 7, 8, edge_explorer_11_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ConstructorClassParamTypeToParamType__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Class_object_SP5": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
			...
			case "JavaConstructorToOperation_object_SP2": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
			...
			case "Constructor_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
			...
			case "Class_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
			...
			case "Operation_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
			...
			case "Parameter_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_8 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
			...
			case "ClassifierReference_object_SP8": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
		...
		switch(match.creator) {
			...
			case "ConstructorClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_164_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaParameterToParameter_target_Parameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Parameter) {
				{
					...
					HMatch match = new LocalSearchMatch("ConstructorClassParamTypeToParamType__FWD_180_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[8] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_17.solve();
