...
public class InterfaceMethodToMethod__CONSISTENCY_527_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceMethodToMethod__Marker) o).getCREATE__CORR__javaMethodToOperation();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceMethodToMethod__Marker) o).getCREATE__SRC__method(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
