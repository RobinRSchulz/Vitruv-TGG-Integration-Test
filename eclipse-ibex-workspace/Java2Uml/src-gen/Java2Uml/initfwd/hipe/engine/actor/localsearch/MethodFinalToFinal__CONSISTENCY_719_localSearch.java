...
public class MethodFinalToFinal__CONSISTENCY_719_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodFinalToFinal__Marker) o).getCONTEXT__SRC__javaMethod(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 4, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodFinalToFinal__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Final ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Java2Uml.MethodFinalToFinal__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodFinalToFinal__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodFinalToFinal__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "ClassMethod_object_SP0": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_719_localSearch", 5);
			...
			case "Final_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_719_localSearch", 5);
			...
			case "Operation_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_719_localSearch", 5);
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_719_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "MethodFinalToFinal__Marker_object": 
				{
					...
					// MethodFinalToFinal_eMoflon_ProtocolNode
					HMatch match_4 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_719_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_719_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			...
			break;
		case "Java2Uml.MethodFinalToFinal__Marker_CONTEXT__SRC__javaMethod_ClassMethod": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
			...
			break;
		case "Java2Uml.MethodFinalToFinal__Marker_CREATE__SRC__modifier_Final": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.modifiers.Final) {
				{
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			...
			break;
		case "Java2Uml.MethodFinalToFinal__Marker_CONTEXT__CORR__javaMethodToOperation_JavaMethodToOperation": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.MethodFinalToFinal__Marker_CONTEXT__TRG__umlOperation_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register MethodFinalToFinal_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister MethodFinalToFinal_eMoflon_ProtocolNode
		Collection<HMatch> matches_4 = obj2matches.get(objs[4]);
		if(matches_4 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_78.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_78.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsLeaf(), "boolean"));
		csp_78.solve();
