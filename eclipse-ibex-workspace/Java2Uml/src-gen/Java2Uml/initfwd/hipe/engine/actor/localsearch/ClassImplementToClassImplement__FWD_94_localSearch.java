...
public class ClassImplementToClassImplement__FWD_94_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassImplementToClassImplement__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "Class_object_SP2": 
				{
					...
					// javaClass
					HMatch match_0 = new LocalSearchMatch("ClassImplementToClassImplement__FWD_94_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP11": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ClassImplementToClassImplement__FWD_94_localSearch", 5);
			...
			case "Class_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_2 = new LocalSearchMatch("ClassImplementToClassImplement__FWD_94_localSearch", 5);
			...
			case "Interface_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// interface
						HMatch match_3 = new LocalSearchMatch("ClassImplementToClassImplement__FWD_94_localSearch", 5);
			...
			case "ClassifierReference_object_SP5": 
				{
					...
					// interfaceTypeRef
					HMatch match_4 = new LocalSearchMatch("ClassImplementToClassImplement__FWD_94_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "ClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_76_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassImplementToClassImplement__FWD_94_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassImplementToClassImplement__FWD_94_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
