...
public class OrdinaryMethodParameterToParameter__CONSISTENCY_804_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.OrdinaryMethodParameterToParameter__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.OrdinaryMethodParameterToParameter__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Java2Uml.OrdinaryMethodParameterToParameter__Marker) o).getCREATE__CORR__parameterToParameter();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Java2Uml.OrdinaryMethodParameterToParameter__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
			...
			case "ClassMethod_object_SP1": 
				{
					...
					// javaParametrizable
					HMatch match_0 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "OrdinaryParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_1 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "Operation_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "Parameter_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_3 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP2": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "JavaParameterToParameter_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "OrdinaryMethodParameterToParameter__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_804_localSearch", 7);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("OrdinaryMethodParameterToParameter__CONSISTENCY_804_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
