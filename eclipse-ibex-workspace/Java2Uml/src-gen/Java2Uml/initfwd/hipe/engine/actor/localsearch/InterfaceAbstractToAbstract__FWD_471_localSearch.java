...
public class InterfaceAbstractToAbstract__FWD_471_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP9": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceAbstractToAbstract__FWD_471_localSearch", 4);
			...
			case "Interface_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceAbstractToAbstract__FWD_471_localSearch", 4);
			...
			case "Interface_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceAbstractToAbstract__FWD_471_localSearch", 4);
			...
			case "Abstract_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("InterfaceAbstractToAbstract__FWD_471_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAbstractToAbstract__FWD_471_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_42.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.isIsAbstract(), "boolean"));
		csp_42.solve();
