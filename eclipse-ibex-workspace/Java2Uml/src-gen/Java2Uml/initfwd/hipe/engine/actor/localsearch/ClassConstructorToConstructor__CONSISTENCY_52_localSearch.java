...
public class ClassConstructorToConstructor__CONSISTENCY_52_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassConstructorToConstructor__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 6, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassConstructorToConstructor__Marker) o).getCREATE__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.ClassConstructorToConstructor__Marker) o).getCONTEXT__CORR__j();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.classifiers.Class) return edge_explorer_7_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassConstructorToConstructor__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Java2Uml.ClassConstructorToConstructor__Marker) o).getCREATE__CORR__javaConstructorToOperation();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassConstructorToConstructor__Marker) o).getCREATE__SRC__constructor(); return (result instanceof org.emftext.language.java.members.Constructor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.multi_lookup = (o) -> ((uml.Class) o).getOwnedOperation();
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> ((uml.Operation) o).getClass();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassConstructorToConstructor__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Constructor_object_SP0": 
				{
					...
					// constructor
					HMatch match_0 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_52_localSearch", 7);
			...
			case "Class_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_52_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_5_1_orchestration, match_1);
					}
				}
				break;
			case "Class_1_object_SP6": 
				{
					if(!lazy_initialization) {
						
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_52_localSearch", 7);
			...
			case "Operation_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_3 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_52_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					// j
					HMatch match_4 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_52_localSearch", 7);
			...
			case "JavaConstructorToOperation_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_52_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_6_1_orchestration, match_5);
				}
				break;
			case "ClassConstructorToConstructor__Marker_object": 
				{
					...
					// ClassConstructorToConstructor_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_52_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "ClassConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_49_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_49_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_52_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Java2Uml.ClassConstructorToConstructor__Marker_CONTEXT__TRG__umlClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("ClassConstructorToConstructor__CONSISTENCY_52_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
			...
			break;
		case "Java2Uml.ClassConstructorToConstructor__Marker_CREATE__TRG__umlOperation_Operation": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.ClassConstructorToConstructor__Marker_CONTEXT__CORR__j_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
		...
		case "org.emftext.language.java.members.MemberContainer_members_Member": 
			...
			break;
		case "Java2Uml.ClassConstructorToConstructor__Marker_CONTEXT__SRC__javaConcreteClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			...
			break;
		case "Java2Uml.ClassConstructorToConstructor__Marker_CREATE__CORR__javaConstructorToOperation_JavaConstructorToOperation": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.ClassConstructorToConstructor__Marker_CREATE__SRC__constructor_Constructor": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Constructor) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ClassConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG
		...
		// register ClassConstructorToConstructor_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ClassConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG
		OverlapMatch oMatch_0 = new OverlapMatch(1);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[3];
		Collection<HMatch> oMatches_0 = overlap2matches_0.get(oMatch_0);
		...
		// deregister ClassConstructorToConstructor_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, constructor.getName(), "java.lang.String"));
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_5.solve();
