...
public class FieldFinalToFinal__CONSISTENCY_430_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.FieldFinalToFinal__Marker) o).getCONTEXT__TRG__umlProperty(); return (result instanceof uml.Property ? result : null);};
			...
			case "Field_object_SP0": 
				{
					...
					// javaField
					HMatch match_0 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_430_localSearch", 5);
			...
			case "Final_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_430_localSearch", 5);
			...
			case "Property_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlProperty
						HMatch match_2 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_430_localSearch", 5);
			...
			case "JavaAttributeToUmlProperty_object_SP0": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_430_localSearch", 5);
			...
			case "FieldFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_430_localSearch", 5);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_430_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_36.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_36.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlProperty.isIsReadOnly(), "boolean"));
		csp_36.solve();
