package Java2Uml.initfwd.hipe.engine.actor.localsearch;
...
public class JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch extends GenericLocalSearchActor{
	...
	SearchOrchestration edge_explorer_26_1_orchestration;
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__doubleType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 14, 5, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 14, 1, edge_explorer_3_methods);
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new EdgeExplorer(this, 7, 11, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__umlModel(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_6 = new CachedEdgeExplorer(this, 14, 11, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__shortType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_7 = new CachedEdgeExplorer(this, 14, 9, edge_explorer_7_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 9, 11, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__booleanType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_9 = new CachedEdgeExplorer(this, 14, 2, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__byteType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_10 = new CachedEdgeExplorer(this, 14, 3, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__stringType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_11 = new CachedEdgeExplorer(this, 14, 10, edge_explorer_11_methods);
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12 = new EdgeExplorer(this, 2, 11, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((uml.Type) o).getPackage(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_13_methods.multi_opposite_lookup = (o) -> ((uml.Package) o).getOwnedType().stream().filter(obj -> obj instanceof uml.PrimitiveType).collect(Collectors.toList());
						edge_explorer_13 = new EdgeExplorer(this, 12, 11, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToUmlModel) o).getTarget(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_14 = new CachedEdgeExplorer(this, 13, 11, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.multi_lookup = (o) -> ((org.emftext.language.java.containers.Package) o).getCompilationUnits();
						edge_explorer_15_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.containers.Package) return edge_explorer_15_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_15 = new EdgeExplorer(this, 1, 0, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__longType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_16 = new CachedEdgeExplorer(this, 14, 8, edge_explorer_16_methods);
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						...
						edge_explorer_17 = new EdgeExplorer(this, 8, 11, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((uml.Type) o).getPackage(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_18_methods.multi_opposite_lookup = (o) -> ((uml.Package) o).getOwnedType().stream().filter(obj -> obj instanceof uml.PrimitiveType).collect(Collectors.toList());
						edge_explorer_18 = new EdgeExplorer(this, 4, 11, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__SRC__compilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
						edge_explorer_19 = new CachedEdgeExplorer(this, 14, 0, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__charType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_20 = new CachedEdgeExplorer(this, 14, 4, edge_explorer_20_methods);
		name2explorer.put("edge_explorer_20", edge_explorer_20);
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToUmlModel) o).getSource(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
						edge_explorer_21 = new CachedEdgeExplorer(this, 13, 0, edge_explorer_21_methods);
		name2explorer.put("edge_explorer_21", edge_explorer_21);
		EdgeLookupMethods edge_explorer_22_methods = new EdgeLookupMethods();
						edge_explorer_22_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__voidType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_22 = new CachedEdgeExplorer(this, 14, 12, edge_explorer_22_methods);
		name2explorer.put("edge_explorer_22", edge_explorer_22);
		EdgeLookupMethods edge_explorer_23_methods = new EdgeLookupMethods();
						edge_explorer_23_methods.unique_lookup = (o) -> ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__CORR__javaCompUnitToUmlModel();
						edge_explorer_23 = new CachedEdgeExplorer(this, 14, 13, edge_explorer_23_methods);
		...
		EdgeLookupMethods edge_explorer_24_methods = new EdgeLookupMethods();
						...
						edge_explorer_24 = new EdgeExplorer(this, 5, 11, edge_explorer_24_methods);
		...
		EdgeLookupMethods edge_explorer_25_methods = new EdgeLookupMethods();
						...
						edge_explorer_25 = new EdgeExplorer(this, 10, 11, edge_explorer_25_methods);
		...
		EdgeLookupMethods edge_explorer_26_methods = new EdgeLookupMethods();
						...
						edge_explorer_26 = new EdgeExplorer(this, 6, 11, edge_explorer_26_methods);
		name2explorer.put("edge_explorer_26", edge_explorer_26);
		EdgeLookupMethods edge_explorer_27_methods = new EdgeLookupMethods();
						edge_explorer_27_methods.unique_lookup = (o) -> {EObject result = ((uml.Type) o).getPackage(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_27_methods.multi_opposite_lookup = (o) -> ((uml.Package) o).getOwnedType().stream().filter(obj -> obj instanceof uml.PrimitiveType).collect(Collectors.toList());
						edge_explorer_27 = new EdgeExplorer(this, 3, 11, edge_explorer_27_methods);
		name2explorer.put("edge_explorer_27", edge_explorer_27);
		EdgeLookupMethods edge_explorer_28_methods = new EdgeLookupMethods();
						edge_explorer_28_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__floatType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_28 = new CachedEdgeExplorer(this, 14, 6, edge_explorer_28_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_16_1_orchestration = initializeOrchestration(node.getOrchestrations().get(27).getPlan());
		edge_explorer_17_0_orchestration = initializeOrchestration(node.getOrchestrations().get(28).getPlan());
		edge_explorer_18_0_orchestration = initializeOrchestration(node.getOrchestrations().get(29).getPlan());
		edge_explorer_18_1_orchestration = initializeOrchestration(node.getOrchestrations().get(30).getPlan());
		...
		edge_explorer_24_0_orchestration = initializeOrchestration(node.getOrchestrations().get(36).getPlan());
		edge_explorer_25_0_orchestration = initializeOrchestration(node.getOrchestrations().get(37).getPlan());
		edge_explorer_26_0_orchestration = initializeOrchestration(node.getOrchestrations().get(38).getPlan());
		edge_explorer_26_1_orchestration = initializeOrchestration(node.getOrchestrations().get(39).getPlan());
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "CompilationUnit_object_SP2": 
				{
					
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
			...
			case "Package_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_1 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
			...
			case "PrimitiveType_object": 
				{
					if(!lazy_initialization) {
						...
						// booleanType
						HMatch match_2 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_9_1_orchestration, match_2);
						
						// byteType
						HMatch match_3 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_10_1_orchestration, match_3);
						
						// charType
						HMatch match_4 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_18_1_orchestration, match_4);
						
						// doubleType
						HMatch match_5 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_2_orchestration, match_5);
						
						// floatType
						HMatch match_6 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_6.getNodes()[6] = objs[0];
						start(edge_explorer_26_1_orchestration, match_6);
						
						// intType
						HMatch match_7 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_7.getNodes()[7] = objs[0];
						start(edge_explorer_4_1_orchestration, match_7);
						
						// longType
						HMatch match_8 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_8.getNodes()[8] = objs[0];
						start(edge_explorer_16_1_orchestration, match_8);
						
						// shortType
						HMatch match_9 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_9.getNodes()[9] = objs[0];
						start(edge_explorer_7_1_orchestration, match_9);
						
						// stringType
						HMatch match_10 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_10.getNodes()[10] = objs[0];
						start(edge_explorer_11_1_orchestration, match_10);
						
						// voidType
						HMatch match_12 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_12.getNodes()[12] = objs[0];
						start(edge_explorer_13_1_orchestration, match_12);
					}
				}
				break;
			case "Model_object": 
				{
					if(!lazy_initialization) {
						...
						// umlModel
						HMatch match_11 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
						match_11.getNodes()[11] = objs[0];
						start(edge_explorer_4_2_orchestration, match_11);
					}
				}
				break;
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_13 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
					match_13.getNodes()[13] = objs[0];
					start(edge_explorer_14_1_orchestration, match_13);
				}
				break;
			case "JavaFirstCompilationUnitToUmlModel__Marker_object": 
				{
					...
					HMatch match_14 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
		...
		case "Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker_CREATE__TRG__doubleType_PrimitiveType": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.PrimitiveType) {
				{
					...
					HMatch match = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_589_localSearch", 15);
					Object[] objs = match.getNodes();
					objs[14] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_57.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "UML_MODEL", "java.lang.String"));
		csp_57.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlModel.getName(), "java.lang.String"));
		csp_57.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_58.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, booleanType.getName(), "java.lang.String"));
		csp_58.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_59.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, byteType.getName(), "java.lang.String"));
		csp_59.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		csp_60.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, charType.getName(), "java.lang.String"));
		csp_60.solve();
	...
	public boolean constraint_checker_3_method(HMatch match) {
		...
		csp_61.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, floatType.getName(), "java.lang.String"));
		csp_61.solve();
	...
	public boolean constraint_checker_4_method(HMatch match) {
		...
		csp_62.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_62.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, doubleType.getName(), "java.lang.String"));
		csp_62.solve();
		
		boolean predicate = csp_62.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_5_method(HMatch match) {
		...
		csp_63.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_63.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, intType.getName(), "java.lang.String"));
		csp_63.solve();
		
		boolean predicate = csp_63.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_6_method(HMatch match) {
		...
		csp_64.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, longType.getName(), "java.lang.String"));
		csp_64.solve();
		
		boolean predicate = csp_64.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_7_method(HMatch match) {
		...
		csp_65.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, shortType.getName(), "java.lang.String"));
		csp_65.solve();
		
		boolean predicate = csp_65.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_8_method(HMatch match) {
		...
		csp_66.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, stringType.getName(), "java.lang.String"));
		csp_66.solve();
		
		boolean predicate = csp_66.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_9_method(HMatch match) {
		...
		csp_67.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, voidType.getName(), "java.lang.String"));
		csp_67.solve();
		
		boolean predicate = csp_67.isSatisfied();
		return predicate;
	}
