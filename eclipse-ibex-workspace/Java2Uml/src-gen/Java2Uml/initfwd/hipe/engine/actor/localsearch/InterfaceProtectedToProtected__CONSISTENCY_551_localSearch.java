...
public class InterfaceProtectedToProtected__CONSISTENCY_551_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceProtectedToProtected__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 4, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceProtectedToProtected__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Protected ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 4, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceProtectedToProtected__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceProtectedToProtected__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceProtectedToProtected__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Interface_1_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_551_localSearch", 5);
			...
			case "Protected_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_551_localSearch", 5);
			...
			case "Interface_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_551_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP20": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_551_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "InterfaceProtectedToProtected__Marker_object": 
				{
					...
					// InterfaceProtectedToProtected_eMoflon_ProtocolNode
					HMatch match_4 = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_551_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_551_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
			...
			break;
		case "Java2Uml.InterfaceProtectedToProtected__Marker_CONTEXT__SRC__javaConcreteClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
			...
			break;
		case "Java2Uml.InterfaceProtectedToProtected__Marker_CREATE__SRC__modifier_Protected": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.InterfaceProtectedToProtected__Marker_CONTEXT__TRG__umlClassifier_Interface": 
			if(!lazy_initialization) {
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			...
			break;
		case "Java2Uml.InterfaceProtectedToProtected__Marker_CONTEXT__CORR__javaClassifierToUmlClassifier_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register InterfaceProtectedToProtected_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister InterfaceProtectedToProtected_eMoflon_ProtocolNode
		Collection<HMatch> matches_4 = obj2matches.get(objs[4]);
		if(matches_4 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected csp_51 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected();
		csp_51.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_51.solve();
