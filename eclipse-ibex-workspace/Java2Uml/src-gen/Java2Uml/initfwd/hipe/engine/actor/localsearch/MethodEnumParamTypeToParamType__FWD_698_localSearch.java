...
public class MethodEnumParamTypeToParamType__FWD_698_localSearch extends GenericLocalSearchActor{
			...
			case "Enumeration_object_SP3": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP9": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
			...
			case "JavaMethodToOperation_object_SP3": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
			...
			case "ClassMethod_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
			...
			case "Parameter_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
			...
			case "Operation_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
			...
			case "Parameter_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_8 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
			...
			case "ClassifierReference_object_SP10": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
		...
		switch(match.creator) {
			...
			case "MethodEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_682_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.types.TypedElement_typeReference_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodEnumParamTypeToParamType__FWD_698_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[9] = msg.target;
					currentDepth++;
