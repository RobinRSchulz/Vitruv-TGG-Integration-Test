...
public class OrdinaryMethodParameterToParameter__FWD_812_localSearch extends GenericLocalSearchActor{
			...
			case "JavaMethodToOperation_object_SP3": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__FWD_812_localSearch", 4);
			...
			case "ClassMethod_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__FWD_812_localSearch", 4);
			...
			case "Operation_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__FWD_812_localSearch", 4);
			...
			case "OrdinaryParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_3 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__FWD_812_localSearch", 4);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("OrdinaryMethodParameterToParameter__FWD_812_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
