...
public class OrdinaryConstructorParameterToParameter__CONSISTENCY_804_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.OrdinaryConstructorParameterToParameter__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.OrdinaryConstructorParameterToParameter__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.Constructor ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.OrdinaryConstructorParameterToParameter__Marker) o).getCREATE__CORR__parameterToParameter();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.OrdinaryConstructorParameterToParameter__Marker) o).getCREATE__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.OrdinaryParameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.OrdinaryConstructorParameterToParameter__Marker) o).getCONTEXT__CORR__javaConstructorToOperation();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaParameterToParameter) o).getSource(); return (result instanceof org.emftext.language.java.parameters.OrdinaryParameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((org.emftext.language.java.parameters.Parametrizable) o).getParameters().stream().filter(obj -> obj instanceof org.emftext.language.java.parameters.OrdinaryParameter).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.OrdinaryConstructorParameterToParameter__Marker) o).getCREATE__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						...
						edge_explorer_13 = new CachedEdgeExplorer(this, 4, 2, edge_explorer_13_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("OrdinaryConstructorParameterToParameter__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Constructor_object_SP2": 
				{
					...
					// javaParametrizable
					HMatch match_0 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "OrdinaryParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_1 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "Operation_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "Parameter_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_3 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "JavaConstructorToOperation_object_SP2": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_804_localSearch", 7);
			...
			case "JavaParameterToParameter_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_804_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_5_1_orchestration, match_5);
				}
				break;
			case "OrdinaryConstructorParameterToParameter__Marker_object": 
				{
					...
					// OrdinaryConstructorParameterToParameter_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_804_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Java2Uml.OrdinaryConstructorParameterToParameter__Marker_CONTEXT__TRG__umlOperation_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_804_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
		...
		case "Java2Uml.JavaConstructorToOperation_source_Constructor": 
			...
			break;
		case "Java2Uml.OrdinaryConstructorParameterToParameter__Marker_CONTEXT__SRC__javaParametrizable_Constructor": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Constructor) {
				{
			...
			break;
		case "Java2Uml.OrdinaryConstructorParameterToParameter__Marker_CREATE__CORR__parameterToParameter_JavaParameterToParameter": 
			if(!lazy_initialization) {
				{
		...
		case "Java2Uml.JavaParameterToParameter_target_Parameter": 
			...
			break;
		case "Java2Uml.OrdinaryConstructorParameterToParameter__Marker_CREATE__SRC__parameter_OrdinaryParameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.parameters.OrdinaryParameter) {
				{
			...
			break;
		case "Java2Uml.OrdinaryConstructorParameterToParameter__Marker_CONTEXT__CORR__javaConstructorToOperation_JavaConstructorToOperation": 
			if(!lazy_initialization) {
				{
		...
		case "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter": 
			...
			break;
		case "Java2Uml.OrdinaryConstructorParameterToParameter__Marker_CREATE__TRG__umlParameter_Parameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Parameter) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register OrdinaryConstructorParameterToParameter_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister OrdinaryConstructorParameterToParameter_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.parameters.OrdinaryParameter) {
			HMatch match_1 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_804_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.parameters.OrdinaryParameter parameter = (org.emftext.language.java.parameters.OrdinaryParameter) match.getNodes()[1];
		...
		csp_87.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_87.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_87.solve();
