...
public class MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodClassParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaMethodToOperation) o).getSource(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Java2Uml.MethodClassParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodClassParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodClassParamTypeToParamType__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
			...
			case "Class_object_SP1": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
			...
			case "ClassMethod_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
			...
			case "Parameter_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_2 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
			...
			case "ClassifierReference_object_SP2": 
				{
					...
					// typeReference
					HMatch match_3 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
			...
			case "Class_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
			...
			case "Operation_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
			...
			case "Parameter_1_object_SP1": 
				{
					...
					// umlParameter
					HMatch match_6 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
			...
			case "JavaClassifierToUmlClassifier_object_SP2": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
			...
			case "JavaMethodToOperation_object_SP4": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
			...
			case "JavaParameterToParameter_object_SP2": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
			...
			case "MethodClassParamTypeToParamType__Marker_object": 
				{
					...
					HMatch match_10 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
					match_10.getNodes()[10] = objs[0];
					start(edge_explorer_4_1_orchestration, match_10);
				}
				break;
			case "MethodClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_619_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_619_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodClassParamTypeToParamType__CONSISTENCY_623_localSearch", 11);
					Object[] objs = match.getNodes();
					objs[5] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_70.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_70.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_70.solve();
		
		boolean predicate = csp_70.isSatisfied();
		return predicate;
	}
