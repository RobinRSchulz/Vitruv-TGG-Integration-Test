...
public class InterfaceConstructorToConstructor__CONSISTENCY_487_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCREATE__CORR__javaConstructorToOperation();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((uml.Interface) o).getOwnedOperation();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> ((uml.Operation) o).getInterface();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
			...
			case "Constructor_object_SP0": 
				{
					...
					// constructor
					HMatch match_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_487_localSearch", 7);
			...
			case "Interface_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_487_localSearch", 7);
			...
			case "Interface_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_487_localSearch", 7);
			...
			case "Operation_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_3 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_487_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP10": 
				{
					...
					// j
					HMatch match_4 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_487_localSearch", 7);
			...
			case "JavaConstructorToOperation_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_487_localSearch", 7);
			...
			case "InterfaceConstructorToConstructor__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_487_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "InterfaceConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_484_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "InterfaceConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_484_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_487_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.InterfaceConstructorToConstructor__Marker_CREATE__TRG__umlOperation_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_487_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_44.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, constructor.getName(), "java.lang.String"));
		csp_44.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_44.solve();
