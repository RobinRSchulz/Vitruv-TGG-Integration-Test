...
public class ExistingSuperClassToSuperClass__FWD_409_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass__FWD_409_localSearch", 7);
					...
					HMatch match_2 = new LocalSearchMatch("ExistingSuperClassToSuperClass__FWD_409_localSearch", 7);
			...
			case "Class_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ExistingSuperClassToSuperClass__FWD_409_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
						
						// superclassifier
						HMatch match_3 = new LocalSearchMatch("ExistingSuperClassToSuperClass__FWD_409_localSearch", 7);
			...
			case "Class_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ExistingSuperClassToSuperClass__FWD_409_localSearch", 7);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_6_1_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("ExistingSuperClassToSuperClass__FWD_409_localSearch", 7);
			...
			case "ClassifierReference_object_SP9": 
				{
					...
					// superclassTypeRef
					HMatch match_6 = new LocalSearchMatch("ExistingSuperClassToSuperClass__FWD_409_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_391_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass__FWD_409_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperClassToSuperClass__FWD_409_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
