...
public class ConstructorEnumParamTypeToParamType__CONSISTENCY_195_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getSource(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaConstructorToOperation();
						edge_explorer_16 = new CachedEdgeExplorer(this, 10, 8, edge_explorer_16_methods);
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.Constructor ? result : null);};
