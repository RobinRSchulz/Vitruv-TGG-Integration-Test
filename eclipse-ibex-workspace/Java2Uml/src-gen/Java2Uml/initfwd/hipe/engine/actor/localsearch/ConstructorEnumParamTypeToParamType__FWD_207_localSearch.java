...
public class ConstructorEnumParamTypeToParamType__FWD_207_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4 = new CachedEdgeExplorer(this, 5, 8, edge_explorer_4_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ConstructorEnumParamTypeToParamType__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Enumeration_object_SP2": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP3": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
			...
			case "JavaConstructorToOperation_object_SP1": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
			...
			case "Constructor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
			...
			case "Parameter_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP3": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
			...
			case "Enumeration_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
						match_6.getNodes()[6] = objs[0];
						start(edge_explorer_9_2_orchestration, match_6);
					}
				}
				break;
			case "Operation_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
			...
			case "Parameter_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_8 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
			...
			case "ClassifierReference_object_SP11": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
		...
		switch(match.creator) {
			...
			case "ConstructorEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_191_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__FWD_207_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[8] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_19.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_19.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_19.solve();
