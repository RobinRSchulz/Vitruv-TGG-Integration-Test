...
public class SuperClassToSuperClass__FWD_858_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP17": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperClassToSuperClass__FWD_858_localSearch", 5);
			...
			case "Class_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("SuperClassToSuperClass__FWD_858_localSearch", 5);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
						
						// superclassifier
						HMatch match_4 = new LocalSearchMatch("SuperClassToSuperClass__FWD_858_localSearch", 5);
			...
			case "Class_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("SuperClassToSuperClass__FWD_858_localSearch", 5);
			...
			case "ClassifierReference_object_SP8": 
				{
					...
					// superclassTypeRef
					HMatch match_3 = new LocalSearchMatch("SuperClassToSuperClass__FWD_858_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_839_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperClassToSuperClass__FWD_858_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperClassToSuperClass__FWD_858_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
