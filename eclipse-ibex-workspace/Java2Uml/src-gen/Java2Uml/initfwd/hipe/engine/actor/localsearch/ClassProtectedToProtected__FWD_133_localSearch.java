...
public class ClassProtectedToProtected__FWD_133_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassProtectedToProtected__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP17": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ClassProtectedToProtected__FWD_133_localSearch", 4);
			...
			case "Class_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ClassProtectedToProtected__FWD_133_localSearch", 4);
			...
			case "Class_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassProtectedToProtected__FWD_133_localSearch", 4);
			...
			case "Protected_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("ClassProtectedToProtected__FWD_133_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassProtectedToProtected__FWD_133_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
