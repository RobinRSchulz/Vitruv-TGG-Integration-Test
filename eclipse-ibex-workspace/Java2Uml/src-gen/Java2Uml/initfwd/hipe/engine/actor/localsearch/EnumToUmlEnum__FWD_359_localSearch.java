...
public class EnumToUmlEnum__FWD_359_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumToUmlEnum__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "CompilationUnit_object_SP0": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__FWD_359_localSearch", 5);
			...
			case "JavaPackageToUmlPackage_object_SP1": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("EnumToUmlEnum__FWD_359_localSearch", 5);
			...
			case "Package_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("EnumToUmlEnum__FWD_359_localSearch", 5);
			...
			case "Package_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__FWD_359_localSearch", 5);
			...
			case "Enumeration_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_4 = new LocalSearchMatch("EnumToUmlEnum__FWD_359_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__FWD_359_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
