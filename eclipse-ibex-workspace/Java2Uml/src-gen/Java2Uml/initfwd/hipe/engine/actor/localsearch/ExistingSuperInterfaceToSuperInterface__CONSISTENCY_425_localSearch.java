...
public class ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCONTEXT__TRG__umlGeneralClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCONTEXT__SRC__superclassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCREATE__SRC__superclassTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12 = new CachedEdgeExplorer(this, 1, 2, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCONTEXT__CORR__javaSuperClassifierToUmlSuperClassifier();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						...
						edge_explorer_16 = new CachedEdgeExplorer(this, 7, 5, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
						edge_explorer_17 = new CachedEdgeExplorer(this, 8, 6, edge_explorer_17_methods);
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "Interface_1_object_SP9": 
				{
					
					// javaConcreteClassifier
					HMatch match_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_5_1_orchestration, match_0);
					
					// superclassifier
					HMatch match_2 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
			...
			case "ClassifierReference_object_SP10": 
				{
					...
					// superclassTypeRef
					HMatch match_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
			...
			case "Generalization_object_SP0": 
				{
					...
					// generalization
					HMatch match_3 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_3_1_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
					...
					HMatch match_7 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
			...
			case "ExistingSuperInterfaceToSuperInterface__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_417_localSearch": 
				{
				...
				break;
			case "ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_421_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_417_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_421_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker_CREATE__TRG__generalization_Generalization": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Generalization) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_425_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
