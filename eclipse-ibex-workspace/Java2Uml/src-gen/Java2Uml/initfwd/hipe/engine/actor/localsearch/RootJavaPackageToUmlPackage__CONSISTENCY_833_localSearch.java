...
public class RootJavaPackageToUmlPackage__CONSISTENCY_833_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.RootJavaPackageToUmlPackage__Marker) o).getCREATE__TRG__umlPackage(); return (result instanceof uml.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.RootJavaPackageToUmlPackage__Marker) o).getCREATE__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
			...
			case "JavaPackageToUmlPackage_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_833_localSearch", 4);
			...
			case "RootJavaPackageToUmlPackage__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_833_localSearch", 4);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "RootJavaPackageToUmlPackage_umlPackage_package_incoming_TRG__FILTER_NAC_TRG_830_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "RootJavaPackageToUmlPackage_umlPackage_package_incoming_TRG__FILTER_NAC_TRG_830_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_833_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.RootJavaPackageToUmlPackage__Marker_CREATE__TRG__umlPackage_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Package) {
				{
					...
					HMatch match = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_833_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_89.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, javaPackage.getName(), "java.lang.String"));
		csp_89.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlPackage.getName(), "java.lang.String"));
		csp_89.solve();
