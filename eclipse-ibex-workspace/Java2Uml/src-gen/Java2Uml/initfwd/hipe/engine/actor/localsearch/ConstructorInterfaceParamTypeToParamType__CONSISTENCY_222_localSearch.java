...
public class ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaConstructorToOperation) o).getTarget(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Java2Uml.ConstructorInterfaceParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorInterfaceParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
						edge_explorer_10 = new CachedEdgeExplorer(this, 10, 4, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Java2Uml.ConstructorInterfaceParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaConstructorToOperation();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorInterfaceParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((uml.TypedElement) o).getType(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.Constructor ? result : null);};
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorInterfaceParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_22_methods = new EdgeLookupMethods();
						edge_explorer_22_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorInterfaceParamTypeToParamType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
			...
			case "Interface_1_object_SP3": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
			...
			case "Constructor_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_2 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_3_2_orchestration, match_2);
					}
				}
				break;
			case "ClassifierReference_object_SP12": 
				{
					edge_explorer_18.registerSourceObject(objs[0]);
					
					// typeReference
					HMatch match_3 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
			...
			case "Interface_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
			...
			case "Operation_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
			...
			case "Parameter_1_object_SP4": 
				{
					...
					// umlParameter
					HMatch match_6 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
			...
			case "JavaClassifierToUmlClassifier_object_SP4": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
			...
			case "JavaConstructorToOperation_object_SP2": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
			...
			case "JavaParameterToParameter_object_SP0": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
			...
			case "ConstructorInterfaceParamTypeToParamType__Marker_object": 
				{
					...
					HMatch match_10 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
					match_10.getNodes()[10] = objs[0];
					start(edge_explorer_3_1_orchestration, match_10);
				}
				break;
			case "ConstructorInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_218_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ConstructorInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_218_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaConstructorToOperation_source_Constructor": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Constructor) {
				{
					...
					HMatch match = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__CONSISTENCY_222_localSearch", 11);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_20.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_20.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_20.solve();
