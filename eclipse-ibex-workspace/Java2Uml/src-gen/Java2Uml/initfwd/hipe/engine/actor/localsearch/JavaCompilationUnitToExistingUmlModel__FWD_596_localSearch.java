...
public class JavaCompilationUnitToExistingUmlModel__FWD_596_localSearch extends GenericLocalSearchActor{
			...
			case "CompilationUnit_object_SP1": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_596_localSearch", 5);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_2_orchestration, match_0);
					
					// newCompilationUnit
					HMatch match_4 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_596_localSearch", 5);
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_596_localSearch", 5);
			...
			case "Package_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_596_localSearch", 5);
			...
			case "Model_object": 
				{
					if(!lazy_initialization) {
						...
						// umlModel
						HMatch match_3 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_596_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_596_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
