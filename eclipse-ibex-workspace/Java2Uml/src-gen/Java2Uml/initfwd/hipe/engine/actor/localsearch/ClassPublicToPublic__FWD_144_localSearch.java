...
public class ClassPublicToPublic__FWD_144_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP19": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ClassPublicToPublic__FWD_144_localSearch", 4);
			...
			case "Class_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ClassPublicToPublic__FWD_144_localSearch", 4);
			...
			case "Class_1_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassPublicToPublic__FWD_144_localSearch", 4);
			...
			case "Public_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("ClassPublicToPublic__FWD_144_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassPublicToPublic__FWD_144_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
