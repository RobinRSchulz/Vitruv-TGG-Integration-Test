...
public class EnumAttributeToProperty__CONSISTENCY_259_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.EnumAttributeToProperty__Marker) o).getCREATE__CORR__attributeToProperty();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((uml.DataType) o).getOwnedAttribute();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> {EObject result = ((uml.Property) o).getDatatype(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumAttributeToProperty__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Java2Uml.EnumAttributeToProperty__Marker) o).getCONTEXT__CORR__classToUmlClass();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((org.emftext.language.java.members.MemberContainer) o).getMembers().stream().filter(obj -> obj instanceof org.emftext.language.java.members.Field).collect(Collectors.toList());
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.classifiers.Enumeration) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
