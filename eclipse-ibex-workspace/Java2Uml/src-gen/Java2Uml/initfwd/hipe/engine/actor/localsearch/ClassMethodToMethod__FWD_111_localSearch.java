...
public class ClassMethodToMethod__FWD_111_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassMethodToMethod__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP13": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("ClassMethodToMethod__FWD_111_localSearch", 4);
			...
			case "Class_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ClassMethodToMethod__FWD_111_localSearch", 4);
			...
			case "Class_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassMethodToMethod__FWD_111_localSearch", 4);
			...
			case "ClassMethod_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// method
						HMatch match_3 = new LocalSearchMatch("ClassMethodToMethod__FWD_111_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassMethodToMethod__FWD_111_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
