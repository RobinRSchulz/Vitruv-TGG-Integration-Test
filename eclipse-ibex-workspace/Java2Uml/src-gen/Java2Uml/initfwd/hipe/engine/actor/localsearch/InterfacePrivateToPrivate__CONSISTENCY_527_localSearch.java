...
public class InterfacePrivateToPrivate__CONSISTENCY_527_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfacePrivateToPrivate__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Private ? result : null);};
			...
			case "Interface_1_object_SP3": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_527_localSearch", 5);
			...
			case "Private_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_527_localSearch", 5);
			...
			case "Interface_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_527_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP16": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_527_localSearch", 5);
			...
			case "InterfacePrivateToPrivate__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_527_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_527_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPrivate csp_48 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPrivate();
		csp_48.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_48.solve();
