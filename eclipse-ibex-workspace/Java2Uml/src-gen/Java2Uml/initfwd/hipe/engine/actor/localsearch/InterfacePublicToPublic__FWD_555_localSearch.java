...
public class InterfacePublicToPublic__FWD_555_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfacePublicToPublic__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfacePublicToPublic__FWD_555_localSearch", 4);
			...
			case "Interface_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfacePublicToPublic__FWD_555_localSearch", 4);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfacePublicToPublic__FWD_555_localSearch", 4);
			...
			case "Public_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("InterfacePublicToPublic__FWD_555_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfacePublicToPublic__FWD_555_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
