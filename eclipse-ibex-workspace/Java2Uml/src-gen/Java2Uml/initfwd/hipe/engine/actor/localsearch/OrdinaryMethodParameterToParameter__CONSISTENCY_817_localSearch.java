...
public class OrdinaryMethodParameterToParameter__CONSISTENCY_817_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaParameterToParameter) o).getSource(); return (result instanceof org.emftext.language.java.parameters.OrdinaryParameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Java2Uml.OrdinaryMethodParameterToParameter__Marker) o).getCREATE__CORR__parameterToParameter();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Java2Uml.OrdinaryMethodParameterToParameter__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.OrdinaryMethodParameterToParameter__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
