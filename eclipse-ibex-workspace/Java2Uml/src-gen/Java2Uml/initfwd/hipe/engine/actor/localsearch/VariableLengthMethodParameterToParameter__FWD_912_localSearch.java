...
public class VariableLengthMethodParameterToParameter__FWD_912_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VariableLengthMethodParameterToParameter__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "JavaMethodToOperation_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_912_localSearch", 4);
			...
			case "ClassMethod_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_912_localSearch", 4);
			...
			case "Operation_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_912_localSearch", 4);
			...
			case "VariableLengthParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_3 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_912_localSearch", 4);
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_912_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
