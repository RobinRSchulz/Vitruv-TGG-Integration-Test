...
public class JavaCompilationUnitToExistingUmlModel__CONSISTENCY_588_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Java2Uml.JavaCompilationUnitToExistingUmlModel__Marker) o).getCREATE__CORR__newJavaCompUnitToUmlModel();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToExistingUmlModel__Marker) o).getCONTEXT__TRG__umlModel(); return (result instanceof uml.Model ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12 = new CachedEdgeExplorer(this, 4, 3, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToExistingUmlModel__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
