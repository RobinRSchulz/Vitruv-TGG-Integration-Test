...
public class MethodClassReturnTypeToReturnType__FWD_674_localSearch extends GenericLocalSearchActor{
			...
			case "Class_object_SP6": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_674_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP7": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_674_localSearch", 7);
			...
			case "ClassMethod_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_674_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP1": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_674_localSearch", 7);
			...
			case "Class_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_674_localSearch", 7);
			...
			case "Operation_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_674_localSearch", 7);
			...
			case "ClassifierReference_object_SP7": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_674_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "MethodClassReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_659_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_674_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.types.TypedElement_typeReference_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodClassReturnTypeToReturnType__FWD_674_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
