...
public class MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumParamTypeToParamType__Marker) o).getCONTEXT__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((uml.TypedElement) o).getType(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Java2Uml.MethodEnumParamTypeToParamType__Marker) o).getCONTEXT__CORR__parameterToParameter();
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumParamTypeToParamType__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumParamTypeToParamType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_22_methods = new EdgeLookupMethods();
						edge_explorer_22_methods.unique_lookup = (o) -> ((Java2Uml.MethodEnumParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "Enumeration_object_SP6": 
				{
					
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
			...
			case "ClassMethod_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
			...
			case "Parameter_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_2 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
			...
			case "ClassifierReference_object_SP8": 
				{
					...
					// typeReference
					HMatch match_3 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_1_orchestration, match_3);
				}
				break;
			case "Enumeration_1_object_SP5": 
				{
					if(!lazy_initialization) {
						
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
			...
			case "Operation_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
			...
			case "Parameter_1_object_SP4": 
				{
					...
					// umlParameter
					HMatch match_6 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
			...
			case "JavaMethodToOperation_object_SP2": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
			...
			case "JavaParameterToParameter_object_SP0": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
			...
			case "MethodEnumParamTypeToParamType__Marker_object": 
				{
					...
					HMatch match_10 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
					match_10.getNodes()[10] = objs[0];
					start(edge_explorer_5_1_orchestration, match_10);
				}
				break;
			case "MethodEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_669_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_669_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumParamTypeToParamType__CONSISTENCY_673_localSearch", 11);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_74.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_74.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_74.solve();
