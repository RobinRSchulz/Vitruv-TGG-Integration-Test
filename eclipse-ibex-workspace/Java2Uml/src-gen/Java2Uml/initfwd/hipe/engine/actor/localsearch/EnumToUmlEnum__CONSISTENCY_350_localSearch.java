...
public class EnumToUmlEnum__CONSISTENCY_350_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Java2Uml.EnumToUmlEnum__Marker) o).getCONTEXT__CORR__javaPackToUmlPack();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumToUmlEnum__Marker) o).getCONTEXT__SRC__compilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 7, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumToUmlEnum__Marker) o).getCONTEXT__TRG__umlPackage(); return (result instanceof uml.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumToUmlEnum__Marker) o).getCREATE__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.EnumToUmlEnum__Marker) o).getCREATE__CORR__javaClassToUmlClass();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.multi_lookup = (o) -> ((org.emftext.language.java.containers.CompilationUnit) o).getClassifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.classifiers.Enumeration).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaPackageToUmlPackage) o).getSource(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumToUmlEnum__Marker) o).getCREATE__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.multi_lookup = (o) -> ((uml.Package) o).getPackagedElement().stream().filter(obj -> obj instanceof uml.Enumeration).collect(Collectors.toList());
						edge_explorer_14_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Package) return edge_explorer_14_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumToUmlEnum__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumToUmlEnum__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Enumeration_object_SP6": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
			...
			case "CompilationUnit_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// compilationUnit
						HMatch match_1 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
			...
			case "Package_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
			...
			case "Enumeration_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
			...
			case "Package_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_4 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
			...
			case "JavaPackageToUmlPackage_object_SP0": 
				{
					...
					// javaPackToUmlPack
					HMatch match_6 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_2_orchestration, match_6);
				}
				break;
			case "EnumToUmlEnum__Marker_object": 
				{
					...
					// EnumToUmlEnum_eMoflon_ProtocolNode
					HMatch match_7 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Java2Uml.EnumToUmlEnum__Marker_CONTEXT__CORR__javaPackToUmlPack_JavaPackageToUmlPackage": 
			if(!lazy_initialization) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			...
			break;
		case "Java2Uml.EnumToUmlEnum__Marker_CONTEXT__SRC__compilationUnit_CompilationUnit": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.EnumToUmlEnum__Marker_CONTEXT__TRG__umlPackage_Package": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.EnumToUmlEnum__Marker_CREATE__SRC__classifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
			...
			break;
		case "Java2Uml.EnumToUmlEnum__Marker_CREATE__CORR__javaClassToUmlClass_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
		...
		case "Java2Uml.JavaPackageToUmlPackage_target_Package": 
			...
			break;
		case "Java2Uml.EnumToUmlEnum__Marker_CREATE__TRG__umlClassifier_Enumeration": 
			if(!lazy_initialization) {
		...
		case "uml.Package_packagedElement_PackageableElement": 
			...
			break;
		case "Java2Uml.EnumToUmlEnum__Marker_CONTEXT__SRC__javaPackage_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.containers.Package) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register EnumToUmlEnum_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister EnumToUmlEnum_eMoflon_ProtocolNode
		Collection<HMatch> matches_7 = obj2matches.get(objs[7]);
		if(matches_7 != null) {
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof uml.Enumeration) {
			HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
		...
		if(obj instanceof org.emftext.language.java.classifiers.Enumeration) {
			HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_350_localSearch", 8);
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.classifiers.Enumeration classifier = (org.emftext.language.java.classifiers.Enumeration) match.getNodes()[0];
		uml.Enumeration umlClassifier = (uml.Enumeration) match.getNodes()[3];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_36 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_36.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_36.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_36.solve();
