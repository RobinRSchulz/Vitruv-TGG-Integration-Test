...
public class ClassToUmlClass__CONSISTENCY_149_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCREATE__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 7, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCREATE__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 7, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCONTEXT__SRC__compilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((org.emftext.language.java.containers.CompilationUnit) o).getClassifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.classifiers.Class).collect(Collectors.toList());
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.containers.CompilationUnit) return edge_explorer_6_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCONTEXT__TRG__umlPackage(); return (result instanceof uml.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Java2Uml.ClassToUmlClass__Marker) o).getCONTEXT__CORR__javaPackToUmlPack();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((org.emftext.language.java.containers.Package) o).getCompilationUnits();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.containers.Package) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.multi_lookup = (o) -> ((uml.Package) o).getPackagedElement().stream().filter(obj -> obj instanceof uml.Class).collect(Collectors.toList());
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Package) return edge_explorer_13_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Java2Uml.ClassToUmlClass__Marker) o).getCREATE__CORR__javaClassToUmlClass();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaPackageToUmlPackage) o).getSource(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassToUmlClass__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Class_object_SP1": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_149_localSearch", 8);
			...
			case "CompilationUnit_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// compilationUnit
						HMatch match_1 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_149_localSearch", 8);
			...
			case "Package_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_149_localSearch", 8);
			...
			case "Class_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_149_localSearch", 8);
			...
			case "Package_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_4 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_149_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP20": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_149_localSearch", 8);
			...
			case "JavaPackageToUmlPackage_object_SP0": 
				{
					...
					// javaPackToUmlPack
					HMatch match_6 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_149_localSearch", 8);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_9_1_orchestration, match_6);
				}
				break;
			case "ClassToUmlClass__Marker_object": 
				{
					...
					// ClassToUmlClass_eMoflon_ProtocolNode
					HMatch match_7 = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_149_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Java2Uml.ClassToUmlClass__Marker_CREATE__TRG__umlClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("ClassToUmlClass__CONSISTENCY_149_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
			...
			break;
		case "Java2Uml.ClassToUmlClass__Marker_CREATE__SRC__classifier_Class": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.ClassToUmlClass__Marker_CONTEXT__SRC__compilationUnit_CompilationUnit": 
			if(!lazy_initialization) {
		...
		case "org.emftext.language.java.containers.CompilationUnit_classifiers_ConcreteClassifier": 
			...
			break;
		case "Java2Uml.ClassToUmlClass__Marker_CONTEXT__TRG__umlPackage_Package": 
			if(!lazy_initialization) {
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			...
			break;
		case "Java2Uml.ClassToUmlClass__Marker_CONTEXT__CORR__javaPackToUmlPack_JavaPackageToUmlPackage": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.ClassToUmlClass__Marker_CONTEXT__SRC__javaPackage_Package": 
			if(!lazy_initialization) {
		...
		case "uml.Package_packagedElement_PackageableElement": 
			...
			break;
		case "Java2Uml.ClassToUmlClass__Marker_CREATE__CORR__javaClassToUmlClass_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register ClassToUmlClass_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister ClassToUmlClass_eMoflon_ProtocolNode
		Collection<HMatch> matches_7 = obj2matches.get(objs[7]);
		if(matches_7 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.classifiers.Class classifier = (org.emftext.language.java.classifiers.Class) match.getNodes()[0];
		uml.Class umlClassifier = (uml.Class) match.getNodes()[3];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_15 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_15.solve();
