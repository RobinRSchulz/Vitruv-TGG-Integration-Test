...
public class InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.members.Field) return o.equals(edge_explorer_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer = new EdgeExplorer(this, 1, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__TRG__property(); return (result instanceof uml.Property ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__SRC__field(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaAttributeToUmlProperty) o).getSource(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
			...
			case "Interface_1_object_SP4": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch", 8);
			...
			case "Field_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch", 8);
			...
			case "ClassifierReference_object_SP13": 
				{
					...
					// typeReference
					HMatch match_2 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch", 8);
			...
			case "Property_object_SP0": 
				{
					...
					// property
					HMatch match_3 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch", 8);
			...
			case "Interface_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch", 8);
			...
			case "JavaAttributeToUmlProperty_object_SP1": 
				{
					...
					// attributeToProperty
					HMatch match_5 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP8": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch", 8);
			...
			case "InterfaceAttributeTypeToPropertyType__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_3_1_orchestration, match_7);
				}
				break;
			case "InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_463_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_463_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.types.TypedElement_typeReference_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_467_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_42.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_42.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_42.solve();
