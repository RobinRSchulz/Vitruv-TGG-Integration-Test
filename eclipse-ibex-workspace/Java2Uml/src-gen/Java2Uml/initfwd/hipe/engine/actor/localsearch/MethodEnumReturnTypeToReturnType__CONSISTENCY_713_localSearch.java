...
public class MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCREATE__TRG__umlReturnParameter(); return (result instanceof uml.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCREATE__CORR__javaTypeReferenceToUmlReturnParameter();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCONTEXT__SRC__javaMethod(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
			...
			case "Enumeration_object_SP4": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
			...
			case "ClassMethod_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_1 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_4_1_orchestration, match_1);
					}
				}
				break;
			case "ClassifierReference_object_SP11": 
				{
					edge_explorer_20.registerSourceObject(objs[0]);
					
					// typeReference
					HMatch match_2 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_3_2_orchestration, match_2);
				}
				break;
			case "Enumeration_1_object_SP3": 
				{
					if(!lazy_initialization) {
						
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
			...
			case "Operation_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_4 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
			...
			case "Parameter_1_object_SP1": 
				{
					...
					// umlReturnParameter
					HMatch match_5 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP10": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
			...
			case "JavaMethodToOperation_object_SP4": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
			...
			case "JavaTypeReferenceToUmlReturnParameter_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
			...
			case "MethodEnumReturnTypeToReturnType__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_5_1_orchestration, match_9);
				}
				break;
			case "MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_709_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_709_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_713_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[2];
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_77.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_77.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_77.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_78.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_78.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_78.solve();
