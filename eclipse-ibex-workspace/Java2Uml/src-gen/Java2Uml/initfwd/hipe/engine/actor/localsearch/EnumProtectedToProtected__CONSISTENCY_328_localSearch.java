...
public class EnumProtectedToProtected__CONSISTENCY_328_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumProtectedToProtected__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.EnumProtectedToProtected__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
						edge_explorer_4 = new CachedEdgeExplorer(this, 4, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumProtectedToProtected__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Protected ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 4, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumProtectedToProtected__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((org.emftext.language.java.modifiers.AnnotableAndModifiable) o).getAnnotationsAndModifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.modifiers.Protected).collect(Collectors.toList());
			...
			case "Enumeration_object_SP2": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_328_localSearch", 5);
			...
			case "Protected_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_328_localSearch", 5);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_328_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP18": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_328_localSearch", 5);
			...
			case "EnumProtectedToProtected__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_328_localSearch", 5);
		...
		case "Java2Uml.EnumProtectedToProtected__Marker_CONTEXT__SRC__javaConcreteClassifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_328_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected csp_32 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected();
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_32.solve();
