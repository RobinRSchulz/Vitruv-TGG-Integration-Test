...
public class EnumFinalToFinal__CONSISTENCY_306_localSearch extends GenericLocalSearchActor{
			...
			case "Enumeration_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_306_localSearch", 5);
			...
			case "Final_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_306_localSearch", 5);
			...
			case "Enumeration_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_306_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP14": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_306_localSearch", 5);
			...
			case "EnumFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_306_localSearch", 5);
		...
		case "Java2Uml.EnumFinalToFinal__Marker_CONTEXT__SRC__javaConcreteClassifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_306_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_28.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_28.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.isIsFinalSpecialization(), "boolean"));
		csp_28.solve();
