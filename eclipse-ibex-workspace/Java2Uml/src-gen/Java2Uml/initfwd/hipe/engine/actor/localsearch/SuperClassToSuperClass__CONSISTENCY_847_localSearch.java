...
public class SuperClassToSuperClass__CONSISTENCY_847_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__SRC__superclassTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__CORR__classRefToGeneralization();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__TRG__umlGeneralClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getSource(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((org.emftext.language.java.classifiers.Class) o).getExtends(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
						edge_explorer_9_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.classifiers.Class) return o.equals(edge_explorer_9_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierReferenceToUmlGeneralization) o).getSource(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((uml.Generalization) o).getSpecific(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Java2Uml.SuperClassToSuperClass__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__TRG__generalization(); return (result instanceof uml.Generalization ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__SRC__superclassifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__CORR__javaSuperClassifierToUmlSuperClassifier();
			...
			case "Class_object_SP7": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_9_1_orchestration, match_0);
					
					// superclassifier
					HMatch match_2 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// superclassTypeRef
					HMatch match_1 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
			...
			case "Generalization_object_SP0": 
				{
					...
					// generalization
					HMatch match_3 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
			...
			case "Class_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_12_1_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
			...
			case "JavaClassifierReferenceToUmlGeneralization_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP16": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
					...
					HMatch match_8 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
			...
			case "SuperClassToSuperClass__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_3_1_orchestration, match_9);
				}
				break;
			case "SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_839_localSearch": 
				{
				...
				break;
			case "SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_843_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_839_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_843_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "uml.Generalization_general_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_847_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
