...
public class InterfaceConstructorToConstructor__FWD_508_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP13": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__FWD_508_localSearch", 4);
			...
			case "Interface_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceConstructorToConstructor__FWD_508_localSearch", 4);
			...
			case "Interface_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceConstructorToConstructor__FWD_508_localSearch", 4);
			...
			case "Constructor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// constructor
						HMatch match_3 = new LocalSearchMatch("InterfaceConstructorToConstructor__FWD_508_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceConstructorToConstructor__FWD_508_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
