...
public class EnumToUmlEnum__CONSISTENCY_337_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumToUmlEnum__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumToUmlEnum__Marker) o).getCREATE__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
			...
			case "Enumeration_object_SP4": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_337_localSearch", 8);
			...
			case "CompilationUnit_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// compilationUnit
						HMatch match_1 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_337_localSearch", 8);
			...
			case "Package_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_337_localSearch", 8);
			...
			case "Enumeration_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_337_localSearch", 8);
			...
			case "Package_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_4 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_337_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP20": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_337_localSearch", 8);
			...
			case "JavaPackageToUmlPackage_object_SP0": 
				{
					...
					// javaPackToUmlPack
					HMatch match_6 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_337_localSearch", 8);
			...
			case "EnumToUmlEnum__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_337_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.CompilationUnit_classifiers_ConcreteClassifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__CONSISTENCY_337_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_35.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_35.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_35.solve();
