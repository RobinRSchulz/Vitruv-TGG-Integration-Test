...
public class ClassAttributeToProperty__CONSISTENCY_15_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassAttributeToProperty__Marker) o).getCREATE__SRC__field(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 6, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((org.emftext.language.java.members.MemberContainer) o).getMembers().stream().filter(obj -> obj instanceof org.emftext.language.java.members.Field).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaAttributeToUmlProperty) o).getTarget(); return (result instanceof uml.Property ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 4, 2, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassAttributeToProperty__Marker) o).getCREATE__TRG__property(); return (result instanceof uml.Property ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Java2Uml.ClassAttributeToProperty__Marker) o).getCREATE__CORR__attributeToProperty();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.ClassAttributeToProperty__Marker) o).getCONTEXT__CORR__classToUmlClass();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassAttributeToProperty__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new CachedEdgeExplorer(this, 4, 1, edge_explorer_10_methods);
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((uml.StructuredClassifier) o).getOwnedAttribute();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Class) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassAttributeToProperty__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassAttributeToProperty__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Class_object_SP2": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ClassAttributeToProperty__CONSISTENCY_15_localSearch", 7);
			...
			case "Field_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_1 = new LocalSearchMatch("ClassAttributeToProperty__CONSISTENCY_15_localSearch", 7);
			...
			case "Property_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_2 = new LocalSearchMatch("ClassAttributeToProperty__CONSISTENCY_15_localSearch", 7);
			...
			case "Class_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("ClassAttributeToProperty__CONSISTENCY_15_localSearch", 7);
			...
			case "JavaAttributeToUmlProperty_object_SP0": 
				{
					...
					// attributeToProperty
					HMatch match_4 = new LocalSearchMatch("ClassAttributeToProperty__CONSISTENCY_15_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP2": 
				{
					...
					// classToUmlClass
					HMatch match_5 = new LocalSearchMatch("ClassAttributeToProperty__CONSISTENCY_15_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_7_1_orchestration, match_5);
				}
				break;
			case "ClassAttributeToProperty__Marker_object": 
				{
					...
					// ClassAttributeToProperty_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("ClassAttributeToProperty__CONSISTENCY_15_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "ClassAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_12_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_12_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassAttributeToProperty__CONSISTENCY_15_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Java2Uml.ClassAttributeToProperty__Marker_CREATE__SRC__field_Field": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Field) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("ClassAttributeToProperty__CONSISTENCY_15_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
		...
		case "Java2Uml.JavaAttributeToUmlProperty_target_Property": 
			...
			break;
		case "Java2Uml.ClassAttributeToProperty__Marker_CREATE__TRG__property_Property": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Property) {
				{
			...
			break;
		case "Java2Uml.ClassAttributeToProperty__Marker_CREATE__CORR__attributeToProperty_JavaAttributeToUmlProperty": 
			if(!lazy_initialization) {
				{
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			...
			break;
		case "Java2Uml.ClassAttributeToProperty__Marker_CONTEXT__CORR__classToUmlClass_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.ClassAttributeToProperty__Marker_CONTEXT__TRG__umlClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			...
			break;
		case "uml.StructuredClassifier_ownedAttribute_Property": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.ClassAttributeToProperty__Marker_CONTEXT__SRC__classifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ClassAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG
		...
		// register ClassAttributeToProperty_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ClassAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG
		OverlapMatch oMatch_0 = new OverlapMatch(1);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[2];
		Collection<HMatch> oMatches_0 = overlap2matches_0.get(oMatch_0);
		...
		// deregister ClassAttributeToProperty_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_2.solve();
