...
public class VariableLengthMethodParameterToParameter__FWD_899_localSearch extends GenericLocalSearchActor{
			...
			case "JavaMethodToOperation_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_899_localSearch", 4);
			...
			case "ClassMethod_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_899_localSearch", 4);
			...
			case "Operation_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_899_localSearch", 4);
			...
			case "VariableLengthParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_3 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_899_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_899_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
