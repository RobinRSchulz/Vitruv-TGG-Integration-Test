...
public class EnumConstantToEnumConstant__CONSISTENCY_293_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaEnumConstantToUmlEnumLiteral) o).getTarget(); return (result instanceof uml.EnumerationLiteral ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__SRC__javaEnum(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.multi_lookup = (o) -> ((uml.Enumeration) o).getOwnedLiteral();
						edge_explorer_9_methods.unique_opposite_lookup = (o) -> ((uml.EnumerationLiteral) o).getEnumeration();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaEnumConstantToUmlEnumLiteral) o).getSource(); return (result instanceof org.emftext.language.java.members.EnumConstant ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__TRG__umlLiteral(); return (result instanceof uml.EnumerationLiteral ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Enumeration) o).getConstants();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__SRC__javaConstant(); return (result instanceof org.emftext.language.java.members.EnumConstant ? result : null);};
			...
			case "EnumConstant_object": 
				{
					...
					// javaConstant
					HMatch match_0 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_293_localSearch", 7);
			...
			case "Enumeration_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaEnum
						HMatch match_1 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_293_localSearch", 7);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlEnum
						HMatch match_2 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_293_localSearch", 7);
			...
			case "EnumerationLiteral_object": 
				{
					if(!lazy_initialization) {
						...
						// umlLiteral
						HMatch match_3 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_293_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP12": 
				{
					...
					// j
					HMatch match_4 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_293_localSearch", 7);
			...
			case "JavaEnumConstantToUmlEnumLiteral_object": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_293_localSearch", 7);
			...
			case "EnumConstantToEnumConstant__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_293_localSearch", 7);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_293_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, javaConstant.getName(), "java.lang.String"));
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlLiteral.getName(), "java.lang.String"));
		csp_27.solve();
