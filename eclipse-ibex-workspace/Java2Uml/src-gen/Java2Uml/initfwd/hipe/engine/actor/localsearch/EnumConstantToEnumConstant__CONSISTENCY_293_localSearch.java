...
public class EnumConstantToEnumConstant__CONSISTENCY_293_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((uml.Enumeration) o).getOwnedLiteral();
						edge_explorer_4_methods.unique_opposite_lookup = (o) -> ((uml.EnumerationLiteral) o).getEnumeration();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Enumeration) o).getConstants();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__CORR__javaEnumConstantToUmlEnumLiteral();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__SRC__javaEnum(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__SRC__javaConstant(); return (result instanceof org.emftext.language.java.members.EnumConstant ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__TRG__umlEnum(); return (result instanceof uml.Enumeration ? result : null);};
