...
public class EnumPublicToPublic__CONSISTENCY_326_localSearch extends GenericLocalSearchActor{
			...
			case "Enumeration_object_SP2": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_326_localSearch", 5);
			...
			case "Public_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_326_localSearch", 5);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_326_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP18": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_326_localSearch", 5);
			...
			case "EnumPublicToPublic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_326_localSearch", 5);
		...
		case "Java2Uml.EnumPublicToPublic__Marker_CONTEXT__TRG__umlClassifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_326_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic csp_33 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic();
		csp_33.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_33.solve();
