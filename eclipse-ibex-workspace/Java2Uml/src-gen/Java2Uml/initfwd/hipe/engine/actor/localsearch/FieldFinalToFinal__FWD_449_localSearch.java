...
public class FieldFinalToFinal__FWD_449_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FieldFinalToFinal__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaAttributeToUmlProperty_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("FieldFinalToFinal__FWD_449_localSearch", 4);
			...
			case "Field_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaField
						HMatch match_1 = new LocalSearchMatch("FieldFinalToFinal__FWD_449_localSearch", 4);
			...
			case "Property_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlProperty
						HMatch match_2 = new LocalSearchMatch("FieldFinalToFinal__FWD_449_localSearch", 4);
			...
			case "Final_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("FieldFinalToFinal__FWD_449_localSearch", 4);
		...
		case "Java2Uml.JavaAttributeToUmlProperty_source_Field": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Field) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldFinalToFinal__FWD_449_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_38.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlProperty.isIsReadOnly(), "boolean"));
		csp_38.solve();
