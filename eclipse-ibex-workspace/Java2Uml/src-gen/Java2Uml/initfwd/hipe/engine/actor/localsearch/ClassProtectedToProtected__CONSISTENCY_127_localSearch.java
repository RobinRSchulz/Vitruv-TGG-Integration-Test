...
public class ClassProtectedToProtected__CONSISTENCY_127_localSearch extends GenericLocalSearchActor{
			...
			case "Class_object_SP7": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_127_localSearch", 5);
			...
			case "Protected_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_127_localSearch", 5);
			...
			case "Class_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_127_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP16": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_127_localSearch", 5);
			...
			case "ClassProtectedToProtected__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_127_localSearch", 5);
		...
		case "Java2Uml.ClassProtectedToProtected__Marker_CONTEXT__TRG__umlClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_127_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected csp_11 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected();
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_11.solve();
