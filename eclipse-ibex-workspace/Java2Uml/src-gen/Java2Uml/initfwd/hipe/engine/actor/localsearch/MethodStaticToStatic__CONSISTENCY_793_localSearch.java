...
public class MethodStaticToStatic__CONSISTENCY_793_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Java2Uml.MethodStaticToStatic__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodStaticToStatic__Marker) o).getCONTEXT__SRC__javaMethod(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
			...
			case "ClassMethod_object_SP6": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_793_localSearch", 5);
			...
			case "Static_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_793_localSearch", 5);
			...
			case "Operation_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_793_localSearch", 5);
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_793_localSearch", 5);
			...
			case "MethodStaticToStatic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_793_localSearch", 5);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodStaticToStatic__CONSISTENCY_793_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_85.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsStatic(), "boolean"));
		csp_85.solve();
