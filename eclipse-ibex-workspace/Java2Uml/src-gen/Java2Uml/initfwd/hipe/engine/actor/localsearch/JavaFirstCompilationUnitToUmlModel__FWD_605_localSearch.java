...
public class JavaFirstCompilationUnitToUmlModel__FWD_605_localSearch extends GenericLocalSearchActor{
			...
			case "Package_object_SP0": 
				{
					...
					// javaPackage
					HMatch match_0 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__FWD_605_localSearch", 2);
			...
			case "CompilationUnit_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// compilationUnit
						HMatch match_1 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__FWD_605_localSearch", 2);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__FWD_605_localSearch", 2);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
