...
import Java2Uml.modelgen.hipe.engine.actor.localsearch.EnumConstantToEnumConstant__GEN_148_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.EnumFinalToFinal__GEN_152_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.EnumPrivateToPrivate__GEN_156_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.EnumProtectedToProtected__GEN_160_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.EnumPublicToPublic__GEN_164_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.EnumToUmlEnum__GEN_168_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.junction.ExistingClassImplementToClassImplement__GEN_173_junction;
import Java2Uml.modelgen.hipe.engine.actor.junction.ExistingSuperClassToSuperClass__GEN_186_junction;
import Java2Uml.modelgen.hipe.engine.actor.junction.ExistingSuperInterfaceToSuperInterface__GEN_199_junction;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.FieldFinalToFinal__GEN_212_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.FieldStaticToStatic__GEN_216_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.InterfaceAbstractToAbstract__GEN_220_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.junction.InterfaceAttributeTypeToPropertyType__GEN_225_junction;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.InterfaceConstructorToConstructor__GEN_237_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.InterfaceFinalToFinal__GEN_241_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.InterfaceMethodToMethod__GEN_245_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.InterfacePrivateToPrivate__GEN_249_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.InterfaceProtectedToProtected__GEN_253_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.InterfacePublicToPublic__GEN_257_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.InterfaceToUmlInterface__GEN_261_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.JavaCompilationUnitToExistingUmlModel__GEN_266_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.MethodAbstractToAbstract__GEN_272_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.junction.MethodClassParamTypeToParamType__GEN_278_junction;
import Java2Uml.modelgen.hipe.engine.actor.junction.MethodEnumParamTypeToParamType__GEN_315_junction;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.MethodFinalToFinal__GEN_350_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.junction.MethodInterfaceParamTypeToParamType__GEN_356_junction;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.MethodStaticToStatic__GEN_391_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.OrdinaryConstructorParameterToParameter__GEN_395_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.OrdinaryMethodParameterToParameter__GEN_399_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.SuperClassToSuperClass__GEN_403_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.SuperInterfaceToSuperInterface__GEN_407_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.VariableLengthConstructorParameterToParameter__GEN_411_localSearch;
import Java2Uml.modelgen.hipe.engine.actor.localsearch.VariableLengthMethodParameterToParameter__GEN_415_localSearch;
...
public class HiPEEngine extends IHiPEEngine{
	...
	public void createProductionNodes() {
		...
		classes.put("EnumConstantToEnumConstant__GEN_production", GenericProductionActor.class);
		productionNodes2pattern.put("EnumConstantToEnumConstant__GEN_production", "EnumConstantToEnumConstant__GEN");
	...
	public void createJunctionNodes() {
		...
		classes.put("EnumConstantToEnumConstant__GEN_148_localSearch", EnumConstantToEnumConstant__GEN_148_localSearch.class);
		classes.put("EnumFinalToFinal__GEN_152_localSearch", EnumFinalToFinal__GEN_152_localSearch.class);
		classes.put("EnumPrivateToPrivate__GEN_156_localSearch", EnumPrivateToPrivate__GEN_156_localSearch.class);
		classes.put("EnumProtectedToProtected__GEN_160_localSearch", EnumProtectedToProtected__GEN_160_localSearch.class);
		classes.put("EnumPublicToPublic__GEN_164_localSearch", EnumPublicToPublic__GEN_164_localSearch.class);
		classes.put("EnumToUmlEnum__GEN_168_localSearch", EnumToUmlEnum__GEN_168_localSearch.class);
		classes.put("ExistingClassImplementToClassImplement__GEN_174_junction", GenericJunctionActor.class);
		classes.put("ExistingClassImplementToClassImplement__GEN_175_junction", GenericJunctionActor.class);
		classes.put("ExistingClassImplementToClassImplement__GEN_173_junction", ExistingClassImplementToClassImplement__GEN_173_junction.class);
		classes.put("ExistingSuperClassToSuperClass__GEN_187_junction", GenericJunctionActor.class);
		classes.put("ExistingSuperClassToSuperClass__GEN_188_junction", GenericJunctionActor.class);
		classes.put("ExistingSuperClassToSuperClass__GEN_186_junction", ExistingSuperClassToSuperClass__GEN_186_junction.class);
		classes.put("ExistingSuperInterfaceToSuperInterface__GEN_200_junction", GenericJunctionActor.class);
		classes.put("ExistingSuperInterfaceToSuperInterface__GEN_201_junction", GenericJunctionActor.class);
		classes.put("ExistingSuperInterfaceToSuperInterface__GEN_199_junction", ExistingSuperInterfaceToSuperInterface__GEN_199_junction.class);
		classes.put("FieldFinalToFinal__GEN_212_localSearch", FieldFinalToFinal__GEN_212_localSearch.class);
		classes.put("FieldStaticToStatic__GEN_216_localSearch", FieldStaticToStatic__GEN_216_localSearch.class);
		classes.put("InterfaceAbstractToAbstract__GEN_220_localSearch", InterfaceAbstractToAbstract__GEN_220_localSearch.class);
		classes.put("InterfaceAttributeTypeToPropertyType__GEN_225_junction", InterfaceAttributeTypeToPropertyType__GEN_225_junction.class);
		classes.put("InterfaceAttributeTypeToPropertyType__GEN_226_junction", GenericJunctionActor.class);
		classes.put("InterfaceAttributeTypeToPropertyType__GEN_224_junction", GenericJunctionActor.class);
		classes.put("InterfaceConstructorToConstructor__GEN_237_localSearch", InterfaceConstructorToConstructor__GEN_237_localSearch.class);
		classes.put("InterfaceFinalToFinal__GEN_241_localSearch", InterfaceFinalToFinal__GEN_241_localSearch.class);
		classes.put("InterfaceMethodToMethod__GEN_245_localSearch", InterfaceMethodToMethod__GEN_245_localSearch.class);
		classes.put("InterfacePrivateToPrivate__GEN_249_localSearch", InterfacePrivateToPrivate__GEN_249_localSearch.class);
		classes.put("InterfaceProtectedToProtected__GEN_253_localSearch", InterfaceProtectedToProtected__GEN_253_localSearch.class);
		classes.put("InterfacePublicToPublic__GEN_257_localSearch", InterfacePublicToPublic__GEN_257_localSearch.class);
		classes.put("InterfaceToUmlInterface__GEN_261_localSearch", InterfaceToUmlInterface__GEN_261_localSearch.class);
		classes.put("JavaCompilationUnitToExistingUmlModel__GEN_266_localSearch", JavaCompilationUnitToExistingUmlModel__GEN_266_localSearch.class);
		classes.put("MethodAbstractToAbstract__GEN_272_localSearch", MethodAbstractToAbstract__GEN_272_localSearch.class);
		classes.put("MethodClassParamTypeToParamType__GEN_277_junction", GenericJunctionActor.class);
		classes.put("MethodClassParamTypeToParamType__GEN_281_junction", GenericJunctionActor.class);
		classes.put("MethodClassParamTypeToParamType__GEN_288_junction", GenericJunctionActor.class);
		classes.put("MethodClassParamTypeToParamType__GEN_289_junction", GenericJunctionActor.class);
		classes.put("MethodClassParamTypeToParamType__GEN_282_junction", GenericJunctionActor.class);
		classes.put("MethodClassParamTypeToParamType__GEN_278_junction", MethodClassParamTypeToParamType__GEN_278_junction.class);
		classes.put("MethodClassParamTypeToParamType__GEN_276_junction", GenericJunctionActor.class);
		classes.put("MethodClassReturnTypeToReturnType__GEN_301_junction", GenericJunctionActor.class);
		classes.put("MethodClassReturnTypeToReturnType__GEN_302_junction", GenericJunctionActor.class);
		classes.put("MethodClassReturnTypeToReturnType__GEN_300_junction", GenericJunctionActor.class);
		classes.put("MethodEnumParamTypeToParamType__GEN_314_junction", GenericJunctionActor.class);
		classes.put("MethodEnumParamTypeToParamType__GEN_318_junction", GenericJunctionActor.class);
		classes.put("MethodEnumParamTypeToParamType__GEN_325_junction", GenericJunctionActor.class);
		classes.put("MethodEnumParamTypeToParamType__GEN_326_junction", GenericJunctionActor.class);
		classes.put("MethodEnumParamTypeToParamType__GEN_319_junction", GenericJunctionActor.class);
		classes.put("MethodEnumParamTypeToParamType__GEN_315_junction", MethodEnumParamTypeToParamType__GEN_315_junction.class);
		classes.put("MethodEnumParamTypeToParamType__GEN_313_junction", GenericJunctionActor.class);
		classes.put("MethodEnumReturnTypeToReturnType__GEN_338_junction", GenericJunctionActor.class);
		classes.put("MethodEnumReturnTypeToReturnType__GEN_339_junction", GenericJunctionActor.class);
		classes.put("MethodEnumReturnTypeToReturnType__GEN_337_junction", GenericJunctionActor.class);
		classes.put("MethodFinalToFinal__GEN_350_localSearch", MethodFinalToFinal__GEN_350_localSearch.class);
		classes.put("MethodInterfaceParamTypeToParamType__GEN_355_junction", GenericJunctionActor.class);
		classes.put("MethodInterfaceParamTypeToParamType__GEN_359_junction", GenericJunctionActor.class);
		classes.put("MethodInterfaceParamTypeToParamType__GEN_366_junction", GenericJunctionActor.class);
		classes.put("MethodInterfaceParamTypeToParamType__GEN_367_junction", GenericJunctionActor.class);
		classes.put("MethodInterfaceParamTypeToParamType__GEN_360_junction", GenericJunctionActor.class);
		classes.put("MethodInterfaceParamTypeToParamType__GEN_356_junction", MethodInterfaceParamTypeToParamType__GEN_356_junction.class);
		classes.put("MethodInterfaceParamTypeToParamType__GEN_354_junction", GenericJunctionActor.class);
		classes.put("MethodInterfaceReturnTypeToReturnType__GEN_379_junction", GenericJunctionActor.class);
		classes.put("MethodInterfaceReturnTypeToReturnType__GEN_380_junction", GenericJunctionActor.class);
		createJunctionNodes_1();
			}	
		
			private void createJunctionNodes_1() {
		classes.put("MethodInterfaceReturnTypeToReturnType__GEN_378_junction", GenericJunctionActor.class);
		classes.put("MethodStaticToStatic__GEN_391_localSearch", MethodStaticToStatic__GEN_391_localSearch.class);
		classes.put("OrdinaryConstructorParameterToParameter__GEN_395_localSearch", OrdinaryConstructorParameterToParameter__GEN_395_localSearch.class);
		classes.put("OrdinaryMethodParameterToParameter__GEN_399_localSearch", OrdinaryMethodParameterToParameter__GEN_399_localSearch.class);
		classes.put("SuperClassToSuperClass__GEN_403_localSearch", SuperClassToSuperClass__GEN_403_localSearch.class);
		classes.put("SuperInterfaceToSuperInterface__GEN_407_localSearch", SuperInterfaceToSuperInterface__GEN_407_localSearch.class);
		classes.put("VariableLengthConstructorParameterToParameter__GEN_411_localSearch", VariableLengthConstructorParameterToParameter__GEN_411_localSearch.class);
		classes.put("VariableLengthMethodParameterToParameter__GEN_415_localSearch", VariableLengthMethodParameterToParameter__GEN_415_localSearch.class);
	}
