...
public class InterfaceAbstractToAbstract__GEN_216_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceAbstractToAbstract__GEN_216_localSearch", 3);
			...
			case "Interface_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceAbstractToAbstract__GEN_216_localSearch", 3);
			...
			case "Interface_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceAbstractToAbstract__GEN_216_localSearch", 3);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAbstractToAbstract__GEN_216_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
