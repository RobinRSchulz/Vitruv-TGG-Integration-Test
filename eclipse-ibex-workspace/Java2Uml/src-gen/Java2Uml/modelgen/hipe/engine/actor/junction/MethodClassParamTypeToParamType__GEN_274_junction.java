...
public class MethodClassParamTypeToParamType__GEN_274_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodClassParamTypeToParamType__GEN_272_junction"), this::returnTrue , 0  , false ));
	}
