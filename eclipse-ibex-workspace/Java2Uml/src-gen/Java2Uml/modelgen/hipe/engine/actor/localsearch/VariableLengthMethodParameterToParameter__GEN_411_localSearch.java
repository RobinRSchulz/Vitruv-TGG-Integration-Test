...
public class VariableLengthMethodParameterToParameter__GEN_411_localSearch extends GenericLocalSearchActor{
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__GEN_411_localSearch", 3);
			...
			case "ClassMethod_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__GEN_411_localSearch", 3);
			...
			case "Operation_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__GEN_411_localSearch", 3);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthMethodParameterToParameter__GEN_411_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
