...
public class EnumToUmlEnum__GEN_164_localSearch extends GenericLocalSearchActor{
			...
			case "CompilationUnit_object": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__GEN_164_localSearch", 4);
			...
			case "JavaPackageToUmlPackage_object": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("EnumToUmlEnum__GEN_164_localSearch", 4);
			...
			case "Package_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("EnumToUmlEnum__GEN_164_localSearch", 4);
			...
			case "Package_1_object": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__GEN_164_localSearch", 4);
		...
		case "Java2Uml.JavaPackageToUmlPackage_target_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Package) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__GEN_164_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
