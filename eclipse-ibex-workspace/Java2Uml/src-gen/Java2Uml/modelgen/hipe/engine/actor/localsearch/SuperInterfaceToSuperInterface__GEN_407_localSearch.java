...
public class SuperInterfaceToSuperInterface__GEN_407_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SuperInterfaceToSuperInterface__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__GEN_407_localSearch", 3);
			...
			case "Interface_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__GEN_407_localSearch", 3);
			...
			case "Interface_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface__GEN_407_localSearch", 3);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__GEN_407_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
