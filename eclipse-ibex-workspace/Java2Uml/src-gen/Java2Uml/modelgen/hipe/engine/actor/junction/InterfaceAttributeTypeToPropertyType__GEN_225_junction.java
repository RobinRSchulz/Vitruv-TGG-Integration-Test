...
public class InterfaceAttributeTypeToPropertyType__GEN_225_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionLeft(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceAttributeTypeToPropertyType__GEN_224_junction"), this::returnTrue , 0  , false ));
	}
