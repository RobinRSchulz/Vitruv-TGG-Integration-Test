...
public class EnumFinalToFinal__GEN_148_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumFinalToFinal__GEN_148_localSearch", 3);
			...
			case "Enumeration_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("EnumFinalToFinal__GEN_148_localSearch", 3);
			...
			case "Enumeration_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumFinalToFinal__GEN_148_localSearch", 3);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumFinalToFinal__GEN_148_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
