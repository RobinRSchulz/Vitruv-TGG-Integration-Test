...
public class MethodFinalToFinal__GEN_350_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodFinalToFinal__GEN_production"), this::returnTrue , 0  , false ));
	}
			...
			case "ClassMethod_object_SP1": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodFinalToFinal__GEN_350_localSearch", 3);
			...
			case "JavaMethodToOperation_object_SP1": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodFinalToFinal__GEN_350_localSearch", 3);
			...
			case "Operation_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodFinalToFinal__GEN_350_localSearch", 3);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodFinalToFinal__GEN_350_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsLeaf(), "boolean"));
		csp_27.solve();
