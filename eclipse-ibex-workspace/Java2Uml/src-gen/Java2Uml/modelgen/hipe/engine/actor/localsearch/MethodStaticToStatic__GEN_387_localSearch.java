...
public class MethodStaticToStatic__GEN_387_localSearch extends GenericLocalSearchActor{
			...
			case "ClassMethod_object_SP0": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodStaticToStatic__GEN_387_localSearch", 3);
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodStaticToStatic__GEN_387_localSearch", 3);
			...
			case "Operation_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodStaticToStatic__GEN_387_localSearch", 3);
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodStaticToStatic__GEN_387_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
