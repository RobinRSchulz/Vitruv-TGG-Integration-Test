...
public class ExistingSuperInterfaceToSuperInterface__GEN_199_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ExistingSuperInterfaceToSuperInterface__GEN_production"), this::returnTrue , 0  , false ));
	}
