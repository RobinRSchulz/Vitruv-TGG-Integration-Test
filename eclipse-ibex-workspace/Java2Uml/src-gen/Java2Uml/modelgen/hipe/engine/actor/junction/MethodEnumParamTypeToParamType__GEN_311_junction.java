...
public class MethodEnumParamTypeToParamType__GEN_311_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodEnumParamTypeToParamType__GEN_309_junction"), this::returnTrue , 0  , false ));
	}
