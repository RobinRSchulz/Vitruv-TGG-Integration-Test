...
public class MethodInterfaceParamTypeToParamType__GEN_352_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodInterfaceParamTypeToParamType__GEN_350_junction"), this::returnTrue , 0  , false ));
	}
