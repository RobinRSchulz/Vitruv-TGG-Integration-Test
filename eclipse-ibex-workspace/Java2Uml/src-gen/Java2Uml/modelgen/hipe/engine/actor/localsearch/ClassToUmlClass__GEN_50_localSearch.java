...
public class ClassToUmlClass__GEN_50_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassToUmlClass__GEN_production"), this::returnTrue  , false ));
	}
			...
			case "CompilationUnit_object": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("ClassToUmlClass__GEN_50_localSearch", 4);
			...
			case "JavaPackageToUmlPackage_object": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("ClassToUmlClass__GEN_50_localSearch", 4);
			...
			case "Package_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("ClassToUmlClass__GEN_50_localSearch", 4);
			...
			case "Package_1_object": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("ClassToUmlClass__GEN_50_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("ClassToUmlClass__GEN_50_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
