...
public class ConstructorEnumParamTypeToParamType__CC_107_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new EdgeExplorer(this, 7, 8, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 4, 9, edge_explorer_6_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ConstructorEnumParamTypeToParamType__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Enumeration_object_SP0": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
			...
			case "JavaConstructorToOperation_object_SP1": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
			...
			case "Constructor_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
			...
			case "Enumeration_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
			...
			case "Operation_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
			...
			case "Parameter_1_object_SP1": 
				{
					...
					// umlParameter
					HMatch match_8 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_6_1_orchestration, match_9);
				}
				break;
			case "ConstructorEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_103_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ConstructorEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_103_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CC_107_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_11.solve();
