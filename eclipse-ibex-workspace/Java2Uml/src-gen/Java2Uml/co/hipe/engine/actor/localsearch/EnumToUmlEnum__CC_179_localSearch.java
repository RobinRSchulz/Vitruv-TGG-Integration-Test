...
public class EnumToUmlEnum__CC_179_localSearch extends GenericLocalSearchActor{
			...
			case "CompilationUnit_object_SP1": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__CC_179_localSearch", 6);
			...
			case "JavaPackageToUmlPackage_object": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("EnumToUmlEnum__CC_179_localSearch", 6);
			...
			case "Package_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("EnumToUmlEnum__CC_179_localSearch", 6);
			...
			case "Package_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__CC_179_localSearch", 6);
			...
			case "Enumeration_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_4 = new LocalSearchMatch("EnumToUmlEnum__CC_179_localSearch", 6);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("EnumToUmlEnum__CC_179_localSearch", 6);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.Package_packagedElement_PackageableElement": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__CC_179_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_20.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_20.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_20.solve();
