...
public class MethodStaticToStatic__CC_449_localSearch extends GenericLocalSearchActor{
			...
			case "ClassMethod_object_SP2": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodStaticToStatic__CC_449_localSearch", 4);
			...
			case "JavaMethodToOperation_object_SP2": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodStaticToStatic__CC_449_localSearch", 4);
			...
			case "Operation_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodStaticToStatic__CC_449_localSearch", 4);
			...
			case "Static_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("MethodStaticToStatic__CC_449_localSearch", 4);
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodStaticToStatic__CC_449_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_56.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_56.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsStatic(), "boolean"));
		csp_56.solve();
