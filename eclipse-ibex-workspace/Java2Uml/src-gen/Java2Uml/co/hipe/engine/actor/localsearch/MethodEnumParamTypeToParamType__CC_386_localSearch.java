...
public class MethodEnumParamTypeToParamType__CC_386_localSearch extends GenericLocalSearchActor{
			...
			case "Enumeration_object_SP3": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP3": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
			...
			case "ClassMethod_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
			...
			case "Parameter_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
			...
			case "Enumeration_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
			...
			case "Operation_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
			...
			case "Parameter_1_object_SP1": 
				{
					...
					// umlParameter
					HMatch match_8 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_3_2_orchestration, match_9);
				}
				break;
			case "MethodEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_382_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_382_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumParamTypeToParamType__CC_386_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_48.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_48.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_48.solve();
