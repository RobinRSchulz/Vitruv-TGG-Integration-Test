...
public class EnumToUmlEnum__FWD_428_localSearch extends GenericLocalSearchActor{
			...
			case "CompilationUnit_object_SP1": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__FWD_428_localSearch", 5);
			...
			case "JavaPackageToUmlPackage_object_SP2": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("EnumToUmlEnum__FWD_428_localSearch", 5);
			...
			case "Package_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("EnumToUmlEnum__FWD_428_localSearch", 5);
			...
			case "Package_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__FWD_428_localSearch", 5);
			...
			case "Enumeration_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_4 = new LocalSearchMatch("EnumToUmlEnum__FWD_428_localSearch", 5);
		...
		case "Java2Uml.JavaPackageToUmlPackage_source_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.containers.Package) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__FWD_428_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
