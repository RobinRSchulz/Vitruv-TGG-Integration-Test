...
public class InterfacePublicToPublic__CONSISTENCY_690_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfacePublicToPublic__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Java2Uml.InterfacePublicToPublic__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
			...
			case "Interface_1_object_SP7": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_690_localSearch", 5);
			...
			case "Public_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_690_localSearch", 5);
			...
			case "Interface_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_690_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP0": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_690_localSearch", 5);
			...
			case "InterfacePublicToPublic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_690_localSearch", 5);
		...
		case "Java2Uml.InterfacePublicToPublic__Marker_CONTEXT__SRC__javaConcreteClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_690_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic csp_59 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic();
		csp_59.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_59.solve();
