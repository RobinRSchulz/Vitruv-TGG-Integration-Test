...
public class SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__TRG__generalization(); return (result instanceof uml.Generalization ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 9, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((org.emftext.language.java.types.ClassifierReference) o).getTarget(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 1, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__SRC__superclassTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 7, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__SRC__superclassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((uml.Generalization) o).getSpecific(); return (result instanceof uml.Interface ? result : null);};
						edge_explorer_9_methods.multi_opposite_lookup = (o) -> ((uml.Classifier) o).getGeneralization();
						edge_explorer_9 = new EdgeExplorer(this, 3, 4, edge_explorer_9_methods);
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__TRG__umlGeneralClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierReferenceToUmlGeneralization) o).getSource(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__CORR__javaSuperClassifierToUmlSuperClassifier();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierReferenceToUmlGeneralization) o).getTarget(); return (result instanceof uml.Generalization ? result : null);};
						edge_explorer_14 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Interface) o).getExtends().stream().filter(obj -> obj instanceof org.emftext.language.java.types.ClassifierReference).collect(Collectors.toList());
						edge_explorer_15_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.classifiers.Interface) return edge_explorer_15_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_15 = new EdgeExplorer(this, 0, 1, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__CORR__classRefToGeneralization();
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((uml.Generalization) o).getGeneral(); return (result instanceof uml.Interface ? result : null);};
						edge_explorer_17 = new CachedEdgeExplorer(this, 3, 5, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer_18 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getTarget(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						...
						edge_explorer_20 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_20_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_10_2_orchestration = initializeOrchestration(node.getOrchestrations().get(17).getPlan());
		...
		nac_checker_0_orchestration = initializeOrchestration(node.getOrchestrations().get(30).getPlan());
	}
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SuperInterfaceToSuperInterface__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Interface_1_object_SP7": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_7_1_orchestration, match_0);
					
					// superclassifier
					HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
			...
			case "ClassifierReference_object_SP9": 
				{
					...
					// superclassTypeRef
					HMatch match_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
			...
			case "Generalization_object_SP2": 
				{
					...
					// generalization
					HMatch match_3 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_2_orchestration, match_3);
				}
				break;
			case "Interface_object_SP9": 
				{
					if(!lazy_initialization) {
						
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_6_1_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_10_2_orchestration, match_5);
					}
				}
				break;
			case "JavaClassifierReferenceToUmlGeneralization_object": 
				{
					edge_explorer_12.registerSourceObject(objs[0]);
					edge_explorer_14.registerSourceObject(objs[0]);
					
					// classRefToGeneralization
					HMatch match_6 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_12_1_orchestration, match_6);
				}
				break;
			case "JavaClassifierToUmlClassifier_object_SP25": 
				{
					edge_explorer_7.registerSourceObject(objs[0]);
					edge_explorer_19.registerSourceObject(objs[0]);
					
					// javaClassifierToUmlClassifier
					HMatch match_7 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
					...
					HMatch match_8 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_10_1_orchestration, match_8);
				}
				break;
			case "SuperInterfaceToSuperInterface__Marker_object": 
				{
					...
					// SuperInterfaceToSuperInterface_eMoflon_ProtocolNode
					HMatch match_9 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1112_localSearch": 
				{
				...
				break;
			case "SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1102_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1112_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1102_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CREATE__TRG__generalization_Generalization": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Generalization) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[9] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			...
			break;
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CREATE__SRC__superclassTypeRef_ClassifierReference": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CONTEXT__CORR__javaClassifierToUmlClassifier_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CONTEXT__TRG__umlClassifier_Interface": 
			if(!lazy_initialization) {
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			...
			break;
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CREATE__SRC__superclassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			...
			break;
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CREATE__TRG__umlGeneralClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
			...
			break;
		case "Java2Uml.JavaClassifierReferenceToUmlGeneralization_source_ClassifierReference": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.types.ClassifierReference) {
				{
			...
			break;
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CREATE__CORR__javaSuperClassifierToUmlSuperClassifier_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.JavaClassifierReferenceToUmlGeneralization_target_Generalization": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Generalization) {
				{
			...
			break;
		case "org.emftext.language.java.classifiers.Interface_extends_TypeReference": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.types.ClassifierReference) {
				{
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
			...
			break;
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CREATE__CORR__classRefToGeneralization_JavaClassifierReferenceToUmlGeneralization": 
			if(!lazy_initialization) {
				{
		...
		case "uml.Generalization_general_Classifier": 
			...
			break;
		case "Java2Uml.SuperInterfaceToSuperInterface__Marker_CONTEXT__SRC__javaConcreteClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC
		...
		// register SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG
		...
		// register classRefToGeneralization
		...
		// register SuperInterfaceToSuperInterface_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[1];
		oMatch_Nodes_0[1] = objs[2];
		...
		// deregister SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG
		OverlapMatch oMatch_1 = new OverlapMatch(2);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[3];
		oMatch_Nodes_1[1] = objs[5];
		...
		// deregister classRefToGeneralization
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
		...
		// deregister SuperInterfaceToSuperInterface_eMoflon_ProtocolNode
		Collection<HMatch> matches_9 = obj2matches.get(objs[9]);
		if(matches_9 != null) {
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.emftext.language.java.classifiers.Interface) {
			HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_1116_localSearch", 10);
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.classifiers.Interface superclassifier = (org.emftext.language.java.classifiers.Interface) match.getNodes()[2];
		...
		csp_117.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, superclassifier.getName(), "java.lang.String"));
		csp_117.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlGeneralClassifier.getName(), "java.lang.String"));
		csp_117.solve();
