...
public class EnumFinalToFinal__CONSISTENCY_387_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumFinalToFinal__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Final ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumFinalToFinal__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 4, 2, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.EnumFinalToFinal__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
						edge_explorer_5 = new CachedEdgeExplorer(this, 4, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((org.emftext.language.java.modifiers.AnnotableAndModifiable) o).getAnnotationsAndModifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.modifiers.Final).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumFinalToFinal__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumFinalToFinal__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Enumeration_object_SP7": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_387_localSearch", 5);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_3_2_orchestration, match_0);
				}
				break;
			case "Final_object_SP2": 
				{
					if(!lazy_initialization) {
						
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_387_localSearch", 5);
			...
			case "Enumeration_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_387_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP19": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_387_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_1_orchestration, match_3);
				}
				break;
			case "EnumFinalToFinal__Marker_object": 
				{
					...
					// EnumFinalToFinal_eMoflon_ProtocolNode
					HMatch match_4 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_387_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Java2Uml.EnumFinalToFinal__Marker_CREATE__SRC__modifier_Final": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.modifiers.Final) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_387_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			...
			break;
		case "Java2Uml.EnumFinalToFinal__Marker_CONTEXT__TRG__umlClassifier_Enumeration": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.EnumFinalToFinal__Marker_CONTEXT__CORR__javaClassifierToUmlClassifier_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			...
			break;
		case "Java2Uml.EnumFinalToFinal__Marker_CONTEXT__SRC__javaConcreteClassifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register EnumFinalToFinal_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister EnumFinalToFinal_eMoflon_ProtocolNode
		Collection<HMatch> matches_4 = obj2matches.get(objs[4]);
		if(matches_4 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_33.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_33.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.isIsFinalSpecialization(), "boolean"));
		csp_33.solve();
