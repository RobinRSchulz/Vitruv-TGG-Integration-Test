...
public class JavaFirstCompilationUnitToUmlModel__CONSISTENCY_768_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__shortType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 14, 9, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new EdgeExplorer(this, 2, 11, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__SRC__compilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
						edge_explorer_9 = new CachedEdgeExplorer(this, 14, 0, edge_explorer_9_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new EdgeExplorer(this, 4, 11, edge_explorer_10_methods);
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						...
						edge_explorer_12 = new EdgeExplorer(this, 9, 11, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__byteType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_13 = new CachedEdgeExplorer(this, 14, 3, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((uml.Type) o).getPackage(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_14_methods.multi_opposite_lookup = (o) -> ((uml.Package) o).getOwnedType().stream().filter(obj -> obj instanceof uml.PrimitiveType).collect(Collectors.toList());
						edge_explorer_14 = new EdgeExplorer(this, 3, 11, edge_explorer_14_methods);
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						...
						edge_explorer_15 = new EdgeExplorer(this, 10, 11, edge_explorer_15_methods);
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						...
						edge_explorer_17 = new EdgeExplorer(this, 7, 11, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
						edge_explorer_18 = new CachedEdgeExplorer(this, 14, 1, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__doubleType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_19 = new CachedEdgeExplorer(this, 14, 5, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__longType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_20 = new CachedEdgeExplorer(this, 14, 8, edge_explorer_20_methods);
		name2explorer.put("edge_explorer_20", edge_explorer_20);
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> {EObject result = ((uml.Type) o).getPackage(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_21_methods.multi_opposite_lookup = (o) -> ((uml.Package) o).getOwnedType().stream().filter(obj -> obj instanceof uml.PrimitiveType).collect(Collectors.toList());
						edge_explorer_21 = new EdgeExplorer(this, 5, 11, edge_explorer_21_methods);
		name2explorer.put("edge_explorer_21", edge_explorer_21);
		EdgeLookupMethods edge_explorer_22_methods = new EdgeLookupMethods();
						edge_explorer_22_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__stringType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_22 = new CachedEdgeExplorer(this, 14, 10, edge_explorer_22_methods);
		name2explorer.put("edge_explorer_22", edge_explorer_22);
		EdgeLookupMethods edge_explorer_23_methods = new EdgeLookupMethods();
						edge_explorer_23_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__floatType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_23 = new CachedEdgeExplorer(this, 14, 6, edge_explorer_23_methods);
		name2explorer.put("edge_explorer_23", edge_explorer_23);
		EdgeLookupMethods edge_explorer_24_methods = new EdgeLookupMethods();
						edge_explorer_24_methods.unique_lookup = (o) -> ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__CORR__javaCompUnitToUmlModel();
						edge_explorer_24 = new CachedEdgeExplorer(this, 14, 13, edge_explorer_24_methods);
		name2explorer.put("edge_explorer_24", edge_explorer_24);
		EdgeLookupMethods edge_explorer_25_methods = new EdgeLookupMethods();
						edge_explorer_25_methods.multi_lookup = (o) -> ((org.emftext.language.java.containers.Package) o).getCompilationUnits();
						edge_explorer_25_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.containers.Package) return edge_explorer_25_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_26_methods = new EdgeLookupMethods();
						...
						edge_explorer_26 = new EdgeExplorer(this, 8, 11, edge_explorer_26_methods);
		name2explorer.put("edge_explorer_26", edge_explorer_26);
		EdgeLookupMethods edge_explorer_27_methods = new EdgeLookupMethods();
						edge_explorer_27_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToUmlModel) o).getSource(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
						edge_explorer_27 = new CachedEdgeExplorer(this, 13, 0, edge_explorer_27_methods);
		...
		EdgeLookupMethods edge_explorer_28_methods = new EdgeLookupMethods();
						...
						edge_explorer_28 = new EdgeExplorer(this, 12, 11, edge_explorer_28_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_15_1_orchestration = initializeOrchestration(node.getOrchestrations().get(24).getPlan());
		edge_explorer_16_0_orchestration = initializeOrchestration(node.getOrchestrations().get(25).getPlan());
		edge_explorer_16_1_orchestration = initializeOrchestration(node.getOrchestrations().get(26).getPlan());
		...
		edge_explorer_18_1_orchestration = initializeOrchestration(node.getOrchestrations().get(29).getPlan());
		...
		edge_explorer_20_1_orchestration = initializeOrchestration(node.getOrchestrations().get(33).getPlan());
			...
			case "Package_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						start(edge_explorer_18_1_orchestration, match_1);
					}
				}
				break;
			case "PrimitiveType_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						start(edge_explorer_13_1_orchestration, match_3);
						...
						start(edge_explorer_19_1_orchestration, match_5);
						...
						start(edge_explorer_20_1_orchestration, match_8);
						...
						start(edge_explorer_15_1_orchestration, match_10);
