...
public class OrdinaryConstructorParameterToParameter__FWD_1019_localSearch extends GenericLocalSearchActor{
			...
			case "JavaConstructorToOperation_object_SP3": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__FWD_1019_localSearch", 4);
			...
			case "Constructor_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__FWD_1019_localSearch", 4);
			...
			case "Operation_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__FWD_1019_localSearch", 4);
			...
			case "OrdinaryParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_3 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__FWD_1019_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__FWD_1019_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
