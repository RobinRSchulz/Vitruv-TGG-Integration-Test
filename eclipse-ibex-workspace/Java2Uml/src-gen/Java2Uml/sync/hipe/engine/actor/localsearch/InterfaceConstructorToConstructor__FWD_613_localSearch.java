...
public class InterfaceConstructorToConstructor__FWD_613_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP14": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__FWD_613_localSearch", 4);
			...
			case "Interface_1_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceConstructorToConstructor__FWD_613_localSearch", 4);
			...
			case "Interface_object_SP11": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceConstructorToConstructor__FWD_613_localSearch", 4);
			...
			case "Constructor_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// constructor
						HMatch match_3 = new LocalSearchMatch("InterfaceConstructorToConstructor__FWD_613_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceConstructorToConstructor__FWD_613_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
