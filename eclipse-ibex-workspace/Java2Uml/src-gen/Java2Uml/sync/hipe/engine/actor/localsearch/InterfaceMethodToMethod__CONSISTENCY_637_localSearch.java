...
public class InterfaceMethodToMethod__CONSISTENCY_637_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceMethodToMethod__Marker) o).getCONTEXT__CORR__j();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceMethodToMethod__Marker) o).getCREATE__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceMethodToMethod__Marker) o).getCREATE__SRC__method(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((org.emftext.language.java.members.MemberContainer) o).getMembers().stream().filter(obj -> obj instanceof org.emftext.language.java.members.ClassMethod).collect(Collectors.toList());
			...
			case "Interface_1_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_637_localSearch", 7);
			...
			case "ClassMethod_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// method
						HMatch match_1 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_637_localSearch", 7);
			...
			case "Interface_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_637_localSearch", 7);
			...
			case "Operation_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_3 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_637_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP18": 
				{
					...
					// j
					HMatch match_4 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_637_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_637_localSearch", 7);
			...
			case "InterfaceMethodToMethod__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_637_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_4_1_orchestration, match_6);
				}
				break;
			case "InterfaceMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_629_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "InterfaceMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_629_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_637_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceMethodToMethod__CONSISTENCY_637_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_53.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, method.getName(), "java.lang.String"));
		csp_53.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_53.solve();
