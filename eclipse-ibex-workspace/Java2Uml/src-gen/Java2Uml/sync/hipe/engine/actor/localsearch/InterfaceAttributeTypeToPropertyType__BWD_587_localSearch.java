...
public class InterfaceAttributeTypeToPropertyType__BWD_587_localSearch extends GenericLocalSearchActor{
			...
			case "JavaAttributeToUmlProperty_object_SP0": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_587_localSearch", 6);
			...
			case "Interface_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_587_localSearch", 6);
			...
			case "Field_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_2 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_587_localSearch", 6);
			...
			case "JavaClassifierToUmlClassifier_object_SP12": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_587_localSearch", 6);
			...
			case "Property_object_SP1": 
				{
					...
					// property
					HMatch match_4 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_587_localSearch", 6);
			...
			case "Interface_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_587_localSearch", 6);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__BWD_587_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
