...
public class InterfaceProtectedToProtected__CONSISTENCY_661_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceProtectedToProtected__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceProtectedToProtected__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Protected ? result : null);};
			...
			case "Interface_1_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_661_localSearch", 5);
			...
			case "Protected_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_661_localSearch", 5);
			...
			case "Interface_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_661_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP22": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_661_localSearch", 5);
			...
			case "InterfaceProtectedToProtected__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_661_localSearch", 5);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceProtectedToProtected__CONSISTENCY_661_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected csp_56 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected();
		csp_56.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_56.solve();
