...
public class ClassConstructorToConstructor__BWD_64_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP8": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("ClassConstructorToConstructor__BWD_64_localSearch", 4);
			...
			case "Class_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ClassConstructorToConstructor__BWD_64_localSearch", 4);
			...
			case "Class_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassConstructorToConstructor__BWD_64_localSearch", 4);
			...
			case "Operation_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_3 = new LocalSearchMatch("ClassConstructorToConstructor__BWD_64_localSearch", 4);
		...
		switch(match.creator) {
			...
			case "ClassConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_61_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassConstructorToConstructor__BWD_64_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassConstructorToConstructor__BWD_64_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
