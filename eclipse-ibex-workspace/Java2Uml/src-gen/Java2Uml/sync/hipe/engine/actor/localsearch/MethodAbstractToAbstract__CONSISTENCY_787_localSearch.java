...
public class MethodAbstractToAbstract__CONSISTENCY_787_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodAbstractToAbstract__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Abstract ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.MethodAbstractToAbstract__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodAbstractToAbstract__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodAbstractToAbstract__Marker) o).getCONTEXT__SRC__javaMethod(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
			...
			case "ClassMethod_object_SP2": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_787_localSearch", 5);
			...
			case "Abstract_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_787_localSearch", 5);
			...
			case "Operation_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_787_localSearch", 5);
			...
			case "JavaMethodToOperation_object_SP2": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_787_localSearch", 5);
			...
			case "MethodAbstractToAbstract__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_787_localSearch", 5);
		...
		case "Java2Uml.MethodAbstractToAbstract__Marker_CREATE__SRC__modifier_Abstract": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.modifiers.Abstract) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_787_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_86.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_86.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsAbstract(), "boolean"));
		csp_86.solve();
