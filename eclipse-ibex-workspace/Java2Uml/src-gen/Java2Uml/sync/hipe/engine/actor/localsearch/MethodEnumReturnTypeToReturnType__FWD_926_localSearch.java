...
public class MethodEnumReturnTypeToReturnType__FWD_926_localSearch extends GenericLocalSearchActor{
			...
			case "Enumeration_object_SP6": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_926_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP14": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_926_localSearch", 7);
			...
			case "ClassMethod_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_926_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP7": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_926_localSearch", 7);
			...
			case "Enumeration_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_926_localSearch", 7);
			...
			case "Operation_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_926_localSearch", 7);
			...
			case "ClassifierReference_object_SP13": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_926_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_911_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_926_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__FWD_926_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
