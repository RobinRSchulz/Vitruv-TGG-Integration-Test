			...
			case "Class_object_SP1": 
				{
					...
					// javaClass
					HMatch match_0 = new LocalSearchMatch("ClassImplementToClassImplement__BWD_97_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP13": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ClassImplementToClassImplement__BWD_97_localSearch", 5);
			...
			case "Class_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_2 = new LocalSearchMatch("ClassImplementToClassImplement__BWD_97_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_93_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassImplementToClassImplement__BWD_97_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
