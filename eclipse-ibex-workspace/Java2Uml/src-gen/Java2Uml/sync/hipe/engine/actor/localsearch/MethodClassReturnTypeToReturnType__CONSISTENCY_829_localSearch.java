...
public class MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Java2Uml.MethodClassReturnTypeToReturnType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						...
						edge_explorer_4_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.members.ClassMethod) return o.equals(edge_explorer_4_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_4 = new EdgeExplorer(this, 1, 2, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodClassReturnTypeToReturnType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((uml.TypedElement) o).getType(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodClassReturnTypeToReturnType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						...
						edge_explorer_13 = new EdgeExplorer(this, 4, 5, edge_explorer_13_methods);
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodClassReturnTypeToReturnType__Marker) o).getCREATE__TRG__umlReturnParameter(); return (result instanceof uml.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodClassReturnTypeToReturnType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodClassReturnTypeToReturnType__Marker) o).getCONTEXT__SRC__javaMethod(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Java2Uml.MethodClassReturnTypeToReturnType__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
			...
			case "Class_object_SP5": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
			...
			case "ClassMethod_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_1 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
			...
			case "ClassifierReference_object_SP5": 
				{
					...
					// typeReference
					HMatch match_2 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
			...
			case "Class_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
			...
			case "Operation_object_SP12": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_4 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
			...
			case "Parameter_1_object_SP5": 
				{
					...
					// umlReturnParameter
					HMatch match_5 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP4": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
			...
			case "JavaTypeReferenceToUmlReturnParameter_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
			...
			case "MethodClassReturnTypeToReturnType__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_3_1_orchestration, match_9);
				}
				break;
			case "MethodClassReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_825_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodClassReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_825_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodClassReturnTypeToReturnType__CONSISTENCY_829_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_92.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_92.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_92.solve();
		
		boolean predicate = csp_92.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_93.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_93.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_93.solve();
