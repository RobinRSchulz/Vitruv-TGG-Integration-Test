...
public class SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1081_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SuperClassToSuperClass__CONSISTENCY_1085_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("SuperClassToSuperClass__FWD_1096_localSearch"), this::returnTrue  , false ));
			...
			case "ClassifierReference_object_SP7": 
				{
					...
					// superclassTypeRef
					HMatch match_0 = new LocalSearchMatch("SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1081_localSearch", 3);
			...
			case "Class_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						// superclassifier
						HMatch match_1 = new LocalSearchMatch("SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1081_localSearch", 3);
			...
			case "Classifier_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// FILTER_NAC_NODE
						HMatch match_2 = new LocalSearchMatch("SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1081_localSearch", 3);
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1081_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
