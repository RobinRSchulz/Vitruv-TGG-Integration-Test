...
public class MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 10, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.Parameter ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 10, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((uml.TypedElement) o).getType(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new CachedEdgeExplorer(this, 7, 0, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__CORR__parameterToParameter();
						edge_explorer_8 = new CachedEdgeExplorer(this, 10, 9, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((org.emftext.language.java.types.TypedElement) o).getTypeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
						edge_explorer_9_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.parameters.Parameter) return o.equals(edge_explorer_9_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_9 = new EdgeExplorer(this, 2, 3, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaMethodToOperation) o).getTarget(); return (result instanceof uml.Operation ? result : null);};
						edge_explorer_10 = new CachedEdgeExplorer(this, 8, 5, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((uml.BehavioralFeature) o).getOwnedParameter();
						edge_explorer_11_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Operation) return edge_explorer_11_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_11 = new EdgeExplorer(this, 5, 6, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer_12 = new CachedEdgeExplorer(this, 10, 0, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getTarget(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
						edge_explorer_15 = new CachedEdgeExplorer(this, 10, 5, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
						edge_explorer_16 = new CachedEdgeExplorer(this, 10, 3, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaConstructorToOperation();
						edge_explorer_18 = new CachedEdgeExplorer(this, 10, 8, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((org.emftext.language.java.types.ClassifierReference) o).getTarget(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer_19 = new CachedEdgeExplorer(this, 3, 0, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaMethodToOperation) o).getSource(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
						edge_explorer_20 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_20_methods);
		name2explorer.put("edge_explorer_20", edge_explorer_20);
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
						edge_explorer_21 = new CachedEdgeExplorer(this, 10, 6, edge_explorer_21_methods);
		name2explorer.put("edge_explorer_21", edge_explorer_21);
		EdgeLookupMethods edge_explorer_22_methods = new EdgeLookupMethods();
						edge_explorer_22_methods.multi_lookup = (o) -> ((org.emftext.language.java.parameters.Parametrizable) o).getParameters();
						edge_explorer_22_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.members.ClassMethod) return edge_explorer_22_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_22 = new EdgeExplorer(this, 1, 2, edge_explorer_22_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_10_2_orchestration = initializeOrchestration(node.getOrchestrations().get(19).getPlan());
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "Interface_1_object_SP12": 
				{
					
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
			...
			case "ClassMethod_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_2 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
			...
			case "ClassifierReference_object_SP0": 
				{
					...
					// typeReference
					HMatch match_3 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_9_1_orchestration, match_3);
				}
				break;
			case "Interface_object_SP2": 
				{
					if(!lazy_initialization) {
						
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_4_2_orchestration, match_4);
					}
				}
				break;
			case "Operation_object_SP8": 
				{
					if(!lazy_initialization) {
						
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_10_2_orchestration, match_5);
					}
				}
				break;
			case "Parameter_1_object_SP4": 
				{
					...
					// umlParameter
					HMatch match_6 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_4_1_orchestration, match_6);
				}
				break;
			case "JavaClassifierToUmlClassifier_object_SP16": 
				{
					edge_explorer_7.registerSourceObject(objs[0]);
					edge_explorer_13.registerSourceObject(objs[0]);
					
					// javaClassifierToUmlClassifier
					HMatch match_7 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
			...
			case "JavaMethodToOperation_object_SP3": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
			...
			case "JavaParameterToParameter_object_SP4": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
			...
			case "MethodInterfaceParamTypeToParamType__Marker_object": 
				{
					...
					HMatch match_10 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
					match_10.getNodes()[10] = objs[0];
					start(edge_explorer_1_orchestration, match_10);
				}
				break;
			case "MethodInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_955_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_955_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.MethodInterfaceParamTypeToParamType__Marker_CONTEXT__SRC__javaParametrizable_ClassMethod": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_959_localSearch", 11);
					Object[] objs = match.getNodes();
					objs[10] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_105.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_105.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_105.solve();
