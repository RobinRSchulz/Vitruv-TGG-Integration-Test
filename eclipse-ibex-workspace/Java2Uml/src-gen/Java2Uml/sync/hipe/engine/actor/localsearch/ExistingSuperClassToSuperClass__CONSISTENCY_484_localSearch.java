...
public class ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Java2Uml.ExistingSuperClassToSuperClass__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperClassToSuperClass__Marker) o).getCREATE__TRG__generalization(); return (result instanceof uml.Generalization ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Java2Uml.ExistingSuperClassToSuperClass__Marker) o).getCONTEXT__CORR__javaSuperClassifierToUmlSuperClassifier();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperClassToSuperClass__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperClassToSuperClass__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperClassToSuperClass__Marker) o).getCONTEXT__SRC__superclassifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
			...
			case "Class_object_SP10": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_5_1_orchestration, match_0);
					
					// superclassifier
					HMatch match_2 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
			...
			case "ClassifierReference_object_SP7": 
				{
					...
					// superclassTypeRef
					HMatch match_1 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
			...
			case "Generalization_object_SP2": 
				{
					...
					// generalization
					HMatch match_3 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
			...
			case "Class_1_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_10_1_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
			...
			case "JavaClassifierToUmlClassifier_object_SP2": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
					...
					HMatch match_7 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
			...
			case "ExistingSuperClassToSuperClass__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_480_localSearch": 
				{
				...
				break;
			case "ExistingSuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_468_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_480_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ExistingSuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_468_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperClassToSuperClass__CONSISTENCY_484_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
