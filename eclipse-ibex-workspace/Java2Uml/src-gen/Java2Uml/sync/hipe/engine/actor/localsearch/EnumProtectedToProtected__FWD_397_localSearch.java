...
public class EnumProtectedToProtected__FWD_397_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP21": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumProtectedToProtected__FWD_397_localSearch", 4);
			...
			case "Enumeration_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("EnumProtectedToProtected__FWD_397_localSearch", 4);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumProtectedToProtected__FWD_397_localSearch", 4);
			...
			case "Protected_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("EnumProtectedToProtected__FWD_397_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("EnumProtectedToProtected__FWD_397_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
