...
public class EnumAttributeTypeToPropertyType__FWD_361_localSearch extends GenericLocalSearchActor{
			...
			case "JavaAttributeToUmlProperty_object_SP3": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__FWD_361_localSearch", 7);
			...
			case "Enumeration_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__FWD_361_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
					}
				}
				break;
			case "Field_object_SP4": 
				{
					if(!lazy_initialization) {
						
						// field
						HMatch match_2 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__FWD_361_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP15": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__FWD_361_localSearch", 7);
			...
			case "Property_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_4 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__FWD_361_localSearch", 7);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__FWD_361_localSearch", 7);
			...
			case "ClassifierReference_object_SP3": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__FWD_361_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "EnumAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_348_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("EnumAttributeTypeToPropertyType__FWD_361_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumAttributeTypeToPropertyType__FWD_361_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
