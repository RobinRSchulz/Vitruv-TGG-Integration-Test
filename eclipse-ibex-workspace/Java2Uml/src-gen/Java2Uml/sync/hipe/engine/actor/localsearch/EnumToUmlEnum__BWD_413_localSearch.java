...
public class EnumToUmlEnum__BWD_413_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumToUmlEnum__BWD_production"), this::returnTrue  , false ));
	}
			...
			case "CompilationUnit_object_SP3": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("EnumToUmlEnum__BWD_413_localSearch", 5);
			...
			case "JavaPackageToUmlPackage_object_SP0": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("EnumToUmlEnum__BWD_413_localSearch", 5);
			...
			case "Package_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("EnumToUmlEnum__BWD_413_localSearch", 5);
			...
			case "Package_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("EnumToUmlEnum__BWD_413_localSearch", 5);
			...
			case "Enumeration_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("EnumToUmlEnum__BWD_413_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.Package_packagedElement_PackageableElement": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("EnumToUmlEnum__BWD_413_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
