...
public class ClassAttributeTypeToPropertyType__FWD_53_localSearch extends GenericLocalSearchActor{
			...
			case "JavaAttributeToUmlProperty_object_SP3": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__FWD_53_localSearch", 7);
			...
			case "Class_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__FWD_53_localSearch", 7);
			...
			case "Field_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_2 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__FWD_53_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP7": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__FWD_53_localSearch", 7);
			...
			case "Property_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_4 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__FWD_53_localSearch", 7);
			...
			case "Class_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__FWD_53_localSearch", 7);
			...
			case "ClassifierReference_object_SP2": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__FWD_53_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "ClassAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_40_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__FWD_53_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaAttributeToUmlProperty_target_Property": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Property) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassAttributeTypeToPropertyType__FWD_53_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_5.solve();
