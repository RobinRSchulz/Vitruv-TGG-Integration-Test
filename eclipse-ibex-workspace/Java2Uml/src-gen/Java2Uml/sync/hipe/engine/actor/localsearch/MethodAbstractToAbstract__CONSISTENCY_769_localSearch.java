...
public class MethodAbstractToAbstract__CONSISTENCY_769_localSearch extends GenericLocalSearchActor{
			...
			case "ClassMethod_object_SP4": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_769_localSearch", 5);
			...
			case "Abstract_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_769_localSearch", 5);
			...
			case "Operation_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_769_localSearch", 5);
			...
			case "JavaMethodToOperation_object_SP2": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_769_localSearch", 5);
			...
			case "MethodAbstractToAbstract__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_769_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_769_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_85.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_85.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsAbstract(), "boolean"));
		csp_85.solve();
