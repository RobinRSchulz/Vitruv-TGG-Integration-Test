...
public class ExistingSuperInterfaceToSuperInterface__FWD_528_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__FWD_528_localSearch", 7);
					...
					HMatch match_2 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__FWD_528_localSearch", 7);
			...
			case "Interface_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__FWD_528_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_5_1_orchestration, match_1);
						
						// superclassifier
						HMatch match_3 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__FWD_528_localSearch", 7);
			...
			case "Interface_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__FWD_528_localSearch", 7);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_7_1_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__FWD_528_localSearch", 7);
			...
			case "ClassifierReference_object_SP12": 
				{
					...
					// superclassTypeRef
					HMatch match_6 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__FWD_528_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_514_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__FWD_528_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__FWD_528_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
