...
public class ExistingClassImplementToClassImplement__BWD_456_localSearch extends GenericLocalSearchActor{
			...
			case "Interface_1_object_SP7": 
				{
					...
					// interface
					HMatch match_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_456_localSearch", 7);
			...
			case "Class_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// javaClass
						HMatch match_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_456_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_456_localSearch", 7);
					...
					HMatch match_3 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_456_localSearch", 7);
			...
			case "Class_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_4 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_456_localSearch", 7);
			...
			case "Interface_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_5 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_456_localSearch", 7);
			...
			case "InterfaceRealization_object_SP1": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_456_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_452_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_456_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__BWD_456_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
