...
public class ClassAttributeToProperty__FWD_28_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP4": 
				{
					...
					// classToUmlClass
					HMatch match_0 = new LocalSearchMatch("ClassAttributeToProperty__FWD_28_localSearch", 4);
			...
			case "Class_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("ClassAttributeToProperty__FWD_28_localSearch", 4);
			...
			case "Class_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassAttributeToProperty__FWD_28_localSearch", 4);
			...
			case "Field_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_3 = new LocalSearchMatch("ClassAttributeToProperty__FWD_28_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassAttributeToProperty__FWD_28_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
