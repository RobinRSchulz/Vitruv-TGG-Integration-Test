...
public class MethodClassParamTypeToParamType__FWD_824_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 4, 9, edge_explorer_3_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodClassParamTypeToParamType__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Class_object_SP3": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP5": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
			...
			case "JavaMethodToOperation_object_SP6": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_8_1_orchestration, match_2);
				}
				break;
			case "ClassMethod_object_SP8": 
				{
					if(!lazy_initialization) {
						
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP5": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
			...
			case "Class_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
			...
			case "Operation_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
			...
			case "Parameter_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_8 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
			...
			case "ClassifierReference_object_SP4": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_3_2_orchestration, match_9);
				}
				break;
		...
		switch(match.creator) {
			...
			case "MethodClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_808_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodClassParamTypeToParamType__FWD_824_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_90.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_90.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_90.solve();
