...
public class EnumConstantToEnumConstant__CONSISTENCY_374_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Enumeration) o).getConstants();
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.classifiers.Enumeration) return edge_explorer_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__TRG__umlEnum(); return (result instanceof uml.Enumeration ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__SRC__javaEnum(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((uml.Enumeration) o).getOwnedLiteral();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> ((uml.EnumerationLiteral) o).getEnumeration();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__CORR__javaEnumConstantToUmlEnumLiteral();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__CORR__j();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__SRC__javaConstant(); return (result instanceof org.emftext.language.java.members.EnumConstant ? result : null);};
			...
			case "EnumConstant_object": 
				{
					...
					// javaConstant
					HMatch match_0 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_374_localSearch", 7);
			...
			case "Enumeration_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// javaEnum
						HMatch match_1 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_374_localSearch", 7);
			...
			case "Enumeration_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlEnum
						HMatch match_2 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_374_localSearch", 7);
			...
			case "EnumerationLiteral_object": 
				{
					if(!lazy_initialization) {
						...
						// umlLiteral
						HMatch match_3 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_374_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP17": 
				{
					...
					// j
					HMatch match_4 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_374_localSearch", 7);
			...
			case "JavaEnumConstantToUmlEnumLiteral_object": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_374_localSearch", 7);
			...
			case "EnumConstantToEnumConstant__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_374_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.classifiers.Enumeration_constants_EnumConstant": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_374_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, javaConstant.getName(), "java.lang.String"));
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlLiteral.getName(), "java.lang.String"));
		csp_32.solve();
