...
public class FieldStaticToStatic__CONSISTENCY_565_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.FieldStaticToStatic__Marker) o).getCONTEXT__TRG__umlProperty(); return (result instanceof uml.Property ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 4, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.FieldStaticToStatic__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Static ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.FieldStaticToStatic__Marker) o).getCONTEXT__SRC__javaField(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((org.emftext.language.java.modifiers.AnnotableAndModifiable) o).getAnnotationsAndModifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.modifiers.Static).collect(Collectors.toList());
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.members.Field) return edge_explorer_7_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.FieldStaticToStatic__Marker) o).getCONTEXT__CORR__javaClassifierToUmlProperty();
			...
			case "Field_object_SP2": 
				{
					...
					// javaField
					HMatch match_0 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_565_localSearch", 5);
			...
			case "Static_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_565_localSearch", 5);
			...
			case "Property_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlProperty
						HMatch match_2 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_565_localSearch", 5);
			...
			case "JavaAttributeToUmlProperty_object_SP2": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_565_localSearch", 5);
			...
			case "FieldStaticToStatic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_565_localSearch", 5);
		...
		case "Java2Uml.JavaAttributeToUmlProperty_target_Property": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Property) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_565_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_44.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_44.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlProperty.isIsStatic(), "boolean"));
		csp_44.solve();
