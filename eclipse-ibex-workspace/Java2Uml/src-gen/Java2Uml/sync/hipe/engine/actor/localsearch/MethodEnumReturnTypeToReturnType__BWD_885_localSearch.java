...
public class MethodEnumReturnTypeToReturnType__BWD_885_localSearch extends GenericLocalSearchActor{
			...
			case "Enumeration_object_SP3": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_885_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP9": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_885_localSearch", 7);
			...
			case "ClassMethod_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_885_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP5": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_885_localSearch", 7);
			...
			case "Enumeration_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_885_localSearch", 7);
			...
			case "Operation_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_885_localSearch", 7);
			...
			case "Parameter_1_object_SP1": 
				{
					...
					// umlReturnParameter
					HMatch match_6 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_885_localSearch", 7);
		...
		case "uml.TypedElement_type_Type": 
			if(!lazy_initialization) {
				...
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__BWD_885_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_97.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_97.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_97.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_98.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_98.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_98.solve();
