...
public class VariableLengthMethodParameterToParameter__CONSISTENCY_1141_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((org.emftext.language.java.parameters.Parametrizable) o).getParameters().stream().filter(obj -> obj instanceof org.emftext.language.java.parameters.VariableLengthParameter).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__TRG__upperValue(); return (result instanceof uml.LiteralUnlimitedNatural ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 7, 4, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
						edge_explorer_4 = new CachedEdgeExplorer(this, 7, 5, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 7, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((uml.MultiplicityElement) o).getUpperValue(); return (result instanceof uml.LiteralUnlimitedNatural ? result : null);};
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Parameter) return o.equals(edge_explorer_7_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						...
						edge_explorer_10 = new CachedEdgeExplorer(this, 5, 0, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.VariableLengthParameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__CORR__parameterToParameter();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaParameterToParameter) o).getSource(); return (result instanceof org.emftext.language.java.parameters.VariableLengthParameter ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VariableLengthMethodParameterToParameter__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "ClassMethod_object_SP5": 
				{
					...
					// javaParametrizable
					HMatch match_0 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_1141_localSearch", 8);
			...
			case "VariableLengthParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_1 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_1141_localSearch", 8);
			...
			case "Operation_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_1141_localSearch", 8);
			...
			case "Parameter_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_3 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_1141_localSearch", 8);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_6_1_orchestration, match_3);
					}
				}
				break;
			case "LiteralUnlimitedNatural_object": 
				{
					if(!lazy_initialization) {
						
						// upperValue
						HMatch match_4 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_1141_localSearch", 8);
			...
			case "JavaMethodToOperation_object_SP6": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_1141_localSearch", 8);
			...
			case "JavaParameterToParameter_object_SP3": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_1141_localSearch", 8);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_12_1_orchestration, match_6);
				}
				break;
			case "VariableLengthMethodParameterToParameter__Marker_object": 
				{
					...
					// VariableLengthMethodParameterToParameter_eMoflon_ProtocolNode
					HMatch match_7 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_1141_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_1141_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
			...
			break;
		case "Java2Uml.VariableLengthMethodParameterToParameter__Marker_CREATE__TRG__upperValue_LiteralUnlimitedNatural": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.VariableLengthMethodParameterToParameter__Marker_CONTEXT__CORR__javaMethodToOperation_JavaMethodToOperation": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.VariableLengthMethodParameterToParameter__Marker_CONTEXT__TRG__umlOperation_Operation": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.VariableLengthMethodParameterToParameter__Marker_CREATE__TRG__umlParameter_Parameter": 
			if(!lazy_initialization) {
			...
			break;
		case "uml.MultiplicityElement_upperValue_ValueSpecification": 
			if(!lazy_initialization) {
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			...
			break;
		case "Java2Uml.VariableLengthMethodParameterToParameter__Marker_CONTEXT__SRC__javaParametrizable_ClassMethod": 
			if(!lazy_initialization) {
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			...
			break;
		case "Java2Uml.VariableLengthMethodParameterToParameter__Marker_CREATE__SRC__parameter_VariableLengthParameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.parameters.VariableLengthParameter) {
				{
			...
			break;
		case "Java2Uml.VariableLengthMethodParameterToParameter__Marker_CREATE__CORR__parameterToParameter_JavaParameterToParameter": 
			if(!lazy_initialization) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register VariableLengthMethodParameterToParameter_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister VariableLengthMethodParameterToParameter_eMoflon_ProtocolNode
		Collection<HMatch> matches_7 = obj2matches.get(objs[7]);
		if(matches_7 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_124.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 0, "java.lang.String"));
		csp_124.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getLower(), "int"));
		csp_124.solve();
		
		boolean predicate = csp_124.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_125.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, -1, "java.lang.String"));
		csp_125.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, upperValue.getValue(), "int"));
		csp_125.solve();
		
		boolean predicate = csp_125.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_126.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_126.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_126.solve();
		
		boolean predicate = csp_126.isSatisfied();
		return predicate;
	}
