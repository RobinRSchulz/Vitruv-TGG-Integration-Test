...
public class ExistingClassImplementToClassImplement__FWD_460_localSearch extends GenericLocalSearchActor{
			...
			case "Interface_1_object_SP10": 
				{
					...
					// interface
					HMatch match_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_460_localSearch", 7);
			...
			case "Class_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// javaClass
						HMatch match_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_460_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_460_localSearch", 7);
					...
					HMatch match_3 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_460_localSearch", 7);
			...
			case "Class_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_4 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_460_localSearch", 7);
			...
			case "Interface_object_SP11": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_5 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_460_localSearch", 7);
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// interfaceTypeRef
					HMatch match_6 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_460_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_446_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_460_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__FWD_460_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
