...
public class VariableLengthMethodParameterToParameter__CONSISTENCY_1159_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.VariableLengthParameter ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 7, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__TRG__upperValue(); return (result instanceof uml.LiteralUnlimitedNatural ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((uml.MultiplicityElement) o).getUpperValue(); return (result instanceof uml.LiteralUnlimitedNatural ? result : null);};
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Parameter) return o.equals(edge_explorer_8_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaParameterToParameter) o).getSource(); return (result instanceof org.emftext.language.java.parameters.VariableLengthParameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						...
						edge_explorer_13 = new CachedEdgeExplorer(this, 5, 0, edge_explorer_13_methods);
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						...
						edge_explorer_14 = new CachedEdgeExplorer(this, 5, 2, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__CORR__parameterToParameter();
