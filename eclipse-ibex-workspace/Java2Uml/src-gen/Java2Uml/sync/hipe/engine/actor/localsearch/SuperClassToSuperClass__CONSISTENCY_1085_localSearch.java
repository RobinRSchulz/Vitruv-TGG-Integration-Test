...
public class SuperClassToSuperClass__CONSISTENCY_1085_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((uml.Generalization) o).getSpecific(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__SRC__superclassifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__SRC__superclassTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((uml.Generalization) o).getGeneral(); return (result instanceof uml.Class ? result : null);};
						edge_explorer_8 = new CachedEdgeExplorer(this, 3, 5, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getTarget(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__TRG__umlGeneralClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((org.emftext.language.java.classifiers.Class) o).getExtends(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.classifiers.Class) return o.equals(edge_explorer_12_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Java2Uml.SuperClassToSuperClass__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__CORR__classRefToGeneralization();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						...
						edge_explorer_15 = new CachedEdgeExplorer(this, 1, 2, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__CORR__javaSuperClassifierToUmlSuperClassifier();
						edge_explorer_17 = new CachedEdgeExplorer(this, 9, 8, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getSource(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
						edge_explorer_19 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperClassToSuperClass__Marker) o).getCREATE__TRG__generalization(); return (result instanceof uml.Generalization ? result : null);};
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_9_2_orchestration = initializeOrchestration(node.getOrchestrations().get(17).getPlan());
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SuperClassToSuperClass__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Class_object_SP9": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_9_2_orchestration, match_0);
					
					// superclassifier
					HMatch match_2 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// superclassTypeRef
					HMatch match_1 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
			...
			case "Generalization_object_SP2": 
				{
					...
					// generalization
					HMatch match_3 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "Class_1_object_SP8": 
				{
					if(!lazy_initialization) {
						
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_2_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
			...
			case "JavaClassifierReferenceToUmlGeneralization_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "JavaClassifierToUmlClassifier_object_SP22": 
				{
					edge_explorer_9.registerSourceObject(objs[0]);
					edge_explorer_10.registerSourceObject(objs[0]);
					
					// javaClassifierToUmlClassifier
					HMatch match_7 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
					...
					HMatch match_8 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_6_1_orchestration, match_8);
				}
				break;
			case "SuperClassToSuperClass__Marker_object": 
				{
					...
					// SuperClassToSuperClass_eMoflon_ProtocolNode
					HMatch match_9 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_5_1_orchestration, match_9);
				}
				break;
			case "SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1081_localSearch": 
				{
				...
				break;
			case "SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1071_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1081_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1071_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.Generalization_specific_Classifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("SuperClassToSuperClass__CONSISTENCY_1085_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
		...
		case "Java2Uml.JavaClassifierReferenceToUmlGeneralization_source_ClassifierReference": 
			...
			break;
		case "Java2Uml.SuperClassToSuperClass__Marker_CREATE__SRC__superclassifier_Class": 
			if(!lazy_initialization) {
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			...
			break;
		case "Java2Uml.SuperClassToSuperClass__Marker_CREATE__SRC__superclassTypeRef_ClassifierReference": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.types.ClassifierReference) {
				{
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			...
			break;
		case "Java2Uml.SuperClassToSuperClass__Marker_CREATE__TRG__umlGeneralClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
		...
		case "org.emftext.language.java.classifiers.Class_extends_TypeReference": 
			...
			break;
		case "Java2Uml.SuperClassToSuperClass__Marker_CONTEXT__CORR__javaClassifierToUmlClassifier_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.SuperClassToSuperClass__Marker_CREATE__CORR__classRefToGeneralization_JavaClassifierReferenceToUmlGeneralization": 
			if(!lazy_initialization) {
				{
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			...
			break;
		case "Java2Uml.SuperClassToSuperClass__Marker_CONTEXT__TRG__umlClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
			...
			break;
		case "Java2Uml.SuperClassToSuperClass__Marker_CREATE__CORR__javaSuperClassifierToUmlSuperClassifier_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.SuperClassToSuperClass__Marker_CONTEXT__SRC__javaConcreteClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
			...
			break;
		case "Java2Uml.SuperClassToSuperClass__Marker_CREATE__TRG__generalization_Generalization": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Generalization) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC
		...
		// register SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG
		...
		// register SuperClassToSuperClass_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[1];
		oMatch_Nodes_0[1] = objs[2];
		...
		// deregister SuperClassToSuperClass_generalization_general_outgoing_TRG__FILTER_NAC_TRG
		OverlapMatch oMatch_1 = new OverlapMatch(2);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[3];
		oMatch_Nodes_1[1] = objs[5];
		...
		// deregister SuperClassToSuperClass_eMoflon_ProtocolNode
		Collection<HMatch> matches_9 = obj2matches.get(objs[9]);
		if(matches_9 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.classifiers.Class superclassifier = (org.emftext.language.java.classifiers.Class) match.getNodes()[2];
		...
		csp_116.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, superclassifier.getName(), "java.lang.String"));
		csp_116.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlGeneralClassifier.getName(), "java.lang.String"));
		csp_116.solve();
