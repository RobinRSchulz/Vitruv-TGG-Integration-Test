...
public class EnumFinalToFinal__CONSISTENCY_369_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.EnumFinalToFinal__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
			...
			case "Enumeration_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_369_localSearch", 5);
			...
			case "Final_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_369_localSearch", 5);
			...
			case "Enumeration_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_369_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP16": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_369_localSearch", 5);
			...
			case "EnumFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_369_localSearch", 5);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_369_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
