...
public class EnumPublicToPublic__CONSISTENCY_402_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumPublicToPublic__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Public ? result : null);};
			...
			case "Enumeration_object_SP3": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_402_localSearch", 5);
			...
			case "Public_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_402_localSearch", 5);
			...
			case "Enumeration_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_402_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP22": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_402_localSearch", 5);
			...
			case "EnumPublicToPublic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_402_localSearch", 5);
		...
		case "Java2Uml.EnumPublicToPublic__Marker_CONTEXT__SRC__javaConcreteClassifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_402_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic csp_38 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic();
		csp_38.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_38.solve();
