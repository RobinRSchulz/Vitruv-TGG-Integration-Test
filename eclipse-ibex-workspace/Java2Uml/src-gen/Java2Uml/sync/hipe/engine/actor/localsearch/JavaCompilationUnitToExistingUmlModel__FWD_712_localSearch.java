...
public class JavaCompilationUnitToExistingUmlModel__FWD_712_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaCompilationUnitToExistingUmlModel__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "CompilationUnit_object_SP2": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_712_localSearch", 5);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_3_1_orchestration, match_0);
					
					// newCompilationUnit
					HMatch match_4 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_712_localSearch", 5);
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_712_localSearch", 5);
			...
			case "Package_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_712_localSearch", 5);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_4_1_orchestration, match_2);
					}
				}
				break;
			case "Model_object_SP1": 
				{
					if(!lazy_initialization) {
						
						// umlModel
						HMatch match_3 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_712_localSearch", 5);
		...
		case "Java2Uml.JavaCompilationUnitToUmlModel_target_Model": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Model) {
				{
					...
					HMatch match = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_712_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
