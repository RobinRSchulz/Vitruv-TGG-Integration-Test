...
public class MethodInterfaceReturnTypeToReturnType__BWD_982_localSearch extends GenericLocalSearchActor{
			...
			case "Interface_1_object_SP2": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_982_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP18": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_982_localSearch", 7);
			...
			case "ClassMethod_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_2 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_982_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP5": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_982_localSearch", 7);
			...
			case "Interface_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_982_localSearch", 7);
			...
			case "Operation_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_982_localSearch", 7);
			...
			case "Parameter_1_object_SP6": 
				{
					...
					// umlReturnParameter
					HMatch match_6 = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_982_localSearch", 7);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodInterfaceReturnTypeToReturnType__BWD_982_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_107.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 3, "java.lang.String"));
		csp_107.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getDirection(), "Enum::ParameterDirectionKind"));
		csp_107.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_108.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "returnParameter", "java.lang.String"));
		csp_108.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlReturnParameter.getName(), "java.lang.String"));
		csp_108.solve();
