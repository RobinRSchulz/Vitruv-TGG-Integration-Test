...
public class JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch extends GenericLocalSearchActor{
	...
	SearchOrchestration edge_explorer_23_1_orchestration;
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__SRC__compilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 14, 0, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 4, 11, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__charType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 14, 4, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__intType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 14, 7, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((org.emftext.language.java.containers.Package) o).getCompilationUnits();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.containers.Package) return edge_explorer_6_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToUmlModel) o).getSource(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
						edge_explorer_7 = new CachedEdgeExplorer(this, 13, 0, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
						edge_explorer_8 = new CachedEdgeExplorer(this, 14, 1, edge_explorer_8_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new EdgeExplorer(this, 10, 11, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__stringType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_10 = new CachedEdgeExplorer(this, 14, 10, edge_explorer_10_methods);
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11 = new EdgeExplorer(this, 6, 11, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((uml.Type) o).getPackage(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_12_methods.multi_opposite_lookup = (o) -> ((uml.Package) o).getOwnedType().stream().filter(obj -> obj instanceof uml.PrimitiveType).collect(Collectors.toList());
						edge_explorer_12 = new EdgeExplorer(this, 3, 11, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__doubleType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_13 = new CachedEdgeExplorer(this, 14, 5, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__shortType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_14 = new CachedEdgeExplorer(this, 14, 9, edge_explorer_14_methods);
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						...
						edge_explorer_15 = new EdgeExplorer(this, 8, 11, edge_explorer_15_methods);
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						...
						edge_explorer_16 = new EdgeExplorer(this, 12, 11, edge_explorer_16_methods);
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						...
						edge_explorer_17 = new EdgeExplorer(this, 5, 11, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__umlModel(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_18 = new CachedEdgeExplorer(this, 14, 11, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((uml.Type) o).getPackage(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_19_methods.multi_opposite_lookup = (o) -> ((uml.Package) o).getOwnedType().stream().filter(obj -> obj instanceof uml.PrimitiveType).collect(Collectors.toList());
						edge_explorer_19 = new EdgeExplorer(this, 7, 11, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__voidType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_20 = new CachedEdgeExplorer(this, 14, 12, edge_explorer_20_methods);
		name2explorer.put("edge_explorer_20", edge_explorer_20);
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToUmlModel) o).getTarget(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_21 = new CachedEdgeExplorer(this, 13, 11, edge_explorer_21_methods);
		name2explorer.put("edge_explorer_21", edge_explorer_21);
		EdgeLookupMethods edge_explorer_22_methods = new EdgeLookupMethods();
						edge_explorer_22_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__floatType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_22 = new CachedEdgeExplorer(this, 14, 6, edge_explorer_22_methods);
		...
		EdgeLookupMethods edge_explorer_24_methods = new EdgeLookupMethods();
						edge_explorer_24_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__byteType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_24 = new CachedEdgeExplorer(this, 14, 3, edge_explorer_24_methods);
		name2explorer.put("edge_explorer_24", edge_explorer_24);
		EdgeLookupMethods edge_explorer_25_methods = new EdgeLookupMethods();
						edge_explorer_25_methods.unique_lookup = (o) -> {EObject result = ((uml.Type) o).getPackage(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_25_methods.multi_opposite_lookup = (o) -> ((uml.Package) o).getOwnedType().stream().filter(obj -> obj instanceof uml.PrimitiveType).collect(Collectors.toList());
						edge_explorer_25 = new EdgeExplorer(this, 2, 11, edge_explorer_25_methods);
		name2explorer.put("edge_explorer_25", edge_explorer_25);
		EdgeLookupMethods edge_explorer_26_methods = new EdgeLookupMethods();
						edge_explorer_26_methods.unique_lookup = (o) -> {EObject result = ((uml.Type) o).getPackage(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_26_methods.multi_opposite_lookup = (o) -> ((uml.Package) o).getOwnedType().stream().filter(obj -> obj instanceof uml.PrimitiveType).collect(Collectors.toList());
						edge_explorer_26 = new EdgeExplorer(this, 9, 11, edge_explorer_26_methods);
		name2explorer.put("edge_explorer_26", edge_explorer_26);
		EdgeLookupMethods edge_explorer_27_methods = new EdgeLookupMethods();
						edge_explorer_27_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__longType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_27 = new CachedEdgeExplorer(this, 14, 8, edge_explorer_27_methods);
		name2explorer.put("edge_explorer_27", edge_explorer_27);
		EdgeLookupMethods edge_explorer_28_methods = new EdgeLookupMethods();
						edge_explorer_28_methods.unique_lookup = (o) -> ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__CORR__javaCompUnitToUmlModel();
						edge_explorer_28 = new CachedEdgeExplorer(this, 14, 13, edge_explorer_28_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_16_1_orchestration = initializeOrchestration(node.getOrchestrations().get(28).getPlan());
		edge_explorer_17_0_orchestration = initializeOrchestration(node.getOrchestrations().get(29).getPlan());
		edge_explorer_18_0_orchestration = initializeOrchestration(node.getOrchestrations().get(30).getPlan());
		edge_explorer_19_0_orchestration = initializeOrchestration(node.getOrchestrations().get(31).getPlan());
		edge_explorer_20_0_orchestration = initializeOrchestration(node.getOrchestrations().get(32).getPlan());
		edge_explorer_21_0_orchestration = initializeOrchestration(node.getOrchestrations().get(33).getPlan());
		edge_explorer_22_0_orchestration = initializeOrchestration(node.getOrchestrations().get(34).getPlan());
		edge_explorer_23_0_orchestration = initializeOrchestration(node.getOrchestrations().get(35).getPlan());
		edge_explorer_23_1_orchestration = initializeOrchestration(node.getOrchestrations().get(36).getPlan());
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "CompilationUnit_object_SP3": 
				{
					
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
			...
			case "Package_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_1 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
			...
			case "PrimitiveType_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// booleanType
						HMatch match_2 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_23_1_orchestration, match_2);
						
						// byteType
						HMatch match_3 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_12_1_orchestration, match_3);
						
						// charType
						HMatch match_4 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_3_1_orchestration, match_4);
						
						// doubleType
						HMatch match_5 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_13_1_orchestration, match_5);
						
						// floatType
						HMatch match_6 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
						match_6.getNodes()[6] = objs[0];
						start(edge_explorer_11_1_orchestration, match_6);
						
						// intType
						HMatch match_7 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
						match_7.getNodes()[7] = objs[0];
						start(edge_explorer_5_1_orchestration, match_7);
						
						// longType
						HMatch match_8 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
						match_8.getNodes()[8] = objs[0];
						start(edge_explorer_15_1_orchestration, match_8);
						
						// shortType
						HMatch match_9 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
						match_9.getNodes()[9] = objs[0];
						start(edge_explorer_14_1_orchestration, match_9);
						
						// stringType
						HMatch match_10 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
						match_10.getNodes()[10] = objs[0];
						start(edge_explorer_9_1_orchestration, match_10);
						
						// voidType
						HMatch match_12 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
						match_12.getNodes()[12] = objs[0];
						start(edge_explorer_16_1_orchestration, match_12);
					}
				}
				break;
			case "Model_object_SP0": 
				{
					if(!lazy_initialization) {
						
						// umlModel
						HMatch match_11 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_13 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
					match_13.getNodes()[13] = objs[0];
					start(edge_explorer_7_1_orchestration, match_13);
				}
				break;
			case "JavaFirstCompilationUnitToUmlModel__Marker_object": 
				{
					...
					HMatch match_14 = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
		...
		case "Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker_CREATE__SRC__compilationUnit_CompilationUnit": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.containers.CompilationUnit) {
				{
					...
					HMatch match = new LocalSearchMatch("JavaFirstCompilationUnitToUmlModel__CONSISTENCY_750_localSearch", 15);
					Object[] objs = match.getNodes();
					objs[14] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_74 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_74.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "UML_MODEL", "java.lang.String"));
		csp_74.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlModel.getName(), "java.lang.String"));
		csp_74.solve();
		
		boolean predicate = csp_74.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_75.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_75.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, booleanType.getName(), "java.lang.String"));
		csp_75.solve();
		
		boolean predicate = csp_75.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_76 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_76.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_76.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, byteType.getName(), "java.lang.String"));
		csp_76.solve();
		
		boolean predicate = csp_76.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		csp_77.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_77.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, charType.getName(), "java.lang.String"));
		csp_77.solve();
		
		boolean predicate = csp_77.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_3_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_78 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_78.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_78.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, floatType.getName(), "java.lang.String"));
		csp_78.solve();
		
		boolean predicate = csp_78.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_4_method(HMatch match) {
		...
		csp_79.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_79.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, doubleType.getName(), "java.lang.String"));
		csp_79.solve();
		
		boolean predicate = csp_79.isSatisfied();
		return predicate;
	}
	...
	public boolean constraint_checker_5_method(HMatch match) {
		...
		csp_80.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_80.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, intType.getName(), "java.lang.String"));
		csp_80.solve();
	...
	public boolean constraint_checker_6_method(HMatch match) {
		...
		csp_81.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_81.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, longType.getName(), "java.lang.String"));
		csp_81.solve();
	...
	public boolean constraint_checker_7_method(HMatch match) {
		...
		csp_82.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_82.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, shortType.getName(), "java.lang.String"));
		csp_82.solve();
	...
	public boolean constraint_checker_8_method(HMatch match) {
		...
		csp_83.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_83.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, stringType.getName(), "java.lang.String"));
		csp_83.solve();
	...
	public boolean constraint_checker_9_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_84 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_84.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "boolean", "java.lang.String"));
		csp_84.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, voidType.getName(), "java.lang.String"));
		csp_84.solve();
		
		boolean predicate = csp_84.isSatisfied();
		return predicate;
	}
