...
public class ClassProtectedToProtected__CONSISTENCY_155_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.ClassProtectedToProtected__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
			...
			case "Class_object_SP9": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_155_localSearch", 5);
			...
			case "Protected_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_155_localSearch", 5);
			...
			case "Class_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_155_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP21": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_155_localSearch", 5);
			...
			case "ClassProtectedToProtected__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_155_localSearch", 5);
		...
		case "Java2Uml.ClassProtectedToProtected__Marker_CONTEXT__TRG__umlClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassProtectedToProtected__CONSISTENCY_155_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected csp_12 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected();
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_12.solve();
