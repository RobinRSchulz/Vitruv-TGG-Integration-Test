...
public class SuperInterfaceToSuperInterface__BWD_1106_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SuperInterfaceToSuperInterface__BWD_production"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP24": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1106_localSearch", 5);
			...
			case "Interface_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1106_localSearch", 5);
			...
			case "Interface_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1106_localSearch", 5);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_2_orchestration, match_2);
						
						// umlGeneralClassifier
						HMatch match_4 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1106_localSearch", 5);
			...
			case "Generalization_object_SP0": 
				{
					...
					// generalization
					HMatch match_3 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1106_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1102_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1106_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.Generalization_specific_Classifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1106_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
