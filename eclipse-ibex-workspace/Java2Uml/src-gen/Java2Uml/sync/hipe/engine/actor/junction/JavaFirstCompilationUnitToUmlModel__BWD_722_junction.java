...
public class JavaFirstCompilationUnitToUmlModel__BWD_722_junction extends GenericJunctionActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		...
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaFirstCompilationUnitToUmlModel__BWD_720_junction"), this::returnTrue , 0  , false ));
	}
