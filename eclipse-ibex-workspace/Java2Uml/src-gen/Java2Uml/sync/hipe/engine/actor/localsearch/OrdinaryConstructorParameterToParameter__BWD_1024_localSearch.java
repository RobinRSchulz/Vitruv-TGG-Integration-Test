...
public class OrdinaryConstructorParameterToParameter__BWD_1024_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("OrdinaryConstructorParameterToParameter__BWD_production"), this::returnTrue  , false ));
	}
			...
			case "JavaConstructorToOperation_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__BWD_1024_localSearch", 4);
			...
			case "Constructor_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__BWD_1024_localSearch", 4);
			...
			case "Operation_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__BWD_1024_localSearch", 4);
			...
			case "Parameter_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_3 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__BWD_1024_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__BWD_1024_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
