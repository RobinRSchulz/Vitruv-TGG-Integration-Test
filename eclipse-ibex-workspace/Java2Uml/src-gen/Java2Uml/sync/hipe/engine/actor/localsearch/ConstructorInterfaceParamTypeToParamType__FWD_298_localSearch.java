...
public class ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 5, 8, edge_explorer_5_methods);
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						...
						edge_explorer_7 = new EdgeExplorer(this, 7, 8, edge_explorer_7_methods);
	...
	protected void initializeOrchestration() {
		...
		nac_checker_orchestration = initializeOrchestration(node.getOrchestrations().get(20).getPlan());
	}
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		ports = new LinkedList<>();
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ConstructorInterfaceParamTypeToParamType__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Interface_1_object_SP6": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP7": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_1_orchestration, match_1);
				}
				break;
			case "JavaConstructorToOperation_object_SP4": 
				{
					edge_explorer_8.registerSourceObject(objs[0]);
					edge_explorer_9.registerSourceObject(objs[0]);
					
					// javaConstructorToOperation
					HMatch match_2 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
			...
			case "Constructor_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
			...
			case "Parameter_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
			...
			case "JavaParameterToParameter_object_SP2": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
			...
			case "Interface_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
						match_6.getNodes()[6] = objs[0];
						start(edge_explorer_10_1_orchestration, match_6);
					}
				}
				break;
			case "Operation_object_SP14": 
				{
					if(!lazy_initialization) {
						
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
			...
			case "Parameter_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_8 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
			...
			case "ClassifierReference_object_SP0": 
				{
					...
					// typeReference
					HMatch match_9 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
		...
		switch(match.creator) {
			...
			case "ConstructorInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_282_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ConstructorInterfaceParamTypeToParamType__FWD_298_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_25.solve();
