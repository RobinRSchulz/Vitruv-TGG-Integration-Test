...
public class MethodAbstractToAbstract__FWD_793_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodAbstractToAbstract__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "ClassMethod_object_SP5": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodAbstractToAbstract__FWD_793_localSearch", 4);
			...
			case "JavaMethodToOperation_object_SP3": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodAbstractToAbstract__FWD_793_localSearch", 4);
			...
			case "Operation_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodAbstractToAbstract__FWD_793_localSearch", 4);
			...
			case "Abstract_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("MethodAbstractToAbstract__FWD_793_localSearch", 4);
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodAbstractToAbstract__FWD_793_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_87.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_87.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsAbstract(), "boolean"));
		csp_87.solve();
