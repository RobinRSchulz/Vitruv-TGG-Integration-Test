...
public class MethodFinalToFinal__FWD_940_localSearch extends GenericLocalSearchActor{
			...
			case "ClassMethod_object_SP1": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodFinalToFinal__FWD_940_localSearch", 4);
			...
			case "JavaMethodToOperation_object_SP1": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodFinalToFinal__FWD_940_localSearch", 4);
			...
			case "Operation_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodFinalToFinal__FWD_940_localSearch", 4);
			...
			case "Final_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("MethodFinalToFinal__FWD_940_localSearch", 4);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodFinalToFinal__FWD_940_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_103.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_103.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsLeaf(), "boolean"));
		csp_103.solve();
