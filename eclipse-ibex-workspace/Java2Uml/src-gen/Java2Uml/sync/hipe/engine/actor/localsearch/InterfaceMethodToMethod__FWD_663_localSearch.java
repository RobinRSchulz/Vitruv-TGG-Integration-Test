...
public class InterfaceMethodToMethod__FWD_663_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceMethodToMethod__FWD_production"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP22": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("InterfaceMethodToMethod__FWD_663_localSearch", 4);
			...
			case "Interface_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceMethodToMethod__FWD_663_localSearch", 4);
			...
			case "Interface_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceMethodToMethod__FWD_663_localSearch", 4);
			...
			case "InterfaceMethod_object": 
				{
					if(!lazy_initialization) {
						...
						// method
						HMatch match_3 = new LocalSearchMatch("InterfaceMethodToMethod__FWD_663_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceMethodToMethod__FWD_663_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
