...
public class SuperInterfaceToSuperInterface__FWD_1109_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP23": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__FWD_1109_localSearch", 5);
			...
			case "Interface_1_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__FWD_1109_localSearch", 5);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_3_1_orchestration, match_1);
						
						// superclassifier
						HMatch match_4 = new LocalSearchMatch("SuperInterfaceToSuperInterface__FWD_1109_localSearch", 5);
			...
			case "Interface_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface__FWD_1109_localSearch", 5);
			...
			case "ClassifierReference_object_SP11": 
				{
					...
					// superclassTypeRef
					HMatch match_3 = new LocalSearchMatch("SuperInterfaceToSuperInterface__FWD_1109_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_1094_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__FWD_1109_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__FWD_1109_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
