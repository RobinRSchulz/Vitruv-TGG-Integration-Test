...
public class EnumPrivateToPrivate__FWD_404_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP22": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumPrivateToPrivate__FWD_404_localSearch", 4);
			...
			case "Enumeration_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("EnumPrivateToPrivate__FWD_404_localSearch", 4);
			...
			case "Enumeration_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumPrivateToPrivate__FWD_404_localSearch", 4);
			...
			case "Private_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("EnumPrivateToPrivate__FWD_404_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumPrivateToPrivate__FWD_404_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPrivate csp_36 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPrivate();
