...
public class InterfaceToUmlInterface__CONSISTENCY_707_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__SRC__compilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__CORR__javaClassToUmlClass();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__CORR__javaPackToUmlPack();
