...
public class InterfaceToUmlInterface__CONSISTENCY_707_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 7, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__CORR__javaClassToUmlClass();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((uml.Package) o).getPackagedElement().stream().filter(obj -> obj instanceof uml.Interface).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaPackageToUmlPackage) o).getSource(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((org.emftext.language.java.containers.Package) o).getCompilationUnits();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.containers.Package) return edge_explorer_8_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__TRG__umlPackage(); return (result instanceof uml.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((org.emftext.language.java.containers.CompilationUnit) o).getClassifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.classifiers.Interface).collect(Collectors.toList());
						edge_explorer_11_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.containers.CompilationUnit) return edge_explorer_11_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaPackageToUmlPackage) o).getTarget(); return (result instanceof uml.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__CORR__javaPackToUmlPack();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__SRC__compilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceToUmlInterface__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Interface_1_object_SP9": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_707_localSearch", 8);
			...
			case "CompilationUnit_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// compilationUnit
						HMatch match_1 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_707_localSearch", 8);
			...
			case "Package_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_707_localSearch", 8);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_707_localSearch", 8);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_2_orchestration, match_3);
					}
				}
				break;
			case "Package_1_object_SP1": 
				{
					if(!lazy_initialization) {
						
						// umlPackage
						HMatch match_4 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_707_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP2": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_707_localSearch", 8);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_3_1_orchestration, match_5);
				}
				break;
			case "JavaPackageToUmlPackage_object_SP1": 
				{
					edge_explorer_7.registerSourceObject(objs[0]);
					edge_explorer_12.registerSourceObject(objs[0]);
					
					// javaPackToUmlPack
					HMatch match_6 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_707_localSearch", 8);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_7_1_orchestration, match_6);
				}
				break;
			case "InterfaceToUmlInterface__Marker_object": 
				{
					...
					// InterfaceToUmlInterface_eMoflon_ProtocolNode
					HMatch match_7 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_707_localSearch", 8);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Java2Uml.InterfaceToUmlInterface__Marker_CREATE__TRG__umlClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_707_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
			...
			break;
		case "Java2Uml.InterfaceToUmlInterface__Marker_CREATE__CORR__javaClassToUmlClass_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
		...
		case "uml.Package_packagedElement_PackageableElement": 
			...
			break;
		case "Java2Uml.InterfaceToUmlInterface__Marker_CREATE__SRC__classifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			...
			break;
		case "Java2Uml.InterfaceToUmlInterface__Marker_CONTEXT__TRG__umlPackage_Package": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.InterfaceToUmlInterface__Marker_CONTEXT__SRC__javaPackage_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.containers.Package) {
				{
		...
		case "Java2Uml.JavaPackageToUmlPackage_target_Package": 
			...
			break;
		case "Java2Uml.InterfaceToUmlInterface__Marker_CONTEXT__CORR__javaPackToUmlPack_JavaPackageToUmlPackage": 
			if(!lazy_initialization) {
				{
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			...
			break;
		case "Java2Uml.InterfaceToUmlInterface__Marker_CONTEXT__SRC__compilationUnit_CompilationUnit": 
			if(!lazy_initialization) {
	...
	protected void registerMatch(HMatch match) {
		...
		// register InterfaceToUmlInterface_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister javaClassToUmlClass
		Collection<HMatch> matches_5 = obj2matches.get(objs[5]);
		if(matches_5 != null) {
		...
		// deregister InterfaceToUmlInterface_eMoflon_ProtocolNode
		Collection<HMatch> matches_7 = obj2matches.get(objs[7]);
		if(matches_7 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.classifiers.Interface classifier = (org.emftext.language.java.classifiers.Interface) match.getNodes()[0];
		uml.Interface umlClassifier = (uml.Interface) match.getNodes()[3];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_61 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_61.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_61.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_61.solve();
