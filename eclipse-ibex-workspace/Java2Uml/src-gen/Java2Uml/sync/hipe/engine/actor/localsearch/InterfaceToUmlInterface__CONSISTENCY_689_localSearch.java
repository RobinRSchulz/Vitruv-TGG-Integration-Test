...
public class InterfaceToUmlInterface__CONSISTENCY_689_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((uml.Package) o).getPackagedElement().stream().filter(obj -> obj instanceof uml.Interface).collect(Collectors.toList());
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Package) return edge_explorer_8_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__CORR__javaClassToUmlClass();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
			...
			case "Interface_1_object_SP9": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_689_localSearch", 8);
			...
			case "CompilationUnit_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// compilationUnit
						HMatch match_1 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_689_localSearch", 8);
			...
			case "Package_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_689_localSearch", 8);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_689_localSearch", 8);
			...
			case "Package_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_4 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_689_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP26": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_689_localSearch", 8);
			...
			case "JavaPackageToUmlPackage_object_SP1": 
				{
					...
					// javaPackToUmlPack
					HMatch match_6 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_689_localSearch", 8);
			...
			case "InterfaceToUmlInterface__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_689_localSearch", 8);
		...
		case "Java2Uml.JavaPackageToUmlPackage_target_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Package) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_689_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_60.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_60.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_60.solve();
