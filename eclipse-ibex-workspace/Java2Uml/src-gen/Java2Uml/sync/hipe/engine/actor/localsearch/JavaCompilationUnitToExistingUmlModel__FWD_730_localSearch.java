...
public class JavaCompilationUnitToExistingUmlModel__FWD_730_localSearch extends GenericLocalSearchActor{
			...
			case "CompilationUnit_object_SP2": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_730_localSearch", 5);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_4_1_orchestration, match_0);
					
					// newCompilationUnit
					HMatch match_4 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_730_localSearch", 5);
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_730_localSearch", 5);
			...
			case "Package_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_730_localSearch", 5);
			...
			case "Model_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlModel
						HMatch match_3 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_730_localSearch", 5);
		...
		case "Java2Uml.JavaCompilationUnitToUmlModel_target_Model": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Model) {
				{
					...
					HMatch match = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__FWD_730_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
