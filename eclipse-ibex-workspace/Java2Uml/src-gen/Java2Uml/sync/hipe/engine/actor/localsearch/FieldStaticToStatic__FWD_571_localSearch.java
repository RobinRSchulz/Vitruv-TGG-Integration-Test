...
public class FieldStaticToStatic__FWD_571_localSearch extends GenericLocalSearchActor{
			...
			case "JavaAttributeToUmlProperty_object_SP3": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("FieldStaticToStatic__FWD_571_localSearch", 4);
			...
			case "Field_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaField
						HMatch match_1 = new LocalSearchMatch("FieldStaticToStatic__FWD_571_localSearch", 4);
			...
			case "Property_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlProperty
						HMatch match_2 = new LocalSearchMatch("FieldStaticToStatic__FWD_571_localSearch", 4);
			...
			case "Static_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("FieldStaticToStatic__FWD_571_localSearch", 4);
		...
		case "Java2Uml.JavaAttributeToUmlProperty_source_Field": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Field) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldStaticToStatic__FWD_571_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_45.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlProperty.isIsStatic(), "boolean"));
		csp_45.solve();
