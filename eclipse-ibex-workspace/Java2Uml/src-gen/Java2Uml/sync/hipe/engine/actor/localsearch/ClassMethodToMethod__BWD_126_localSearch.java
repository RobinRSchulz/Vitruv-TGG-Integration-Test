...
public class ClassMethodToMethod__BWD_126_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP16": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("ClassMethodToMethod__BWD_126_localSearch", 4);
			...
			case "Class_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ClassMethodToMethod__BWD_126_localSearch", 4);
			...
			case "Class_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassMethodToMethod__BWD_126_localSearch", 4);
			...
			case "Operation_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_3 = new LocalSearchMatch("ClassMethodToMethod__BWD_126_localSearch", 4);
		...
		switch(match.creator) {
			...
			case "ClassMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_123_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassMethodToMethod__BWD_126_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.Class_ownedOperation_Operation": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("ClassMethodToMethod__BWD_126_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
