...
public class OrdinaryMethodParameterToParameter__BWD_1042_localSearch extends GenericLocalSearchActor{
			...
			case "JavaMethodToOperation_object_SP2": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__BWD_1042_localSearch", 4);
			...
			case "Parameter_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_3 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__BWD_1042_localSearch", 4);
