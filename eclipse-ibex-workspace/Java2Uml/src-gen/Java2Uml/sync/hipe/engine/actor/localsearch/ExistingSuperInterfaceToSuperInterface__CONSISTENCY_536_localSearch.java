...
public class ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCREATE__TRG__generalization(); return (result instanceof uml.Generalization ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingSuperInterfaceToSuperInterface__Marker) o).getCONTEXT__TRG__umlGeneralClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Interface) o).getExtends().stream().filter(obj -> obj instanceof org.emftext.language.java.types.ClassifierReference).collect(Collectors.toList());
						edge_explorer_16_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.classifiers.Interface) return edge_explorer_16_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
			...
			case "Interface_1_object_SP12": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_4_1_orchestration, match_0);
					
					// superclassifier
					HMatch match_2 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
			...
			case "ClassifierReference_object_SP10": 
				{
					...
					// superclassTypeRef
					HMatch match_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
			...
			case "Generalization_object_SP2": 
				{
					...
					// generalization
					HMatch match_3 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
			...
			case "Interface_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_7_2_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
			...
			case "JavaClassifierToUmlClassifier_object_SP8": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
					...
					HMatch match_7 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
			...
			case "ExistingSuperInterfaceToSuperInterface__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_532_localSearch": 
				{
				...
				break;
			case "ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_520_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ExistingSuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_532_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_520_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__CONSISTENCY_536_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[6] = msg.target;
					currentDepth++;
