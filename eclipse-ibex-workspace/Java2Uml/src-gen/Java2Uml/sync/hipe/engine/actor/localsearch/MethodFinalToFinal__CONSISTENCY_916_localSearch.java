...
public class MethodFinalToFinal__CONSISTENCY_916_localSearch extends GenericLocalSearchActor{
			...
			case "ClassMethod_object_SP0": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_916_localSearch", 5);
			...
			case "Final_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_916_localSearch", 5);
			...
			case "Operation_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_916_localSearch", 5);
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_916_localSearch", 5);
			...
			case "MethodFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_916_localSearch", 5);
		...
		case "Java2Uml.MethodFinalToFinal__Marker_CONTEXT__SRC__javaMethod_ClassMethod": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_916_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_101.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_101.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsLeaf(), "boolean"));
		csp_101.solve();
