...
public class InterfaceAttributeTypeToPropertyType__FWD_607_localSearch extends GenericLocalSearchActor{
			...
			case "JavaAttributeToUmlProperty_object_SP2": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_607_localSearch", 7);
			...
			case "Interface_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_607_localSearch", 7);
			...
			case "Field_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_2 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_607_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP14": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_607_localSearch", 7);
			...
			case "Property_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_4 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_607_localSearch", 7);
			...
			case "Interface_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_607_localSearch", 7);
			...
			case "ClassifierReference_object_SP1": 
				{
					...
					// typeReference
					HMatch match_6 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_607_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_594_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_607_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaAttributeToUmlProperty_source_Field": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Field) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__FWD_607_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_50.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, field.getName(), "java.lang.String"));
		csp_50.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_50.solve();
