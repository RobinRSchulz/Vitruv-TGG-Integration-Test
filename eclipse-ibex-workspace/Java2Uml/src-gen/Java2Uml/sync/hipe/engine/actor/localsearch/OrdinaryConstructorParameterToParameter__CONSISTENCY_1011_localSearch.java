...
public class OrdinaryConstructorParameterToParameter__CONSISTENCY_1011_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((org.emftext.language.java.parameters.Parametrizable) o).getParameters().stream().filter(obj -> obj instanceof org.emftext.language.java.parameters.OrdinaryParameter).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.OrdinaryConstructorParameterToParameter__Marker) o).getCREATE__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.OrdinaryConstructorParameterToParameter__Marker) o).getCREATE__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.OrdinaryParameter ? result : null);};
			...
			case "Constructor_object_SP4": 
				{
					...
					// javaParametrizable
					HMatch match_0 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_1011_localSearch", 7);
			...
			case "OrdinaryParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_1 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_1011_localSearch", 7);
			...
			case "Operation_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_1011_localSearch", 7);
			...
			case "Parameter_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_3 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_1011_localSearch", 7);
			...
			case "JavaConstructorToOperation_object_SP2": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_1011_localSearch", 7);
			...
			case "JavaParameterToParameter_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_1011_localSearch", 7);
			...
			case "OrdinaryConstructorParameterToParameter__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_1011_localSearch", 7);
		...
		case "Java2Uml.JavaConstructorToOperation_target_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("OrdinaryConstructorParameterToParameter__CONSISTENCY_1011_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_112.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_112.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_112.solve();
