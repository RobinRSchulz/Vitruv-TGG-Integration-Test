...
public class ClassAttributeTypeToPropertyType__BWD_33_localSearch extends GenericLocalSearchActor{
			...
			case "JavaAttributeToUmlProperty_object_SP1": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_33_localSearch", 6);
			...
			case "Class_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_33_localSearch", 6);
			...
			case "Field_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_2 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_33_localSearch", 6);
			...
			case "JavaClassifierToUmlClassifier_object_SP5": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_33_localSearch", 6);
			...
			case "Property_object_SP3": 
				{
					...
					// property
					HMatch match_4 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_33_localSearch", 6);
			...
			case "Class_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_33_localSearch", 6);
		...
		case "Java2Uml.JavaAttributeToUmlProperty_source_Field": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Field) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_33_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
