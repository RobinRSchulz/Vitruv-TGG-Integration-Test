...
public class ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Implementor) o).getImplements().stream().filter(obj -> obj instanceof org.emftext.language.java.types.ClassifierReference).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCONTEXT__SRC__javaClass(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCREATE__TRG__umlInterfaceRealization(); return (result instanceof uml.InterfaceRealization ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCONTEXT__TRG__umlClass(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCREATE__SRC__interfaceTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCONTEXT__TRG__umlInterface(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.multi_lookup = (o) -> ((uml.BehavioredClassifier) o).getInterfaceRealization();
						edge_explorer_16_methods.unique_opposite_lookup = (o) -> {EObject result = ((uml.InterfaceRealization) o).getImplementingClassifier(); return (result instanceof uml.Class ? result : null);};
						edge_explorer_16 = new EdgeExplorer(this, 3, 5, edge_explorer_16_methods);
			...
			case "Interface_1_object_SP8": 
				{
					...
					// interface
					HMatch match_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
			...
			case "ClassifierReference_object_SP4": 
				{
					...
					// interfaceTypeRef
					HMatch match_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
			...
			case "Class_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// javaClass
						HMatch match_2 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
			...
			case "Class_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_3 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
			...
			case "Interface_object_SP10": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_4 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
			...
			case "InterfaceRealization_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_6_1_orchestration, match_5);
				}
				break;
			case "JavaClassifierToUmlClassifier_object_SP26": 
				{
					edge_explorer_3.registerSourceObject(objs[0]);
					edge_explorer_14.registerSourceObject(objs[0]);
					
					// javaClassifierToUmlClassifier
					HMatch match_6 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
					...
					HMatch match_7 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
			...
			case "ExistingClassImplementToClassImplement__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_4_1_orchestration, match_8);
				}
				break;
			case "ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_446_localSearch": 
				{
				...
				break;
			case "ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_434_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_446_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_434_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.classifiers.Implementor_implements_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_450_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
