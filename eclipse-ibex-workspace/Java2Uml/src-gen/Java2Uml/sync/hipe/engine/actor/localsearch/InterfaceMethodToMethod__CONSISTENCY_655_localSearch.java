...
public class InterfaceMethodToMethod__CONSISTENCY_655_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.multi_lookup = (o) -> ((org.emftext.language.java.members.MemberContainer) o).getMembers().stream().filter(obj -> obj instanceof org.emftext.language.java.members.InterfaceMethod).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaMethodToOperation) o).getSource(); return (result instanceof org.emftext.language.java.members.InterfaceMethod ? result : null);};
