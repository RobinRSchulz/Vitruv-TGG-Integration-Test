...
public class EnumPrivateToPrivate__CONSISTENCY_380_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Java2Uml.EnumPrivateToPrivate__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
						edge_explorer_3 = new CachedEdgeExplorer(this, 4, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((org.emftext.language.java.modifiers.AnnotableAndModifiable) o).getAnnotationsAndModifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.modifiers.Private).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumPrivateToPrivate__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumPrivateToPrivate__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
			...
			case "Enumeration_object_SP7": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_380_localSearch", 5);
			...
			case "Private_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_380_localSearch", 5);
			...
			case "Enumeration_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_380_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP18": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_380_localSearch", 5);
			...
			case "EnumPrivateToPrivate__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_380_localSearch", 5);
		...
		case "Java2Uml.EnumPrivateToPrivate__Marker_CREATE__SRC__modifier_Private": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.modifiers.Private) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_380_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPrivate csp_34 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPrivate();
		csp_34.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_34.solve();
