...
public class EnumAbstractToAbstract__CONSISTENCY_309_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.EnumAbstractToAbstract__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumAbstractToAbstract__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
			...
			case "Enumeration_object_SP4": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumAbstractToAbstract__CONSISTENCY_309_localSearch", 5);
			...
			case "Abstract_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumAbstractToAbstract__CONSISTENCY_309_localSearch", 5);
			...
			case "Enumeration_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumAbstractToAbstract__CONSISTENCY_309_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP8": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumAbstractToAbstract__CONSISTENCY_309_localSearch", 5);
			...
			case "EnumAbstractToAbstract__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumAbstractToAbstract__CONSISTENCY_309_localSearch", 5);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumAbstractToAbstract__CONSISTENCY_309_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.isIsAbstract(), "boolean"));
		csp_26.solve();
