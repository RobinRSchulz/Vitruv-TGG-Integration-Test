...
public class ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCREATE__TRG__umlInterfaceRealization(); return (result instanceof uml.InterfaceRealization ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 8, 5, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCONTEXT__TRG__umlClass(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCONTEXT__SRC__javaClass(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((uml.InterfaceRealization) o).getContract();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCONTEXT__CORR__javaSuperClassifierToUmlSuperClassifier();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCONTEXT__TRG__umlInterface(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ExistingClassImplementToClassImplement__Marker) o).getCREATE__SRC__interfaceTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Implementor) o).getImplements().stream().filter(obj -> obj instanceof org.emftext.language.java.types.ClassifierReference).collect(Collectors.toList());
						edge_explorer_17_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.classifiers.Class) return edge_explorer_17_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_17 = new EdgeExplorer(this, 2, 1, edge_explorer_17_methods);
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "Interface_1_object_SP8": 
				{
					
					// interface
					HMatch match_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
			...
			case "ClassifierReference_object_SP4": 
				{
					...
					// interfaceTypeRef
					HMatch match_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
			...
			case "Class_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// javaClass
						HMatch match_2 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
			...
			case "Class_1_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_3 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
						match_3.getNodes()[3] = objs[0];
						start(edge_explorer_3_1_orchestration, match_3);
					}
				}
				break;
			case "Interface_object_SP10": 
				{
					if(!lazy_initialization) {
						
						// umlInterface
						HMatch match_4 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
			...
			case "InterfaceRealization_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
			...
			case "JavaClassifierToUmlClassifier_object_SP2": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
					...
					HMatch match_7 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
			...
			case "ExistingClassImplementToClassImplement__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_464_localSearch": 
				{
				...
				break;
			case "ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_452_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ExistingClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_464_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ExistingClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_452_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "Java2Uml.ExistingClassImplementToClassImplement__Marker_CREATE__TRG__umlInterfaceRealization_InterfaceRealization": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.InterfaceRealization) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingClassImplementToClassImplement__CONSISTENCY_468_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
