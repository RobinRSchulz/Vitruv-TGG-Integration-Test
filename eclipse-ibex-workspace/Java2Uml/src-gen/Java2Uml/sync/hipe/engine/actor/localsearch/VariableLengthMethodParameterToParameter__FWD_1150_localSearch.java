...
public class VariableLengthMethodParameterToParameter__FWD_1150_localSearch extends GenericLocalSearchActor{
			...
			case "JavaMethodToOperation_object_SP7": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_1150_localSearch", 4);
			...
			case "ClassMethod_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_1150_localSearch", 4);
			...
			case "Operation_object_SP11": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_1150_localSearch", 4);
			...
			case "VariableLengthParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_3 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_1150_localSearch", 4);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthMethodParameterToParameter__FWD_1150_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
