...
public class ExistingSuperInterfaceToSuperInterface__BWD_506_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new EdgeExplorer(this, 6, 4, edge_explorer_6_methods);
			...
			case "JavaClassifierToUmlClassifier_object_SP4": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_506_localSearch", 7);
					...
					HMatch match_2 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_506_localSearch", 7);
			...
			case "Interface_1_object_SP11": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_506_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_4_2_orchestration, match_1);
						
						// superclassifier
						HMatch match_3 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_506_localSearch", 7);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_506_localSearch", 7);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_6_1_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_506_localSearch", 7);
			...
			case "Generalization_object_SP0": 
				{
					...
					// generalization
					HMatch match_6 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_506_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_502_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_506_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_506_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
