...
public class SuperInterfaceToSuperInterface__BWD_1088_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP21": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1088_localSearch", 5);
			...
			case "Interface_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1088_localSearch", 5);
			...
			case "Interface_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1088_localSearch", 5);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_3_2_orchestration, match_2);
						
						// umlGeneralClassifier
						HMatch match_4 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1088_localSearch", 5);
			...
			case "Generalization_object_SP0": 
				{
					...
					// generalization
					HMatch match_3 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1088_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_1084_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1088_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__BWD_1088_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
