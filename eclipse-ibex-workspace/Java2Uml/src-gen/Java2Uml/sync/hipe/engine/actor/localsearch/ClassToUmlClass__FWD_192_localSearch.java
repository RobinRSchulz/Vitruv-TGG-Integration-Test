...
public class ClassToUmlClass__FWD_192_localSearch extends GenericLocalSearchActor{
			...
			case "CompilationUnit_object_SP2": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("ClassToUmlClass__FWD_192_localSearch", 5);
			...
			case "JavaPackageToUmlPackage_object_SP2": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("ClassToUmlClass__FWD_192_localSearch", 5);
			...
			case "Package_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("ClassToUmlClass__FWD_192_localSearch", 5);
			...
			case "Package_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("ClassToUmlClass__FWD_192_localSearch", 5);
			...
			case "Class_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_4 = new LocalSearchMatch("ClassToUmlClass__FWD_192_localSearch", 5);
		...
		case "Java2Uml.JavaPackageToUmlPackage_source_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.containers.Package) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassToUmlClass__FWD_192_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
