...
public class MethodAbstractToAbstract__FWD_775_localSearch extends GenericLocalSearchActor{
			...
			case "ClassMethod_object_SP5": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodAbstractToAbstract__FWD_775_localSearch", 4);
			...
			case "JavaMethodToOperation_object_SP3": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodAbstractToAbstract__FWD_775_localSearch", 4);
			...
			case "Operation_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodAbstractToAbstract__FWD_775_localSearch", 4);
			...
			case "Abstract_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("MethodAbstractToAbstract__FWD_775_localSearch", 4);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodAbstractToAbstract__FWD_775_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
