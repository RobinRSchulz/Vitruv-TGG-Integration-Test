...
public class InterfaceToUmlInterface__BWD_683_localSearch extends GenericLocalSearchActor{
			...
			case "CompilationUnit_object_SP2": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("InterfaceToUmlInterface__BWD_683_localSearch", 5);
			...
			case "JavaPackageToUmlPackage_object_SP0": 
				{
					...
					// javaPackToUmlPack
					HMatch match_1 = new LocalSearchMatch("InterfaceToUmlInterface__BWD_683_localSearch", 5);
			...
			case "Package_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("InterfaceToUmlInterface__BWD_683_localSearch", 5);
			...
			case "Package_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_3 = new LocalSearchMatch("InterfaceToUmlInterface__BWD_683_localSearch", 5);
			...
			case "Interface_object_SP11": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("InterfaceToUmlInterface__BWD_683_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("InterfaceToUmlInterface__BWD_683_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
