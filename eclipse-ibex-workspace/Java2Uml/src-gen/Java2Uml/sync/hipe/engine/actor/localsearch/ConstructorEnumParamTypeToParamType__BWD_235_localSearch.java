...
public class ConstructorEnumParamTypeToParamType__BWD_235_localSearch extends GenericLocalSearchActor{
			...
			case "Enumeration_object_SP0": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__BWD_235_localSearch", 9);
			...
			case "JavaClassifierToUmlClassifier_object_SP2": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__BWD_235_localSearch", 9);
			...
			case "JavaConstructorToOperation_object_SP4": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__BWD_235_localSearch", 9);
			...
			case "Constructor_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__BWD_235_localSearch", 9);
			...
			case "Parameter_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__BWD_235_localSearch", 9);
			...
			case "JavaParameterToParameter_object_SP3": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__BWD_235_localSearch", 9);
			...
			case "Enumeration_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__BWD_235_localSearch", 9);
			...
			case "Operation_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__BWD_235_localSearch", 9);
			...
			case "Parameter_1_object_SP3": 
				{
					...
					// umlParameter
					HMatch match_8 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__BWD_235_localSearch", 9);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__BWD_235_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
