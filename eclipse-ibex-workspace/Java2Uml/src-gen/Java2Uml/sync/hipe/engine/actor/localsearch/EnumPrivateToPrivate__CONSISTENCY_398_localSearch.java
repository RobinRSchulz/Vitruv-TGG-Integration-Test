...
public class EnumPrivateToPrivate__CONSISTENCY_398_localSearch extends GenericLocalSearchActor{
			...
			case "Enumeration_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_398_localSearch", 5);
			...
			case "Private_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_398_localSearch", 5);
			...
			case "Enumeration_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_398_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP21": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_398_localSearch", 5);
			...
			case "EnumPrivateToPrivate__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_398_localSearch", 5);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_398_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPrivate csp_35 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPrivate();
		csp_35.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_35.solve();
