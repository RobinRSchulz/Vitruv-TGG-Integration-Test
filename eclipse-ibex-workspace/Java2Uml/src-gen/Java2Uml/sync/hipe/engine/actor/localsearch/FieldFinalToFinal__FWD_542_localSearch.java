...
public class FieldFinalToFinal__FWD_542_localSearch extends GenericLocalSearchActor{
			...
			case "JavaAttributeToUmlProperty_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("FieldFinalToFinal__FWD_542_localSearch", 4);
			...
			case "Field_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaField
						HMatch match_1 = new LocalSearchMatch("FieldFinalToFinal__FWD_542_localSearch", 4);
			...
			case "Property_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlProperty
						HMatch match_2 = new LocalSearchMatch("FieldFinalToFinal__FWD_542_localSearch", 4);
			...
			case "Final_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_3 = new LocalSearchMatch("FieldFinalToFinal__FWD_542_localSearch", 4);
		...
		case "Java2Uml.JavaAttributeToUmlProperty_source_Field": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Field) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldFinalToFinal__FWD_542_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
