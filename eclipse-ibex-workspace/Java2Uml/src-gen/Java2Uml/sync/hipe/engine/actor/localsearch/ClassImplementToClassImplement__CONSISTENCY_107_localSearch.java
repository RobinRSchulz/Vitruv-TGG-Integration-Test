...
public class ClassImplementToClassImplement__CONSISTENCY_107_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCREATE__SRC__interfaceTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCREATE__TRG__umlInterfaceRealization(); return (result instanceof uml.InterfaceRealization ? result : null);};
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			...
			case "Interface_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_4 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_107_localSearch", 9);
			...
			case "ClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_103_localSearch": 
				...
				break;
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_93_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_103_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_107_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_93_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_107_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
