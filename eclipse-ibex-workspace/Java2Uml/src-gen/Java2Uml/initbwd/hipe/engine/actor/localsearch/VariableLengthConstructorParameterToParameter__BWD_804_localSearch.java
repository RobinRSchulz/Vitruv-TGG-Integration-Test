...
public class VariableLengthConstructorParameterToParameter__BWD_804_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("VariableLengthConstructorParameterToParameter__BWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaConstructorToOperation_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_804_localSearch", 5);
			...
			case "Constructor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_804_localSearch", 5);
			...
			case "Operation_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_804_localSearch", 5);
			...
			case "Parameter_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_3 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_804_localSearch", 5);
			...
			case "LiteralUnlimitedNatural_object": 
				{
					if(!lazy_initialization) {
						...
						// upperValue
						HMatch match_4 = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_804_localSearch", 5);
		...
		case "Java2Uml.JavaConstructorToOperation_source_Constructor": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Constructor) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthConstructorParameterToParameter__BWD_804_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_88.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 0, "java.lang.String"));
		csp_88.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getLower(), "int"));
		csp_88.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_89.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, -1, "java.lang.String"));
		csp_89.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, upperValue.getValue(), "int"));
		csp_89.solve();
