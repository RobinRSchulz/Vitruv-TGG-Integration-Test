...
public class ClassMethodToMethod__CONSISTENCY_97_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassMethodToMethod__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassMethodToMethod__Marker) o).getCREATE__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassMethodToMethod__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.multi_lookup = (o) -> ((org.emftext.language.java.members.MemberContainer) o).getMembers().stream().filter(obj -> obj instanceof org.emftext.language.java.members.ClassMethod).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassMethodToMethod__Marker) o).getCREATE__SRC__method(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Java2Uml.ClassMethodToMethod__Marker) o).getCONTEXT__CORR__j();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Java2Uml.ClassMethodToMethod__Marker) o).getCREATE__CORR__javaMethodToOperation();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassMethodToMethod__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Class_object_SP3": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_97_localSearch", 7);
			...
			case "ClassMethod_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// method
						HMatch match_1 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_97_localSearch", 7);
			...
			case "Class_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_97_localSearch", 7);
			...
			case "Operation_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_3 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_97_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP11": 
				{
					...
					// j
					HMatch match_4 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_97_localSearch", 7);
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_97_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_7_1_orchestration, match_5);
				}
				break;
			case "ClassMethodToMethod__Marker_object": 
				{
					...
					// ClassMethodToMethod_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_97_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "ClassMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_89_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_89_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_97_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Java2Uml.ClassMethodToMethod__Marker_CONTEXT__TRG__umlClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("ClassMethodToMethod__CONSISTENCY_97_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
		...
		case "uml.Class_ownedOperation_Operation": 
			...
			break;
		case "Java2Uml.ClassMethodToMethod__Marker_CREATE__TRG__umlOperation_Operation": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.ClassMethodToMethod__Marker_CONTEXT__SRC__javaConcreteClassifier_Class": 
			if(!lazy_initialization) {
		...
		case "org.emftext.language.java.members.MemberContainer_members_Member": 
			...
			break;
		case "Java2Uml.ClassMethodToMethod__Marker_CREATE__SRC__method_ClassMethod": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
			...
			break;
		case "Java2Uml.ClassMethodToMethod__Marker_CONTEXT__CORR__j_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.ClassMethodToMethod__Marker_CREATE__CORR__javaMethodToOperation_JavaMethodToOperation": 
			if(!lazy_initialization) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ClassMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG
		...
		// register ClassMethodToMethod_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ClassMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG
		OverlapMatch oMatch_0 = new OverlapMatch(1);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[3];
		Collection<HMatch> oMatches_0 = overlap2matches_0.get(oMatch_0);
		...
		// deregister ClassMethodToMethod_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.members.ClassMethod method = (org.emftext.language.java.members.ClassMethod) match.getNodes()[1];
		...
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, method.getName(), "java.lang.String"));
