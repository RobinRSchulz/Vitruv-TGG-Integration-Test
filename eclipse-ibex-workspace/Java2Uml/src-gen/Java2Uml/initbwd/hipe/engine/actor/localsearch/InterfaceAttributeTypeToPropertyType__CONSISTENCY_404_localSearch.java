...
public class InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__CORR__attributeToProperty();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaAttributeToUmlProperty) o).getTarget(); return (result instanceof uml.Property ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaAttributeToUmlProperty) o).getSource(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCONTEXT__SRC__field(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceAttributeTypeToPropertyType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
			...
			case "Interface_1_object_SP4": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch", 8);
			...
			case "Field_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_1 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch", 8);
			...
			case "ClassifierReference_object_SP0": 
				{
					...
					// typeReference
					HMatch match_2 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch", 8);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_4_2_orchestration, match_2);
				}
				break;
			case "Property_object_SP1": 
				{
					edge_explorer_5.registerSourceObject(objs[0]);
					
					// property
					HMatch match_3 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch", 8);
			...
			case "Interface_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch", 8);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_3_2_orchestration, match_4);
					}
				}
				break;
			case "JavaAttributeToUmlProperty_object_SP0": 
				{
					edge_explorer_9.registerSourceObject(objs[0]);
					edge_explorer_10.registerSourceObject(objs[0]);
					
					// attributeToProperty
					HMatch match_5 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch", 8);
			...
			case "InterfaceAttributeTypeToPropertyType__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch", 8);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_1_orchestration, match_7);
				}
				break;
			case "InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_400_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "InterfaceAttributeTypeToPropertyType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_400_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch", 8);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.InterfaceAttributeTypeToPropertyType__Marker_CONTEXT__SRC__classifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceAttributeTypeToPropertyType__CONSISTENCY_404_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
