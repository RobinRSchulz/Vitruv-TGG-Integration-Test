...
public class ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__CORR__parameterToParameter();
						edge_explorer_4 = new CachedEdgeExplorer(this, 10, 9, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 10, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.Constructor ? result : null);};
						edge_explorer_6 = new CachedEdgeExplorer(this, 10, 1, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getSource(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((org.emftext.language.java.types.ClassifierReference) o).getTarget(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
						edge_explorer_13 = new CachedEdgeExplorer(this, 3, 0, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaParameterToParameter) o).getSource(); return (result instanceof org.emftext.language.java.parameters.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((uml.TypedElement) o).getType(); return (result instanceof uml.Enumeration ? result : null);};
						edge_explorer_17 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorEnumParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
						edge_explorer_20 = new CachedEdgeExplorer(this, 10, 6, edge_explorer_20_methods);
			...
			case "Enumeration_object_SP1": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
			...
			case "Constructor_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
			...
			case "Parameter_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_2 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// typeReference
					HMatch match_3 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
			...
			case "Enumeration_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
			...
			case "Operation_object_SP9": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
			...
			case "Parameter_1_object_SP3": 
				{
					...
					// umlParameter
					HMatch match_6 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
			...
			case "JavaClassifierToUmlClassifier_object_SP2": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
			...
			case "JavaConstructorToOperation_object_SP1": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
			...
			case "JavaParameterToParameter_object_SP3": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_4_2_orchestration, match_9);
				}
				break;
			case "ConstructorEnumParamTypeToParamType__Marker_object": 
				{
					...
					HMatch match_10 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
					match_10.getNodes()[10] = objs[0];
					start(edge_explorer_4_1_orchestration, match_10);
				}
				break;
			case "ConstructorEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_174_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ConstructorEnumParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_174_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaConstructorToOperation_source_Constructor": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Constructor) {
				{
					...
					HMatch match = new LocalSearchMatch("ConstructorEnumParamTypeToParamType__CONSISTENCY_178_localSearch", 11);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_14.solve();
