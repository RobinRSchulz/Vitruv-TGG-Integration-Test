...
public class MethodAbstractToAbstract__CONSISTENCY_553_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodAbstractToAbstract__Marker) o).getCONTEXT__SRC__javaMethod(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 4, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodAbstractToAbstract__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Abstract ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 4, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((org.emftext.language.java.modifiers.AnnotableAndModifiable) o).getAnnotationsAndModifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.modifiers.Abstract).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Java2Uml.MethodAbstractToAbstract__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodAbstractToAbstract__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodAbstractToAbstract__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "ClassMethod_object_SP1": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_553_localSearch", 5);
			...
			case "Abstract_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_553_localSearch", 5);
			...
			case "Operation_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_553_localSearch", 5);
			...
			case "JavaMethodToOperation_object_SP2": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_553_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_5_1_orchestration, match_3);
				}
				break;
			case "MethodAbstractToAbstract__Marker_object": 
				{
					...
					// MethodAbstractToAbstract_eMoflon_ProtocolNode
					HMatch match_4 = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_553_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "Java2Uml.MethodAbstractToAbstract__Marker_CONTEXT__SRC__javaMethod_ClassMethod": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					edge_explorer.registerEdge(msg.source, msg.target);
					HMatch match = new LocalSearchMatch("MethodAbstractToAbstract__CONSISTENCY_553_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
			...
			break;
		case "Java2Uml.MethodAbstractToAbstract__Marker_CREATE__SRC__modifier_Abstract": 
			if(!lazy_initialization) {
		...
		case "Java2Uml.JavaMethodToOperation_target_Operation": 
			...
			break;
		case "Java2Uml.MethodAbstractToAbstract__Marker_CONTEXT__CORR__javaMethodToOperation_JavaMethodToOperation": 
			if(!lazy_initialization) {
				{
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			...
			break;
		case "Java2Uml.MethodAbstractToAbstract__Marker_CONTEXT__TRG__umlOperation_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register MethodAbstractToAbstract_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister MethodAbstractToAbstract_eMoflon_ProtocolNode
		Collection<HMatch> matches_4 = obj2matches.get(objs[4]);
		if(matches_4 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		uml.Operation umlOperation = (uml.Operation) match.getNodes()[2];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_62 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_62.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_62.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsAbstract(), "boolean"));
		csp_62.solve();
