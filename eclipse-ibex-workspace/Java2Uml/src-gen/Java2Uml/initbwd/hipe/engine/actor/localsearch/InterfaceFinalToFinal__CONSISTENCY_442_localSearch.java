...
public class InterfaceFinalToFinal__CONSISTENCY_442_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceFinalToFinal__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 4, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceFinalToFinal__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceFinalToFinal__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceFinalToFinal__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Final ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("InterfaceFinalToFinal__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Interface_1_object_SP8": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_442_localSearch", 5);
			...
			case "Final_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_442_localSearch", 5);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_442_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP11": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_442_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "InterfaceFinalToFinal__Marker_object": 
				{
					...
					// InterfaceFinalToFinal_eMoflon_ProtocolNode
					HMatch match_4 = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_442_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_442_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			...
			break;
		case "Java2Uml.InterfaceFinalToFinal__Marker_CONTEXT__SRC__javaConcreteClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
			...
			break;
		case "Java2Uml.InterfaceFinalToFinal__Marker_CONTEXT__TRG__umlClassifier_Interface": 
			if(!lazy_initialization) {
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			...
			break;
		case "Java2Uml.InterfaceFinalToFinal__Marker_CONTEXT__CORR__javaClassifierToUmlClassifier_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
			...
			break;
		case "Java2Uml.InterfaceFinalToFinal__Marker_CREATE__SRC__modifier_Final": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.modifiers.Final) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		// register InterfaceFinalToFinal_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister InterfaceFinalToFinal_eMoflon_ProtocolNode
		Collection<HMatch> matches_4 = obj2matches.get(objs[4]);
		if(matches_4 != null) {
