...
public class ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_335_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ExistingSuperClassToSuperClass__CONSISTENCY_339_localSearch"), this::returnTrue  , false ));
			...
			case "ClassifierReference_object_SP6": 
				{
					...
					// superclassTypeRef
					HMatch match_0 = new LocalSearchMatch("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_335_localSearch", 3);
			...
			case "Class_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// superclassifier
						HMatch match_1 = new LocalSearchMatch("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_335_localSearch", 3);
			...
			case "Classifier_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// FILTER_NAC_NODE
						HMatch match_2 = new LocalSearchMatch("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_335_localSearch", 3);
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperClassToSuperClass_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_335_localSearch", 3);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
