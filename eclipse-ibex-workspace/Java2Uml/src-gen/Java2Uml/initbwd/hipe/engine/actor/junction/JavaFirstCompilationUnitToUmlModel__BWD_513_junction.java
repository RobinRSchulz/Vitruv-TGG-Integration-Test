...
public class JavaFirstCompilationUnitToUmlModel__BWD_513_junction extends GenericJunctionActor{
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		constraints.add(this::check_constraint_86);
		
		ports = new LinkedList<>();
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaFirstCompilationUnitToUmlModel__BWD_509_junction"), this::returnTrue , 0  , false ));
	}
	...
	public boolean check_constraint_86(HMatch match, int index) {
