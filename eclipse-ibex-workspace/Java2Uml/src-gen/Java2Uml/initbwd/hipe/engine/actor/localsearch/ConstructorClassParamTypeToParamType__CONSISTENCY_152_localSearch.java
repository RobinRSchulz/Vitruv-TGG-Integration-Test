...
public class ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((org.emftext.language.java.types.TypedElement) o).getTypeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.parameters.Parameter) return o.equals(edge_explorer_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer = new EdgeExplorer(this, 2, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorClassParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 10, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorClassParamTypeToParamType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 10, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorClassParamTypeToParamType__Marker) o).getCONTEXT__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.Parameter ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 10, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((uml.TypedElement) o).getType(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorClassParamTypeToParamType__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.Constructor ? result : null);};
						edge_explorer_7 = new CachedEdgeExplorer(this, 10, 1, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorClassParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
						edge_explorer_8 = new CachedEdgeExplorer(this, 10, 4, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.multi_lookup = (o) -> ((org.emftext.language.java.parameters.Parametrizable) o).getParameters();
						edge_explorer_9_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.members.Constructor) return edge_explorer_9_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_9 = new EdgeExplorer(this, 1, 2, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((org.emftext.language.java.types.ClassifierReference) o).getTarget(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
						edge_explorer_10 = new CachedEdgeExplorer(this, 3, 0, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorClassParamTypeToParamType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((uml.BehavioralFeature) o).getOwnedParameter();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Operation) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_12 = new EdgeExplorer(this, 5, 6, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Java2Uml.ConstructorClassParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaConstructorToOperation();
						edge_explorer_13 = new CachedEdgeExplorer(this, 10, 8, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaParameterToParameter) o).getTarget(); return (result instanceof uml.Parameter ? result : null);};
						edge_explorer_14 = new CachedEdgeExplorer(this, 9, 6, edge_explorer_14_methods);
		name2explorer.put("edge_explorer_14", edge_explorer_14);
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaParameterToParameter) o).getSource(); return (result instanceof org.emftext.language.java.parameters.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaConstructorToOperation) o).getTarget(); return (result instanceof uml.Operation ? result : null);};
						edge_explorer_16 = new CachedEdgeExplorer(this, 8, 5, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getTarget(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ConstructorClassParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
						edge_explorer_18 = new CachedEdgeExplorer(this, 10, 6, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Java2Uml.ConstructorClassParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
						edge_explorer_19 = new CachedEdgeExplorer(this, 10, 7, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getSource(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> ((Java2Uml.ConstructorClassParamTypeToParamType__Marker) o).getCONTEXT__CORR__parameterToParameter();
						edge_explorer_21 = new CachedEdgeExplorer(this, 10, 9, edge_explorer_21_methods);
		name2explorer.put("edge_explorer_21", edge_explorer_21);
		EdgeLookupMethods edge_explorer_22_methods = new EdgeLookupMethods();
						edge_explorer_22_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaConstructorToOperation) o).getSource(); return (result instanceof org.emftext.language.java.members.Constructor ? result : null);};
						edge_explorer_22 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_22_methods);
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_17_1_orchestration = initializeOrchestration(node.getOrchestrations().get(26).getPlan());
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ConstructorClassParamTypeToParamType__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "Class_object_SP0": 
				{
					
					// classifier
					HMatch match_0 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
			...
			case "Constructor_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_7_1_orchestration, match_1);
					}
				}
				break;
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						
						// parameter
						HMatch match_2 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_1_orchestration, match_2);
					}
				}
				break;
			case "ClassifierReference_object_SP4": 
				{
					edge_explorer_10.registerSourceObject(objs[0]);
					
					// typeReference
					HMatch match_3 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_2_orchestration, match_3);
				}
				break;
			case "Class_1_object_SP0": 
				{
					if(!lazy_initialization) {
						
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_6_2_orchestration, match_4);
					}
				}
				break;
			case "Operation_object_SP7": 
				{
					if(!lazy_initialization) {
						
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
						match_5.getNodes()[5] = objs[0];
						start(edge_explorer_3_2_orchestration, match_5);
					}
				}
				break;
			case "Parameter_1_object_SP1": 
				{
					edge_explorer_6.registerSourceObject(objs[0]);
					
					// umlParameter
					HMatch match_6 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_6_1_orchestration, match_6);
				}
				break;
			case "JavaClassifierToUmlClassifier_object_SP0": 
				{
					edge_explorer_17.registerSourceObject(objs[0]);
					edge_explorer_20.registerSourceObject(objs[0]);
					
					// javaClassifierToUmlClassifier
					HMatch match_7 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_17_1_orchestration, match_7);
				}
				break;
			case "JavaConstructorToOperation_object_SP2": 
				{
					edge_explorer_16.registerSourceObject(objs[0]);
					edge_explorer_22.registerSourceObject(objs[0]);
					
					// javaConstructorToOperation
					HMatch match_8 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
			...
			case "JavaParameterToParameter_object_SP1": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_14_1_orchestration, match_9);
				}
				break;
			case "ConstructorClassParamTypeToParamType__Marker_object": 
				{
					...
					// ConstructorClassParamTypeToParamType_eMoflon_ProtocolNode
					HMatch match_10 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
					match_10.getNodes()[10] = objs[0];
					start(edge_explorer_3_1_orchestration, match_10);
				}
				break;
			case "ConstructorClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_148_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ConstructorClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_148_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.types.TypedElement_typeReference_TypeReference": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("ConstructorClassParamTypeToParamType__CONSISTENCY_152_localSearch", 11);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
			...
			break;
		case "Java2Uml.ConstructorClassParamTypeToParamType__Marker_CONTEXT__TRG__umlOperation_Operation": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.ConstructorClassParamTypeToParamType__Marker_CREATE__SRC__typeReference_ClassifierReference": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.types.ClassifierReference) {
				{
			...
			break;
		case "Java2Uml.ConstructorClassParamTypeToParamType__Marker_CONTEXT__SRC__parameter_Parameter": 
			if(!lazy_initialization) {
		...
		case "uml.TypedElement_type_Type": 
			...
			break;
		case "Java2Uml.ConstructorClassParamTypeToParamType__Marker_CONTEXT__SRC__javaParametrizable_Constructor": 
			if(!lazy_initialization) {
			...
			break;
		case "Java2Uml.ConstructorClassParamTypeToParamType__Marker_CONTEXT__TRG__umlClassifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
		...
		case "org.emftext.language.java.types.ClassifierReference_target_Classifier": 
			...
			break;
		case "Java2Uml.ConstructorClassParamTypeToParamType__Marker_CONTEXT__SRC__classifier_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			...
			break;
		case "Java2Uml.ConstructorClassParamTypeToParamType__Marker_CONTEXT__CORR__javaConstructorToOperation_JavaConstructorToOperation": 
			if(!lazy_initialization) {
				{
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			...
			break;
		case "Java2Uml.ConstructorClassParamTypeToParamType__Marker_CONTEXT__TRG__umlParameter_Parameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Parameter) {
				{
			...
			break;
		case "Java2Uml.ConstructorClassParamTypeToParamType__Marker_CONTEXT__CORR__javaClassifierToUmlClassifier_JavaClassifierToUmlClassifier": 
			if(!lazy_initialization) {
				{
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			...
			break;
		case "Java2Uml.ConstructorClassParamTypeToParamType__Marker_CONTEXT__CORR__parameterToParameter_JavaParameterToParameter": 
			if(!lazy_initialization) {
				{
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ConstructorClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC
		...
		// register ConstructorClassParamTypeToParamType_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ConstructorClassParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[3];
		...
		// deregister ConstructorClassParamTypeToParamType_eMoflon_ProtocolNode
		Collection<HMatch> matches_10 = obj2matches.get(objs[10]);
		if(matches_10 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_12.solve();
