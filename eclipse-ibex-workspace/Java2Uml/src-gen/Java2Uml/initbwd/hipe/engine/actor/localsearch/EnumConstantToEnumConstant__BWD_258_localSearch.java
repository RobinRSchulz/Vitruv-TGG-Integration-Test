...
public class EnumConstantToEnumConstant__BWD_258_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP10": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("EnumConstantToEnumConstant__BWD_258_localSearch", 4);
			...
			case "Enumeration_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// javaEnum
						HMatch match_1 = new LocalSearchMatch("EnumConstantToEnumConstant__BWD_258_localSearch", 4);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlEnum
						HMatch match_2 = new LocalSearchMatch("EnumConstantToEnumConstant__BWD_258_localSearch", 4);
			...
			case "EnumerationLiteral_object": 
				{
					if(!lazy_initialization) {
						...
						// umlLiteral
						HMatch match_3 = new LocalSearchMatch("EnumConstantToEnumConstant__BWD_258_localSearch", 4);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumConstantToEnumConstant__BWD_258_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
