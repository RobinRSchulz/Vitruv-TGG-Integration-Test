...
public class SuperInterfaceToSuperInterface__CONSISTENCY_793_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__SRC__superclassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__TRG__umlGeneralClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierReferenceToUmlGeneralization) o).getTarget(); return (result instanceof uml.Generalization ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((uml.Generalization) o).getGeneral(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
						edge_explorer_13 = new CachedEdgeExplorer(this, 9, 7, edge_explorer_13_methods);
		name2explorer.put("edge_explorer_13", edge_explorer_13);
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__CORR__classRefToGeneralization();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((uml.Generalization) o).getSpecific(); return (result instanceof uml.Interface ? result : null);};
						edge_explorer_15_methods.multi_opposite_lookup = (o) -> ((uml.Classifier) o).getGeneralization();
						edge_explorer_15 = new EdgeExplorer(this, 3, 4, edge_explorer_15_methods);
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Interface) o).getExtends().stream().filter(obj -> obj instanceof org.emftext.language.java.types.ClassifierReference).collect(Collectors.toList());
						edge_explorer_17_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.classifiers.Interface) return edge_explorer_17_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__SRC__superclassTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
						edge_explorer_20 = new CachedEdgeExplorer(this, 9, 4, edge_explorer_20_methods);
