...
public class MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getTarget(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCONTEXT__SRC__javaMethod(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCREATE__CORR__javaTypeReferenceToUmlReturnParameter();
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 8, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCREATE__TRG__umlReturnParameter(); return (result instanceof uml.Parameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCONTEXT__CORR__javaMethodToOperation();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodEnumReturnTypeToReturnType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
			...
			case "Enumeration_object_SP3": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
			...
			case "ClassMethod_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// javaMethod
						HMatch match_1 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
			...
			case "ClassifierReference_object_SP8": 
				{
					...
					// typeReference
					HMatch match_2 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
			...
			case "Enumeration_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
			...
			case "Operation_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_4 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
			...
			case "Parameter_1_object_SP6": 
				{
					...
					// umlReturnParameter
					HMatch match_5 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
			...
			case "JavaMethodToOperation_object_SP4": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
			...
			case "JavaTypeReferenceToUmlReturnParameter_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
			...
			case "MethodEnumReturnTypeToReturnType__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_4_1_orchestration, match_9);
				}
				break;
			case "MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_629_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodEnumReturnTypeToReturnType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_629_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodEnumReturnTypeToReturnType__CONSISTENCY_633_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
