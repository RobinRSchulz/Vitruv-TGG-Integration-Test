...
public class FieldStaticToStatic__CONSISTENCY_381_localSearch extends GenericLocalSearchActor{
			...
			case "Field_object_SP1": 
				{
					...
					// javaField
					HMatch match_0 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_381_localSearch", 5);
			...
			case "Static_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_381_localSearch", 5);
			...
			case "Property_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlProperty
						HMatch match_2 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_381_localSearch", 5);
			...
			case "JavaAttributeToUmlProperty_object_SP1": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_381_localSearch", 5);
			...
			case "FieldStaticToStatic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_381_localSearch", 5);
		...
		case "Java2Uml.FieldStaticToStatic__Marker_CONTEXT__SRC__javaField_Field": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.Field) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_381_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_27.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlProperty.isIsStatic(), "boolean"));
		csp_27.solve();
