...
public class ClassAttributeToProperty__CONSISTENCY_15_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaAttributeToUmlProperty) o).getSource(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassAttributeToProperty__Marker) o).getCREATE__SRC__field(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Java2Uml.ClassAttributeToProperty__Marker) o).getCONTEXT__CORR__classToUmlClass();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((uml.StructuredClassifier) o).getOwnedAttribute();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Class) return edge_explorer_8_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			...
			case "ClassAttributeToProperty__Marker_object": 
				...
				break;
			case "ClassAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_7_localSearch": 
				{
