...
public class JavaFirstCompilationUnitToUmlModel__BWD_500_junction extends GenericJunctionActor{
	
	@Override
	protected void initializePorts(Map<String, ActorRef> name2actor, JunctionNode node) {
		constraints.add(this::check_constraint_85);
		
		ports = new LinkedList<>();
		ports.add(new PortJunctionRight(node.getPorts().getPort().get(0), getSelf(), name2actor.get("JavaFirstCompilationUnitToUmlModel__BWD_496_junction"), this::returnTrue , 0  , false ));
	}
	...
	public boolean check_constraint_85(HMatch match, int index) {
