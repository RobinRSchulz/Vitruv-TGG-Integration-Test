...
public class EnumProtectedToProtected__CONSISTENCY_270_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumProtectedToProtected__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Protected ? result : null);};
			...
			case "Enumeration_object_SP1": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_270_localSearch", 5);
			...
			case "Protected_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_270_localSearch", 5);
			...
			case "Enumeration_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_270_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP12": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_270_localSearch", 5);
			...
			case "EnumProtectedToProtected__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_270_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("EnumProtectedToProtected__CONSISTENCY_270_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected csp_23 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectProtected();
