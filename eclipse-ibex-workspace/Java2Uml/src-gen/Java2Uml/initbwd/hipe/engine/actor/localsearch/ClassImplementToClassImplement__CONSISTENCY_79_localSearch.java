...
public class ClassImplementToClassImplement__CONSISTENCY_79_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCONTEXT__SRC__javaClass(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 8, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((uml.InterfaceRealization) o).getContract();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCREATE__TRG__umlInterfaceRealization(); return (result instanceof uml.InterfaceRealization ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCREATE__TRG__umlInterface(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.multi_lookup = (o) -> ((uml.BehavioredClassifier) o).getInterfaceRealization();
						edge_explorer_10_methods.unique_opposite_lookup = (o) -> {EObject result = ((uml.InterfaceRealization) o).getImplementingClassifier(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCREATE__SRC__interfaceTypeRef(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCREATE__SRC__interface(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCONTEXT__TRG__umlClass(); return (result instanceof uml.Class ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((Java2Uml.ClassImplementToClassImplement__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
			...
			case "Interface_1_object_SP0": 
				{
					...
					// interface
					HMatch match_0 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
			...
			case "ClassifierReference_object_SP2": 
				{
					...
					// interfaceTypeRef
					HMatch match_1 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
			...
			case "Class_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaClass
						HMatch match_2 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
			...
			case "Class_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_3 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
			...
			case "Interface_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_4 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
			...
			case "InterfaceRealization_object_SP0": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
			...
			case "JavaClassifierToUmlClassifier_object_SP9": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
					...
					HMatch match_7 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
			...
			case "ClassImplementToClassImplement__Marker_object": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_1_orchestration, match_8);
				}
				break;
			case "ClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_75_localSearch": 
				{
				...
				break;
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_65_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "ClassImplementToClassImplement_interfaceTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_75_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_65_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "Java2Uml.ClassImplementToClassImplement__Marker_CONTEXT__SRC__javaClass_Class": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassImplementToClassImplement__CONSISTENCY_79_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[8] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
