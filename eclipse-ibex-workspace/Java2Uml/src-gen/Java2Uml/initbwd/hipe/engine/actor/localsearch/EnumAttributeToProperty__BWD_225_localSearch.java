...
public class EnumAttributeToProperty__BWD_225_localSearch extends GenericLocalSearchActor{
			...
			case "JavaClassifierToUmlClassifier_object_SP6": 
				{
					...
					// classToUmlClass
					HMatch match_0 = new LocalSearchMatch("EnumAttributeToProperty__BWD_225_localSearch", 4);
			...
			case "Enumeration_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("EnumAttributeToProperty__BWD_225_localSearch", 4);
			...
			case "Enumeration_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumAttributeToProperty__BWD_225_localSearch", 4);
			...
			case "Property_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_3 = new LocalSearchMatch("EnumAttributeToProperty__BWD_225_localSearch", 4);
		...
		switch(match.creator) {
			...
			case "EnumAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_222_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("EnumAttributeToProperty__BWD_225_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumAttributeToProperty__BWD_225_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
