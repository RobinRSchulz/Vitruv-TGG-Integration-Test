...
public class SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((uml.Generalization) o).getSpecific(); return (result instanceof uml.Interface ? result : null);};
						edge_explorer_3_methods.multi_opposite_lookup = (o) -> ((uml.Classifier) o).getGeneralization();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__TRG__umlGeneralClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierReferenceToUmlGeneralization) o).getSource(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getSource(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((Java2Uml.SuperInterfaceToSuperInterface__Marker) o).getCREATE__CORR__classRefToGeneralization();
			...
			case "Interface_1_object_SP4": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_5_1_orchestration, match_0);
					
					// superclassifier
					HMatch match_2 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_11_2_orchestration, match_2);
				}
				break;
			case "ClassifierReference_object_SP7": 
				{
					...
					// superclassTypeRef
					HMatch match_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
			...
			case "Generalization_object_SP2": 
				{
					...
					// generalization
					HMatch match_3 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
			...
			case "Interface_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_3_1_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
			...
			case "JavaClassifierReferenceToUmlGeneralization_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
			...
			case "JavaClassifierToUmlClassifier_object_SP14": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
					...
					HMatch match_8 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
			...
			case "SuperInterfaceToSuperInterface__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_6_1_orchestration, match_9);
				}
				break;
			case "SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_776_localSearch": 
				{
				...
				break;
			case "SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_766_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "SuperInterfaceToSuperInterface_superclassTypeRef_target_outgoing_SRC__FILTER_NAC_SRC_776_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			case "SuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_766_localSearch": 
				if(nac_checker_0.deregister(match)) {
					HMatch acMatch_1 = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
					Object[] acMatch_nodes_1 = acMatch_1.getNodes();
		...
		case "uml.Generalization_general_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("SuperInterfaceToSuperInterface__CONSISTENCY_780_localSearch", 10);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_86.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, superclassifier.getName(), "java.lang.String"));
		csp_86.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlGeneralClassifier.getName(), "java.lang.String"));
		csp_86.solve();
		
		boolean predicate = csp_86.isSatisfied();
		return predicate;
	}
