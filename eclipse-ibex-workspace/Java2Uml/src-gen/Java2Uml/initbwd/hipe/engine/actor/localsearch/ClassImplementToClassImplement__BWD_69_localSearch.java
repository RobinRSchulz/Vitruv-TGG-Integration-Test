...
public class ClassImplementToClassImplement__BWD_69_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassImplementToClassImplement__BWD_production"), this::returnTrue  , false ));
	}
			...
			case "Class_object_SP0": 
				{
					...
					// javaClass
					HMatch match_0 = new LocalSearchMatch("ClassImplementToClassImplement__BWD_69_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP8": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("ClassImplementToClassImplement__BWD_69_localSearch", 5);
			...
			case "Class_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlClass
						HMatch match_2 = new LocalSearchMatch("ClassImplementToClassImplement__BWD_69_localSearch", 5);
			...
			case "Interface_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlInterface
						HMatch match_3 = new LocalSearchMatch("ClassImplementToClassImplement__BWD_69_localSearch", 5);
			...
			case "InterfaceRealization_object_SP0": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("ClassImplementToClassImplement__BWD_69_localSearch", 5);
		...
		switch(match.creator) {
			...
			case "ClassImplementToClassImplement_umlInterfaceRealization_contract_outgoing_TRG__FILTER_NAC_TRG_65_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassImplementToClassImplement__BWD_69_localSearch", 5);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassImplementToClassImplement__BWD_69_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
