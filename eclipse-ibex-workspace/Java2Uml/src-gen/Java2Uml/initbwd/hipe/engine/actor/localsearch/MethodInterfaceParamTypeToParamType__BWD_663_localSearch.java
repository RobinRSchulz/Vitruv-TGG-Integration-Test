...
public class MethodInterfaceParamTypeToParamType__BWD_663_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("MethodInterfaceParamTypeToParamType__BWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Interface_1_object_SP6": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__BWD_663_localSearch", 9);
			...
			case "JavaClassifierToUmlClassifier_object_SP9": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__BWD_663_localSearch", 9);
			...
			case "JavaMethodToOperation_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__BWD_663_localSearch", 9);
			...
			case "ClassMethod_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__BWD_663_localSearch", 9);
			...
			case "Parameter_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__BWD_663_localSearch", 9);
			...
			case "JavaParameterToParameter_object_SP2": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__BWD_663_localSearch", 9);
			...
			case "Interface_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__BWD_663_localSearch", 9);
			...
			case "Operation_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__BWD_663_localSearch", 9);
			...
			case "Parameter_1_object_SP0": 
				{
					...
					// umlParameter
					HMatch match_8 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__BWD_663_localSearch", 9);
		...
		case "Java2Uml.JavaMethodToOperation_source_Method": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.members.ClassMethod) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__BWD_663_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
