...
public class MethodFinalToFinal__CONSISTENCY_657_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodFinalToFinal__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Final ? result : null);};
			...
			case "ClassMethod_object_SP0": 
				{
					...
					// javaMethod
					HMatch match_0 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_657_localSearch", 5);
			...
			case "Final_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_657_localSearch", 5);
			...
			case "Operation_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_657_localSearch", 5);
			...
			case "JavaMethodToOperation_object_SP5": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_657_localSearch", 5);
			...
			case "MethodFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_657_localSearch", 5);
		...
		case "Java2Uml.MethodFinalToFinal__Marker_CONTEXT__TRG__umlOperation_Operation": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Operation) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodFinalToFinal__CONSISTENCY_657_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_75.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_75.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.isIsLeaf(), "boolean"));
		csp_75.solve();
