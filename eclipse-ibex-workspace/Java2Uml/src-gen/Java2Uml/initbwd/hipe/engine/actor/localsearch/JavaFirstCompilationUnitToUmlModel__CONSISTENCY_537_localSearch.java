...
public class JavaFirstCompilationUnitToUmlModel__CONSISTENCY_537_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__shortType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 14, 9, edge_explorer_4_methods);
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						...
						edge_explorer_11 = new EdgeExplorer(this, 5, 11, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__doubleType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_12 = new CachedEdgeExplorer(this, 14, 5, edge_explorer_12_methods);
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						...
						edge_explorer_15 = new EdgeExplorer(this, 6, 11, edge_explorer_15_methods);
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__umlModel(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_19 = new CachedEdgeExplorer(this, 14, 11, edge_explorer_19_methods);
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						...
						edge_explorer_20 = new EdgeExplorer(this, 9, 11, edge_explorer_20_methods);
		name2explorer.put("edge_explorer_20", edge_explorer_20);
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__booleanType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_21 = new CachedEdgeExplorer(this, 14, 2, edge_explorer_21_methods);
		name2explorer.put("edge_explorer_21", edge_explorer_21);
		EdgeLookupMethods edge_explorer_22_methods = new EdgeLookupMethods();
						edge_explorer_22_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__intType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_22 = new CachedEdgeExplorer(this, 14, 7, edge_explorer_22_methods);
		...
		EdgeLookupMethods edge_explorer_23_methods = new EdgeLookupMethods();
						...
						edge_explorer_23 = new EdgeExplorer(this, 2, 11, edge_explorer_23_methods);
		name2explorer.put("edge_explorer_23", edge_explorer_23);
		EdgeLookupMethods edge_explorer_24_methods = new EdgeLookupMethods();
						edge_explorer_24_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToUmlModel) o).getTarget(); return (result instanceof uml.Model ? result : null);};
						edge_explorer_24 = new CachedEdgeExplorer(this, 13, 11, edge_explorer_24_methods);
		...
		EdgeLookupMethods edge_explorer_25_methods = new EdgeLookupMethods();
						...
						edge_explorer_25 = new EdgeExplorer(this, 3, 11, edge_explorer_25_methods);
		name2explorer.put("edge_explorer_25", edge_explorer_25);
		EdgeLookupMethods edge_explorer_26_methods = new EdgeLookupMethods();
						edge_explorer_26_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__floatType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_26 = new CachedEdgeExplorer(this, 14, 6, edge_explorer_26_methods);
		name2explorer.put("edge_explorer_26", edge_explorer_26);
		EdgeLookupMethods edge_explorer_27_methods = new EdgeLookupMethods();
						edge_explorer_27_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__stringType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_27 = new CachedEdgeExplorer(this, 14, 10, edge_explorer_27_methods);
		name2explorer.put("edge_explorer_27", edge_explorer_27);
		EdgeLookupMethods edge_explorer_28_methods = new EdgeLookupMethods();
						edge_explorer_28_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaFirstCompilationUnitToUmlModel__Marker) o).getCREATE__TRG__longType(); return (result instanceof uml.PrimitiveType ? result : null);};
						edge_explorer_28 = new CachedEdgeExplorer(this, 14, 8, edge_explorer_28_methods);
			...
			case "PrimitiveType_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						start(edge_explorer_21_1_orchestration, match_2);
						...
						start(edge_explorer_18_1_orchestration, match_10);
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					start(edge_explorer_8_1_orchestration, match_13);
				}
				break;
