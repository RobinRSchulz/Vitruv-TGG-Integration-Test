...
public class InterfaceFinalToFinal__CONSISTENCY_429_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceFinalToFinal__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Final ? result : null);};
			...
			case "Interface_1_object_SP8": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_429_localSearch", 5);
			...
			case "Final_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_429_localSearch", 5);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_429_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP9": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_429_localSearch", 5);
			...
			case "InterfaceFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_429_localSearch", 5);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceFinalToFinal__CONSISTENCY_429_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_32.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.isIsFinalSpecialization(), "boolean"));
		csp_32.solve();
