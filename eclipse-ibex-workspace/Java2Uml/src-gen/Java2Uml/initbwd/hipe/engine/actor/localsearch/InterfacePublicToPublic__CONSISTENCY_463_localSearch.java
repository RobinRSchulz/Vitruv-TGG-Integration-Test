...
public class InterfacePublicToPublic__CONSISTENCY_463_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((org.emftext.language.java.modifiers.AnnotableAndModifiable) o).getAnnotationsAndModifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.modifiers.Public).collect(Collectors.toList());
			...
			case "Interface_1_object_SP4": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_463_localSearch", 5);
			...
			case "Public_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_463_localSearch", 5);
			...
			case "Interface_object_SP5": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_463_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP14": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_463_localSearch", 5);
			...
			case "InterfacePublicToPublic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_463_localSearch", 5);
		...
		case "Java2Uml.InterfacePublicToPublic__Marker_CONTEXT__SRC__javaConcreteClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfacePublicToPublic__CONSISTENCY_463_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic csp_36 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic();
