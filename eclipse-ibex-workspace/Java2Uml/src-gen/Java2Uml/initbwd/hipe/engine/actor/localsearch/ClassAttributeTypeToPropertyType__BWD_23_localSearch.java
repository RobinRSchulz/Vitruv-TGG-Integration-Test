...
public class ClassAttributeTypeToPropertyType__BWD_23_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassAttributeTypeToPropertyType__BWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaAttributeToUmlProperty_object_SP1": 
				{
					...
					// attributeToProperty
					HMatch match_0 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_23_localSearch", 6);
			...
			case "Class_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_23_localSearch", 6);
			...
			case "Field_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_2 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_23_localSearch", 6);
			...
			case "JavaClassifierToUmlClassifier_object_SP3": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_23_localSearch", 6);
			...
			case "Property_object_SP3": 
				{
					...
					// property
					HMatch match_4 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_23_localSearch", 6);
			...
			case "Class_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_5 = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_23_localSearch", 6);
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassAttributeTypeToPropertyType__BWD_23_localSearch", 6);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
