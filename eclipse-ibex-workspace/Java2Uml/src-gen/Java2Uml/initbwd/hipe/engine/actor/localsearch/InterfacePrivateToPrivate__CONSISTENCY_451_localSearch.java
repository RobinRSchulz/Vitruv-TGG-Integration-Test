...
public class InterfacePrivateToPrivate__CONSISTENCY_451_localSearch extends GenericLocalSearchActor{
			...
			case "Interface_1_object_SP2": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_451_localSearch", 5);
			...
			case "Private_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_451_localSearch", 5);
			...
			case "Interface_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_451_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP12": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_451_localSearch", 5);
			...
			case "InterfacePrivateToPrivate__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_451_localSearch", 5);
		...
		case "Java2Uml.InterfacePrivateToPrivate__Marker_CONTEXT__SRC__javaConcreteClassifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfacePrivateToPrivate__CONSISTENCY_451_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
