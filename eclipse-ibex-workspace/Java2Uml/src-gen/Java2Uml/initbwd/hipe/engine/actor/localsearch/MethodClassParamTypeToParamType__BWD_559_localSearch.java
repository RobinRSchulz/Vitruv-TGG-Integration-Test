...
public class MethodClassParamTypeToParamType__BWD_559_localSearch extends GenericLocalSearchActor{
			...
			case "Class_object_SP7": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_559_localSearch", 9);
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					HMatch match_1 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_559_localSearch", 9);
			...
			case "JavaMethodToOperation_object_SP3": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_559_localSearch", 9);
			...
			case "ClassMethod_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_3 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_559_localSearch", 9);
			...
			case "Parameter_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_4 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_559_localSearch", 9);
			...
			case "JavaParameterToParameter_object_SP2": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_559_localSearch", 9);
			...
			case "Class_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_6 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_559_localSearch", 9);
			...
			case "Operation_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_7 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_559_localSearch", 9);
			...
			case "Parameter_1_object_SP6": 
				{
					...
					// umlParameter
					HMatch match_8 = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_559_localSearch", 9);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.parameters.Parametrizable_parameters_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("MethodClassParamTypeToParamType__BWD_559_localSearch", 9);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
