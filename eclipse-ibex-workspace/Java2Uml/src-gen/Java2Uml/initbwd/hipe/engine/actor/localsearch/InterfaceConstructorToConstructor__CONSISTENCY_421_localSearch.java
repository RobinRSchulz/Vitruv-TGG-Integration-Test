...
public class InterfaceConstructorToConstructor__CONSISTENCY_421_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCREATE__SRC__constructor(); return (result instanceof org.emftext.language.java.members.Constructor ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((org.emftext.language.java.members.MemberContainer) o).getMembers().stream().filter(obj -> obj instanceof org.emftext.language.java.members.Constructor).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCONTEXT__CORR__j();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.multi_lookup = (o) -> ((uml.Interface) o).getOwnedOperation();
						edge_explorer_10_methods.unique_opposite_lookup = (o) -> ((uml.Operation) o).getInterface();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCREATE__CORR__javaConstructorToOperation();
			...
			case "Constructor_object_SP1": 
				{
					...
					// constructor
					HMatch match_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_421_localSearch", 7);
			...
			case "Interface_1_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_421_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_2_orchestration, match_1);
					}
				}
				break;
			case "Interface_object_SP8": 
				{
					if(!lazy_initialization) {
						
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_421_localSearch", 7);
			...
			case "Operation_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_3 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_421_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP8": 
				{
					...
					// j
					HMatch match_4 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_421_localSearch", 7);
			...
			case "JavaConstructorToOperation_object_SP1": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_421_localSearch", 7);
			...
			case "InterfaceConstructorToConstructor__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_421_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "InterfaceConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_413_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "InterfaceConstructorToConstructor_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_413_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_421_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_source_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceConstructorToConstructor__CONSISTENCY_421_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_31.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, constructor.getName(), "java.lang.String"));
		csp_31.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlOperation.getName(), "java.lang.String"));
		csp_31.solve();
