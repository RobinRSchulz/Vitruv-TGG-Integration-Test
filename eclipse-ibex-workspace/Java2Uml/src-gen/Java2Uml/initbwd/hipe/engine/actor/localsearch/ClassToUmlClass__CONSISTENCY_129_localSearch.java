...
public class ClassToUmlClass__CONSISTENCY_129_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCONTEXT__TRG__umlPackage(); return (result instanceof uml.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCREATE__TRG__umlClassifier(); return (result instanceof uml.Class ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 7, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.ClassToUmlClass__Marker) o).getCONTEXT__CORR__javaPackToUmlPack();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((org.emftext.language.java.containers.CompilationUnit) o).getClassifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.classifiers.Class).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.ClassToUmlClass__Marker) o).getCREATE__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Class ? result : null);};
