...
public class VariableLengthMethodParameterToParameter__CONSISTENCY_812_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((org.emftext.language.java.parameters.Parametrizable) o).getParameters().stream().filter(obj -> obj instanceof org.emftext.language.java.parameters.VariableLengthParameter).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.VariableLengthParameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__TRG__upperValue(); return (result instanceof uml.LiteralUnlimitedNatural ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
			...
			case "ClassMethod_object_SP2": 
				{
					...
					// javaParametrizable
					HMatch match_0 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_812_localSearch", 8);
			...
			case "VariableLengthParameter_object": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_1 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_812_localSearch", 8);
			...
			case "Operation_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_812_localSearch", 8);
			...
			case "Parameter_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_3 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_812_localSearch", 8);
			...
			case "LiteralUnlimitedNatural_object": 
				{
					if(!lazy_initialization) {
						...
						// upperValue
						HMatch match_4 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_812_localSearch", 8);
			...
			case "JavaMethodToOperation_object_SP2": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_812_localSearch", 8);
			...
			case "JavaParameterToParameter_object_SP3": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_812_localSearch", 8);
			...
			case "VariableLengthMethodParameterToParameter__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_812_localSearch", 8);
		...
		case "Java2Uml.VariableLengthMethodParameterToParameter__Marker_CREATE__TRG__umlParameter_Parameter": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Parameter) {
				{
					...
					HMatch match = new LocalSearchMatch("VariableLengthMethodParameterToParameter__CONSISTENCY_812_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_94.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, 0, "java.lang.String"));
		csp_94.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getLower(), "int"));
		csp_94.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_95.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, -1, "java.lang.String"));
		csp_95.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, upperValue.getValue(), "int"));
		csp_95.solve();
