...
public class InterfaceConstructorToConstructor__CONSISTENCY_434_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCREATE__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((uml.Interface) o).getOwnedOperation();
						edge_explorer_11_methods.unique_opposite_lookup = (o) -> ((uml.Operation) o).getInterface();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceConstructorToConstructor__Marker) o).getCREATE__SRC__constructor(); return (result instanceof org.emftext.language.java.members.Constructor ? result : null);};
