...
public class VariableLengthMethodParameterToParameter__CONSISTENCY_825_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__CORR__parameterToParameter();
						edge_explorer_3 = new CachedEdgeExplorer(this, 7, 6, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__TRG__upperValue(); return (result instanceof uml.LiteralUnlimitedNatural ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.VariableLengthMethodParameterToParameter__Marker) o).getCREATE__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.VariableLengthParameter ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((uml.MultiplicityElement) o).getUpperValue(); return (result instanceof uml.LiteralUnlimitedNatural ? result : null);};
						edge_explorer_15_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Parameter) return o.equals(edge_explorer_15_methods.unique_lookup.apply(result)) ? result : null; else return null;};
