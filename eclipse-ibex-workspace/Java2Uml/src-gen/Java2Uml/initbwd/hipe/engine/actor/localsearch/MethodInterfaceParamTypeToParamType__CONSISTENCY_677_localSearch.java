...
public class MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((uml.TypedElement) o).getType(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
						edge_explorer_5 = new CachedEdgeExplorer(this, 10, 7, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((uml.BehavioralFeature) o).getOwnedParameter();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Operation) return edge_explorer_6_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_6 = new EdgeExplorer(this, 5, 6, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__parameter(); return (result instanceof org.emftext.language.java.parameters.Parameter ? result : null);};
						edge_explorer_8 = new CachedEdgeExplorer(this, 10, 2, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCREATE__SRC__typeReference(); return (result instanceof org.emftext.language.java.types.ClassifierReference ? result : null);};
						edge_explorer_9 = new CachedEdgeExplorer(this, 10, 3, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__CORR__parameterToParameter();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getTarget(); return (result instanceof uml.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlParameter(); return (result instanceof uml.Parameter ? result : null);};
						edge_explorer_12 = new CachedEdgeExplorer(this, 10, 6, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaMethodToOperation) o).getSource(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlOperation(); return (result instanceof uml.Operation ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaClassifierToUmlClassifier) o).getSource(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
		...
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__SRC__javaParametrizable(); return (result instanceof org.emftext.language.java.members.ClassMethod ? result : null);};
		...
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> {EObject result = ((org.emftext.language.java.types.ClassifierReference) o).getTarget(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer_18 = new CachedEdgeExplorer(this, 3, 0, edge_explorer_18_methods);
		name2explorer.put("edge_explorer_18", edge_explorer_18);
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__CORR__javaConstructorToOperation();
		...
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						...
						edge_explorer_20_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.members.ClassMethod) return edge_explorer_20_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_21_methods = new EdgeLookupMethods();
						edge_explorer_21_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.MethodInterfaceParamTypeToParamType__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
			...
			case "Interface_1_object_SP7": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
			...
			case "ClassMethod_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
			...
			case "Parameter_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// parameter
						HMatch match_2 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
			...
			case "ClassifierReference_object_SP1": 
				{
					...
					// typeReference
					HMatch match_3 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
			...
			case "Interface_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
			...
			case "Operation_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_5 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
			...
			case "Parameter_1_object_SP1": 
				{
					...
					// umlParameter
					HMatch match_6 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
			...
			case "JavaClassifierToUmlClassifier_object_SP10": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
			...
			case "JavaMethodToOperation_object_SP1": 
				{
					...
					HMatch match_8 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
			...
			case "JavaParameterToParameter_object_SP3": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
			...
			case "MethodInterfaceParamTypeToParamType__Marker_object": 
				{
					...
					HMatch match_10 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
					match_10.getNodes()[10] = objs[0];
					start(edge_explorer_5_1_orchestration, match_10);
				}
				break;
			case "MethodInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_673_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "MethodInterfaceParamTypeToParamType_typeReference_target_outgoing_SRC__FILTER_NAC_SRC_673_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "uml.TypedElement_type_Type": 
			if(!lazy_initialization) {
				...
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("MethodInterfaceParamTypeToParamType__CONSISTENCY_677_localSearch", 11);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_77.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, parameter.getName(), "java.lang.String"));
		csp_77.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlParameter.getName(), "java.lang.String"));
		csp_77.solve();
