...
public class FieldFinalToFinal__CONSISTENCY_375_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						...
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.members.Field) return edge_explorer_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer = new EdgeExplorer(this, 0, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.FieldFinalToFinal__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Final ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 4, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.FieldFinalToFinal__Marker) o).getCONTEXT__SRC__javaField(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Java2Uml.FieldFinalToFinal__Marker) o).getCONTEXT__CORR__javaClassifierToUmlProperty();
			...
			case "Field_object_SP0": 
				{
					...
					// javaField
					HMatch match_0 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_375_localSearch", 5);
			...
			case "Final_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_375_localSearch", 5);
			...
			case "Property_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlProperty
						HMatch match_2 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_375_localSearch", 5);
			...
			case "JavaAttributeToUmlProperty_object_SP0": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_375_localSearch", 5);
			...
			case "FieldFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_375_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("FieldFinalToFinal__CONSISTENCY_375_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_26.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlProperty.isIsReadOnly(), "boolean"));
		csp_26.solve();
