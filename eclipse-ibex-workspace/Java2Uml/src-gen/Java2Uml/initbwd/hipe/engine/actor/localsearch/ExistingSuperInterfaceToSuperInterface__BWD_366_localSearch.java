...
public class ExistingSuperInterfaceToSuperInterface__BWD_366_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new EdgeExplorer(this, 6, 4, edge_explorer_3_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ExistingSuperInterfaceToSuperInterface__BWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP4": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_366_localSearch", 7);
					...
					HMatch match_2 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_366_localSearch", 7);
			...
			case "Interface_1_object_SP8": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_366_localSearch", 7);
						match_1.getNodes()[1] = objs[0];
						start(edge_explorer_6_1_orchestration, match_1);
						
						// superclassifier
						HMatch match_3 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_366_localSearch", 7);
			...
			case "Interface_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_4 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_366_localSearch", 7);
						match_4.getNodes()[4] = objs[0];
						start(edge_explorer_3_1_orchestration, match_4);
						
						// umlGeneralClassifier
						HMatch match_5 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_366_localSearch", 7);
			...
			case "Generalization_object_SP0": 
				{
					...
					// generalization
					HMatch match_6 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_366_localSearch", 7);
		...
		switch(match.creator) {
			...
			case "ExistingSuperInterfaceToSuperInterface_generalization_general_outgoing_TRG__FILTER_NAC_TRG_362_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_366_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "uml.Generalization_general_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("ExistingSuperInterfaceToSuperInterface__BWD_366_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[5] = msg.target;
					currentDepth++;
