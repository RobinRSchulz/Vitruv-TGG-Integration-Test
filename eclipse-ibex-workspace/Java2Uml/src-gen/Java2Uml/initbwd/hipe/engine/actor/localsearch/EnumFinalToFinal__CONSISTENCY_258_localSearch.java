...
public class EnumFinalToFinal__CONSISTENCY_258_localSearch extends GenericLocalSearchActor{
			...
			case "Enumeration_object_SP4": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_258_localSearch", 5);
			...
			case "Final_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_258_localSearch", 5);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_258_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP10": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_258_localSearch", 5);
			...
			case "EnumFinalToFinal__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_258_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.modifiers.AnnotableAndModifiable_annotationsAndModifiers_AnnotationInstanceOrModifier": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("EnumFinalToFinal__CONSISTENCY_258_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_21.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, true, "java.lang.String"));
		csp_21.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.isIsFinalSpecialization(), "boolean"));
		csp_21.solve();
