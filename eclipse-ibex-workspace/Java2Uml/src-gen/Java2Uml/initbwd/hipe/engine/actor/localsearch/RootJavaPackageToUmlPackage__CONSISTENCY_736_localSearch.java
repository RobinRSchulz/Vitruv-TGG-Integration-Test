...
public class RootJavaPackageToUmlPackage__CONSISTENCY_736_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Java2Uml.RootJavaPackageToUmlPackage__Marker) o).getCREATE__CORR__javaPackageToUmlPackage();
						edge_explorer = new CachedEdgeExplorer(this, 3, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.RootJavaPackageToUmlPackage__Marker) o).getCREATE__TRG__umlPackage(); return (result instanceof uml.Package ? result : null);};
			...
			case "Package_object_SP0": 
				{
					...
					// javaPackage
					HMatch match_0 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_736_localSearch", 4);
			...
			case "Package_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_1 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_736_localSearch", 4);
			...
			case "JavaPackageToUmlPackage_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_736_localSearch", 4);
			...
			case "RootJavaPackageToUmlPackage__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_736_localSearch", 4);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_1_orchestration, match_3);
				}
				break;
			case "RootJavaPackageToUmlPackage_umlPackage_package_incoming_TRG__FILTER_NAC_TRG_731_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "RootJavaPackageToUmlPackage_umlPackage_package_incoming_TRG__FILTER_NAC_TRG_731_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_736_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_736_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register RootJavaPackageToUmlPackage_umlPackage_package_incoming_TRG__FILTER_NAC_TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister RootJavaPackageToUmlPackage_umlPackage_package_incoming_TRG__FILTER_NAC_TRG
		OverlapMatch oMatch_0 = new OverlapMatch(1);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[1];
		Collection<HMatch> oMatches_0 = overlap2matches_0.get(oMatch_0);
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_84.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, javaPackage.getName(), "java.lang.String"));
		csp_84.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlPackage.getName(), "java.lang.String"));
		csp_84.solve();
