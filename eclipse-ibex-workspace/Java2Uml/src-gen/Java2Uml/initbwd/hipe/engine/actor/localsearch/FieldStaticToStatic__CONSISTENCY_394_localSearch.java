...
public class FieldStaticToStatic__CONSISTENCY_394_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Java2Uml.FieldStaticToStatic__Marker) o).getCONTEXT__CORR__javaClassifierToUmlProperty();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.FieldStaticToStatic__Marker) o).getCONTEXT__TRG__umlProperty(); return (result instanceof uml.Property ? result : null);};
