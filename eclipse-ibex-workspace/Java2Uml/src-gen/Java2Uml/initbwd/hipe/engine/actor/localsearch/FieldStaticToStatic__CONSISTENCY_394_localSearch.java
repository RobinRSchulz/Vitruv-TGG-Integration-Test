...
public class FieldStaticToStatic__CONSISTENCY_394_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((org.emftext.language.java.modifiers.AnnotableAndModifiable) o).getAnnotationsAndModifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.modifiers.Static).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.FieldStaticToStatic__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Static ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.FieldStaticToStatic__Marker) o).getCONTEXT__SRC__javaField(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
			...
			case "Field_object_SP1": 
				{
					...
					// javaField
					HMatch match_0 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_394_localSearch", 5);
			...
			case "Static_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_394_localSearch", 5);
			...
			case "Property_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlProperty
						HMatch match_2 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_394_localSearch", 5);
			...
			case "JavaAttributeToUmlProperty_object_SP1": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_394_localSearch", 5);
			...
			case "FieldStaticToStatic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_394_localSearch", 5);
		...
		case "Java2Uml.FieldStaticToStatic__Marker_CONTEXT__TRG__umlProperty_Property": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Property) {
				{
					...
					HMatch match = new LocalSearchMatch("FieldStaticToStatic__CONSISTENCY_394_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_28.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlProperty.isIsStatic(), "boolean"));
		csp_28.solve();
