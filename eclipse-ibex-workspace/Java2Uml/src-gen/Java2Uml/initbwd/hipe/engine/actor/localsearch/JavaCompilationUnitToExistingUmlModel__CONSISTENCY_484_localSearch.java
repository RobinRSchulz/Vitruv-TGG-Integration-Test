...
public class JavaCompilationUnitToExistingUmlModel__CONSISTENCY_484_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToUmlModel) o).getSource(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 4, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((Java2Uml.JavaCompilationUnitToExistingUmlModel__Marker) o).getCREATE__CORR__newJavaCompUnitToUmlModel();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToExistingUmlModel__Marker) o).getCREATE__SRC__newCompilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaCompilationUnitToExistingUmlModel__Marker) o).getCONTEXT__TRG__umlModel(); return (result instanceof uml.Model ? result : null);};
			...
			case "CompilationUnit_object_SP0": 
				{
					...
					// compilationUnit
					HMatch match_0 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_484_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_5_2_orchestration, match_0);
					
					// newCompilationUnit
					HMatch match_2 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_484_localSearch", 7);
			...
			case "Package_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_1 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_484_localSearch", 7);
			...
			case "Model_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlModel
						HMatch match_3 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_484_localSearch", 7);
			...
			case "JavaCompilationUnitToUmlModel_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_484_localSearch", 7);
					...
					HMatch match_5 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_484_localSearch", 7);
			...
			case "JavaCompilationUnitToExistingUmlModel__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_484_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "org.emftext.language.java.containers.Package_compilationUnits_CompilationUnit": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("JavaCompilationUnitToExistingUmlModel__CONSISTENCY_484_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[1] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_38.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, "UML_MODEL", "java.lang.String"));
		csp_38.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlModel.getName(), "java.lang.String"));
		csp_38.solve();
