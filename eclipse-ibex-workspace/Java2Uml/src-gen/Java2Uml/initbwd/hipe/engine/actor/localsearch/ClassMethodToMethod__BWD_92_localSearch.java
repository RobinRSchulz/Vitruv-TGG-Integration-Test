...
public class ClassMethodToMethod__BWD_92_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassMethodToMethod__BWD_production"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP10": 
				{
					...
					// j
					HMatch match_0 = new LocalSearchMatch("ClassMethodToMethod__BWD_92_localSearch", 4);
			...
			case "Class_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						HMatch match_1 = new LocalSearchMatch("ClassMethodToMethod__BWD_92_localSearch", 4);
			...
			case "Class_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassMethodToMethod__BWD_92_localSearch", 4);
			...
			case "Operation_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_3 = new LocalSearchMatch("ClassMethodToMethod__BWD_92_localSearch", 4);
		...
		switch(match.creator) {
			...
			case "ClassMethodToMethod_umlOperation_ownedOperation_incoming_TRG__FILTER_NAC_TRG_89_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassMethodToMethod__BWD_92_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassMethodToMethod__BWD_92_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
