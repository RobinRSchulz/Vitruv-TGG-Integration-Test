...
public class InterfaceToUmlInterface__CONSISTENCY_488_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Interface ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 7, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((uml.Package) o).getPackagedElement().stream().filter(obj -> obj instanceof uml.Interface).collect(Collectors.toList());
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof uml.Package) return edge_explorer_3_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_3 = new EdgeExplorer(this, 4, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__CORR__javaClassToUmlClass();
						edge_explorer_4 = new CachedEdgeExplorer(this, 7, 5, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCREATE__TRG__umlClassifier(); return (result instanceof uml.Interface ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 7, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__SRC__compilationUnit(); return (result instanceof org.emftext.language.java.containers.CompilationUnit ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((org.emftext.language.java.containers.CompilationUnit) o).getClassifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.classifiers.Interface).collect(Collectors.toList());
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.containers.CompilationUnit) return edge_explorer_7_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__SRC__javaPackage(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaPackageToUmlPackage) o).getSource(); return (result instanceof org.emftext.language.java.containers.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaPackageToUmlPackage) o).getTarget(); return (result instanceof uml.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__TRG__umlPackage(); return (result instanceof uml.Package ? result : null);};
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((Java2Uml.InterfaceToUmlInterface__Marker) o).getCONTEXT__CORR__javaPackToUmlPack();
			...
			case "Interface_1_object_SP5": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_488_localSearch", 8);
			...
			case "CompilationUnit_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// compilationUnit
						HMatch match_1 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_488_localSearch", 8);
			...
			case "Package_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// javaPackage
						HMatch match_2 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_488_localSearch", 8);
			...
			case "Interface_object_SP7": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_488_localSearch", 8);
			...
			case "Package_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_4 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_488_localSearch", 8);
			...
			case "JavaClassifierToUmlClassifier_object_SP0": 
				{
					...
					// javaClassToUmlClass
					HMatch match_5 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_488_localSearch", 8);
			...
			case "JavaPackageToUmlPackage_object_SP1": 
				{
					...
					// javaPackToUmlPack
					HMatch match_6 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_488_localSearch", 8);
			...
			case "InterfaceToUmlInterface__Marker_object": 
				{
					...
					HMatch match_7 = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_488_localSearch", 8);
		...
		case "Java2Uml.InterfaceToUmlInterface__Marker_CREATE__SRC__classifier_Interface": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.classifiers.Interface) {
				{
					...
					HMatch match = new LocalSearchMatch("InterfaceToUmlInterface__CONSISTENCY_488_localSearch", 8);
					Object[] objs = match.getNodes();
					objs[7] = msg.source;
					objs[0] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_38.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, classifier.getName(), "java.lang.String"));
		csp_38.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getName(), "java.lang.String"));
		csp_38.solve();
