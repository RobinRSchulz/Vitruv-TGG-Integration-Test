...
public class EnumPublicToPublic__CONSISTENCY_289_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Java2Uml.EnumPublicToPublic__Marker) o).getCONTEXT__CORR__javaClassifierToUmlClassifier();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((org.emftext.language.java.modifiers.AnnotableAndModifiable) o).getAnnotationsAndModifiers().stream().filter(obj -> obj instanceof org.emftext.language.java.modifiers.Public).collect(Collectors.toList());
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumPublicToPublic__Marker) o).getCONTEXT__SRC__javaConcreteClassifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumPublicToPublic__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
			...
			case "Enumeration_object_SP2": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_289_localSearch", 5);
			...
			case "Public_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_289_localSearch", 5);
			...
			case "Enumeration_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_289_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP15": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_289_localSearch", 5);
			...
			case "EnumPublicToPublic__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_289_localSearch", 5);
		...
		case "Java2Uml.EnumPublicToPublic__Marker_CREATE__SRC__modifier_Public": 
			if(!lazy_initialization) {
				if(msg.target instanceof org.emftext.language.java.modifiers.Public) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumPublicToPublic__CONSISTENCY_289_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic csp_25 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPublic();
		csp_25.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_25.solve();
