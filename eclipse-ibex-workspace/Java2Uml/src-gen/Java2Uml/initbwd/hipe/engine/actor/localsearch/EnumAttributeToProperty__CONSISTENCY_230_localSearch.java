...
public class EnumAttributeToProperty__CONSISTENCY_230_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Java2Uml.EnumAttributeToProperty__Marker) o).getCREATE__CORR__attributeToProperty();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumAttributeToProperty__Marker) o).getCREATE__TRG__property(); return (result instanceof uml.Property ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumAttributeToProperty__Marker) o).getCREATE__SRC__field(); return (result instanceof org.emftext.language.java.members.Field ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumAttributeToProperty__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumAttributeToProperty__Marker) o).getCONTEXT__SRC__classifier(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.multi_lookup = (o) -> ((org.emftext.language.java.members.MemberContainer) o).getMembers().stream().filter(obj -> obj instanceof org.emftext.language.java.members.Field).collect(Collectors.toList());
						edge_explorer_10_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.emftext.language.java.classifiers.Enumeration) return edge_explorer_10_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((Java2Uml.EnumAttributeToProperty__Marker) o).getCONTEXT__CORR__classToUmlClass();
			...
			case "Enumeration_object_SP5": 
				{
					...
					// classifier
					HMatch match_0 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_230_localSearch", 7);
			...
			case "Field_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// field
						HMatch match_1 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_230_localSearch", 7);
			...
			case "Property_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_2 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_230_localSearch", 7);
			...
			case "Enumeration_1_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_3 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_230_localSearch", 7);
			...
			case "JavaAttributeToUmlProperty_object_SP0": 
				{
					...
					// attributeToProperty
					HMatch match_4 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_230_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP7": 
				{
					...
					// classToUmlClass
					HMatch match_5 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_230_localSearch", 7);
			...
			case "EnumAttributeToProperty__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_230_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "EnumAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_222_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "EnumAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_222_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_230_localSearch", 7);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.DataType_ownedAttribute_Property": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("EnumAttributeToProperty__CONSISTENCY_230_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[3] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_18.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, property.getName(), "java.lang.String"));
		csp_18.solve();
