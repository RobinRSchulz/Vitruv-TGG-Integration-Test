...
public class EnumConstantToEnumConstant__CONSISTENCY_263_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__CORR__javaEnumConstantToUmlEnumLiteral();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__TRG__umlLiteral(); return (result instanceof uml.EnumerationLiteral ? result : null);};
