...
public class EnumConstantToEnumConstant__CONSISTENCY_263_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__CORR__j();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__SRC__javaConstant(); return (result instanceof org.emftext.language.java.members.EnumConstant ? result : null);};
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.multi_lookup = (o) -> ((uml.Enumeration) o).getOwnedLiteral();
						edge_explorer_11_methods.unique_opposite_lookup = (o) -> ((uml.EnumerationLiteral) o).getEnumeration();
