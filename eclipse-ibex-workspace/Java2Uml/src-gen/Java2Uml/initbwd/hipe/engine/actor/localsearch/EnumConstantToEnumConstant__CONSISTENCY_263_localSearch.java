...
public class EnumConstantToEnumConstant__CONSISTENCY_263_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__TRG__umlLiteral(); return (result instanceof uml.EnumerationLiteral ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__CORR__javaEnumConstantToUmlEnumLiteral();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 5, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaEnumConstantToUmlEnumLiteral) o).getTarget(); return (result instanceof uml.EnumerationLiteral ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Enumeration) o).getConstants();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__TRG__umlEnum(); return (result instanceof uml.Enumeration ? result : null);};
