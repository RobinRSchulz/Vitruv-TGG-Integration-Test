...
public class EnumConstantToEnumConstant__CONSISTENCY_263_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__CORR__j();
						edge_explorer = new CachedEdgeExplorer(this, 6, 4, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__SRC__javaEnum(); return (result instanceof org.emftext.language.java.classifiers.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((org.emftext.language.java.classifiers.Enumeration) o).getConstants();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCONTEXT__TRG__umlEnum(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaEnumConstantToUmlEnumLiteral) o).getTarget(); return (result instanceof uml.EnumerationLiteral ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__SRC__javaConstant(); return (result instanceof org.emftext.language.java.members.EnumConstant ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.JavaEnumConstantToUmlEnumLiteral) o).getSource(); return (result instanceof org.emftext.language.java.members.EnumConstant ? result : null);};
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.multi_lookup = (o) -> ((uml.Enumeration) o).getOwnedLiteral();
						edge_explorer_10_methods.unique_opposite_lookup = (o) -> ((uml.EnumerationLiteral) o).getEnumeration();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__CORR__javaEnumConstantToUmlEnumLiteral();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumConstantToEnumConstant__Marker) o).getCREATE__TRG__umlLiteral(); return (result instanceof uml.EnumerationLiteral ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("EnumConstantToEnumConstant__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "EnumConstant_object": 
				{
					
					// javaConstant
					HMatch match_0 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_263_localSearch", 7);
			...
			case "Enumeration_object_SP4": 
				{
					if(!lazy_initialization) {
						...
						// javaEnum
						HMatch match_1 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_263_localSearch", 7);
			...
			case "Enumeration_1_object_SP3": 
				{
					if(!lazy_initialization) {
						...
						// umlEnum
						HMatch match_2 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_263_localSearch", 7);
						match_2.getNodes()[2] = objs[0];
						start(edge_explorer_4_1_orchestration, match_2);
					}
				}
				break;
			case "EnumerationLiteral_object": 
				{
					if(!lazy_initialization) {
						
						// umlLiteral
						HMatch match_3 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_263_localSearch", 7);
			...
			case "JavaClassifierToUmlClassifier_object_SP11": 
				{
					...
					// j
					HMatch match_4 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_263_localSearch", 7);
			...
			case "JavaEnumConstantToUmlEnumLiteral_object": 
				{
					...
					HMatch match_5 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_263_localSearch", 7);
			...
			case "EnumConstantToEnumConstant__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_263_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
			...
			if(!lazy_initialization) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_263_localSearch", 7);
					Object[] objs = match.getNodes();
					objs[6] = msg.source;
					objs[4] = msg.target;
					currentDepth++;
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			...
			break;
		case "org.emftext.language.java.classifiers.Enumeration_constants_EnumConstant": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_263_localSearch", 7);
					Object[] objs = match.getNodes();
		...
		case "Java2Uml.JavaEnumConstantToUmlEnumLiteral_source_EnumConstant": 
			...
			break;
		case "uml.Enumeration_ownedLiteral_EnumerationLiteral": 
			if(!lazy_initialization) {
				{
					HMatch match = new LocalSearchMatch("EnumConstantToEnumConstant__CONSISTENCY_263_localSearch", 7);
					Object[] objs = match.getNodes();
	...
	protected void registerMatch(HMatch match) {
		...
		// register javaEnumConstantToUmlEnumLiteral
		...
		// register EnumConstantToEnumConstant_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister javaEnumConstantToUmlEnumLiteral
		Collection<HMatch> matches_5 = obj2matches.get(objs[5]);
		if(matches_5 != null) {
			matches_5.remove(match);
		}
		
		// deregister EnumConstantToEnumConstant_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
	...
	public boolean constraint_checker_method(HMatch match) {
		org.emftext.language.java.members.EnumConstant javaConstant = (org.emftext.language.java.members.EnumConstant) match.getNodes()[0];
		uml.EnumerationLiteral umlLiteral = (uml.EnumerationLiteral) match.getNodes()[3];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_21 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_21.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, javaConstant.getName(), "java.lang.String"));
		csp_21.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlLiteral.getName(), "java.lang.String"));
		csp_21.solve();
