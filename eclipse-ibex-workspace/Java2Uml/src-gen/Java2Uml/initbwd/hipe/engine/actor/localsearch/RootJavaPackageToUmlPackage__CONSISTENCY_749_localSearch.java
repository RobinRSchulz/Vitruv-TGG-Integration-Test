...
public class RootJavaPackageToUmlPackage__CONSISTENCY_749_localSearch extends GenericLocalSearchActor{
			...
			case "Package_object_SP0": 
				{
					...
					// javaPackage
					HMatch match_0 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_749_localSearch", 4);
			...
			case "Package_1_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlPackage
						HMatch match_1 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_749_localSearch", 4);
			...
			case "JavaPackageToUmlPackage_object_SP0": 
				{
					...
					HMatch match_2 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_749_localSearch", 4);
			...
			case "RootJavaPackageToUmlPackage__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_749_localSearch", 4);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_1_orchestration, match_3);
				}
				break;
			case "RootJavaPackageToUmlPackage_umlPackage_package_incoming_TRG__FILTER_NAC_TRG_744_localSearch": 
				{
		...
		switch(match.creator) {
			...
			case "RootJavaPackageToUmlPackage_umlPackage_package_incoming_TRG__FILTER_NAC_TRG_744_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_749_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaPackageToUmlPackage_target_Package": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Package) {
				{
					...
					HMatch match = new LocalSearchMatch("RootJavaPackageToUmlPackage__CONSISTENCY_749_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[1] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_85.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, javaPackage.getName(), "java.lang.String"));
		csp_85.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlPackage.getName(), "java.lang.String"));
		csp_85.solve();
