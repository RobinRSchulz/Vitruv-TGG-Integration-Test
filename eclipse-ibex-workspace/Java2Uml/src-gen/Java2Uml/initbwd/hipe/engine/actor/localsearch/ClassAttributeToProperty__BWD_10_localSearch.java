...
public class ClassAttributeToProperty__BWD_10_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ClassAttributeToProperty__BWD_production"), this::returnTrue  , false ));
	}
			...
			case "JavaClassifierToUmlClassifier_object_SP1": 
				{
					...
					// classToUmlClass
					HMatch match_0 = new LocalSearchMatch("ClassAttributeToProperty__BWD_10_localSearch", 4);
			...
			case "Class_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// classifier
						HMatch match_1 = new LocalSearchMatch("ClassAttributeToProperty__BWD_10_localSearch", 4);
			...
			case "Class_1_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("ClassAttributeToProperty__BWD_10_localSearch", 4);
			...
			case "Property_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// property
						HMatch match_3 = new LocalSearchMatch("ClassAttributeToProperty__BWD_10_localSearch", 4);
		...
		switch(match.creator) {
			...
			case "ClassAttributeToProperty_property_ownedAttribute_incoming_TRG__FILTER_NAC_TRG_7_localSearch": 
				if(nac_checker.deregister(match)) {
					HMatch acMatch_0 = new LocalSearchMatch("ClassAttributeToProperty__BWD_10_localSearch", 4);
					Object[] acMatch_nodes_0 = acMatch_0.getNodes();
		...
		case "Java2Uml.JavaClassifierToUmlClassifier_target_Classifier": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Class) {
				{
					...
					HMatch match = new LocalSearchMatch("ClassAttributeToProperty__BWD_10_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[0] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
