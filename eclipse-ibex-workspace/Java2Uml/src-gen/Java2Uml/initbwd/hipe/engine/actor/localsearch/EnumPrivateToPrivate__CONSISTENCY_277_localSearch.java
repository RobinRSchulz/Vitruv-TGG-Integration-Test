...
public class EnumPrivateToPrivate__CONSISTENCY_277_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumPrivateToPrivate__Marker) o).getCONTEXT__TRG__umlClassifier(); return (result instanceof uml.Enumeration ? result : null);};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((Java2Uml.EnumPrivateToPrivate__Marker) o).getCREATE__SRC__modifier(); return (result instanceof org.emftext.language.java.modifiers.Private ? result : null);};
			...
			case "Enumeration_object_SP0": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_277_localSearch", 5);
			...
			case "Private_object": 
				{
					if(!lazy_initialization) {
						...
						// modifier
						HMatch match_1 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_277_localSearch", 5);
			...
			case "Enumeration_1_object_SP0": 
				{
					if(!lazy_initialization) {
						...
						// umlClassifier
						HMatch match_2 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_277_localSearch", 5);
			...
			case "JavaClassifierToUmlClassifier_object_SP13": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_277_localSearch", 5);
			...
			case "EnumPrivateToPrivate__Marker_object": 
				{
					...
					HMatch match_4 = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_277_localSearch", 5);
		...
		case "Java2Uml.EnumPrivateToPrivate__Marker_CONTEXT__TRG__umlClassifier_Enumeration": 
			if(!lazy_initialization) {
				if(msg.target instanceof uml.Enumeration) {
				{
					...
					HMatch match = new LocalSearchMatch("EnumPrivateToPrivate__CONSISTENCY_277_localSearch", 5);
					Object[] objs = match.getNodes();
					objs[4] = msg.source;
					objs[2] = msg.target;
					currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPrivate csp_23 = new org.emoflon.ibex.tgg.operational.csp.constraints.custom.java2uml.UserDefined_expectPrivate();
		csp_23.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, umlClassifier.getVisibility(), "Enum::VisibilityKind"));
		csp_23.solve();
