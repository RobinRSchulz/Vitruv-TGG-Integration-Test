...
public class OrdinaryMethodParameterToParameter__BWD_731_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("OrdinaryMethodParameterToParameter__BWD_production"), this::returnTrue  , false ));
	}
			...
			case "JavaMethodToOperation_object_SP5": 
				{
					...
					HMatch match_0 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__BWD_731_localSearch", 4);
			...
			case "ClassMethod_object_SP1": 
				{
					if(!lazy_initialization) {
						...
						// javaParametrizable
						HMatch match_1 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__BWD_731_localSearch", 4);
			...
			case "Operation_object_SP2": 
				{
					if(!lazy_initialization) {
						...
						// umlOperation
						HMatch match_2 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__BWD_731_localSearch", 4);
			...
			case "Parameter_1_object_SP6": 
				{
					if(!lazy_initialization) {
						...
						// umlParameter
						HMatch match_3 = new LocalSearchMatch("OrdinaryMethodParameterToParameter__BWD_731_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "uml.BehavioralFeature_ownedParameter_Parameter": 
			if(!lazy_initialization) {
				...
				{
					HMatch match = new LocalSearchMatch("OrdinaryMethodParameterToParameter__BWD_731_localSearch", 4);
					Object[] objs = match.getNodes();
					objs[2] = msg.source;
					objs[3] = msg.target;
					currentDepth++;
